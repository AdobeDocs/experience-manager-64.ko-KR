---
title: AEM 6.4 릴리스 노트
seo-title: AEM 6.4 릴리스 노트
description: AEM 릴리스 노트에는 새로운 기능, 지원되는 플랫폼, 가치 하락 및 제거된 기능, 알려진 문제 등 최신 릴리스의 AEM에 대한 중요한 정보가 수록되어 있습니다.
seo-description: AEM 릴리스 노트에는 새로운 기능, 지원되는 플랫폼, 가치 하락 및 제거된 기능, 알려진 문제 등 최신 릴리스의 AEM에 대한 중요한 정보가 수록되어 있습니다.
...
AEM 릴리스 노트에는 새로운 기능, 지원되는 플랫폼, 가치 하락 및 제거된 기능, 알려진 문제 등 최신 릴리스의 AEM에 대한 중요한 정보가 수록되어 있습니다.
...
| 사용 안내서 | 설명 |
|--- |---|
| [자산 사용 안내서](/help/assets/home.md) | 디지털 자산을 제작, 관리, 전달 및 최적화할 수 있습니다. |
...
자세한 내용은 https://www.adobe.com/legal/terms/enterprise-licensing.html을 [참조하십시오](https://www.adobe.com/legal/terms/enterprise-licensing.html)
