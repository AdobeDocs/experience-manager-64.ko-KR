...
* HTTP 연결 시간 초과가 구성에서 읽히지 않습니다. NPR-29264: SLING-7902용 핫픽스
...
* (HTML 작업 공간) 사용자가 작업을 요청하면 해당 사용자에 대한 큐 개수를 새로 고치지만 다른 사용자의 경우 페이지를 새로 고쳐야만 큐 개수를 새로 고칩니다. 이 문제는 새 속성에 의해 수정되었습니다. 이 새 속성을 AEM 인스턴스에 구성하려면 해당 구성 설정을 참조하십시오. NPR-24536: CQ-4233665용 핫픽스
