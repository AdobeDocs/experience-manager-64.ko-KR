...
* Experience Manager 클라우드 서비스에서 Adobe Analytics을 구성하는 동안 **보고 소스**&#x200B;가 선택되면 **회사** 및 **보고** 세트 드롭다운 메뉴가 숨겨집니다(NPR-31729).
...
* 디자이너:표에 병합된 셀이 있으면 출력 서비스를 사용하여 XDP 양식에서 변환된 출력 PDF 파일에 대해 액세서빌러티 테스트가 실패합니다(NPR-32079).
...
* Dynamic Media 인코딩 비디오 워크플로에서 Scene 7에서 Dynamic Media - Scene 7 실행 모드로 마이그레이션된 비디오의 축소판을 생성하지 못합니다(NPR-31523).
...
* 복제 내용 com.day.cq.replication.AccessDeniedException을 작성하는 동안 오류가 발생했습니다. NPR-28314: CQ-4261401용 핫픽스
...
* Wan 적응형 양식이 빈 템플릿으로 작성되면 고객은 양식의 루트 패널에 하위 패널을 추가할 수 없습니다. NPR-28758: CQ-4264157용 핫픽스
...
* 적응형 양식의 레이지 로드된 조각 필드 사이에 값을 설정할 수 없습니다. NPR-27758: CQ-4259703용 핫픽스
...
* 적응형 양식의 레이지 로드된 조각 필드 사이에 값을 설정할 수 없습니다. NPR-28320: CQ-4262345용 핫픽스
* 적응형 양식에서는 리치 텍스트 편집기를 사용하지 않고 라이브러리를 로드합니다.  NPR-28001: CQ-4259703, CQ-4259193용 핫픽스
* Apple iOS 12.1에서 실행되는 AEM Forms 앱에서는 스크리블 서명이 작동하지 않습니다. NPR-28497:CQ-4261765 핫픽스
* 6.4의 &#39;Forms Workflow&#39; 클래식 작성 문제를 사용하여 작업 제출. CQ-4252740 핫픽스
...
* 디지털 서명 사용 또는 문서를 청구 가능한 거래로 인증하는 지원을 추가했습니다. NPR-28495: CQ-4260236용 핫픽스
* 청구 가능한 API에 디지털 서명 및 인증을 추가했습니다. CQ-4260236용 핫픽스

**Forms 관리**

Forms Manager의 시작 검토 마법사 및 자산 이동 마법사에 handlebars 클라이언트 라이브러리를 밑줄로 대체하는 지원을 추가했습니다. NPR-27643: CQ-4246536용 핫픽스.
릴리스/640 분기에 Forms 관리 패키지를 설치한 후에도 하나의 번들이 설치 상태로 유지됩니다. CQ-4265410 핫픽스
첨부 파일과 함께 제출된 Forms이 제출 작업 &quot;AEM Forms Workflow 호출&quot; 및 선택한 포털 제출 활성화와 함께 워크플로우에 나타나지 않습니다. CQ-4263110용 핫픽스

**Forms - 백엔드 통합**

* 클라이언트 SDK, CQ-4238469 핫픽스를 사용하여 사전/사후 프리프로세서 및 사용자 정의 제출을 테스트할 수 없습니다.
...
* JBoss 7에서는 기본 제출 프로세스를 갖는 HTML5 Forms이 작동하지 않습니다. NPR-28675: CQ-4243928용 핫픽스
* HTML 작업 영역에서 PDF forms을 제출할 수 없습니다. NPR-28058: CQ-4260373용 핫픽스
* 고객 데이터는 FDM 서비스 Forms Workflow 호출을 사용하여 정보 로그에 출력됩니다. CQ-4260385용 핫픽스
...
* OSGI 구성 **AEM 워크플로 해지 기능 플래그**&#x200B;에 활성화된 기능입니다. 해지 작업은 플래그를 설정한 후 워크플로우 인스턴스를 종료해야 합니다. NPR-26451: CQ-4259090용 핫픽스
...
AEM 6.4.3.0은 2018년 4월 AEM 6.4의 공식 출시 이후에 릴리스된 성능, 안정성, 보안 및 주요 고객 수정 사항과 개선 사항을 포함하는 중요한 업데이트입니다.

또한 누적되어 모든 AEM 6.4 서비스 팩 릴리스 이전에 6.4.3.0이 포함되어 있습니다.

AEM 6.4.3.0의 주요 특징 중 몇 가지는 다음과 같습니다.

* 내장된 저장소(Apache Jackrabbit Oak)가 버전 1.8.9으로 업데이트되었습니다.
* 적응형 양식 템플릿에 allowedPaths 속성에 대한 지원을 추가했습니다.
* AEM에서 에셋에 대한 향상된 패널 기반 검색
* 로그인 페이지에서 XSS(교차 사이트 스크립팅)가 수정되었습니다.
* UI 계측이 개선되었습니다.
* FormData 처리 개선.
* 다중 필드 내의 항목 이름 지정 처리가 개선되었습니다.
...
* 검색 결과에서 자산을 본 후 브라우저에서 [뒤로] 단추를 클릭하면 400 오류 코드가 있는 &#39;잘못된 요청&#39; 오류 메시지가 표시됩니다. NPR 26578;CQ-4253741 핫픽스
* 서비스 팩을 설치한 후 자산 메타데이터에 잘못된 네임스페이스 오류가 표시됩니다. NPR-22341;CQ-4237202 빠른 수정
* 목록 보기에서 폴더 및 컨텐츠 조각 순서를 변경하는 옵션은 해당 폴더에 대해 표시되지 않습니다. NPR-27153;CQ-4255873 핫픽스
* 사용자는 오류 팝업 대화 상자에서 이미지가 끊어진 오류 메시지가 표시되므로 새 컬렉션에 자산을 추가할 수 없습니다. NPR-22431;CQ-4237086 핫픽스
* 동적 드롭다운 목록에서 계단식 드롭다운이 지원되지 않습니다. NPR-27043;CQ-4252564 핫픽스
* 사용자가 DMS7 클라우드 구성에서 &#39;회사 루트 폴더&#39;에 대한 기본값이 아닌 값을 설정하면 뷰어 사전 설정이 예상대로 작동하지 않습니다. NPR-26360;CQ-4249505 핫픽스
* 자산 수가 매우 많은 인스턴스에 대해 자산 보고가 실패합니다. NPR-27278;CQ-4256748 핫픽스
* 하위 폴더는 상위 폴더의 SmartCrop 이미지 프로필을 상속하지 않습니다. NPR-27197;CQ-4256273 핫픽스
* Dynamic Media 통합이 활성화되면 자산의 일부 메타데이터 속성이 수정됩니다. 폭, 높이 및 위치 속성은 표시되지 않습니다. NPR-27203;CQ-4256258 핫픽스
* Dynamic Media은 일부 유형의 자산에 대해 구성된 프록시를 사용하지 않습니다. NPR-25211;CQ-4244871 핫픽스
* 메타데이터 편집기 페이지에 잘못된 항목 매개 변수에 대한 Null 포인터 예외가 있습니다. NPR-26169;CQ-4241368 핫픽스.
...
* 리치 텍스트 편집기의 목록 플러그인은 자동으로 비활성화되며 수정을 허용하지 않습니다. NPR-26507: CQ-4239387용 핫픽스
...
* 작성 인스턴스에서 게시 인스턴스로 하위 규칙이 활성화되면 게시 인스턴스가 작업을 중지합니다. NPR-26601: CQ-4253588용 핫픽스
...
* 나중에 게시 관리 옵션을 사용하여 활성화할 페이지를 예약하고 목록 보기로 전환하면 달력 아이콘이 없습니다. NPR-26974: CQ-4239206용 핫픽스
* 사용자는 페이지 속성에서 닫힌 사용자 그룹 권한을 편집할 수 없습니다. NPR-27138:CQ-4256089 핫픽스
태그를 지정하여 태그를 편집할 수 없습니다. NPR-26957: CQ-4254858용 핫픽스
* 구조화된 컨텐츠 조각 모델에서 참조되는 태그가 이동하면 컨텐츠 조각 내의 태그에 대한 기존 참조는 업데이트되지 않습니다. 이 작업은 컨텐츠 조각 모델의 편집 화면에서 발생합니다. NPR-26776: CQ-4251805용 핫픽스
* 여러 페이지로 구성된 론치를 만들고 홍보할 때 각 페이지에 대한 여러 버전이 만들어집니다. NPR-26917: CQ-4254663용 핫픽스
...
* 빈 경험 조각을 포함하는 템플릿으로 페이지를 만들고 게시하면 페이지가 열리지 않고 DefaultSlingScript 오류가 발생합니다. NPR-26305: CQ-4252460용 핫픽스
* 동일한 이름의 클래스와 함께 데이터-슬라이스를 사용하면 비호환 코드가 생성됩니다. NPR-27282: Sling-7581용 핫픽스
* 업그레이드 SP 설치 후 사이트에 블루프린트 롤아웃 구성이 없습니다. NPR-27609: CQ-4257078용 핫픽스

**DAM - 브랜드 포털**

* 메타데이터 스키마 양식이 브랜드 포털에 게시되면 태그 예측이 게시되지 않습니다. CQ-4256218용 핫픽스
* 상위 폴더를 게시하지 않고 AEM에서 브랜드 포털로 3차 수준 폴더를 게시하면 폴더 이름이 변경됩니다. CQ-4255423용 핫픽스
* 경로 브라우저 조건자는 예상대로 AEM Assets에서 브랜드 포털로 게시됩니다. 그러나 BP의 게시된 경로는 업데이트해야 하는 /content/dam으로 유지됩니다. CQ-4256240용 핫픽스

**DAM - Creative Cloud**

* &quot;Adobe 자산 검색&quot; 아이콘이 AEM 주 탐색에서 누락되었습니다. CQ-4254343용 핫픽스

**DAM - DM 클라이언트**

* 비디오를 AVS 비디오 처리 프로필과 연관된 폴더로 인제스트한 후 브라우저 창이 계속 새로 고쳐집니다. CQ-4253563용 핫픽스
...
* Dynamic Media은 일부 유형의 자산에 대해 구성된 프록시를 사용하지 않습니다. NPR-10727;CQ-4244871 핫픽스

**플랫폼**

* org.apache.sling.i18n의 성능 문제 NPR-26812:SLING-7543에 대한 핫픽스
...
* 6.2에서 6.4로 업그레이드한 후 로그 파일에는 닫히지 않은 리소스 확인자 com.adobe.granite.repository.hc.impl.content.sling.SlingContentHealthCheck에 대한 스택 추적이 표시됩니다. NPR-26176: Granite-21734용 핫픽스
...
* 제한적 페이지(폐쇄된 사용자 그룹 페이지):별칭은 사용자를 로그인 페이지로 리디렉션하지 않습니다. NPR-25715:Granite=22263용 핫픽스
* 태그 게시 시 UI에 활동이 표시되지 않습니다. CQ-4255961용 핫픽스
* 클래식 UI에서 태그를 편집할 수 없습니다. CQ-4258697용 핫픽스
* org.apache.felix.http.bridge를 버전 4.0.4으로 업데이트했습니다. NPR-27038:Granite - 23334 백포트
...
* ACP API는 하위 디렉터리 하위만 사용하여 페이징을 잘못 처리했습니다. NPR-27617: CQ-4258639용 핫픽스
...
* 감사 로그는 매일 750개 이하로 지속적으로 증가하는 활성 세션을 통해 열려 있습니다. NPR-27062: CQ-4241350용 핫픽스

**커뮤니티**

* 포럼 게시물과 답글은 두 번째 페이지 상단에 추가되고, 새로 고치면 게시물이 첫 번째 페이지 상단의 올바른 위치로 이동됩니다. NPR-27342: CQ-4247338용 핫픽스
* 모든 리소스에 대한 링크는 스크롤 후 컨텍스트 경로(/aempublish)를 삭제합니다. NPR-26982: CQ-4254345용 핫픽스
* 게시된 사이트를 편집할 때 커뮤니티 관리자, 커뮤니티 중재자 및 권한 있는 구성원 드롭다운에 추가된 그룹이 표시되지 않습니다. NPR-27190: CQ-4258574용 핫픽스
* 그룹 목록에 페이지 매김을 활성화한 경우에도 활성 리소스 페이지에 그룹이 10개만 표시됩니다. NPR-26934: CQ-4252985용 핫픽스
...
* 커뮤니티 메시지의 받는 사람 필드에서 이름 및 성을 사용하여 검색해도 예상 결과가 반환되지 않습니다. NPR-26385: CQ-4248673용 핫픽스
* 포럼에서 이미지(예: .pdf) 이외의 첨부 파일을 업로드할 때 오류가 관찰되었습니다. NPR-27360: CQ-4257753용 핫픽스
* 작성자-게시가 MySQL DSRP로 설정된 경우 포럼 게시물의 고정 해제 또는 해제 기능이 작동하지 않습니다. NPR-26125;CQ-4251520 핫픽스
* 이제 컬렉션 구성 요소(포럼, 블로그, 일정, 아이디어, QnA)에 WCM 편집 모드에서 UGC 로드를 허용/거부하기 위해 &quot;작성자 편집 모드에서 UGC 차단&quot;을 활성화/비활성화하는 속성이 구성 요소 대화 상자에 있습니다. NPR-26978: CQ-4248161용 핫픽스
* 태그 검색은 현지화된 검색어에 대해 작동하지 않습니다. NPR-26171: CQ-4249926용 핫픽스
...
* 구성 요소의 주석 섹션에 있는 페이지 매김을 사용하면 페이지 매김을 통해 페이지에 도달하면서 페이지 컨텐츠를 보기 위해 위로 스크롤할 수 있습니다. NPR-27032: CQ-4251228용 핫픽스
* AEM 작성자 인스턴스의 관리 콘솔에서 볼 때 축소판 이미지에서 커뮤니티 사이트 폴더를 클릭할 수 없습니다. NPR-26986: CQ-4254036용 핫픽스
* &quot;모든 읽음 표시&quot; 옵션은 처음 10개의 알림만 읽음으로 표시하고 다른 알림은 페이지를 새로 고칠 때까지 읽지 않습니다. NPR-27037: CQ-4254058용 핫픽스
* 페이지 매김은 관념화에 대해 트리거되지 않으며 항목(또는 답글) 목록이 다시 로드되지 않는 한 더 길어집니다. NPR-26193: CQ-4252104용 핫픽스
* 중재자 자격 증명을 사용하여 로그인하고 중재자의 프로필 URL이 끝날 때 &quot;#social-activities&quot; 또는 &quot;#tabs-2&quot;을 추가할 때 표시되는 다른 사용자의 활동 및 삭제된 UGC입니다. CQ-4251355용 핫픽스
* 할당된 모든 태그를 블로그 아티클에서 제거할 수 없습니다. NPR-26851: CQ-4253359용 핫픽스
* UGC 관계는 UGC 삭제 시 삭제되지 않습니다. NPR-27630: CQ-4258706용 핫픽스
* 답글의 링크가 포럼 답글을 연이어 클릭해도 작동하지 않습니다. NPR-27623: CQ-4256138용 핫픽스
* 사용자 구독 수가 1,000개로 제한됩니다. NPR-27614: CQ-4254689용 핫픽스
* 역할 설정에서 사이트를 편집하고 역할을 편집하면 null 포인터 예외가 발생합니다. NPR-27377;CQ-4255909 핫픽스

**번역**

* 번역 미리 보기는 we.retail 샘플 콘텐츠에서 작동하지 않습니다. NPR-26727: CQ-4241179용 핫픽스
...
* 사전 예방 백포트를 참조하십시오. NPR-26294
* 숫자 필드 구성 요소는 Internet Explorer 11에서 음수의 유효성을 검사하지 않습니다. NPR-26701
* granite.ui.coralui3 수정 사항을 위한 사전 예방적 백포트입니다. NPR-26662
* granite.ui.coralui3-eon 수정에 대한 사전 예방적 백포트입니다. NPR-26666
* granite.ui.foundation.components 수정에 대한 사전 예방적 백포트입니다. NPR-27313
* granite.ui.commons 수정 사항을 위한 사전 예방적 백포트입니다. NPR-26753
...
* 시작 API 끝점 업데이트를 참조하십시오. NPR-26790: CQ-4254380용 핫픽스
...
* 디지털 서명, Reader 확장, CryptoProvider 및 TrustStore에서 Reader 확장 워크플로우에 대한 FIPS 규격을 활성화했습니다.
...
* 사이트 및 양식 편집기를 로드할 수 없습니다. NPR-26977;CQ-4249170 핫픽스
* 키보드를 사용하여 응용 양식에 첨부 파일을 추가하는 동안 문제가 발생합니다. NPR-25913;CQ-4249456 핫픽스

**양식 - 대화형 통신**

* 대화형 통신 웹 채널 및 응용 양식의 콘텐츠 트리에서 하위 패널 추가 옵션을 사용하여 추가된 패널을 이동할 수 없습니다. CQ-4253915용 핫픽스
* 표 이름은 [인쇄] 채널의 [데이터 소스] 섹션에서 FDM 연결 제목 대신 표시됩니다. CQ-4253669용 핫픽스
...
* 테스트 데이터 XML에서 입력한 내용이 없는 경우 CCR UI는 날짜 필드에 대한 기본 정크 값을 표시합니다. CQ-4252041용 핫픽스
* 문자에 목록 모듈이 포함되어 있는 경우 문자에서 PDF를 생성하는 동안 글머리 기호와 텍스트 사이의 공간이 손실됩니다. CQ-4250588용 핫픽스
...
* Forms 작업 과정을 실행하는 동안 작업 이름에 중괄호가 포함된 경우 로그에 예외가 표시됩니다. CQ-4256626용 핫픽스
* AEM Forms 작업 영역에서 검색 템플릿을 열 수 없습니다. CQ-4255651용 핫픽스

**모바일 Forms**

* Internet Explorer 또는 Chrome에서 HTML로 렌더링되는 AEM Forms의 날짜 필드를 종료할 때 종료 알림이 표시되지 않습니다. NPR-26483: CQ-4239352용 핫픽스
* 처리가 시작될 때 XML에 포함된 날짜로 인해 사용자가 양식을 떠나려고 할 때 양식에 유효성 검사 오류가 발생합니다. NPR-26787: CQ-4251211용 핫픽스
...
* convertpdf 이진 파일이 AIX Forms 추가 기능 패키지에 없습니다. 이 패키지는 PDFA 서비스를 호출하는 동안 오류가 발생합니다. CQ-4257873용 핫픽스
* TIFF 파일을 처리하는 동안 종이 캡처 서비스가 중단됩니다. NPR-28079: CQ-4240649용 핫픽스
...
* PDF/A-1b 표준을 기준으로 PDF 규격의 유효성을 올바르게 확인할 수 없습니다. NPR-26286: CQ-4227539용 핫픽스
* AEM Forms을 6.1 SP2 CFP5에서 CFP13으로 업그레이드하는 동안 메모리 부족 문제가 발생했습니다. NPR-26285: CQ-4244379용 핫픽스
* PDF/A 표준에 따라 PDF 규격의 유효성을 올바르게 확인할 수 없습니다. NPR-26272: CQ-4248823용 핫픽스

**양식 - 기초 JEE**

* AEM Forms 6.4에 대한 JBoss 7.1.4 지원을 추가했습니다. NPR-27331;CQ-4255601 핫픽스
...
AEM 6.4.2.0은 2018년 4월 **AEM 6.4의 공식 출시 이후에 출시된 성능, 안정성, 보안 및 주요 고객 수정 사항과 개선 사항을 포함하는 중요한 업데이트입니다.**
또한 누적되어 모든 AEM 6.4 서비스 팩 릴리스 이전에 6.4.2.0이 포함되어 있습니다.

AEM 6.4.2.0의 주요 특징 중 몇 가지는 다음과 같습니다.
...
* 선택한 답변이 삭제되는 경우 점수 지정 이벤트에 대한 커뮤니티 회귀 수정이 제대로 처리되지 않습니다.
* 솔러의 최대 검색 결과 제한을 MAX_INT-10000으로 수정했습니다.
* 트랜잭션 플러시 작업은 storeTransaction에 대한 첫 번째 호출에만 시작됩니다.
* 이제 카드 보기 및 열 보기에서 &quot;모두 선택&quot; 단추를 사용할 수 있습니다.
* CoralUI의 액세서빌러티 개선 사항.
* Coral.Keys 처리가 개선되었습니다.
* moment.js를 2.22.2으로 업데이트
* jquery를 1.12.1으로 업데이트했습니다.
...
* (터치 UI) 자산 공유 게시자 페이지에 추가하면 &quot;옵션 설명&quot; 구성 요소가 비어 있습니다. NPR-24643: CQ-4245295용 핫픽스
...
* [하위 자산] 페이지의 슬라이더는 언어 환경 설정이 영어 이외의 것으로 설정된 경우 제대로 작동하지 않습니다. NPR-25274: CQ-4248489용 핫픽스
* 유럽 번호 형식의 시스템에서 메타데이터 내보내기 csv 파일을 열 때 발생하는 문제. NPR-26009: CQ-4250677용 핫픽스
* &quot;삭제&quot; 권한이 없으면 자산 폴더 선택에서 만들기 단추를 사용할 수 없습니다. NPR-25788: CQ-4250140용 핫픽스
* (지원) 접근성 향상:중복 ID:id 속성 값은 고유해야 합니다. 레이블:양식 요소에는 레이블과 링크 이름이 있어야 합니다.링크에 식별 가능한 텍스트가 있어야 합니다. NPR-24252: CQ-4250905, CQ-4250906, CQ-4250907용 핫픽스
* 유럽 국가에서 &quot;,&quot;로 구분된 필드가 있는 csv를 업로드할 수 없습니다. NPR-25549: CQ-4249931용 핫픽스
* (브랜드 포털) 여러 페이지로 된 pdf 파일의 하위 자산은 자산을 게시할 때 게시되지 않습니다. NPR-25991: CQ-4245162용 핫픽스
* AEM을 브랜드 포털 복제에 대한 나중에 게시 기능을 참조하십시오. NPR-25911: CQ-109139용 핫픽스
* 관리자가 아닌 사용자가 비공개 컬렉션을 게시하고 게시 취소하면 PE가 발생합니다. NPR-25906: CQ-4250594용 핫픽스
...
* AEM 6.2의 datasource.jsp 쿼리는 AEM 6.4와 다릅니다. NPR-24968:CQ-4244235 핫픽스
...
* 중첩된 parsys 구성 요소의 경우, 항상 만족스러운 디자인을 만족시키는 첫 번째(중첩된 경로가 가장 적게 있음)가 사용 가능한 여러 구성 요소에서 적용됩니다. 자세한 내용은 [디자인 경로 해상도](https://docs.adobe.com/content/help/en/experience-manager-64/developing/platform/templates/page-templates-static.html)를 참조하십시오. NPR-24973: CQ-4246276용 핫픽스
...
* (페이지 구성 요소) Parsys에 구성 요소를 추가하면 오른쪽에서 잘리고 장치 프레임 너비가 표시됩니다. NPR-25536: CQ-4238224용 핫픽스
* 일반 텍스트 편집기는 트리밍되지 않은 데이터를 보내고 추가 공간을 추가합니다. NPR-25312: CQ-4249006용 핫픽스
* 내장 모드를 사용하여 구성 요소를 여는 동안 이전에 로드한 플러그인은 두 번째로 표시되지 않습니다. NPR-24610: CQ-4236850용 핫픽스
* 복사/붙여넣기를 통해 편집기 보기에서 XF를 로드해도 마스터 변형이 자동으로 로드되지 않습니다. NPR-24841: CQ-4248037용 핫픽스
* siteadmin / damadmin에서 IE11이 중단되는 HTML 구조가 잘못되었습니다. NPR-24686: CQ-4246363, CQ-4248402용 핫픽스
...
* AEM 6.2.1.13에서 AEM 6.4로 구성 요소를 마이그레이션하는 동안 &#39;잘못된 반복 선택기 값&#39; 오류가 발생했습니다. NPR-24146
...
* 단일 속성과 특성을 사용하여 리소스 및 모델 경로를 표시합니다. CQ-4251255용 핫픽스
* export.json API 분리 변경 내용을 되돌립니다. CQ-4251854용 핫픽스
* (편집 가능한 SPA) 1.0.0 릴리스 후보. CQ-4251991 핫픽스
...
* 다시 색인화 반복 | 즉석 업그레이드 중 BinaryTextExtraction을 수행하는 동안 NPE. Granite에 대한 핫픽스 - 21677
...
* delete 이벤트 복제에서 권한이 확인되지 않습니다. NPR-25679: CQ-4241234용 핫픽스
* &quot;일 CQ 메일 서비스&quot;에서 STARTTLS 지원을 추가했습니다. NPR-25611: CQ-4249924용 핫픽스
* granite.platform.login에 대한 사전 예방적 백포트를 통해 액세서빌러티를 향상시킬 수 있습니다. NPR-25176:Granite 21746 및 Granite-21309용 핫픽스
...
* Content-Type은 ContentDispositionFilter를 두 번 적용한 후 응답에서 제어되지 않고 누락됩니다. NPR-24175: Sling-7525용 핫픽스
* AEM 6.4 분기로 업그레이드한 후 패키지 관리자 상태가 잘못되었습니다. NPR-24551: Granite-21750용 핫픽스
* AMS 인스턴스 - 분석 오류 로그. CQ-4249567용 핫픽스

**보안**

* Okta IDP를 사용하여 SAML 재로그인 리디렉션을 로그아웃 페이지로 이동합니다. NPR-25523: GRANITE-22364용 핫픽스
* IMS 외부 IDP OAuth 공급자 구성을 통한 인증에서는 AEM에서 만든 사용자를 비활성화합니다. NPR-25301: Granite-22363용 핫픽스
...
* (파일 라이브러리) 형식 문제로 인해 공백이 있는 에셋을 다운로드할 수 있습니다. NPR-24260: CQ-4245159용 핫픽스
* 여러 Adobe Social 문제에 대한 수정 사항입니다. NPR-24247: CQ-4245054, CQ-4245120, CQ-4245296용 핫픽스
* 작성자가 다른 컨텍스트 경로에서 실행되는 경우에 대비하여 구성원 및 그룹 콘솔에 대한 인라인 스크롤이 실패합니다. NPR-24437: CQ-4246013용 핫픽스
* 답변된 상태에서 제거해도 게시물이 미답변 상태로 돌아가지 않으며 점수는 감소하지 않습니다. NPR-24419: CQ-4245797, CQ-4245932용 핫픽스
...
* 게시물이 많은 스레드에 대한 페이지로 구분된 링크는 알림에서 작동하지 않습니다. NPR-25678: CQ-4243038용 핫픽스
* 검색 결과의 시간 값은 클라이언트의 표준 시간대가 아닌 서버 시간을 표시합니다. NPR-25594: CQ-4248986용 핫픽스
* (포럼 주석) 브라우저 뒤로 단추가 예상대로 작동하지 않습니다. NPR-25205: CQ-4248573용 핫픽스
...
* (MSRP) 새로 만든 달력은 오류 로그에 NPE를 부분적으로 내던집니다. NPR-26071: CQ-4250531용 핫픽스
...
* 만들기 그룹의 이미지 업로드는 모바일에서 작동하지 않습니다. NPR-26172: CQ-4251703용 핫픽스
...
* 지원을 위해 차단된 링크가 표시됩니다. NPR-25966: CQ-4251478용 핫픽스
* 답글을 제거할 때 포럼 페이지 매김은 동적으로 업데이트되지 않습니다. NPR-25970: CQ-4248975, CQ-4252843용 핫픽스
* 자동 스크롤 및 강조 표시는 중첩된 주석의 경우 달력 및 필터링 이벤트에서 작동하지 않습니다. NPR-25958: CQ-4251471용 핫픽스
* (DSRP) 사용자 생성 컨텐츠가 많은 양과 함께 성능이 저하되는 직접/딥 링크 성능입니다. NPR-25957: CQ-4251470용 핫픽스
* 권한이 있는 멤버 및 권한 멤버 허용 속성을 수정할 수 없습니다. NPR-26014: CQ-4244592용 핫픽스
...
* 서버 시간대가 사용자 시간대와 다른 경우 시간을 표시합니다. NPR-26036: CQ-4248751용 핫픽스
...
* 게시물은 삭제 후에도 여전히 UI에 표시되며 콘솔에 오류가 표시됩니다. NPR-26290: CQ-4252803용 핫픽스
* (사이트 설정) 역할에 수행한 변경 내용을 저장할 수 없습니다. NPR-26274: CQ-4252187용 핫픽스
* (보안 취약성) JSON 웹 토큰 구성 오류로 인한 계정 인계. NPR-26458: CQ-4253314용 핫픽스
* 답글을 제거할 때 페이지 매김이 재설정되지 않습니다. NPR-26326: CQ-4252997용 핫픽스
* 편집하는 동안 첨부 이미지가 초안에 표시되지 않습니다. CQ-4253360용 핫픽스
* DSRP(관계형 데이터베이스)에 첨부 파일을 첨부하는 동안 페이지가 새로 고쳐지지 않습니다. CQ-4253084용 핫픽스
* 그룹은 활성 사이트 리소스 내에서 작동하지 않습니다. CQ-4252975용 핫픽스
* 사전 요구 사항 학습 경로는 [지원]에서 지속되지 않습니다. CQ-4252948용 핫픽스

**워크플로우**

* Workflow launcher UI는 지난 41개의 실행 관리자 구성을 표시하지 않으며 콘솔에서 javascript 오류를 트리거합니다. NPR-25028: CQ-4247604용 핫픽스
* 론처를 편집하지 않고 기존 워크플로우를 편집하면 페이지/자산 활성화 단계가 포함된 모든 워크플로우에서 여러 워크플로우가 생성됩니다. NPR-25870: CQ-4250896용 핫픽스
* 페이지에 메타데이터 노드가 있는 경우 워크플로우 페이로드에서 잘못된 링크가 있습니다. NPR-25916: CQ-4250733용 핫픽스

**번역**

* 변환된 프로젝트를 가져오면 두 개의 동시 POST 요청이 수행되므로 오류가 발생하는 문제가 해결되었습니다. NPR-24889: CQ-4247638용 핫픽스
* 여러 언어에 대한 번역 프로젝트를 만들 때 동일한 언어의 모든 페이지가 동일한 작업에 추가되던 문제가 수정되었습니다. NPR-25091: CQ-4246112용 핫픽스
* 일부 경우 번역 작업에 상위 40개 페이지만 나열되는 문제를 해결했습니다. NPR-25974: CQ-4248661용 핫픽스
* DataPicker 구성 요소(Coral2)는 연도를 변경하지 않습니다. NPR-24466: Granite-21893용 핫픽스

**UI - 기초**

* 사전 대응형 Foundation UI 백포트입니다. NPR-24344, NPR-24345, NPR-25176, NPR-25095, NPR-24332, NPR-25653, NPR-259 32, NPR-25935, NPR-25976
* (디자인 가져오기 도구) 페이지를 가져오면 js,css를 가져오지 않습니다. NPR-25203: Granite-22236용 핫픽스
* 사전 예방적 기반 UI 제품의 안정성을 개선하기 위해 지원합니다. NPR-24334

**MAC - Test&amp;Target 통합**

* PersonalizationWizard의 두 번째 페이지(&quot;타깃팅 시작&quot;에서 시작)가 비어 있고 콘솔 오류가 발생합니다. CQ-4253277용 핫픽스

**경험 조각**

* 병합된 경험 조각/Target 통합을 AEM 6.4.2.0. CQ-4248653 핫픽스

**콘텐츠 조각 관리**

* 컨텐츠 조각 주석과 컨텐츠 조각 버전의 나란히 비교. CQ-4247148용 핫픽스

**DAM - 일반**

* &quot;체크 아웃한 사람&quot; 필터가 검색 내에서 올바르게 작동하지 않습니다. CQ-4247070용 핫픽스
* 자산 업데이트 작업 과정을 수행하면 자산 언어 사본과 축소판이 비어 있게 됩니다. CQ-4250641용 핫픽스
...
* 포트 폴더 메타데이터 템플릿 마이그레이션 JMX 및 ServiceUserMapping입니다. CQ-4252947용 핫픽스
* WebdriverIO 테스트가 CQ/dam의 릴리스/640 분기에서 실행되지 않습니다. CQ-4252749용 핫픽스
* 링크가 게시된 경우 이동한 자산에 대한 링크는 리팩토링되지 않습니다. CQ-4245756용 핫픽스

**DAM - 뷰어**

* 새 뷰어를 사용하여 비디오를 로드하는 동안 간헐적인 오류가 발생했습니다. CQ-4250562에 대한 핫픽스

**DAM-Brand Portal**

* 오류가 발생하여 브랜드 포털에서 컬렉션 게시를 취소할 수 없습니다. CQ-4245990용 핫픽스
* 브랜드 포털에서 이미지 사전 설정을 게시 취소할 수 없습니다. CQ-4246140용 핫픽스
* 여러 페이지 pdf 파일의 하위 자산은 자산을 게시할 때 게시되지 않습니다. CQ-4245162용 핫픽스

**DAM - DMClient**

* 비디오 에셋을 YouTube에 게시할 때 YouTube로 이어지는 태그에는 태그의 전체 경로가 포함됩니다. CQ-4245549용 핫픽스
* (옵트아웃 및 옵트인 업그레이드) 뷰어 CSS 리디렉션 관련 문제. CQ-4247854용 핫픽스
* &#39;관리자&#39; 그룹의 비구성원으로 뷰어 사전 설정을 만들거나 편집할 수 없습니다. CQ-4247618용 핫픽스
* (6.4.1.0) 여러 개의 parsys에 여러 비디오를 추가하면 비디오 플레이어가 중단됩니다. CQ-4248517용 핫픽스
* 이미지 세트 내에서 에셋의 이름을 변경하고 이동하면 편집할 수 없습니다. CQ-4248434용 핫픽스
* 큰 비디오를 YouTube에 게시하면 시간 제한 메시지가 표시됩니다. CQ-4237831용 핫픽스
* (목록 보기) 자산 선택기/선택기의 사용자 인터페이스는 모든 회색으로 변경되며 사용자에 대해 비활성화됩니다. CQ-4237817용 핫픽스
* (세로 확대/축소) 404 오류가 발생하여 Css를 로드하지 못합니다. CQ-4236508용 핫픽스
...
* (6.3.2에서 6.4로 업그레이드) 사전 업그레이드 이미지 사전 설정은 변환 페이지에 &quot;게시 안 됨&quot;으로 표시되지만 선택한 경우 URL 단추가 나타나지 않습니다. CQ-4240406용 핫픽스
* 기술 부채/사소한 향상. CQ-4240648용 핫픽스
...
* Analytics 사전 설정에서 6.3 이상에서 6.4 이상으로 업그레이드하면, 새로운 보고서 세트 및 분석 사전 설정이 만들어져 사용자의 이전 보고 데이터가 손실됩니다. CQ-4244529용 핫픽스
* (게시 관리 마법사) 게시 또는 게시 취소를 시도하면 자산 목록이 비어 있는 것으로 나타납니다. CQ-4251881용 핫픽스
* [멤버 설정]을 본 후 뷰어를 선택하면 AVS 비디오가 재생되지 않습니다. CQ-4205308용 핫픽스
* 사전 업그레이드 비디오 처리 사전 설정은 새 비디오 인코딩 사전 설정을 추가하거나 기존 인코딩 사전 설정을 편집할 수 없습니다. CQ-4240407용 핫픽스
* 이미지 사전 설정은 다운로드한 동적 변환에 적용되지 않습니다. CQ-4249862용 핫픽스
...
* Dynamic Media 변환이 EPS 파일에 대해 생성하지 못했습니다. CQ-4243688용 핫픽스

**Granite**

* 번들 SymbolicName의 오타를 사용하면 번들이 중복됩니다. Granite-22155용 핫픽스
* CUGConfiguration에서 CugExclude를 선택할 수 없습니다. Granite-21109용 핫픽스
* Adobe Granite Workflow Core를 다시 시작하면 중간 작업 과정에서 불필요한 작업 과정이 다시 실행됩니다. NPR-25057: Granite-22218용 핫픽스
* JcrResourceBundle은 여러 기본 이름을 올바르게 지원하지 않습니다. NPR-25245: Granite-22317용 핫픽스
* 컨텐츠 패키지 설치에서 ACL은 주별로 그룹화되어 사용 권한 모델이 끊어집니다. NPR-24583: Granite-21591용 핫픽스
* Jetty를 9.4.11으로 업데이트하여 취약점을 해결합니다. NPR-25030: Granite-22120용 핫픽스
...
* 온-프레미스 배포에서 [트랜잭션 보고서 기능](https://docs.adobe.com/content/help/en/experience-manager-64/forms/transaction-reports/transaction-reports-overview.html)을(를) 사용하기 위한 지원을 추가했습니다.
...
* 주기적 플러시 작업의 초기화가 지연되었습니다. NPR-25968: CQ-4245024용 핫픽스
* Null 포인터 예외로 인해 트랜잭션 기록이 실패합니다. CQ-4247302용 핫픽스

**양식 - 워크플로우**

* (HTML 작업 공간) 사용자가 작업을 요청하면 해당 특정 사용자에 대해 큐 개수가 새로 고쳐지지만 페이지를 새로 고치지 않으면 다른 사용자에 대해서는 대기열이 새로 고쳐집니다. 이 문제는 새 속성에 의해 수정되었습니다. 이 새 속성을 AEM 인스턴스에 구성하려면 해당 구성 설정을 참조하십시오. NPR-24536: CQ-4233665용 핫픽스
* 6.4의 AEM Forms 앱에서 큰 양식을 로드할 수 없습니다. NPR-24463:CQ-4245091 핫픽스
* 공유 작업을 보려고 할 때 모바일 작업 공간 앱의 문제가 발생합니다. NPR-25177: CQ-4248733용 핫픽스
* 웹과 APK 간의 유효성 검사 동작이 일관되지 않습니다. NPR-25670: CQ-4248178용 핫픽스
* 웹 서비스에 대한 호출이 클라이언트 내에서 열린 HTML5 양식이 수행되면 오류가 발생하고 오류 메시지가 반환됩니다. NPR-26048: CQ-4244716용 핫픽스
* AEM forms Windows app 6.3에서 서비스를 호출하는 동안 문제가 발생했습니다. NPR-26468:CQ-4252341 핫픽스

**모바일 Forms**

* (양식) 미리 볼 때 SSN 및 모바일 필드 유효성 검사 문제가 발생했습니다. NPR-24458: CQ-4244983용 핫픽스
* HTML 미리 보기에서 여러 줄 필드의 프리필링은 데이터가 표시되지 않습니다. NPR-24549: CQ-4244212용 핫픽스
* 스크립트가 여러 줄 필드에서 평가되면 데이터가 손실됩니다. NPR-25333, CQ-4249610 핫픽스

**Forms - 인터랙티브 커뮤니케이션 및 커뮤니케이션 관리**

* 기본 템플릿 및 참조 IC 인쇄 템플릿과 IC에서 동기화에 실패했습니다. NPR-24912
* (CCR) 유효성 검사기는 필드/변수에서 작동하지 않습니다. CQ-4245047용 핫픽스
...
* 위쪽/아래쪽 화살표가 비활성화된 상태로 남아 있으므로 추가된 자산의 순서를 변경할 수 없습니다. CQ-4252042용 핫픽스
...
* 레이아웃 프레임 및 DD 속성을 업데이트할 수 없습니다. CQ-4247830용 핫픽스
* (CCR) XML 구문 분석으로 인해 초안 다시 로드가 실패합니다. CQ-4250950용 핫픽스
* (IC 편집기) &quot;조각 편집&quot; 단추를 더 검색할 수 있어야 합니다. CQ-4244694용 핫픽스
* (XDP) 새로 만든 하위 폼에서 레이아웃 조각을 추가할 때 빈 화면이 표시됩니다. CQ-4248810용 핫픽스
* DocumentFragment-master-DeployWithServerSideTests 테스트 실패. CQ-4245496용 핫픽스
* 텍스트 모듈 변수 조건이 조건 모듈에 중복되었습니다. CQ-4252128용 핫픽스
...
* (양식 서비스) OSGI는 XFAF를 지원하지 않습니다. NPR-25181, CQ-4251313 핫픽스
* 조합된 PDF 파일의 머리글에 있는 문자가 혼동됩니다. NPR-25113: CQ-4244682용 핫픽스

**적응형 양식**

* Submit Action as Send Mail에서는 CC/BC 필드가 비어 있으면 예외가 발생합니다. NPR-25019: CQ-4243039용 핫픽스
* 비효율적인 쿼리로 인해 OTB AEM 양식 구성 요소를 사용할 수 없습니다. NPR-25065: CQ-4247256용 핫픽스
* guideImageChoiceComponent의 대화 노드에서 sling:orderBefore를 제거합니다. CQ-4245013용 핫픽스
...
* 여러 서비스에 동일한 WSDL 파일을 사용할 수 있는 기능이 추가되었습니다. NPR-24604, CQ-4247756 핫픽스
...
* 출력 서비스는 액세스 가능성 Reader에 올바른 태그를 제공하지 않습니다. NPR-24438, NPR-24439, NPR-24440, NPR-2441:CQ-4243849, CQ-4243845, CQ-4243852, CQ-4243853에 대한 핫픽스
...
* 삭제 권한 없이 컨텐츠 조각 편집을 허용합니다. 자세한 내용은 [컨텐츠 조각 사용자 정의 및 확장](https://docs.adobe.com/content/help/en/experience-manager-64/assets/fragments/content-fragments-delete.html)을 참조하십시오. NPR-25793: CQ-4248750용 핫픽스
* 컨텐츠 조각에 주석을 달 수 있는 기능이 추가되었습니다. 자세한 내용은 [변형 작성 조각](https://docs.adobe.com/content/help/en/experience-manager-64/assets/fragments/content-fragments-variations.html#annotating-a-content-fragment)을 참조하십시오. NPR-25188: CQ-4235336용 핫픽스
* 버전 관리:컨텐츠 조각을 나란히 비교 자세한 내용은 [컨텐츠 조각 관리](https://docs.adobe.com/content/help/en/experience-manager-64/assets/fragments/content-fragments-managing.html#comparing-fragment-versions)를 참조하십시오. NPR-25187: CQ-4237412용 핫픽스
...
AEM 6.4.1.0은 2018년 4월 AEM 6.4의 공식 출시 이후에 릴리스된 성능, 안정성, 보안 및 주요 고객 수정 사항과 개선 사항을 포함하는 중요한 업데이트입니다.
...
* 6.4.0의 DAM 자산 업데이트 워크플로우에서 null 포인터 예외를 방지하려면 다음을 수행합니다. NPR-24134:CQ-4244972 핫픽스
...
* 이동하는 동안 페이지 이름을 변경할 때 페이지 이동은 성공하지만 이름 바꾸기 기능은 작동하지 않습니다. NPR-22923: CQ-4235907용 핫픽스
* Adobe 캠페인의 Importer 페이지를 가리키는 Live Copy 페이지를 게시할 때 오류가 발생했습니다. NPR-23053: CQ-4237164용 핫픽스
* 클래식 UI에서 이동/이름 바꾸기에 &quot;페이지를 이동하는 동안 오류가 발생했습니다.&quot;라는 오류가 발생하여 이름을 변경하지 못했습니다. NPR-23051: CQ-4235907용 핫픽스
...
* 사이트 간 스크립팅(XSS):상거래 크리에이티브 카탈로그에 반영됩니다.wizard.html/content. NPR-24642: CQ-4237017용 핫픽스
...
* granite.ui.commons 수정 사항을 위한 사전 예방적 백포트입니다. NPR-23537
* 사전 예방 백포트를 참조하십시오. NPR-23535
* granite.ui.coralui 수정 사항을 위한 사전 예방적 백포트입니다. NPR-23538
* 그룹에서 한 번에 여러 사용자를 제거할 수 없습니다. NPR-23846
* (OMEGA) &quot;기능&quot;을 영어로만 보고합니다. NPR-23989: Granite-21231용 핫픽스
* (디자인 가져오기 도구) 페이지를 가져오더라도 js, css는 가져오지 않습니다. NPR-25203: Granite-22236용 핫픽스
...
* (Adobe IMS 콘솔) 등록 클라우드 솔루션이 구성 마법사에서 선택되지 않습니다. NPR-23977: CQ-4244549용 핫픽스
* HTML 확장 없이 페이지에 타깃팅된 컨텐츠를 로드할 때 무한 루프가 발생합니다. NPR-23522: CQ-4223600용 핫픽스
...
* 필터 옵션을 사용하면 6.3에서 6.4로 업그레이드한 후 AEM이 느려집니다. NPR-23260:CQ-4239847 핫픽스(확인)
* granite.omnisearch.core 수정 사항을 위한 사전 예방적 백포트 NPR-23536
* platform.clientlibs 수정 사항에 대한 사전 예방적 백포트입니다. NPR-23569
* 다른 페이지 속성을 편집할 때 Cloud Service 구성 상속이 끊겼습니다. NPR-23216: CQ-4239782용 핫픽스
* 일 CQ 메일 서비스에서 STARTTLS 지원을 활성화했습니다. NPR-23941: CQ-4240397용 핫픽스

**프로젝트**

* (컨텐츠 조각) 영어 자산이 번역 기능에 추가되는 동안 포함된 자산에 대한 언어 복사본이 생성되지 않습니다. CQ-4243477용 핫픽스
* 레거시 모드에서 /etc(6.3 구성)의 구성이 아닌 /libs(6.4 구성)의 구성을 표시합니다. CQ-4243475용 핫픽스
* 번역 프로젝트에서 번역 론치를 자동으로 승격 및 삭제합니다. CQ-4243474용 핫픽스
* 사이트 내의 컨텐츠 조각이 번역되지 않습니다. CQ-4243482, CQ-4243483, CQ-4245687용 핫픽스
* 번역 작업 검색 필터를 여는 동안 서버 오류가 발생했습니다. CQ-4236813용 핫픽스
* 자격 증명 구성 드롭다운은 /conf/we-retail에 tif가 있는 경우에도 비어 있습니다. CQ-4236315용 핫픽스
* 프로젝트 KPI 열기:더 많은 프로젝트가 생성되므로 성능이 저하됩니다. NPR-23840: CQ-4238392용 핫픽스
...
* (클래식 UI) 워크플로우 릴리스를 편집할 때 조건이 사라지고 작업 과정이 조건 없이 시작됩니다. NPR-23835: CQ-4239153용 핫픽스
...
* (터치 UI) 워크플로우 모델을 저장할 때 &#39;동기화&#39; 단추가 &#39;동기화됨&#39;으로 변경되어 맞춤법 오류가 발생합니다. CQ-4244843용 핫픽스
* 프로젝트 받은 편지함:달력 보기로 전환하면 기본 받은 편지함 컨텐츠가 표시됩니다. CQ-4244436용 핫픽스
* 대화 상자 참가자 단계에서 대화 상자를 선택할 수 없습니다. CQ-4244532용 핫픽스
* granite.omnisearch.core 수정 사항을 위한 사전 예방적 백포트 NPR-23536
* 공유 작업이 있는 모바일 작업 공간 앱 6.4의 문제. NPR-26383
...
* (MSM) 실제로 발생하는 이벤트와 이벤트 처리 사이의 이벤트 의견 수렴의 시간 간격입니다. CQ-4227766용 핫픽스

**스크린**

* 화면 코어-pkg:1.4.42에 대한 종속성이 없어 오류가 발생하여 화면 페이지가 실패했습니다. CQ-4245918에 대한 핫픽스
...
* 자산의 세부 정보 보기를 닫으면 잘못된 검색 결과 페이지로 돌아갑니다. CQ-4240960용 핫픽스
* (Camera Raw) 이미지 조정 옵션이 없습니다. CQ-4246121용 핫픽스
* IndexOutOfBoundsException:OTB 자산 수정 보고서. CQ-4239744용 핫픽스
* 보고서 csv에서 신뢰 점수를 제거합니다. CQ-4241491용 핫픽스
* &quot;관리자&quot; 이외의 보낸 사람에 대한 링크 공유 이메일 배달이 손상되었습니다. CQ-4240357용 핫픽스
* IT 오류 수정 CQ-4249891용 핫픽스
...
* 디렉터리 조건자에서 검색은 검색 필터에서 필터링/표시되지 않아야 합니다. CQ-4241386용 핫픽스
* 게시 취소 후 기본 검색이 있어야 합니다. CQ-4241383, CQ-4241113용 핫픽스
* 브랜드 포털 제스처에 게시해도 이미지 사전 설정에 사용할 수 없습니다. CQ-4241074용 핫픽스
* 브랜드 포털에 게시가 컬렉션에서 작동하지 않습니다. CQ-4241122, CQ-4246558용 핫픽스

**DAM - DM 클라이언트**

* 6.4로 업그레이드하면 이전에 만든 비디오 인코딩 프로필이 제거됩니다. CQ-4244067용 핫픽스
* 대체 텍스트 속성은 Dynamic Media 구성 요소에서 끊깁니다. CQ-4244081용 핫픽스
* (DMS7) AEM에서 원격 세트를 편집해도 Scene7에서 덮어쓰여지지 않습니다. CQ-4243430용 핫픽스
* DM 하이브리드 기반 6.4 SP1 빌드 확인 CQ-4244623용 핫픽스
* (DMS7-UA) 게시된 비디오 자산에 대한 [포함] 단추를 클릭하면 아무 작업도 발생하지 않습니다. 포함 대화 상자가 HTML 코드와 함께 표시됩니다. CQ-4245237용 핫픽스
* (DM 하이브리드) 게시된 비디오 자산 또는 혼합 미디어 집합에 대한 URL 복사 URL이 URL 대화 상자에서 &quot;`[object Object]`&quot;을(를) 가져옵니다. CQ-4245236, CQ-4245451용 핫픽스
* (DMHybrid) 비디오의 [세부 사항 보기] 페이지에는 비디오 자산 쇼의 미리 보기가 포함되어 있지 않으며 오류 메시지를 콘솔에 출력합니다. CQ-4244320용 핫픽스
* we.retail 컨텐츠의 자동 S7 인코딩. CQ-4242253용 핫픽스
* 업그레이드 전 비디오 처리 사전 설정은 새 비디오 인코딩 사전 설정을 추가하거나 기존 인코딩 사전 설정을 편집할 수 없습니다. CQ-4240407용 핫픽스
* 사전 업그레이드 이미지 사전 설정은 [변환] 페이지에 게시 취소됨으로 표시되며 URL을 생성하지 않습니다. CQ-4240406용 핫픽스
* (CSS) 에셋이 표시되지만 사용된 뷰어는 OTB 뷰어가 아니라 기본값입니다. CQ-4239839용 핫픽스
* 정리 단계 정지 수동 실행 및 개인 산호 클래스의 사용. CQ-4239729용 핫픽스
* 이미지 뷰어에서 오류가 발생하고 올바른 스마트 자르기를 표시하지 않습니다. CQ-4237564용 핫픽스
* /etc 아래의 기존 사전 설정이 손상되어 저장 시 /conf 아래의 위치로 마이그레이션되지 않는 것으로 나타납니다. CQ-4237416용 핫픽스
* OOB VideoViewer 5.8.x에서 회귀 - 뷰어는 iframe을 오른쪽으로 확장하여 페이지 레이아웃을 분리합니다. CQ-4235465용 핫픽스
...
* DropTwo OTB AVS 비디오 처리 프로필은 폴더 속성 아래에 나열되며 하나는 정의된 인코딩을 포함합니다. CQ-4238096용 핫픽스
* (DMS7) 스마트 자르기:세부 사항 보기:URL 단추에는 변환에 대한 복사 단추라는 레이블이 표시됩니다. CQ-4237804용 핫픽스
* 말림 명령을 실행한 후에도 뷰어 사전 설정 목록 페이지가 비어 있는 상태로 유지됩니다. CQ-4243246용 핫픽스
...
* (DMHybrid) 6.3amp;gt;6.4 업그레이드 시 카탈로그 설정이 잘못된 노드로 이동됩니다. CQ-4239974, CQ-4239975용 핫픽스
* (DMHybrid) pushviewerpresets 스크립트는 카탈로그 설정을 수정하는 데 필요한 노드를 만들지 않습니다. CQ-4240076용 핫픽스
* &quot;형식&quot; 드롭다운 선택을 사용하고 PNG 또는 JPG 형식을 선택하면 다운로드한 파일이 원래 자산보다 채도가 높고 어둡게 표시됩니다. CQ-4240073용 핫픽스
* (DMS 7) MIME 유형 매핑을 제거합니다.image_x-eps. CQ-4240394용 핫픽스
...
* (Dynamic Media) 스마트 자르기 폴더 외부에 일반 에셋을 업로드하지 못합니다. CQ-4237670용 핫픽스
...
* 복제 로그가 이미지 서버 설정을 성공적으로 표시하는 동안 이미지 서버 설정이 배달되도록 복제되지 않습니다. CQ-4239480, CQ-4239046용 핫픽스
* (DMS 7) 클라우드 구성에 대한 이전/새 참조를 사용하여 집합을 만들 수 없습니다. CQ-4238078용 핫픽스
* Scene7 워크플로우 단계는 이름 및 설명으로만 Scene7을 읽지만 DAM 업데이트 워크플로우에서 워크플로우 단계를 명확히 전달하지는 않습니다. CQ-4237865용 핫픽스
...
* AEM Forms에서는 AEM Forms 배포에서 제출된 양식, 처리된 문서 및 렌더링된 문서와 같은 거래를 추적하고 유지할 수 있는 [거래 보고서 기능](https://docs.adobe.com/content/help/en/experience-manager-64/forms/transaction-reports/transaction-reports-overview.html)을 도입합니다. 제품 사용에 대한 통찰력을 제공하고 비즈니스 사용자가 디지털 처리 볼륨을 이해하는 데 도움이 됩니다.
...
* (FDM WSDL) DermisException 가져오기:java.lang.Exception:createSOAPParam:잘못된 매개 변수. NPR-24264
* (FDM 클라이언트 SDK) 사전/사후 사전 프로세서 및 사용자 정의 제출 작업을 테스트할 수 없습니다. CQ-4238469용 핫픽스
* Dermis의 Javadoc 문제에 대한 수정 사항. CQ-4244250용 핫픽스
* 웹 서비스 설명 언어(WSDL)의 향상된 입력. CQ-4244133용 핫픽스
* WSDL에 대한 기본 인증 테스트에서 AEM 6.3 및 AEM 6.4의 동일한 구성에 대해 다른 오류가 발생합니다. CQ-4244132 핫픽스
...
* Forms Add-On 클라이언트 sdk에 포함할 WSDLInvokerParams입니다. NPR-23381: CQ-4240233용 핫픽스

**적응형 양식**

* 문서(IC) 변환은 Transaction Recording Service를 사용하여 거래로 기록해야 합니다. CQ-4245333용 핫픽스
...
* (ExpressionEditor) 양식을 제출하는 동안 Verify 스테이지로 이동하는 동안 오류가 발생했습니다. CQ-4241384용 핫픽스
* 제출된 양식의 업그레이드 전 단계에서 확인 단계에서 값이 누락되고 업그레이드된 서버가 업그레이드됩니다. CQ-4241896용 핫픽스
* 페이지 하단의 종료 및 저장 단추가 작동하지 않습니다. CQ-4240112용 핫픽스
* 업그레이드된 설정에서 연락처 번호가 없습니다. CQ-4239870용 핫픽스
* 분쟁 유형 탭의 `ACTION TAKEN` 섹션 아래의 &quot;내 클레임을 지원하기 위한 추가 문서&quot;에 &quot;저장된 증명 유형&quot;이 추가로 있습니다. CQ-4239873용 핫픽스
...
* 응용 양식의 게시 제출 시 오류 로그에서 &quot;sun.util.calendar.ZoneInfo&quot; 클래스에 대해 deserialization을 사용할 수 없습니다. CQ-4240419용 핫픽스
* 상태 필드가 모바일 양식 변환에서 채워지지 않습니다. CQ-4240597용 핫픽스
* 패턴 방지 목록에서 템플릿에 있는 구성 요소의 참조 사용을 제거합니다. CQ-4239217용 핫픽스
* 부동 또는 소수점으로 설정된 HTML5 숫자 상자는 서로 다른 브라우저에서 다른 유효성 검사 결과를 제공합니다. NPR-23528: CQ-4244097용 핫픽스
...
* AEM 양식 구성 요소 속성 대화 상자의 찾아보기 옵션을 사용하여 AF는 사이드 패널의 에셋 탭을 사용하여 표시되지 않습니다. CQ-4236751용 핫픽스
* 양식 변환에 대해 생성된 워크플로 ID는 생성된 적응형 양식에서 사용할 수 있어야 합니다. CQ-4240014용 핫픽스
* 직접 업그레이드 시 사이트에서 페이지를 만들 템플릿을 선택할 수 없습니다.Livecycle을 6.4 서버로 변환 CQ-4241300용 핫픽스

**어셈블러 서비스**

* Assembler Services의 트랜잭션 로깅. CQ-4245018, CQ-4245017, CQ-4245016용 핫픽스.
...
* 제출 탭의 UI에 표시되는 양식은 제출 메시지가 성공적으로 전송되더라도 제출 안 됨 상태로 표시됩니다. CQ-4241487용 핫픽스
* guideContext는 그 자체가 개체인 customPropertyMap이 포함된 guideContext를 포함하여 필드를 깊이 복사함으로써 구성해야 합니다. CQ-4240126용 핫픽스
* 양식을 저장하는 동안 오류가 발생했습니다. CQ-4240763용 핫픽스
* Forms Portal 초안 및 제출 구성에 DB 구성이 제공되었음에도 불구하고 저장 및 제출된 양식에 대한 항목이 crx/de로 채워집니다. CQ-4240726용 핫픽스
* (검색 및 라이브러리) 고급 검색 제목 고정 값은 동일하지 않고 포함으로 작동해야 합니다. CQ-4245499용 핫픽스

**모바일 Forms**

* Mobile Forms에서 날짜 필드가 겹칩니다. CQ-4242256용 핫픽스
* Mobile Forms에 대한 양식 제출은 트랜잭션 기록 서비스를 사용한 거래로 기록해야 합니다. CQ-4246166용 핫픽스
...
* Workflow 할당 작업의 트랜잭션 로깅. CQ-4244440용 핫픽스
* (FDM 단계) 프로세스 단계와 fdm 단계 사이에 [작업 할당] 단계를 삽입하면 워크플로 메타데이터의 값을 사용할 수 없습니다. CQ-4241472용 핫픽스
...
* 웹 채널이 텍스트 문서 조각에서 탭 공간을 인식하지 못합니다. CQ-4244481용 핫픽스
* (인쇄 채널) 문서(IC) 변환은 Transaction Recording Service를 사용하는 거래로 기록해야 합니다. CQ-4245335용 핫픽스
* (웹 채널) 문서(IC) 변환은 Transaction Recording Service를 사용하는 거래로 기록해야 합니다. CQ-4245334용 핫픽스
* 문서 컨테이너 검색 또는 데이터 모델 트리 검색은 자산 필터 검색에 통합되어야 합니다. CQ-4242305용 핫픽스
* (문서 조각) 들여쓰기 속성은 텍스트를 이해할 수 없는 단위별로 들여씁니다. CQ-4241082, CQ-4240643용 핫픽스
* (IC 편집기) 자산 탭 아래에 나열된 문서 조각 타일의 조각 편집 아이콘은 검색하기가 매우 쉽고 이해할 수 없습니다. CQ-4241047용 핫픽스
* 익명 액세스 권한이 없는 IC Anonymous 클라이언트 라이브러리에 대한 액세스 허용 CQ-4245588용 핫픽스
* (웹 채널) 데이터는 웹 미리 보기의 표에서 확인되지 않고 공백으로 표시됩니다. CQ-4244476용 핫픽스
* 테이블 헤더는 자동 생성 시 웹 채널에서 변수로 표시됩니다. CQ-4244242용 핫픽스
...
* 텍스트 편집기 데이터 개체 패널에는 최상위 엔티티만 나열하고 CQ-4244121에 대한 핫픽스
...
* 자리 표시자가 포함된 텍스트 자산을 편집한 후 문자 템플릿에서 캡션을 제거합니다. NPR-24196
...
* 조건 편집기 - 여러 결과 평가가 기본적으로 활성화되어 있어야 합니다. CQ-4240096용 핫픽스
* 목록에서 삭제되어도 미리 보기에 이미지가 계속 표시됩니다. CQ-4239909용 핫픽스
* 조건 모듈의 규칙 세트는 모든 모듈에 대해 &#39;기본값&#39;으로 설정됩니다. CQ-4239878용 핫픽스
* &quot;알 수 없는 JCR 예외&quot; 오류가 발생하여 데이터 사전을 생성하지 못했습니다. CQ-4244122용 핫픽스
...
>[!CAUTION]
>
>AEM 6.4에 기능 팩이 설치된 고객의 경우. Adobe에서 제공하는 옵션 기능 팩은 릴리스 버전 및 서비스 팩에 따라 다릅니다. Feature Pack이 설치되어 있는 경우 AEM 고객 지원 센터에 문의하여 AEM 6.4용 서비스 팩과 해당 기능 팩의 호환성을 확인하십시오.

* AEM 6.4.8.0을 사용하려면 AEM 6.4가 필요합니다. 자세한 내용은 [업그레이드 설명서](../sites-deploying/upgrade.md)를 참조하십시오.
* 서비스 팩 다운로드는 [소프트웨어 배포 포털](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html)에서 다운로드할 수 있습니다.
...
### 패키지 관리자 {#install-the-service-pack-via-package-share}를 통해 서비스 팩 설치

기존 AEM 6.4 인스턴스에 서비스 팩을 설치하려면 다음 단계를 수행하십시오.

1. 소프트웨어 배포에서 패키지를 다운로드합니다.

1. AEM에서 Package Manager에 로그인하고 다운로드한 AEM 6.4.8.0 패키지를 추가합니다. 업로드된 패키지를 선택하고 **[!UICONTROL 설치]**&#x200B;를 클릭합니다.
...
1. 이제 제품 정보 페이지(*/system/console/productinfo *)에 설치된 제품 아래의 업데이트된 버전 문자열 &quot;Adobe Experience Manager, 버전 6.4.8.0&quot;이 표시됩니다.
...
>[!NOTE]
>패키지를 성공적으로 설치할 때 **&quot;Content Package AEM-6.4-Service-Pack-7이(가) 성공적으로 설치되었다는 >정보 메시지가 나타납니다.&quot;**

### Dynamic Media 뷰어 업데이트(5.10.1) {#update-dynamic-media-viewers}

<p id="Dynamic">AEM 6.4.8.0에는 이미지 사전 설정 페이지에서 중복 이름을 확인할 수 있는 새로운 버전의 Dynamic Media 뷰어(5.10.1)이 포함되어 있습니다. Dynamic Media 고객은 다음 명령을 실행하여 박스 뷰어 사전 설정을 최신 상태로 가져와야 합니다.
...
클래식(이전) UI를 사용하고 이 UI를 사용하여 메타데이터 템플릿을 만든 경우 JMX 스크립트를 실행하여 유지 -
...
AEM 6.4.8.0용 Uber Jar는 [Adobe Public Maven 리포지토리](https://repo.adobe.com/nexus/content/groups/public/com/adobe/aem/uber-jar/6.4.8/)에서 사용할 수 있습니다.
...
* 설치 중에 다음 오류 및 경고가 표시될 수 있습니다.
   ...
   * 구성 요소 인스턴스를 만들고 서비스 팩토리에서 null을 반환한 오류는 저장소가 다시 시작됨에 따라 발생합니다.
...
* 메타데이터 가져오기/내보내기에 대해 리소스를 찾을 수 없는 오류가 발견되었습니다. CQ-4253263
* 6.4.2.0 맨 위에 6.4.3.0 적용한 후 이미지 구성 요소 및 페이지 속성을 편집할 수 없습니다. CQ-4260316 &amp; CQ-4260441
이 문제를 해결하려면 다음을 수행하십시오.
   * 패키지 관리자로 이동
   * 패키지 &quot;cq-ui-wcm-admin-content-1.0.1004.zip&quot;을 다시 설치합니다.
   * 모든 JSP `(http://<AEM HOST>:<AEM PORT/system/console/slingjsp)` 를 다시 컴파일하거나 인스턴스를 다시 시작합니다.
