...
>[!NOTE]
>
>[API 설명서](/help/sites-developing/ecommerce.md#api-documentation) 도 사용할 수 있습니다.
...
검색 API의 시작 지점은 입니다 `CommerceService#search` 를 반환하는 메서드 `CommerceResult` 개체. 자세한 내용은 [API 설명서](/help/sites-developing/ecommerce.md#api-documentation) 자세한 내용은 이 항목을 참조하십시오.
