...
AEM에서 사용 가능한 모든 위젯에 대한 자세한 내용은 [위젯 API 설명서](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html)를 참조하십시오.
...
* box
   ...
   폭과 높이를 사용하여 상자로 크기를 지정할 [Component](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component)에 대한 기본 클래스입니다.
...
* browsedialog
   ...
   찾아보기 대화 상자를 사용하면 경로를 선택하기 위해 저장소를 검색할 수 있습니다. 일반적으로 [BrowseField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.BrowseField)를 통해 사용됩니다.
...
* browsefield
   ...
   **가치 하락:CQ [.form.PathField대신 ](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.PathField) 사용**
...
* 불케
   ...
   BulkEditor를 HTML 양식에 삽입해야 합니다(가져오기 기능에 필요). [CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog)와 완벽하게 호환됩니다.
...
* checkboxgroup
   ...
   [CQ.Ext.form.Checkbox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Checkbox) 컨트롤의 그룹화 컨테이너입니다.
...
* 색상 메뉴
   ...
   [CQ.Ext.ColorPalette](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorPalette) 구성 요소를 포함하는 메뉴.
...
* 컨테이너
   ...
   다른 구성 요소를 포함할 수 있는 [CQ.Ext.BoxComponent](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.BoxComponent)에 대한 기본 클래스입니다. 컨테이너는 포함 항목의 기본 비헤이비어를 처리합니다. 즉, 항목을 추가, 삽입 및 제거합니다.
...
* contentfinder
   ...
   ContentFinder는 왼쪽의 실제 컨텐츠 파인더와 오른쪽의 컨텐츠 프레임을 포함하는 2개의 전문화된 열 [뷰포트](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Viewport)입니다.
...
* contentfindertab
   ...
   ContentFinderTab은 [CQ.wcm.ContentFinder](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder)의 탭 패널에 사용되는 기능을 제공하는 전문 패널입니다. 일반적으로 검색 양식(쿼리 상자)과 검색을 표시하는 데이터 보기를 제공합니다.
...
* 사용자 정의 패널
   ...
   CustomContentPanel은 [CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog)에서 사용할 특별한 종류의 패널입니다.대화 상자의 다른 필드가 아닌 다른 URL로 콘텐트를 검색하여 제출합니다.
...
* datemenu
   ...
   [CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) 구성 요소를 포함하는 메뉴.
...
* datepicker
   ...
   팝업 날짜 선택기입니다. 이 클래스는 [DateField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.DateField) 클래스에서 사용하여 유효한 날짜를 검색하고 선택할 수 있도록 합니다.
...
* 편집 막대
   ...
   여기에 나열되지는 않았지만 EditBar에는 [CQ.wcm.EditBase](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditBase)의 모든 구성원이 있습니다.
...
* groupingstore
   ...
   사용 가능한 필드 중 하나로 레코드를 그룹화하는 기능을 제공하는 전문 저장소 구현입니다. 일반적으로 그룹화된 GridPanel에 대한 데이터 모델을 증명하기 위해 [CQ.Ext.grid.GroupingView](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GroupingView)와 함께 사용됩니다.
...
* 목록 보기
   ...
   CQ.Ext.list.ListView는 뷰와 같은 [Grid](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel)의 빠르고 가벼운 구현입니다.
...
* 메뉴
   ...
   메뉴 객체입니다. 메뉴 항목을 추가할 수 있는 컨테이너입니다. 또한 [CQ.Ext.menu.DateMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.DateMenu)와 같은 다른 구성 요소를 기반으로 전문화된 메뉴를 원할 때 메뉴는 기본 클래스로 사용할 수 있습니다.
...
* menuitem
   ...
   하위 메뉴와 같은 메뉴 관련 기능이 필요하고 고정 표시 항목이 아닌 모든 메뉴 항목에 대한 기본 클래스입니다. Item은 메뉴별 활성화를 추가하고 클릭 처리를 추가하여 [CQ.Ext.menu.BaseItem](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.BaseItem)의 기본 기능을 확장합니다.
...
* 패널
   ...
   패널은 [CQ.Ext.Container](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container)로부터 상속받은 결과로 제공됩니다.
...
* 경로 필드
   ...
   PathField는 경로 완료 경로를 위해 설계된 입력 필드이며 서버 저장소를 검색할 수 있도록 [CQ.BrowseDialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.BrowseDialog)를 여는 단추입니다. 또한 고급 링크 생성을 위해 페이지 단락을 검색할 수도 있습니다.
...
* 진행 상황
   ...
   수동 모드에서는 [updateProgress](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ProgressBar)를 통해 표시, 업데이트 및 필요에 따라 자신의 코드에서 진행률 표시줄을 지울 책임이 있습니다. 이 메서드는 진행 상태를 표시하려는 경우에 가장 적합합니다.
...
* propertygrid
   ...
   개발 IDE에서 일반적으로 볼 수 있는 기존의 속성 격자를 모방하기 위한 전문 격자 구현입니다. 격자의 각 행은 일부 객체의 속성을 나타내며, 데이터는 [CQ.Ext.grid.PropertyRecord](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.PropertyRecord)s에서 이름/값 쌍 세트로 저장됩니다.
...
* quicktip
   ...
   @xtype quicktip 마크업에 지정할 수 있고 글로벌 [CQ.Ext.QuickTips](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.QuickTips) 인스턴스에서 자동으로 관리하는 도구 팁에 대한 전문화된 도구 설명 클래스입니다. 자세한 사용 정보와 예는 QuickTips 클래스 헤더를 참조하십시오.
...
* 등록 계획
   ...
   RolloutPlan에서는 페이지 롤아웃 진행 상황을 보는 대화 상자를 제공합니다. RolloutPlan은 [CQ.wcm.msm.RolloutWizard](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutWizard)에 의해 시작됩니다.
...
* 롤아웃마법사
   ...
   롤아웃 마법사는 페이지를 롤아웃하는 마법사를 제공합니다. RolloutWizard가 [CQ.wcm.msm.RolloutPlan](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutPlan)을(를) 시작합니다.
...
* textbutton
   ...
   TextButton은 [CQ.Ext.Button](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Button)의 기능을 포함하는 텍스트 링크를 제공합니다.
