...
description: AEM에서 이용 가능한 모든 xtype에 대한 자세한 내용
seo-description: AEM에서 이용 가능한 모든 xtype에 대한 자세한 내용
...
ExtJS 언어에서 xtype은 클래스에 지정된 상징적 이름입니다. xtype이 무엇이고 xtype을 사용할 수 있는지에 대한 자세한 설명은 ExtJS 2 [의 개요](https://www.sencha.com/learn/overview-of-extjs-2) 의 &quot;구성 요소 XTypes&quot; 단락을 참조할 수 있습니다.

AEM에서 사용 가능한 모든 위젯에 대한 자세한 내용은 [위젯 API 설명서를 참조하십시오](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html).

AEM에서 지정된 xtype의 구성 요소를 사용하려면 &#39;checkbox&#39;를 관심 있는 xtype으로 대체하여 CRXDE에서 다음 Xpath 쿼리를 사용할 수 있습니다.
...
>
>Adobe에서는 Coral UI 및 [ [Granite UI]를](/help/sites-developing/touch-ui-concepts.md) 기반으로 하는 표준 [](/help/sites-developing/touch-ui-concepts.md#coral-ui) , 최신, [터치 지원 UI를](/help/sites-developing/touch-ui-concepts.md#granite-ui-foundation-components)활용할 것을권장합니다.
...
* 주석
   ...
   [CQ.wcm.주석](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.Annotation)
...
* arraystore
   ...
   Array 데이터에서 [CQ.Ext.data.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.Store)Stores를 쉽게 만들 수 있는 작은 헬퍼 클래스입니다. ArrayStore는 [CQ.Ext.data.ArrayReader로 자동으로 구성됩니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.ArrayReader).
...
* bluprintconfig
   ...
   BlueprintConfig는 Blueprint의 Live Copy를 보고 이 Blueprint 속성을 편집할 수 있는 패널을 제공합니다( 동기화 트리거 및 동기화 작업 ).
...
* box
   ...
   너비 및 높이를 사용하여 상자로 [크기를](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component) 지정할 구성 요소의 기본 클래스입니다.
...
* browsedialog
   ...
   찾아보기 대화 상자를 사용하면 경로를 선택하기 위해 저장소를 검색할 수 있습니다. 일반적으로 BrowseField를 통해 [사용됩니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.BrowseField).
...
* browsefield
   ...
   **가치 하락: CQ.[form.PathField를 대신 사용하십시오](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.PathField).**
...
* 벌커지터
   ...
   BulkEditor에서는 검색 결과를 편집할 검색 엔진과 격자를 제공합니다.

   BulkEditor를 HTML 양식에 삽입해야 합니다(가져오기 기능에 필요). CQ. [Dialog와 완벽하게 호환됩니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog).
...
* 벌목형
   ...
   BulkEditorForm은 HTML [폼으로 둘러싸인](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.BulkEditor) CQ.wcm.BulkEditor를 제공합니다. 가져오기 단추에는 HTML 양식이 [필요한 CQ.wcm.BulkEditor](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.BulkEditor)독립 실행형 버전입니다.
...
* 확인란
   ...
   단일 확인란 필드. 기존 확인란 필드에 대한 직접 대체 항목으로 사용할 수 있습니다.
...
* checkboxgroup
   ...
   CQ. [Ext.form.Checkbox 컨트롤에 대한 그룹화](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Checkbox) 컨테이너입니다.
...
* 색상 필드
   ...
   ColorField를 사용하면 사용자가 직접 또는 [CQ.Ext.ColorMenu를 사용하여 색상 16진수 값을 입력할 수 있습니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorMenu).
...
* 색상 메뉴
   ...
   CQ.Ext. [ColorPalette 구성 요소를 포함하는](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorPalette) 메뉴
...
* 콤보
   ...
   자동 완성, 원격 로딩, 페이징 및 기타 많은 기능이 지원되는 컴박스 컨트롤

   ComboBox는 기존 HTML &lt;select> 필드와 유사한 방식으로 작동합니다. 차이점은 valueField를 제출하려면 [숨겨진](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.ComboBox)입력을 만들려면 [hiddenName을](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.ComboBox) 지정해야 합니다.
...
* 구성 요소
   ...
   모든 Ext 구성 요소에 대한 기본 클래스입니다. Component의 모든 하위 클래스는 [Container](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container) 클래스에 의해 제공되는 생성, 렌더링 및 파괴의 자동화된 텍스트 구성 요소 라이프사이클에 참여할 수 있습니다. 컨테이너를 만들 때 [항목](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container) 구성 옵션을 통해 구성 요소를 컨테이너에 추가할 수 있습니다.
...
* 컨테이너
   ...
   다른 구성 요소를 포함할 수 있는 모든 [CQ.Ext.BoxComponent](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.BoxComponent) 에 대한 기본 클래스입니다. 컨테이너는 항목을 추가, 삽입 및 제거하는 것과 같은 포함 항목의 기본 동작을 처리합니다.
...
* contentfinder
   ...
   ContentFinder는 [왼쪽의 실제 Content Finder](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Viewport) 및 오른쪽의 Content Frame이 포함된 두 개의 특수 열 뷰포트입니다.
...
* contentfindertab
   ...
   ContentFinderTab은 [CQ.wcm.ContentFinder의 탭 패널에 사용되는 기능을 제공하는 특수 패널입니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder). 일반적으로 검색 양식(쿼리 상자)과 검색을 표시하는 데이터 보기가 포함되어 있습니다.
...
* cq.workflow.model.combo
   ...
   WorkflowModelCombo는 사용 가능한 워크플로 모델 목록을 보여주는 사용자 [지정된](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.ComboBox) CQ.Ext.form.ComboBox입니다.
...
* cq.workflow.model.selector
   ...
   WorkflowModelSelector는 WorkflowModelCombo와 작업 과정의 축소판 이미지를 결합하고, 단추를 결합하여 워크플로우 모델을 만들고 편집합니다.
...
* createtitewizard
   ...
   CreateSiteWizard는 MSM(사이트 만들기)을 위한 단계별 마법스입니다.
...
* 사용자 정의 패널
   ...
   CustomContentPanel은 [CQ.Dialog에서 사용할 수 있는 특수 종류의 패널입니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog). 컨텐츠는 대화 상자의 다른 필드와 다른 URL로 검색되고 제출됩니다.
...
* 주기
   ...
   CQ.Ext.menu.CheckItem [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.CheckItem) 요소의 메뉴가 포함된 전문화된 SplitButton 이 단추는 클릭할 때마다 각 메뉴 항목을 자동으로 순환하며, 활성 메뉴 항목에 대해 단추의 [변경](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.CycleButton) 이벤트를 발생시키거나(단추의 [changeHandler](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.CycleButton) 함수(제공된 경우)를 호출합니다.
...
* dataview
   ...
   사용자 지정 레이아웃 템플릿과 서식을 사용하여 데이터를 표시하는 메커니즘입니다. DataView는 [CQ.Ext.XTemplate를 내부 템플릿 메커니즘으로](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.XTemplate) 사용하고 [CQ.Ext.data.Store에](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.Store) 바인딩되므로 저장소의 데이터가 변경될 때 뷰가 자동으로 업데이트되어 변경 사항이 반영됩니다.
...
* 날짜 필드
   ...
   CQ.Ext.DatePicker [드롭다운](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) 및 자동 날짜 유효성 검사가 포함된 날짜 입력 필드를 제공합니다.
...
* 날짜 메뉴
   ...
   CQ.Ext. [DatePicker 구성 요소를 포함하는](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) 메뉴
...
* datepicker
   ...
   팝업 날짜 선택기입니다. 이 클래스는 [DateField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.DateField) 클래스에서 사용하여 유효한 날짜를 검색하고 선택할 수 있습니다.
...
* datetime
   ...
   DateTime을 사용하면 사용자가 [CQ.Ext.form.DateField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.DateField) 및 [CQ.Ext.form.TimeField를 결합하여 날짜와 시간을 입력할 수 있습니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TimeField).
...
* dialogfieldset
   ...
   DialogFieldSet은 [대화 상자에서](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FieldSet) 사용할 수 있는 FieldSet [입니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog).
...
* directstore
   ...
   CQ.Ext.data.DirectProxy [및](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.Store) Q.ExtC로 구성된 [CQ.Ext.data.Store](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.DirectProxy)[를 만들 수 있는 소규모 헬퍼 클래스입니다.ExtReader](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.JsonReader) 를 사용하여 CQ Ext.Direct Side Server와 보다 손쉽게 상호 작용하는 [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Direct) [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.direct.Provider) CQ.Ext.data.StoreStore를 만들 수 있습니다.
...
* 디스플레이필드
   ...
   유효성 검사가 되지 않고 제출되지 않는 표시 전용 텍스트 필드.
...
* editbar
   ...
   EditBar를 사용하면 막대의 단추를 사용하여 컨텐츠를 편집할 수 있습니다.

   여기에 나열되지는 않았지만 EditBar에는 [CQ.wcm.EditBase의 모든 구성원이 있습니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditBase).
...
* 편집기
   ...
   요청 시 표시/숨기기를 처리하고 일부 내장 크기 및 이벤트 처리 로직을 포함하는 기본 편집기 필드입니다.
...
* editorgrid
   ...
   이 클래스는 GridPanel [클래스를](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel) 확장하여 선택한 열에 셀 편집을 [제공합니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.Column). 편집 가능한 열은 [열 구성에](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.ColumnModel) 편집기를 제공하여 [지정됩니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.Column).
...
* 편집
   ...
   EditRollover를 사용하면 두 번 클릭으로 컨텐츠를 편집할 수 있으며 컨텍스트 메뉴를 통해 더 많은 편집 작업을 할 수 있습니다. 편집 가능한 영역은 마우스를 컨텐츠 위로 가져가면 프레임으로 표시됩니다.
...
* fielset
   ...
   양식 내의 항목을 그룹화하는 데 사용되는 표준 [컨테이너입니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FormPanel). ...
...
* fileuploadalogbutton
   ...
   FileUploadDialogButton은 FileUploadField를 통해 파일을 업로드하기 위한 새 대화 상자를 여는 단추를 만듭니다. 업로드가 별도의 형식으로 이루어져야 하는 편집 대화 상자 내에서 사용할 수 있습니다.
...
* groupingstore
   ...
   사용 가능한 필드 중 하나별로 레코드를 그룹화하는 기능을 제공하는 전문 저장소 구현입니다. 일반적으로 그룹화된 GridPanel에 대한 데이터 모델을 [증명하기](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GroupingView) 위해 CQ.Ext.grid.GroupingView와 함께 사용됩니다.
...
* historybutton
   ...
   HistoryButton은 뒤로 및 앞으로 단추를 쉽게 제공할 수 있는 작은 도우미 클래스입니다. 일반적으로 두 개의 관련 인스턴스가 필요합니다. 앞으로 단추 인스턴스는 내역을 처리하는 뒤로 단추 인스턴스에 연결된 간단한 단추입니다.
...
* htmlitor
   ...
   크기가 작은 HTML 편집기 구성 요소를 제공합니다. 일부 도구 모음 기능은 Safari에서 지원되지 않으며 필요한 경우 자동으로 숨겨집니다. 이러한 사항은 해당되는 구성 옵션에 명시됩니다.

   편집기의 도구 모음 단추에는 [buttonTips 속성에 도구 설명이 정의되어](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.HtmlEditor) 있습니다.
...
* iframedialog
   ...
   iframe 컨텐츠와 iframe에서 양식을 사용할 수 있는 일반 대화 상자
...
* iframepanel
   ...
   iframe이 포함된 패널. iframe을 쉽게 만들고 iframe load 이벤트를 수신하며 iframe 컨텐츠에 쉽게 액세스할 수 있습니다.
...
* jsonstore
   ...
   JSON 데이터에서 [CQ.Ext.data.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.Store)Stores를 보다 손쉽게 만들 수 있는 소규모 헬퍼 클래스입니다. JsonStore는 [CQ.Ext.data.JsonReader로 자동으로 구성됩니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.JsonReader).
...
* listview
   ...
   CQ.Ext.list.ListView는 뷰와 같은 [격자](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel) 구현의 빠르고 경미합니다.
...
* lvboolean 열
   ...
   부울 데이터 필드를 렌더링하는 열 정의 클래스입니다. 자세한 내용은 [CQ](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.Column) .Ext.list.Column의 xtype [구성 옵션을](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.Column) 참조하십시오.
...
* lvcolumn
   ...
   이 클래스는 ListView의 초기화에 사용할 열 구성 데이터를 [캡슐화합니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.ListView).
...
* lvdatolcolumn
   ...
   기본 로케일 또는 구성된 [형식에 따라 전달된 날짜를 렌더링하는 열 정의 클래스입니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.DateColumn). 자세한 내용은 [CQ](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.Column) .Ext.list.Column의 xtype [구성 옵션을](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.Column) 참조하십시오.
...
* lvnumbercolumn
   ...
   형식 문자열에 따라 숫자 데이터 필드를 렌더링하는 [열 정의](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.NumberColumn) 클래스입니다. 자세한 내용은 [CQ](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.Column) .Ext.list.Column의 xtype [구성 옵션을](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.Column) 참조하십시오.
...
* mediabrowsedialog
   ...
   **가치 하락: 컨텐츠[파인더를](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder)사용하여 미디어를 찾아보십시오.**
...
* 메뉴
   ...
   메뉴 개체입니다. 메뉴 항목을 추가할 수 있는 컨테이너입니다. 또한 다른 구성 요소(예: [CQ.Ext.menu.DateMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.DateMenu) )를 기반으로 하는 특수 메뉴를 원하는 경우 메뉴를 기본 클래스로 사용할 수 있습니다.
...
* menuitem
   ...
   하위 메뉴와 같은 메뉴 관련 기능이 필요하고 정적 표시 항목이 아닌 모든 메뉴 항목에 대한 기본 클래스입니다. Item은 메뉴별 활성화를 추가하고 클릭 처리를 통해 [CQ.Ext.menu.BaseItem](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.BaseItem) 의 기본 기능을 확장합니다.
...
* 멘토레이터
   ...
   메뉴 항목의 논리 그룹을 나누는 데 사용되는 구분 기호를 메뉴에 추가합니다. 일반적으로 add()를 호출하거나 항목 구성에서 직접 만들지 않고 &quot;-&quot;를 사용하여 이러한 항목 중 하나를 추가합니다.
...
* 메타데이터
   ...
   메타데이터는 자산 편집기 페이지에서 사용되는 메타데이터 필드에 필요한 정보를 결정하는 필드 세트를 제공합니다.
...
* 멀티필드
   ...
   MultiField는 다중 값 속성을 편집할 수 있는 양식 필드 목록입니다.
...
* 번호
   ...
   자동 키 입력 필터링 및 숫자 유효성 검사를 제공하는 숫자 텍스트 필드
...
* 패널
   ...
   패널은 [CQ.Ext.Container의 상속을 통해 만들어집니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container).
...
* paragraph reference
   ...
   단락 참조 필드에서 페이지를 검색하고 해당 단락 중 하나를 선택할 수 있습니다. 트리거 필드 및 관련 단락 찾아보기 대화 상자로 구성됩니다.
...
* 암호
   ...
   암호는 [CQ.Ext.form.TextField와](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField) 비슷하지만 값을 비공개로 유지하여 민감한 데이터를 입력할 수 있습니다.
...
* 경로 필드
   ...
   PathField는 경로 완료 경로를 위해 설계된 입력 필드이며 서버 저장소를 검색할 수 있도록 [CQ.BrowseDialog를 여는](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.BrowseDialog) 단추입니다. 또한 고급 링크 생성을 위해 페이지 단락을 검색할 수도 있습니다.
...
* 진행 상황
   ...
   수동 모드에서는 사용자 자신의 코드에서 필요에 따라 진행률 표시줄을 표시, 업데이트( [updateProgress](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ProgressBar)를 통해)하고 삭제할 책임이 있습니다. 이 메서드는 진행 상태를 표시하려는 경우에 가장 적합합니다.
...
* propertygrid
   ...
   개발 IDE에서 일반적으로 볼 수 있는 기존의 속성 격자를 모방하기 위한 특수 격자 구현 그리드의 각 행은 일부 객체의 속성을 나타내며 데이터는 [CQ.Ext.grid.PropertyRecords에서 이름/값 쌍 세트로](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.PropertyRecord)저장됩니다.
...
* 빠른 팁
   ...
   @xtype quicktip 마크업에 지정할 수 있고 글로벌 [CQ.Ext.QuickTips 인스턴스에서 자동으로 관리하는 툴팁에 대한 전문화된 툴팁 클래스입니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.QuickTips) . 자세한 사용 정보와 예는 QuickTips 클래스 헤더를 참조하십시오.
...
* 라디오
   ...
   단일 라디오 필드 확인란과 동일하지만 입력 유형을 자동으로 설정할 수 있는 편의를 위해 제공됩니다. 라디오 그룹화는 그룹의 각 라디오를 같은 이름으로 지정하면 브라우저에서 자동으로 처리됩니다.
...
* 무선 그룹
   ...
   CQ. [Ext.form.Radio](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Radio) 컨트롤의 그룹화 컨테이너입니다.
...
* 롤아웃플랜
   ...
   RolloutPlan에서는 페이지 롤아웃 진행 상황을 보는 대화 상자를 제공합니다. RolloutPlan은 [CQ.wcm.msm.RolloutWizard에 의해 시작됩니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutWizard).
...
* 롤아웃마법사
   ...
   롤아웃 마법사는 페이지를 롤아웃하는 마법사를 제공합니다. RolloutWizard가 [CQ.wcm.msm.RolloutPlan을 시작합니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutPlan).
...
* selection
   ...
   선택 기능을 사용하면 여러 옵션 중에서 선택할 수 있습니다. 옵션은 구성의 일부이거나 JSON 응답에서 로드할 수 있습니다. 선택 항목을 드롭다운(선택) 또는 콤보 상자(더하기 무료 텍스트 입력 선택)로 렌더링할 수 있습니다.
...
* 사이드 킥이
   ...
   사이드킥은 사용자에게 페이지 편집을 위한 일반적인 도구를 제공하는 부동 도우미
...
* 시제필드
   ...
   SizeField를 사용하면 너비와 높이(예: 이미지)를 입력할 수 있습니다.
...
* 슬라이드쇼
   ...
   슬라이드쇼에서는 슬라이드쇼로 볼 수 있는 이미지 및 이미지 제목 집합을 정의하고 편집하는 데 사용할 수 있는 구성 요소를 제공합니다.
...
* 스마트시대
   ...
   SmartImage는 지능적인 이미지 업로더입니다. 이미지 맵과 이미지 크로퍼를 정의하는 도구 등 업로드된 이미지를 처리하는 도구를 제공합니다.
...
* 스플리트버튼
   ...
   이벤트의 기본 클릭 이벤트와 별도로 이벤트를 실행할 수 있는 내장 드롭다운 화살표를 제공하는 분할 단추입니다. 일반적으로 이 메서드는 기본 단추 동작에 대한 추가 옵션을 제공하는 드롭다운 메뉴를 표시하는 데 사용되지만, 모든 사용자 지정 핸들러는 브라우저 구현을 제공할 수 있습니다.
...
* 통계
   ...
   통계에는 페이지 임프레션이 차트로 표시됩니다. 위젯을 사용하면 기간을 선택할 수 있으므로 통계를 표시해야 합니다.
...
* 스토어
   ...
   Store 클래스는 [GridPanel](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.Record) , ComboBox [또는 DataView와 같은 구성 요소에 대한 입력 데이터를 제공하는 Record](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel)개체의 클라이언트 측 캐시를 [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.ComboBox)캡슐화합니다 [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DataView).
...
* 추천 필드
   ...
   SuggestField는 사용자가 자신의 항목을 기반으로 제안을 제시합니다.
...
* 전환기
   ...
   전환기는 콘솔의 헤더 막대에 대해 웹 사이트, 디지털 자산, 도구, 워크플로우 및 보안 간을 전환할 수 있는 단추 그룹을 제공합니다.
...
* tableedit
   ...
   **가치 하락: CQ.[form.TableEdit2를](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.TableEdit2)대신 사용하십시오.**
...
* 표 패널
   ...
   기본 탭 컨테이너입니다. TabPanels는 레이아웃 작업을 위해 표준 [CQ.Ext.Panel과](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Panel) 정확히 동일하게 사용할 수 있지만 하위 구성 요소([`items`](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container))를 포함하는 데 대한 특수 지원도 있습니다.
...
* 텍스트 영역
   ...
   여러 줄로 된 텍스트 필드 기존 텍스트 영역 필드를 직접 대체하는 데 사용할 수 있을 뿐만 아니라 자동 크기 조정 지원이 추가되었습니다.
...
* textbutton
   ...
   TextButton은 [CQ.Ext.Button의 기능이 있는 텍스트 링크를 제공합니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Button).
...
* titleasparator
   ...
   메뉴 항목의 논리 그룹을 나누는 데 사용되는 구분 기호를 메뉴에 추가합니다. 구분 기호는 제목을 추가로 옮길 수 있습니다.
...
* 툴팁
   ...
   대상 요소 위에 마우스를 놓을 때 추가 정보를 제공하기 위한 표준 도구 설명 구현입니다. @xtype tooltip.
...
* 트리파넬
   ...
   [TreePanel에 추가된](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.tree.TreeNode)TreeNodes는 각 응용 프로그램에서 사용하는 메타데이터를 해당 [특성](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.tree.TreeNode) 속성에 포함할 수 있습니다.
...
* 트리거
   ...
   클릭 가능한 트리거 단추를 추가하는 TextFields에 대한 편리한 래퍼를 제공합니다(기본적으로 combobox와 유사). 트리거에는 기본 작업이 없으므로 onTriggerClick을 무시하여 트리거 클릭 핸들러를 구현하는 함수 [를 할당해야 합니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TriggerField). TriggerField는 combobox처럼 렌더링되므로 직접 만들 수 있습니다.
...
* userinfo
   ...
   현재 사용자 이름을 표시하고 사용자 속성 및 가장과 같은 사용자 작업을 허용하는 도구 모음 항목입니다.
...
* 뷰포트
   ...
   뷰포트는 문서 본문에 렌더링을 수행하고 브라우저 뷰포트의 크기에 맞게 자동으로 크기를 조정하며 창 크기를 관리합니다. 만들어진 뷰포트는 하나만 있을 수 있습니다.
...
* xmlstore
   ...
   XML 데이터에서 [CQ.Ext.data.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.Store)Stores를 쉽게 만들 수 있는 작은 도우미 클래스입니다. XmlStore는 [CQ.Ext.data.XmlReader로 자동으로 구성됩니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.XmlReader).

   **보관소의 다른 경로에서 위젯 정의를 포함하는 cqinclude** 의사 xtype 페이지 대화 상자에서 가장 일반적으로 사용됩니다. 이 xtype에 대한 실제 JavaScript 위젯 클래스가 없습니다. CQ.Util 클래스의 formatData() 함수로 처리됩니다. 자세한 내용은 이 기술 자료 문서를 참조하십시오.
