...
description: 'AEM Content Services는 웹 페이지에 초점을 둔 수준에서 벗어나 AEM에서의 컨텐츠 설명 및 제공을 일반화하기 위해 고안되었습니다. 모든 클라이언트가 사용할 수 있는 표준화된 방법을 사용하여 기존 AEM 웹 페이지가 아닌 채널에 컨텐츠를 제공합니다. '
seo-description: 'AEM Content Services는 웹 페이지에 초점을 둔 수준에서 벗어나 AEM에서의 컨텐츠 설명 및 제공을 일반화하기 위해 고안되었습니다. 모든 클라이언트가 사용할 수 있는 표준화된 방법을 사용하여 기존 AEM 웹 페이지가 아닌 채널에 컨텐츠를 제공합니다. '
...
구조화된 컨텐츠를 사용하는 컨텐츠 조각을 사용하면 JSON 내보내기 도구를 사용하여 JSON 데이터 모델 형식으로 AEM 페이지의 컨텐츠를 전달하여 컨텐츠 서비스를 제공할 수 있습니다. 그런 다음 자체 응용 프로그램에서 사용할 수 있습니다.
...
AEM JSON 내보내기 도구를 사용하여 (y) AEM 페이지의 콘텐츠를 JSON 데이터 모델 형식으로 제공할 수 있습니다. 그런 다음 자체 응용 프로그램에서 사용할 수 있습니다.

AEM 내에서 전달은 접미사를 사용하여 이루어집니다
...
구조화된 컨텐츠 조각을 구체적으로 타깃팅하여 컨텐츠를 제공할 수도 있습니다.
...
* 다음과 같은 컨텐츠를 제공합니다.
   ...
   >[!NOTE]
   >
   >이 데이터에 액세스하고 사용할 수 있도록 고유한 구성 요소를 [](/help/sites-developing/json-exporter-components.md) 조정할 수 있습니다.
...
* Sling Models:
   ...
   * [Sling Models - 130 이후 모델 클래스를 리소스 유형과 연결](https://sling.apache.org/documentation/bundles/models.html#associating-a-model-class-with-a-resource-type-since-130)
