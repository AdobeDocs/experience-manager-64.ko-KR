...
>[!NOTE]
>
>진단 정보를 반환하려면 디버그 모드를 활성화해야 하고, 진단 페이지가 비어 있게 됩니다. 디버그 모드 활성화 방법에 대한 자세한 내용은 [이 문서를](/help/sites-administering/contexthub-config.md#debugging-contexthub) 참조하십시오.
