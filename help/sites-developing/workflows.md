...
>* 정보 위치를 변경하면 AEM 6.4 [의 리포지토리 재조정](/help/sites-deploying/repository-restructuring.md) 및 [워크플로우 우수 사례 - 위치를 참조하십시오](/help/sites-developing/workflows-best-practices.md#locations).
>
