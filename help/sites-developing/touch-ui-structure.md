...
* 사이드 패널
* 모든 오버레이
* 기타 페이지 작성 요소 예를 들어, 구성 요소 도구 모음
...
터치 지원 UI에 대한 자세한 내용은 AEM 터치 지원 UI의 [개념 아티클을 참조하십시오](/help/sites-developing/touch-ui-concepts.md).

자세한 기술 정보는 터치 지원 페이지 편집기의 [JS 설명서](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/jsdoc/ui-touch/editor-core/index.html) 세트를 참조하십시오.
