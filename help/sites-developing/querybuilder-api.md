...
쿼리 설명은 단순히 예측([`Predicate`](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/search/Predicate.html)) 세트입니다. 예에는 XPath의 함수에 해당하는 전체 텍스트 `jcr:contains()` 조건자가 포함됩니다.
...
| [com.day.cq.search.facults.extractor](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/search/facets/extractors/package-summary.html) | 패싯 추출(평가자용) |
