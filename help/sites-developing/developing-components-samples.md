...
* 프로젝트를 ZIP 파일 [로 다운로드](https://github.com/Adobe-Marketing-Cloud/aem-authoring-dialog-fields-customization/archive/master.zip)

>[!NOTE]
>
>이 코드 샘플은 대화 상자 필드 사용자 지정에 있는 AEM Gems 세션 [과 관련되어 있습니다](https://docs.adobe.com/content/ddc/en/gems/customizing-dialog-fields-in-touch-ui.html).
...
코드 샘플에 대한 링크와 함께 세부 사항은 구성 요소 도구 모음에 [새 작업 추가 아래에 있습니다](/help/sites-developing/customizing-page-authoring-touch.md#add-new-action-to-a-component-toolbar).
