...
이러한 모든 구성 요소는 표준 AEM 설치에서 사용할 수 있는 일련의 기본 [양식 구성 요소](/help/sites-authoring/default-components.md)로 구현됩니다.
...
1. 폴더에서 다음 중 하나를 만듭니다.
   ...
   1. 게시물 스크립트.
      ...
      양식 처리를 위해 양식이 전송될 때 게시물 스크립트가 호출되며, 여기에는 `POST` 양식에서 도착하는 데이터를 처리하는 코드가 포함됩니다.
...
스크립트를 작성할 때 사용할 수 있는 API 요소에 대한 자세한 내용은 양식](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/foundation/forms/package-summary.html)과 관련된 [javadocs를 참조하십시오.
