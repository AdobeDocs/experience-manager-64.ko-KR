...
* 프로젝트를 ZIP 파일 [로 다운로드](https://github.com/justinedelson/aem-uberjar-demo/archive/6.2-unobfuscated.zip)

>[!NOTE]
>
>Maven *settings.xml* 파일에서 이러한 저장소를 구성할 수도 있습니다.

다른 빌드 시스템(예: Apache Ant, Gradle) 사용자는 선택한 도구의 특정 구문에 따라 유사한 단계를 따라야 합니다.
...
### JSP를 사용한 작업 방법 {#how-to-work-with-jsps}
