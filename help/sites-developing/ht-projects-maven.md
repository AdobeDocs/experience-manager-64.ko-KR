...
### 우버jar는 어떻게 사용합니까? {#how-to-i-use-the-uberjar}
...
* [GitHub에서 aem-uberjar-demo 프로젝트 열기](https://github.com/justinedelson/aem-uberjar-demo)
* 프로젝트를 ZIP [파일로 다운로드](https://github.com/justinedelson/aem-uberjar-demo/archive/6.2-unobfuscated.zip)

>[!NOTE]
>
>Maven *settings.xml* 파일에서 이러한 저장소를 구성할 수도 있습니다.

다른 빌드 시스템(예: Apache Ant, Gradle) 사용자는 선택한 도구의 특정 구문에 맞게 유사한 단계를 따라야 합니다.
...
### JSP를 사용한 사용 방법 {#how-to-work-with-jsps}
...
>[!NOTE]
>
>위에 설명된 대로 제품 종속성을 가져오지 않는 한, 상기에 설명된 바와 같이 AEM 설정과 일치하는 버전과 함께 상위 POM에도 해당 종속성을 추가해야 합니다. 아래 각 항목의 댓글에는 종속성 파인더에서 검색할 패키지가 표시됩니다.
