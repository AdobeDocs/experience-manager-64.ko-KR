...
seo-description: 프로젝트 설정, 구성 요소 매핑, 프런트 엔드 개발 도구 및 애플리케이션 라우팅을 통해 SPA을 구현하도록 안내하는 이 여러 부분으로 구성된 자습서를 통해 SPA 개발에 몰두하십시오.
...
그러나 AEM용 SPA 프로젝트를 시작하기 전에 [AEM for SPA 개발](/help/sites-developing/spa-architecture.md) 문서도 검토하십시오.
