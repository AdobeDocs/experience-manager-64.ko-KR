...
* CQ QueryBuilder [를 기반으로 합니다](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/search/QueryBuilder.html).
...
이 대화 상자는 표준 CQ [대화 상자이며](/help/sites-developing/components-basics.md#dialogs) 이와 같이 구성할 수 있습니다( [자세한 내용은 CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog) 참조).
