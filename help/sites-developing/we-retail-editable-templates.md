...
자세한 내용은 작성 문서 [페이지 템플릿](/help/sites-authoring/templates.md) 만들기 또는 개발자 문서 페이지 템플릿 [- 편집 가능](/help/sites-developing/page-templates-editable.md) 템플릿에 대한 자세한 기술 정보를 참조하십시오.

또한 [핵심 구성 요소를 조사할 수도 있습니다](/help/sites-developing/we-retail-core-components.md). 핵심 구성 요소의 기능에 대한 개요 [는 제작 문서](https://docs.adobe.com/content/help/ko-KR/experience-manager-core-components/using/introduction.html) 핵심 구성 요소 [를](https://helpx.adobe.com/experience-manager/core-components/using/developing.html) 참조하고, 기술 개요는 개발자 문서를참조하십시오.
