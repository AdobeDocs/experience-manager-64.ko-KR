...
description: 이 문서에서는 SPA의 개념을 소개하고 저작 시 기본 SPA 응용 프로그램을 사용하는 방법을 단계별로 살펴봅니다. 이 프로그램은 기본 AEM SPA Editor와 어떻게 관련되어 있는지 보여줍니다.
seo-description: 이 문서에서는 SPA의 개념을 소개하고 저작 시 기본 SPA 응용 프로그램을 사용하는 방법을 단계별로 살펴봅니다. 이 프로그램은 기본 AEM SPA Editor와 어떻게 관련되어 있는지 보여줍니다.
...
1. 새 탭 `react.model.json` 에서 을 로드합니다.
   ...
   AEM SPA Editor는 [AEM Content Services](/help/assets/content-fragments.md) 를 활용하여 페이지의 전체 컨텐츠를 JSON 모델로 전달합니다.
