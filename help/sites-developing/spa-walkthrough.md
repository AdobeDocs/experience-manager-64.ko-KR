...
1. We.Retail 저널 응용 프로그램을 게시 서버에 로드하거나 페이지 편집기의 **페이지 정보** 메뉴에서 **[!UICONTROL 게시됨으로 보기]** 옵션을 사용하여 로드합니다.
...
1. 아직 로드되지 않은 경우, We.Retail 저널 애플리케이션을 게시 서버에 로드하거나 페이지 편집기의 **페이지 정보** 메뉴에서 **[!UICONTROL 게시됨으로 보기]** 옵션을 사용하여 로드합니다.
