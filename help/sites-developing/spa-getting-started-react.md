...
인제스트는 페이지 모델의 JSON 표현을 `Page` 설정하고 컨텐츠가 페이지의 각 요소를 래핑/장식하도록 처리합니다. 자세한 내용은 `Page` SPA Blueprint 문서를 [참조하십시오](/help/sites-developing/spa-blueprint.md).
...
자세한 내용은 SPA Blueprint [문서를](/help/sites-developing/spa-blueprint.md)참조하십시오.
