...
다음 `Page` 페이지 모델의 JSON 표현을 설정하고 컨텐츠를 처리하여 페이지의 각 요소를 래핑/장식합니다. 에 대한 자세한 내용 `Page` 문서에서 찾을 수 있습니다. [SPA 블루프린트](/help/sites-developing/spa-blueprint.md).
...
자세한 내용은 [SPA 블루프린트 문서](/help/sites-developing/spa-blueprint.md).
