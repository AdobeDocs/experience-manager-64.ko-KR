...
기본 [`Component Mapping`](/help/sites-developing/spa-blueprint.md#componentmapping) 라이브러리 및 그 `MapTo` 함수를 캡슐화하고 확장하여 현재 구성 요소 클래스와 함께 제공된 편집 구성에 대한 기능을 제공할 수 있습니다.
...
## 페이지 편집기 {#contract-with-the-page-editor}와 계약
