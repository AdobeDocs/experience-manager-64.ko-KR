...
>[!NOTE]
>
>AEM 6.4.5.0 이상은 [SPA Editor](/help/sites-developing/spa-overview.md)에서 편집 가능한 템플릿을 사용해야 합니다.
...
1. 새 템플릿의 구조, 컨텐츠 정책, 초기 컨텐츠 및 레이아웃을 구성합니다.
   ...
   * 초기 컨텐츠를 정의할 수 있도록 하려면 구성 요소 잠금을 해제했다가 다시 잠글 수 있습니다.
   ...
   구조에 대한 자세한 내용은 이 문서에서 [구조](/help/sites-developing/page-templates-editable.md#structure)를 참조하십시오.
...
1. 템플릿을 활성화한 다음 특정 컨텐츠 트리에 대해 허용합니다.
   ...
   * 특정 페이지 분기에서 템플릿을 사용하거나 사용할 수 없게 지정할 수 있습니다.
   ...
   템플릿 활성화에 대한 자세한 내용은 이 문서에서 [Us](/help/sites-developing/page-templates-editable.md#enabling-and-allowing-a-template-for-use)용 템플릿 활성화 및 허용 을 참조하십시오
...
* 템플릿 유형을 사용하면 다음을 정의할 수 있습니다.
   ...
   * 템플릿 유형에서 응답형 그리드에 대한 중단점을 정의하고 모바일 에뮬레이터를 설정하는 것이 좋습니다. 구성은 개별 템플릿에서도 정의할 수 있으므로 선택 사항입니다([템플릿 유형 및 모바일 장치 그룹](/help/sites-developing/page-templates-editable.md#template-type-and-mobile-device-groups) 참조).
...
1. **허용된 템플릿**
   ...
   * 속성을 설정합니다.
      ...
      필요한 분기의 `jcr:content` 노드에서 다음을 수행합니다.
   예를 들어 다음 값이 있는 경우:
