...
>[!NOTE]
>
>AEM 6.4.5.0 이상은 편집 가능한 템플릿을 [SPA 편집기](/help/sites-developing/spa-overview.md).
...
1. 새 템플릿의 구조, 컨텐츠 정책, 초기 컨텐츠 및 레이아웃을 구성합니다.
   ...
   * 초기 콘텐츠를 정의할 수 있도록 하려면 구성 요소 잠금을 해제했다가 다시 잠글 수 있습니다.
   ...
   구조에 대한 자세한 내용은 [구조](/help/sites-developing/page-templates-editable.md#structure) 참조하십시오.

   **정책**

   * 컨텐츠 정책은 구성 요소의 디자인 속성을 정의합니다.

      * 예를 들어 사용 가능한 구성 요소나 최소/최대 차원을 사용할 수 있습니다.
   * 템플릿(및 템플릿으로 만든 페이지)에 적용할 수 있습니다.
   ...
   정책에 대한 기술적인 세부 사항은 [컨텐츠 정책](/help/sites-developing/page-templates-editable.md#content-policies) 참조하십시오.
...
1. 템플릿을 활성화한 다음 특정 컨텐츠 트리에 대해 허용합니다.
   ...
   * 특정 페이지 분기에서 템플릿을 사용하거나 사용할 수 없게 지정할 수 있습니다.
   ...
   템플릿 활성화에 대한 자세한 내용은 [Adobe에 대한 템플릿 활성화 및 허용](/help/sites-developing/page-templates-editable.md#enabling-and-allowing-a-template-for-use)이 문서의 e

1. 이 필드를 사용하여 컨텐츠 페이지를 만듭니다.

   * 템플릿을 사용하여 새 페이지를 만들 때 정적 템플릿과 편집 가능한 템플릿 간에 차이점은 없으며 구분하는 표시도 없습니다.
...
* 템플릿 유형을 사용하면 다음을 정의할 수 있습니다.
   ...
   * 템플릿 유형에서 응답형 그리드에 대한 중단점을 정의하고 모바일 에뮬레이터를 설정하는 것이 좋습니다. 구성은 개별 템플릿에서도 정의할 수 있으므로 선택 사항입니다(참조). [템플릿 유형 및 모바일 장치 그룹](/help/sites-developing/page-templates-editable.md#template-type-and-mobile-device-groups)).
...
콘텐츠(또는 디자인) 정책은 구성 요소의 디자인 속성을 정의합니다. 예를 들어 사용 가능한 구성 요소나 최소/최대 차원을 사용할 수 있습니다. 템플릿(및 템플릿으로 만든 페이지)에 적용할 수 있습니다. 템플릿 편집기에서 컨텐츠 정책을 만들고 선택할 수 있습니다.
...
1. **템플릿 활성화**
   ...
   * [템플릿 활성화](/help/sites-authoring/templates.md#enabling-and-allowing-a-template-template-author) 에서 **템플릿** 콘솔.
...
* 모델 - OSGi 번들
   ...
   다음 [OSGI 번들](/help/sites-deploying/osgi-configuration-settings.md) 기능을 구현합니다.
