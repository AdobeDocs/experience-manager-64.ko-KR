...
이러한 세그먼트는 방문자에게 특정 타깃팅된 컨텐츠를 제공하는 데 사용됩니다. 이 컨텐츠는 웹 사이트의 [캠페인](/help/sites-authoring/personalization.md) 섹션에서 유지 관리됩니다. 여기에 정의된 Teaser 페이지는 모든 페이지에서 Teaser 단락에 포함될 수 있으며 특수 컨텐츠가 적용되는 방문자 세그먼트를 정의할 수 있습니다.
...
1. 세그먼트 템플릿을 사용하여 [새 페이지를](/help/sites-authoring/managing-pages.md) **만듭니다** .
...
1. 세그먼트 정의를 편집하여 **제목, 설명** 및 **증폭 인수를**&#x200B;지정할 수 ******[있습니다](/help/sites-administering/campaign-segmentation.md#boost-factor)**.
...
1. 테스트할 세그먼트를 선택합니다.
1. Ctrl- **[Alt-C](/help/sites-authoring/keyboard-shortcuts.md)**를 눌러**[](/help/sites-administering/client-context.md)**수집된 데이터를 보여주는 클라이언트 컨텍스트를 엽니다. 테스트 목적으로 특정 **값을 편집하거나** 다른 **프로파일을 로드하여** 해당 값을 확인할 수 있습니다.
...
세그먼트는 현재 캠페인 내에서 사용됩니다 [](/help/sites-authoring/personalization.md). 특정 타겟 고객이 보는 실제 컨텐츠를 유도하는 데 사용됩니다. 자세한 [내용은](/help/sites-authoring/segmentation-overview.md) 세그먼트 이해를 참조하십시오.
