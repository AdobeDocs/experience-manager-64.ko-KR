...
# AEM Screens 플레이어용 호환성 표{#compatibility-matrix-for-aem-screens-player}
...
|---|---|
| **AEM 6.3+SP1+Screens FP1(1.0.64_B002)** | **3.2.68 -** (Macromedia 사이트에서 이용 가능) 및 Google Play 스토어 |
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td><strong>3.2.68 -</strong> (Macromedia 사이트에서 이용 가능) 및 Google Play 스토어</td> 
  </tr>
  <tr>
   <td><strong><strong>AEM 6.3+SP1+Screens FP2(1.0.298)</strong></strong></td> 
