...
* **랜딩 페이지를 위한 HTML 준비**  - 랜딩 페이지를 사용하면 디자인과 컨텐츠를 빠르고 손쉽게 AEM 페이지로 가져올 수 있습니다. 에셋을 제대로 가져올 수 있도록 HTML을 준비해야 합니다. 랜딩 페이지는 제한된 시간 동안만 활성화되고 빠르게 만들어야 하는 마케팅 랜딩 페이지를 만들 때 유용합니다.
...
* [랜딩 페이지를 Adobe Analytics과 통합](/help/sites-administering/integrating-landing-pages-with-adobe-analytics.md)
