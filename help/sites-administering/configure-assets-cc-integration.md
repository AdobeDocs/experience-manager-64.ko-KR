...
>[!NOTE]
>
>이 기능은 AEM Assets에서 더 이상 사용되지 않습니다. [AEM 및 Creative Cloud 통합 우수 사례](/help/assets/aem-cc-integration-best-practices.md)에서 대체 항목을 찾습니다. 쿼리가 있으면 [Adobe 고객 지원 센터](https://www.adobe.com/kr/account/sign-in.supportportal.html)에 문의하십시오.
