---
title: 검색 양식 구성
description: Search Forms을 구성하는 방법을 알아봅니다.
...
사용 **Forms 검색** 다양한 AEM 콘솔 및/또는 작성 환경의 패널에서 사용할 수 있는 검색 패널에서 사용되는 검색 조건자의 선택을 사용자 지정하려면 를 선택합니다. 이러한 패널을 사용자 지정하여 특정 요구 사항에 따라 검색 기능을 다양하게 활용할 수 있습니다.

A [조건자 범위](#predicates-and-their-settings)기본적으로 제공됩니다. 속성 조건부를 포함하여(다른 속성들 중) 여러 조건자를 추가하여 사용자가 지정한 단일 속성과 일치하는 자산을 검색하거나 옵션 조건부를 사용하여 특정 속성에 대해 지정한 하나 이상의 값과 일치하는 자산을 검색할 수 있습니다.

다음을 수행할 수 있습니다 [검색 양식 구성](#configuring-your-search-forms) 다양한 콘솔 및 자산 브라우저 내에서 사용됩니다(페이지를 편집할 때). 다음 [이러한 양식 구성을 위한 대화 상자](#configuring-your-search-forms) 는 다음을 통해 액세스할 수 있습니다.
...
이 콘솔에 처음 액세스하면 모든 구성에 자물쇠 기호가 있음을 알 수 있습니다. 이는 적절한 구성이 기본(기본) 구성이며 삭제할 수 없음을 나타냅니다. 구성을 사용자 지정했으면 잠금이 사라집니다. [사용자 지정된 구성 삭제](#deleting-a-configuration-to-reinstate-the-default)- 기본(및 자물쇠 표시기)가 복원됩니다.
...
* **페이지 편집기(Dynamic Media Classic) [이전 Scene7] search)**:
   ...
   이 구성은 자산 브라우저에서 Dynamic Media Classic 리소스를 검색할 때(페이지를 편집할 때) 사용할 수 있는 옵션을 정의합니다.
...
* **자산 관리자 검색 레일:**
   ...
   이 구성은 자산 콘솔을 사용할 때 사용자가 사용할 수 있는 검색 옵션을 정의합니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>마지막으로 수정된 자산 </td> 
   <td>자산이 마지막으로 수정된 날짜입니다.<br /> </td> 
   <td>날짜 설명을 기반으로 하는 사용자 지정된 조건자입니다.</td> 
  </tr> 
  <tr> 
   <td>구성 요소 </td> 
  ...
  <tr> 
   <td>날짜 </td> 
   <td>날짜 속성을 기반으로 자산의 슬라이더 기반 검색.</td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>속성 이름*</li> 
  ...
  <tr> 
   <td>날짜 범위 </td> 
   <td>지정된 범위 내에서 만든 자산에 대해 날짜 속성을 검색합니다. 검색 패널에서 시작 및 종료 날짜를 지정할 수 있습니다.</td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>자리 표시자</li> 
  ...
  <tr> 
   <td>범위 옵션 </td> 
   <td>자산에 대한 특정 검색 조건이며, 일반적인 슬라이더 조건자와 동일합니다. 이전 버전과의 호환성 문제로 인해 계속 사용할 수 있습니다.</td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>속성 이름*</li> 
  ...
  <tr> 
   <td>상대적 날짜 </td> 
   <td>자산의 상대적 작성 날짜를 기준으로 자산을 검색합니다<br /> </td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>속성 이름*</li> 
  ...
  <tr> 
   <td>태그 </td> 
   <td>태그를 기준으로 자산을 검색합니다. 태그 목록에서 다양한 태그를 채우도록 경로 속성을 구성할 수 있습니다.</td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>속성 이름*</li> 
...
조건자에 따라 설정에 대한 선택 항목을 구성할 수 있습니다.
...
1. 를 엽니다. **Forms 검색** 콘솔에서 업데이트할 구성을 선택합니다. 예, **Sites 관리 검색 레일**.
...
1. 선택 **완료** 구성을 저장합니다.
1. 해당 콘솔로 이동합니다(이 예에서 **Sites**)를 클릭하여 엽니다. **검색** 레일. 새로 정의된 검색 양식과 다양한 옵션이 표시됩니다. 필요한 옵션을 선택하여 검색 결과를 확인합니다.
