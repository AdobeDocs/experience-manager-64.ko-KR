...
Forms **검색** 기능을 사용하여 다양한 AEM 콘솔 및/또는 작성 환경의 패널에서 사용할 수 있는 검색 패널에 사용되는 검색 예측 항목을 사용자 정의할 수 있습니다. 이러한 패널을 사용자 정의하면 특정 요구 사항에 따라 검색 기능을 사용할 수 있습니다.

즉시 사용 가능한 [다양한](#predicates-and-their-settings)예측자를 이용할 수 있습니다. 전체 텍스트 검색에 대한 전체 텍스트 설명, 사용자가 지정한 단일 속성과 일치하는 자산을 검색하도록 속성 설명, 특정 속성에 대해 지정한 하나 이상의 값과 일치하는 자산을 검색하도록 옵션 설명 등 여러 개의 조건자를 추가할 수 있습니다.

다양한 콘솔 및 자산 브라우저 [](#configuring-your-search-forms) (페이지를 편집할 때)에서 사용되는 검색 양식을 구성할 수 있습니다. 이러한 양식 [을 구성하기 위한 대화 상자는 다음을 통해 액세스할](#configuring-your-search-forms) 수 있습니다.
...
이 콘솔에 처음 액세스하면 모든 구성에 자물쇠 기호가 있음을 확인할 수 있습니다. 이는 해당 구성이 기본(기본) 구성이며 삭제할 수 없음을 나타냅니다. 구성을 사용자 지정했으면 잠금이 사라집니다. 사용자 지정된 구성을 [삭제하지](#deleting-a-configuration-to-reinstate-the-default)않으면 기본(및 자물쇠 표시기)이 복원됩니다.

![chlimage_1-374](assets/chlimage_1-374.png)

## 구성 {#configurations}

사용 가능한 기본 구성은 다음과 같습니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>날짜 술어를 기반으로 하는 사용자 지정 조건자입니다.</td> 
  </tr> 
  <tr> 
   <td>구성 요소 </td> 
  ...
  <tr> 
   <td>날짜 </td> 
   <td>날짜 속성을 기반으로 한 자산의 슬라이더 기반 검색</td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>속성 이름*</li> 
  ...
  <tr> 
   <td>범위 옵션 </td> 
   <td>자산에 대한 특정 검색 조건자 및 일반적인 슬라이더 조건자와 동일합니다. 이전 버전과의 호환성 문제로 여전히 사용할 수 있습니다.</td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>속성 이름*</li> 
...
* siteadmin과 관련된 검색 설명(클래식 UI)은
   > `/libs/cq/gui/components/siteadmin/admin/searchpanel/searchpredicates`
   >   * 이러한 이미지는 더 이상 사용되지 않으며 이전 버전과의 호환성에만 사용할 수 있습니다.
