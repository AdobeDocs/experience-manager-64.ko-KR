...
title: 검색 양식 구성
seo-title: 검색 양식 구성
description: 검색 양식을 구성하는 방법을 알아봅니다.
seo-description: 검색 양식을 구성하는 방법을 알아봅니다.
...
즉시 사용 가능한 [다양한](#predicates-and-their-settings)예측자를 이용할 수 있습니다. 전체 텍스트 검색에 대한 전체 텍스트 설명, 속성 설명 등 여러 조건자를 추가하여 사용자가 지정한 단일 속성과 일치하는 자산을 검색하거나 옵션 조건자를 추가하여 특정 속성에 대해 지정한 하나 이상의 값과 일치하는 자산을 검색할 수 있습니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>마지막으로 수정된 자산 </td> 
   <td>자산이 마지막으로 수정된 날짜.<br /> </td> 
   <td>날짜 조건부를 기반으로 하는 사용자 지정 조건자입니다.</td> 
  </tr> 
  <tr> 
   <td>구성 요소 </td> 
  ...
  <tr> 
   <td>날짜 </td> 
   <td>날짜 속성을 기반으로 한 슬라이더 기반의 자산 검색</td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>속성 이름*</li> 
  ...
  <tr> 
   <td>범위 옵션 </td> 
   <td>자산에 대한 특정 검색 조건자 및 일반적인 슬라이더 조건자와 동일합니다. 이전 버전과의 호환성 문제로 인해 계속 사용할 수 있습니다.</td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>속성 이름*</li> 
  ...
  <tr> 
   <td>태그 </td> 
   <td>태그를 기반으로 자산을 검색합니다. [태그] 목록에서 다양한 태그를 채우도록 Path 속성을 구성할 수 있습니다.</td> 
   <td> 
    <ul> 
     <li>필드 레이블</li> 
     <li>속성 이름*</li> 
...
* siteadmin(클래식 UI)과 관련된 검색 조건자는 다음 아래에 있습니다.
   > `/libs/cq/gui/components/siteadmin/admin/searchpanel/searchpredicates`
   >   * 이러한 기능은 더 이상 사용되지 않으며 이전 버전과의 호환성을 위해서만 사용할 수 있습니다.
> 
>
...
1. 사용자 지정된 구성이 삭제되고 기본 복원됩니다(콘솔에 자물쇠 기호가 다시 표시된 경우).
