...
## AEM Content Portlet {#administering-the-aem-content-portlet} 관리
...
1. *템플릿*&#x200B;복제 에이전트&#x200B;*를 선택하고 에이전트의 이름을 입력합니다.* *만들기*&#x200B;를 클릭합니다.
...
#### 포틀릿 캐시 {#manually-flushing-the-portlet-cache} 수동으로 플러시
