...
1. AEM 자산을 Dynamic Media Classic에 자동으로 업로드하려면 해당 옵션을 활성화하고 DAM 자산 업데이트 워크플로우에 Dynamic Media Classic을 추가해야 합니다. 자산을 수동으로 업로드할 수도 있습니다.
...
1. Dynamic Media Classic 계정의 이메일 주소, 암호 및 영역을 입력하고 **[!UICONTROL Connect를 눌러 Dynamic Media Classic을 누릅니다]**. Dynamic Media Classic 서버에 연결되고 대화 상자가 더 많은 옵션을 사용하여 확장됩니다.
...
1. **[!UICONTROL 확인]**&#x200B;을 클릭합니다. AEM이 구성을 저장합니다.
...
1. 고급 **[!UICONTROL 탭을]** 누르고 **[!UICONTROL 자동 업로드]** 활성화 **[!UICONTROL 확인란을 선택한 다음]**&#x200B;확인을누릅니다. 이제 Dynamic Media Classic에 대한 업로드를 포함하도록 DAM 자산 워크플로우를 구성해야 합니다.
...
AEM의 페이지에서 Dynamic Media Classic 구성 요소로 이동하고 편집을 탭하여 이 항목을 확인할 **[!UICONTROL 수 있습니다]**. 자산에 URL에 보안 미리 보기 서버가 나열됩니다. AEM에 게시하면 파일 참조의 서버 도메인이 미리 보기 URL에서 프로덕션 URL로 업데이트됩니다.
