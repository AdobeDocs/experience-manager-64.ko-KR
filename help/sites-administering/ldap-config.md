...
>
>Apache DS로 Experience Manager을 구성하는 예제를 보려면 [Apache Directory Service를 사용하도록 Adobe Experience Manager 6.4 구성을 참조하십시오.](https://helpx.adobe.com/experience-manager/using/configuring-aem64-apache-directory-service.html)
