...
>[!NOTE]
>
>6.4로 업그레이드한 후 /etc에서 파일을 이동하는 것이 좋습니다. 자세한 [내용은 AEM 6.4의](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules) 공용 저장소 구조화를 참조하십시오.
...
편집기에서 [필터] 탭에서 [ **i]를`s Deep`**선택/선택 취소할**&#x200B;수&#x200B;**있습니다.
