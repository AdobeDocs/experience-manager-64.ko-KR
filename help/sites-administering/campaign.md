...
이 버전의 AEM을 다음 버전의 Adobe Campaign과 통합할 수 있습니다.

* Adobe Campaign 6.1 - 온-프레미스 솔루션입니다.
* Adobe Campaign Standard - 가입 기반 솔루션입니다.

이 설명서는 AEM과 Adobe Campaign을 통합하는 방법을 설명합니다. 구독 기반 솔루션인지 온-프레미스 솔루션인지 여부에 따라 통합 단계는 약간 다릅니다.
...
>[!NOTE]
>
>관련 AEM 커뮤니티 아티클을 검토하려면 다음을 참조하십시오. [Adobe Experience Manager과 Adobe Campaign Standard을 통합하여 뉴레터](https://helpx.adobe.com/experience-manager/using/aem_campaign.html)제작
