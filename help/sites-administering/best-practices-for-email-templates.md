---
title: 이메일 템플릿 우수 사례
description: Adobe Experience Manager에서 잘 개발된 이메일 캠페인 템플릿을 제공하는 이메일 디자인에 대한 모범 사례를 확인할 수 있습니다.
contentOwner: User
...
>[!NOTE]
>
>모든 캠페인 컨텐츠는 `cq/personalization/components/ambitpage` 유형의 `master` 페이지 아래에 만들어야 합니다. 예를 들어 캠페인 구조를 계획하는 경우 다음과 같습니다.
>
...
기본 템플릿을 제공하고 다양한 컨텐츠 흐름을 확장하려면 기본적으로 3가지 서로 다른 템플릿 유형을 사용할 수 있습니다. 이러한 템플릿을 사용하여 맞춤형 뉴스레터를 만들 수 있습니다.
