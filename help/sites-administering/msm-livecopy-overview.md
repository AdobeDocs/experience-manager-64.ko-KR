...
Live Copy **개요** 는 사이트 **콘솔** 의 **참조** 사이드 패널에서 열 수있습니다.

1. 사이트 **콘솔** 에서 [블루프린트 페이지로 이동하여 선택합니다](/help/sites-authoring/basic-handling.md#viewing-and-selecting-resources).
...
1. 선택한 **블루프린트와 관련된 모든 Live Copy** 개요를 표시하고 사용하려면 Live Copy 개요를 선택합니다.
1. [ **닫기** ]를 사용하여 **사이트** 콘솔로 돌아갑니다.
...
1. 적절한 **블루프린트** 페이지에 대한 속성을 엽니다.
1. 블루프린트 **탭** 열기 - **Live Copy 개요** 옵션이 상단 도구 모음에 표시됩니다.

   ![chlimage_1-360](assets/chlimage_1-360.png)

1. 현재 **블루프린트와** 관련된 모든 Live Copy 개요를 표시하고 사용하려면 Live Copy 개요를 선택합니다.
...
Live Copy **개요** 기능을 사용하여 Live Copy에서 작업을 수행할 수도 있습니다.

1. Open the **Live Copy Overview**.
1. 필요한 블루프린트 또는 Live Copy 페이지를 선택합니다. 사용 가능한 작업을 표시하도록 도구 모음이 업데이트됩니다. 사용 가능한 [작업은](/help/sites-administering/msm.md#terms-used) 블루프린트 [또는](#actions-for-a-blueprint-page) Live Copy [페이지를 선택하는지에 따라](#actions-for-a-live-copy-page) 달라집니다.
