...
1. **Lucene 이진 파일 정리 **작업은 **일별 유지 관리 창** 메뉴 아래에 있습니다.

1. **워크플로우 삭제 **작업은 **주별 유지 관리 창** 메뉴 아래에 있습니다.
...
AEM 6.4용 개정 정리 작업에 대한 자세한 내용은 [이 전용 문서](/help/sites-deploying/revision-cleanup.md)를 참조하십시오.
...
>[!NOTE]
>
>워크플로우 유지 관리에 대한 자세한 내용은 [이 페이지](workflows-administering.md#regular-purging-of-workflow-instances)를 참조하십시오.
