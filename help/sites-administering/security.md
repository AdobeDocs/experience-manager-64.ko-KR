...
>[!NOTE]
>
>AEM은 [컬렉션](/help/assets/managing-collections-touch-ui.md)에서 역할 할당(소유자, 편집기, 뷰어)에 대한 사용자 그룹을 자동으로 생성합니다. 그러나 이러한 그룹에 대해 ACL을 수동으로 추가하면 AEM 내에 보안 취약점이 발생할 수 있습니다. Adobe은 ACL을 수동으로 추가하지 않는 것을 권장합니다.
