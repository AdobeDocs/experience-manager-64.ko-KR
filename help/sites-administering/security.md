...
* 애플리케이션 내 역할 예를 들어 컨텐츠 서핑이 허용된 사람 또는 컨텐츠 제공 권한이 있는 사람과 같이
* 귀하의 조직 컨텐츠 트리의 다른 분기로 제한된 경우 다른 부서의 기여자별로 구분하기 위해 역할을 확장할 수 있습니다.
...
>[!NOTE]
>
>AEM은 컬렉션에 역할 할당(소유자, 편집기, 뷰어)을 위한 사용자 그룹을 자동으로 [생성합니다](/help/assets/managing-collections-touch-ui.md). 그러나 이러한 그룹에 대해 ACL을 수동으로 추가하면 AEM에서 보안 취약점이 발생할 수 있습니다. ACL을 수동으로 추가하지 않는 것이 좋습니다.
...
1. [ **속성** ] 탭을 클릭하고 필요한 사항을 변경한 다음 [저장]을 **클릭합니다**.
