...
1. 필요한 제품을 선택하십시오. 보조 레일이 업데이트되어 사용 가능한 참조 유형이 표시됩니다.
...
>[!NOTE]
>
>카탈로그 수준 및 제품 콘솔 수준 모두에 대해 수정 사항을 적용하고 제품 페이지에서 차이점을 보려면 변경 사항을 롤아웃해야 합니다.
...
1. 모양을 클릭합니다.
1. 찾아보기 아이콘을 클릭하면 [자산 선택기가 열립니다](/help/assets/asset-selector.md#using-the-asset-selector).
...
>[!NOTE]
>
>다음 예제는 [캠페인에서](/help/sites-authoring/personalization.md)직접 열린 프로모션을 다루며 이는 바우처에 사용됩니다.
>
...
1. 이제 판촉을 활성화할 수 있으므로 구매자는 판촉을 게시 인스턴스에서 볼 수 있습니다.
...
고객이 사용할 수 없는 바우처를 만들려면 다음 중 하나를 수행합니다.
...
>[!NOTE]
>
>주문 콘솔에는 발행되지 않은 공급업체 주문 정보가 표시됩니다.
>  
