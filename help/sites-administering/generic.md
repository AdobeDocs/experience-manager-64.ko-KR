...
1. 지정:
   ...
   * **가져오기**
      ...
      특정 [상거래 공급자](/help/sites-administering/concepts.md#commerce-providers)에 대한 가져오기 프로그램은 기본적으로 `Geometrixx`입니다.
...
1. 지정:
   ...
   * **상거래 공급자**
      ...
      [상거래 공급자의 가져오기](/help/sites-administering/concepts.md#commerce-providers);기본 Geometrixx.
...
1. 마법사가 열립니다. **기본** 및 **제품 탭**&#x200B;을 사용하여 새 제품 또는 제품 변형에 대한 [제품 속성](/help/sites-administering/concepts.md#product-attributes)을 입력합니다.
...
1. [제품 속성](/help/sites-administering/concepts.md#product-attributes)이 표시됩니다. **편집** 및 **완료**&#x200B;를 사용하여 변경합니다.
...
>[!NOTE]
>
>카탈로그가 [제품 데이터](#editing-product-information)를 참조합니다.
...
>[!NOTE]
>
>다음 예제에서는 [campaign](/help/sites-authoring/personalization.md)에서 직접 수행한 프로모션을 다룹니다. 이 판촉은 바우처에 사용됩니다.
>
