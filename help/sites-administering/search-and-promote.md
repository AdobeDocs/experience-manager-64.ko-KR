...
1. Search&amp;Promote 구성 요소를 사이드킥에 [!UICONTROL 추가합니다].
...
1. 원격 **[!UICONTROL 서버 URI]** 텍스트 필드에 URL을 입력한 다음 저장을 **[!UICONTROL 누릅니다]**.
...
1. 도구 **[!UICONTROL 아이콘 >]** 배포에서 **[!UICONTROL 클라우드]**&#x200B;서비스를 **[!UICONTROL 선택합니다]**.

   그러면 클라우드 서비스 대시보드로 이동합니다. 로컬 컴퓨터에서 대시보드의 URL은 다음과 같이 표시됩니다.

   [http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html)

1. 클라우드 서비스 [!UICONTROL 페이지에서] Adobe Search&amp;Promote **[!UICONTROL 링크]** 또는 **[!UICONTROL Search&amp;Promote]** 아이콘을 누릅니다.

1. Adobe Search&amp;Promote를 처음 구성하는 경우 지금 구성을 눌러 **[!UICONTROL 구성]** 만들기 [!UICONTROL 패널을 엽니다] .

   Search&amp;Promote에 대한 자세한 내용을 보려면 **[!UICONTROL 자세한 내용을]** 클릭하십시오.

   ![chlimage_1-409](assets/chlimage_1-409.png)

1. 페이지 **[!UICONTROL 작성자가]** 인식할 수 있는 제목을 입력하고 고유한 이름을 **[!UICONTROL 입력한 다음]**&#x200B;만들기를 **[!UICONTROL 누릅니다]**.

   또한 새로 만든 구성은 클라우드 서비스 **[!UICONTROL 대시보드]** Adobe Search&amp;Promote 목록 **[!UICONTROL 항목의 사용 가능한 구성]** 아래에 표시됩니다.

   ![chlimage_1-410](assets/chlimage_1-410.png)

1. 구성 [!UICONTROL 요소 편집] 대화 상자에서 필드에 다음을 추가합니다.

   * **[!UICONTROL 구성원 ID]**
   * **[!UICONTROL 계정 번호]**
   >[!NOTE]
   >
   >이 정보를 직접 받으려면 다음 항목에 로그인합니다.
   >
   >[https://searchandpromote.omniture.com/center/](https://searchandpromote.omniture.com/center/)
   >
   >유효한 Search&amp;Promote 자격 증명 사용(이메일/암호).
   >
   >브라우저의 주소 표시줄에 있는 URL을 확인합니다. 다음과 비슷한 모양이어야 합니다.
   >
   >[](https://searchandpromote.omniture.com/px/home/?sp_id=XXXXXXXX-spYYYYYYYY)
   >
   >[https://searchandpromote.omniture.com/px/home/?sp_id=XXXXXXXX-spYYYYYYYY](https://searchandpromote.omniture.com/px/home/?sp_id=XXXXXXXX-spYYYYYYYY)
   >
   >여기서 **XXXXXXXX는** **[!UICONTROL 멤버 ID에]** 해당하고 **[!UICONTROL spYYYYYY는]** 계정 번호에 해당합니다.

1. Tap **[!UICONTROL Connect To Search&amp;Promote]**.

   연결 성공 메시지가 나타나면 확인을 **[!UICONTROL 누릅니다]**.

   연결 후 단추 텍스트가 Search&amp; **[!UICONTROL Promote에 다시 연결로 변경됩니다]**.

1. 확인을 **[!UICONTROL 누릅니다]**. 방금 만든 구성에 대해 [Search&amp;Promote 설정] 페이지가 나타납니다.

## 데이터 센터 구성 {#configuring-the-data-center}

Search&amp;Promote 계정이 아시아 또는 유럽에 있는 경우 기본 데이터 센터가 올바른 데이터 센터를 가리키도록 변경해야 합니다(기본 데이터 센터는 북미 계정).

**데이터 센터를**&#x200B;구성하려면:

1. 웹 콘솔의 `http://localhost:4502/system/console/configMgr/com.day.cq.searchpromote.impl.SearchPromoteServiceImpl`
...
>[!NOTE]
>
>서비스 연결을 이미 구성해야 합니다. Search&amp; [Promote에 대한 연결 구성을 참조하십시오](#configuring-the-connection-to-search-promote).

1. 페이지 **[!UICONTROL 속성]** 대화 상자를 엽니다. 예를 들어 웹 사이트 **[!UICONTROL 페이지에서]** 페이지를 마우스 오른쪽 단추로 클릭하고 속성을 **[!UICONTROL 클릭합니다]**.

1. 클라우드 서비스 **[!UICONTROL 탭을]** 클릭합니다.

1. 상위 페이지에서 클라우드 서비스 구성의 상속을 비활성화하려면 상속 경로 옆에 있는 자물쇠 아이콘을 클릭합니다.

   ![샌드핀 상속 자물쇠](assets/sandpinheritpadlock.png)

1. 서비스 **[!UICONTROL 추가를]**&#x200B;클릭하고 Adobe **[!UICONTROL Search&amp;Promote를]**&#x200B;선택한 다음 확인을 **[!UICONTROL 클릭합니다]**.

1. Search&amp;Promote 계정에 대한 연결 구성을 선택한 다음 확인을 **[!UICONTROL 클릭합니다]**.

## Product Feed {#product-feed}

Search&amp;Promote 통합을 사용하여 다음을 수행할 수 있습니다.

* 기본 [!UICONTROL 저장소 구조] 및 상거래 플랫폼과는 별도로 eCommerce API를 사용합니다.
* Search&amp; [!UICONTROL Promote의] 색인 커넥터 기능을 활용하여 제품 피드를 XML 형식으로 제공합니다.
* Search&amp; [!UICONTROL Promote의] 원격 제어 기능을 활용하여 제품 피드의 on-demand 또는 예약된 요청을 수행할 수 있습니다.
