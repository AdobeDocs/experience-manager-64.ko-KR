...
>[!NOTE]
>
>OWASP(Open Web Application Security Project)에서 게시한 가장 위험한 보안 위협에 대해서도 [추가 정보를 사용할 수 있습니다](https://www.owasp.org/index.php/OWASP_Top_Ten_Project).
...
1. ** Apache Felix OSGi Management Console**로 이동하고 **사용자 이름** 및 **암호**&#x200B;를 변경합니다.
...
이 기능으로 인해 발생할 수 있는 DoS 위험을 완화하려면 최신 AEM 버전의 게시 인스턴스에 대해 `AssetDownloadServlet` OSGi 구성 요소가 기본적으로 비활성화됩니다.
