...
SharePoint 커넥터는 [packagesshare](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq630/featurepack/cq-6.3.0-featurepack-17673)에서 다운로드할 수 있습니다.
...
AEM 패키지 공유는 제품 기능, 예제 및 핫픽스를 배포하는 데 사용됩니다. 자세한 내용은 [패키지 공유 설명서](/help/sites-administering/package-manager.md#package-share)를 참조하십시오.

AEM 시작 페이지에서 패키지 공유에 액세스하려면 **도구**&#x200B;를 탭/클릭한 다음 **패키지 공유**&#x200B;를 선택합니다. 회사 이메일 주소가 포함된 유효한 Adobe ID이 필요합니다. 또한 계정에 로그인한 후에는 패키지 공유 액세스 권한을 적용하십시오.
...
1. `basic auth` 패키지를 다운로드하고 설치합니다. `zip` 패키지 공유에서.
