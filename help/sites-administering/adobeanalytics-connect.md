...
2. **Adobe Analytics**&#x200B;로 스크롤하고 **사용 가능한 구성** 옆에 있는 **[+]**&#x200B;을 클릭합니다.
...
5. 사이드 창의 **보고서 세트** 섹션(기본 패널의 오른쪽)에서 **항목 추가**&#x200B;를 클릭합니다. 그런 다음 드롭다운을 사용하여 프레임워크와 상호 작용할 보고서 세트 ID(예: `geometrixxauth`)를 선택합니다.

   >[!NOTE]
   >
   >왼쪽의 컨텐츠 파인더는 보고서 세트 ID를 선택하면 Adobe Analytics 변수(SiteCatalyst 변수)로 채워집니다.

6. 그런 다음 **실행 모드** 드롭다운(보고서 세트 ID 옆)을 사용하여 보고서 세트에 정보를 보낼 서버 인스턴스를 선택합니다.
...
자세한 내용은 [페이지 분석 데이터 보기](/help/sites-authoring/pa-using.md)를 참조하십시오.
...
* **사용**:
   ...
   서비스를 활성화하거나 비활성화합니다. 기본적으로 서비스는 활성화되어 있습니다.
