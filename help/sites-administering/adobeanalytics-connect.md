...
5. 사이드 pod(기본 패널의 오른쪽)의 **보고서 세트** 섹션에서 **항목 추가**&#x200B;를 클릭합니다. 그런 다음 드롭다운을 사용하여 프레임워크가 상호 작용하는 보고서 세트 ID(예: `geometrixxauth`)를 선택합니다.

   >[!NOTE]
   >
   >왼쪽의 컨텐츠 파인더는 보고서 세트 ID를 선택하면 Adobe Analytics 변수(SiteCatalyst 변수)로 채워집니다.

6. 그런 다음 **실행 모드** 드롭다운(보고서 세트 ID 옆)을 사용하여 보고서 세트에 정보를 전송할 서버 인스턴스를 선택합니다.

   ![aa-framework-01](assets/aa-framework-01.png)

7. 사이트의 게시 인스턴스에서 프레임워크를 사용할 수 있도록 하려면 사이드 킥의 **페이지** 탭에서 **프레임워크 활성화** 를 클릭합니다.
