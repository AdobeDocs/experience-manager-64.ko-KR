...
클라우드 구성 및 프레임워크를 찾으려면 **도구를** 통해 **클라우드 서비스로** 이동 **>** Cloud **를**&#x200B;통해클라우드서비스로이동합니다. ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))\
...
1. Target **에 연결을** 클릭하여 Target과의 연결을 초기화합니다. 연결이 성공하면*** 연결 성공* 메시지가 표시됩니다. 메시지에 **대해** 확인을 클릭한 다음 **대화** 상자에서확인을 클릭합니다.
