...
클라우드 구성 및 프레임워크를 찾으려면 도구 **>** 배포 **>** 클라우드를 통해 **Cloud Service으로** 이동합니다 ****. ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))\
