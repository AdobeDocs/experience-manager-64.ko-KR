...
1. Target과의 연결을 초기화하려면 **Target에 연결**&#x200B;을 클릭합니다. 연결이 성공하면 message** Connection successful**가 표시됩니다. 메시지에서 **확인**&#x200B;을 클릭한 다음 대화 상자에서 **확인**&#x200B;을 클릭합니다.
...
1. 프레임워크 만들기 대화 상자에서 **제목**&#x200B;을 지정하고 **Adobe Target Framework**&#x200B;을 선택하고 **만들기**&#x200B;를 클릭합니다.
   ...
   프레임워크 페이지가 열립니다. 사이드 킥은 매핑할 수 있는 [Client Context](/help/sites-administering/client-context.md) 또는 [ContextHub](/help/sites-administering/contexthub-config.md)의 정보를 나타내는 구성 요소를 제공합니다.
