...
Livefyre Adobe Experience Manager 패키지는 AEM 6.1, 6.2SP1, 6.3, 6.4 및 6.4 SP1에서 사용할 수 있습니다. AEM 5.x 및 6.0은 지원되지 않습니다. 자세한 지침은 [Livefyre와 통합](/help/sites-administering/livefyre.md).

지원되는 Livefyre 앱을 확인하려면 다음을 참조하십시오. [Livefyre 앱에 대한 AEM 지원 매트릭스](/help/sites-administering/livefyre.md#aem-support-matrix-for-livefyre-apps).
...
1. [시작하기](/help/sites-administering/livefyre.md#getting-started)
1. [Livefyre를 사용하도록 AEM 구성](/help/sites-administering/livefyre.md#configure-aem-to-use-livefyre-create-a-configuration-folder)
1. [Livefyre에서 AEM Assets으로 조정된 UGC 가져오기](/help/sites-administering/livefyre.md#use-livefyre-with-aem-assets)
