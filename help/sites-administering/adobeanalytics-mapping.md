...
1. 사이트의 게시 인스턴스에서 프레임워크를 사용할 수 있게 하려면 사이드 킥의 **Page **탭을 열고 **프레임워크 활성화를 클릭합니다.**
...
1. Adobe Analytics 보기에서 Content Finder는 CQ 보기에서 드래그한 추적 구성 요소에 속하는 모든 CQ 변수를 표시합니다.
   ...
   * 예: **Download 구성 요소 **이 CQ 보기에서 *단 하나의 드래그된 뷰인 경우(2개의 매핑 가능한 변수* eventdata.downloadLink *및* eventdata.events.startDownload *), Adobe Analytics 보기로 전환할 때 컨텐츠 파인더는 다음과 같이 표시됩니다.*
