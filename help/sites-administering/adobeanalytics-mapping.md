...
1. 사이트의 게시 인스턴스에서 프레임워크를 사용할 수 있도록 하려면 사이드 킥의 **Page ** 탭을 열고 를 클릭합니다. **프레임워크를 활성화합니다.**
...
1. Adobe Analytics 보기에서는 콘텐츠 파인더에 CQ 보기에서 드래그한 추적 구성 요소에 속하는 모든 CQ 변수가 표시됩니다.
   ...
   * 예: **Download 구성 요소 **가 *단 한 개* CQ 보기에서(매핑 가능한 변수 두 개 있음) *eventdata.downloadLink* 및 *eventdata.events.startDownload*)를 채울 때는 Adobe Analytics 보기로 전환하는 것이 좋습니다.
