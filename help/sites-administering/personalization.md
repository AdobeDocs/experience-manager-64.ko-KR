...
* 고객이 현재 계정 및 청구 정보를 볼 수 있도록 웹 사이트를 제공하는 회사전화 공급자 등
...
### 개인화의 강점과 고려해야 할 사항 {#strengths-of-personalization-and-points-to-consider}
...
>[!TIP]
>
>성능 및 관련 캐싱 항목에 대한 개인화의 영향은 [성능 최적화.](/help/sites-deploying/configuring-performance.md) 문서에 자세히 설명되어 있습니다.
...
블로그, 포럼 및 달력과 같은 커뮤니티 기능으로 인해 커뮤니티 컨텐츠가 생성되며, 일반적으로 사용자 생성 콘텐츠(UGC)라고 합니다. UGC가 여러 AEM 인스턴스([게시 팜](/help/communities/topologies.md))로 구성된 게시 환경에 입력되면 하나의 주요 문제는 모든 인스턴스에서 UGC를 동기화하는 방법입니다.

[AEM Communities 6.1](/help/communities/overview.md) 확장을 사용하면 이 문제가 UGC](/help/communities/working-with-srp.md)의 [공용 스토어를 사용하여 해결됩니다. 개인화와 관련하여 커뮤니티에는 [소셜 로그인](/help/communities/social-login.md) - 사이트 방문자가 Facebook 및 Twitter으로 로그인할 수 있는 옵션을 제공하는 기능이 포함됩니다.
