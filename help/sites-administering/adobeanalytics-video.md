...
1. CQ 변수를 Adobe Analytics 속성에 매핑하려면 구성 요소의 CQ 변수 옆에 있는 ContentFinder에서 Adobe Analytics 속성을 드래그합니다.
   ...
   매핑 최적화에 대한 자세한 내용은 Adobe Analytics](https://docs.adobe.com/content/help/en/media-analytics/using/sdk-implement/setup/setup-overview.html) 안내서의 [비디오 측정 설명서를 참조하십시오.
...
* Adobe Analytics 속성을 사용하여 매핑하도록 정의된 CQ 변수](#milestones)의 [정적 집합.
