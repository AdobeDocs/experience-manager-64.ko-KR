...
XX 접미사는 이정표를 정의하는 트랙 오프셋입니다. 예를 들어 4, 8, 16, 20 및 28초의 추적 오프셋을 지정하면 다음 CQ 변수가 생성됩니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>이 변수에 매핑된 변수에는 파일 이름이 포함됩니다. eventdata.events.a.media.view와 함께 전송된 경우 </td> 
  </tr> 
  <tr> 
   <td>eventdata.videoFilePath </td> 
   <td>이 변수에 매핑된 변수에는 서버의 파일 경로가 포함됩니다. eventdata.events.a.media.view와 함께 전송된 경우 </td> 
  </tr> 
  <tr> 
...
>[!NOTE]
>
>DAM에서 편집하기 위해 비디오를 열고 **제목** 메타데이터 필드를 원하는 이름으로 설정하여 비디오의 **사용자 친화적인 **이름을 설정할 수 있습니다.
...
이 예에서 비디오 구성 요소는 프레임워크 페이지에 다음과 같이 나타납니다.
...
* Adobe Analytics 속성을 사용하여 매핑하기 위해 정의된 [CQ 변수의](#milestones) 정적 세트입니다.
...
1. 비레거시 마일스톤을 추적 방법으로 선택한 후, 오프셋 추적 상자에 트랙 길이의 백분율로 구분된 목록을 입력합니다. 예를 들어 다음 기본값은 트랙 길이의 10, 25, 50 및 75%에서 마일스톤을 정의합니다.
...
>[!NOTE]
>
>DAM에서 편집할 비디오를 열고 **Title **메타데이터 필드를 원하는 이름으로 설정하여 비디오의 **사용자 친화적인 **이름 설정을 할 수 있습니다. 또한 완료되면 변경 내용을 저장해야 합니다.
...
*** 레거시 초** 메서드를 사용하는 경우 Adobe Analytics 호출은 매 N번째 초마다 트리거되며 여기서 N은 추적 오프셋 필드에 지정됩니다.
...
>[!NOTE]
>
>DAM에서 편집하기 위해 비디오를 열고 **제목** 메타데이터 필드를 원하는 이름으로 설정하여 비디오의 **사용자 친화적인 **이름을 설정할 수 있습니다. 또한 완료되면 변경 내용을 저장해야 합니다.
