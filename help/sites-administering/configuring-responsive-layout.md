...
또한 추가 구성 및 함수 호출을 제공하기 위해 [클라이언트 라이브러리](https://docs.adobe.com/content/docs/en/aem/6-0/develop/the-basics/clientlibs.html)를 만들어야 합니다. 다음 LESS 추출은 프로젝트에 추가해야 하는 최소값의 예입니다.
