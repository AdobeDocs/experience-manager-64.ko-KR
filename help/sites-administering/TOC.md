...
+ 보안 {#security}
   ...
   + [[MOCK] Granite Operations - User and Group Administration](granite-user-group-admin.md)
...
+ 통합 {#integration}
   ...
   + [SharePoint Connector 라이센스, 저작권 고지 사항 및 부인](sharepoint-connector-licenses.md)
