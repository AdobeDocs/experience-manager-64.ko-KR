...
# AEM 6.4 관리 사용 안내서 {#administering}
...
+ 작업 {#operations}
   ...
   + [JMX 콘솔을 사용한 서버 리소스 모니터링](jmx-console.md)
   ...
   + [액세스 가능한 사이트를 생성하기 위한 RTE 구성](rte-accessible-content.md)
   ...
   + [페이지 편집을 위해 실행 취소 구성](config-undo.md)
...
+ 보안 {#security}
   ...
   + [사용자 동기화](sync.md)
   + [압축된 토큰 지원](encapsulated-token.md)
...
+ 통합 {#integration}
   ...
   + [Adobe Analytics 연결 및 프레임워크 만들기](adobeanalytics-connect.md)
   ...
   + [SharePoint 커넥터 라이선스, 저작권 공지 및 면책조항](sharepoint-connector-licenses.md)
   ...
   + [이메일 템플릿에 대한 우수 사례](best-practices-for-email-templates.md)
   ...
   + [Adobe Target과의 통합 수동 구성](target-configuring.md)
...
+ 우수 사례 {#bestpractices}
   ...
   + [번역 모범 사례](https://experienceleague.adobe.com/docs/experience-manager-64/administering/introduction/tc-bp.html)
   + [MSM 모범 사례](https://experienceleague.adobe.com/docs/experience-manager-64/administering/introduction/msm-best-practices.html)
   ...
   + [AEM Commerce - GDPR 준비 완료](https://experienceleague.adobe.com/docs/experience-manager-64/administering/ecommerce/gdpr-compliance-commerce.html)
+ 컨텐츠 관리 {#contentmanagement}
   + [패키지를 사용하여 작업하는 방법](package-manager.md)
   + [자산 워크플로우 오프로더](workflow-offloader.md)
   + [태그 관리](tags.md)
   + [페이지 내보내기](page-exporter.md)
   + [클래식 UI 태깅 콘솔](classic-console.md)
   + [Screens용 콘텐츠 관리](content-management-screens.md)
