...
+ 작업 {#operations}
   ...
   + [JMX 콘솔을 사용한 모니터링 서버 리소스](jmx-console.md)
   ...
   + [페이지 편집을 위한 실행 취소 구성](config-undo.md)
   + [프록시 서버 도구(proxy.jar)](proxy-jar.md)
   + [AEM Apps 구성](config-apps.md)
...
+ 개인화 {#personalization}
   ...
   + [Adobe Analytics와 랜딩 페이지 통합](integrating-landing-pages-with-adobe-analytics.md)
+ eCommerce {#ecommerce}
...
+ 통합 {#integration}
   ...
   + [컨텐츠의 HTTP2 전달 FAQ](scene7-http2faq.md)
   + [Adobe Campaign 통합 문제 해결](troubleshooting-campaignintegration.md)
   + [SharePoint 커넥터 라이센스, 저작권 고지 사항 및 부인](sharepoint-connector-licenses.md)
   ...
   + [Adobe Creative Cloud와 통합](https://docs.adobe.com/content/help/en/experience-manager-64/assets/administer/aem-cc-integration-best-practices.html)
   ...
   + [Experience Cloud 및 Creative Cloud와 AEM 자산 통합 구성](configure-assets-cc-integration.md)
   ...
   + [Adobe Marketing Cloud와 통합](marketing-cloud.md)
   ...
   + [Adobe Search&amp;Promote와 통합](search-and-promote.md)
   + [솔루션 통합](integration.md)
   + [경험 조각과 타겟 통합](experience-fragments-target.md)
   + [이메일 템플릿 우수 사례](best-practices-for-email-templates.md)
+ 우수 사례 {#bestpractices}
...
+ 컨텐츠 관리 {#contentmanagement}
   ...
   + [화면용 컨텐츠 관리](content-management-screens.md)
