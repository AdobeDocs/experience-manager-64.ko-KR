...
## 앱 타일 관리 이해 {#understanding-the-manage-app-tile}
...
PhoneGap config.xml에 정의된 모든 플랫폼에는 사용자 지정 플랫폼 속성이 포함될 수 있습니다. AEM 개발자는 이러한 속성을 캡처하기 위해 컨텐츠 구조에 기여해야 합니다. 제공된 플랫폼 특정 속성 예는 iOS에 대해 찾을 수 있습니다.
