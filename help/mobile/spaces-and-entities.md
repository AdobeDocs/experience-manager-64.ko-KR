...
컨텐츠 서비스가 공백으로 작동하도록 구성되지 않은 처음 사용자의 경우, AEM Mobile 대시보드는 **컨텐츠 서비스를 선택한 후 앱만 표시합니다**.

>[!CAUTION]
>
>**스페이스 추가를 위한 전제 조건**
>
>AEM **Content Services** 활성화에서 스페이스와 함께 작업하고 AEM Mobile 애플리케이션 대시보드에서 활성화합니다.
>
>자세한 [내용은 콘텐츠 서비스](/help/mobile/developing-content-services.md) 관리를 참조하십시오.

대시보드에서 공백을 구성한 후에는 다음 단계에 따라 공백을 만듭니다.

1. 컨텐츠 서비스 **에서** 스페이스를 선택합니다.

   ![chlimage_1-83](assets/chlimage_1-83.png)

1. 만들기 **를** 선택하여 공간을 만듭니다. 스페이스의 **제목**, **이름**&#x200B;및 **설명** 을입력합니다.
...
>[!NOTE]
>
>스페이스 **를 게시** 취소할 수 있습니다. 그러면 게시 인스턴스에서 공백이 제거됩니다.
>
>다음 이미지는 공간을 게시한 후 수행할 수 있는 작업을 보여 줍니다.

![chlimage_1-86](assets/chlimage_1-86.png)

## 스페이스의 폴더 사용 {#working-with-folders-in-a-space}

공백에는 스페이스의 컨텐츠와 에셋을 추가로 구성하는 데 도움이 되는 폴더가 포함될 수 있습니다. 사용자는 스페이스 아래에 자신의 계층을 만들 수 있습니다.

### Creating a Folder {#creating-a-folder}

1. 공간 콘솔의 목록에서 공간을 클릭하고 폴더 **만들기를 클릭합니다**

   ![chlimage_1-87](assets/chlimage_1-87.png)

1. 폴더의 **제목**, **** 이름 **및** 설명을입력합니다.

   ![chlimage_1-88](assets/chlimage_1-88.png)

1. 만들기 **를** 클릭하여 스페이스에 폴더를 만듭니다.
...
1. 콘텐츠 **패키지 언어 선택;ast;** 및 **제목 입력;ast;** 언어 **복사 만들기 대화 상자에서** .
...
## 공간에서 개체 사용 {#working-with-entities-in-a-space}
...
1. 엔티티의 모델을 선택합니다. 만들려는 엔티티 유형입니다. 다음을 클릭합니다.
   ...
   >[!NOTE]
   >
   >이전에 만든 **자산 모델**, 페이지 모델 ****&#x200B;또는 엔티티 유형의 모델을 선택할 수 있습니다.
   >
   >사용자 [지정 엔티티를 만들려면 모델](/help/mobile/administer-mobile-apps.md)만들기를 참조하십시오.
...
1. 편집할 엔티티를 선택하고 편집을 **클릭합니다**.
   ...
   ***엔티티를 자산 모델로 만드는 템플릿을 선택하는 경우***&#x200B;편집을 **** 클릭하면 아래 그림에 표시된 대로 자산을 추가할 수 있습니다.
   ...
   ***개체를 페이지 모델로 만들 템플릿을 선택하는 경우***&#x200B;편집을 **** 클릭하면 아래 그림에 표시된 대로 자산을 추가할 수 있습니다.
   ...
   자산을 추가하려면 **경로의** 아이콘을 클릭합니다.

   ![chlimage_1-100](assets/chlimage_1-100.png)

   >[!NOTE]
   >
   >엔티티를 추가한 후에는 미리 보기 링크가 작동되도록 저장해야 합니다. 미리 보기를 보려면 저장을 **클릭합니다**. 미리 **보기** 를 클릭하면 아래 그림과 같이 추가된 자산의 json이 표시됩니다.

   ![chlimage_1-101](assets/chlimage_1-101.png)

   >[!NOTE]
   >
   >엔티티에 에셋 추가가 완료되면 **저장을 선택하여** 변경 사항을 저장하거나 **저장** 및 닫기를 선택하여엔티티가 정의된 공간 콘솔 목록으로 리디렉션할 수 있습니다.

   또한 공간 콘솔 목록에서 엔티티를 선택하고 속성 **을** 클릭하여 정의된 엔티티의 속성을 보고 편집합니다.

   ![chlimage_1-102](assets/chlimage_1-102.png)

   제목, 설명, 태그를 편집하고 엔터티에 자산을 추가할 수 있습니다.
...
1. 도구 모음에서 **삭제를** 클릭하여 스페이스에서 특정 엔티티를 제거합니다.

### 엔티티 게시 {#publishing-an-entity}

엔티티를 게시하려면 트리 **게시** 또는 **빠른 게시** 를 선택할 수 있습니다.
