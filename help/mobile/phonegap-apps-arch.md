...
title: 앱의 구조
seo-title: 앱의 구조
description: '이 페이지에서는 응용 프로그램에 대해 만드는 페이지 구성 요소에 대한 설명을 /libs/mobileapps/components/angular/ng-page 구성 요소(로컬 서버의 CRXDE Lite)을 기반으로 합니다. '
seo-description: '이 페이지에서는 응용 프로그램에 대해 만드는 페이지 구성 요소에 대한 설명을 /libs/mobileapps/components/angular/ng-page 구성 요소(로컬 서버의 CRXDE Lite)을 기반으로 합니다. '
...
앱의 구조에 대해 알게 되면 [단일 페이지 애플리케이션을 참조하십시오](/help/mobile/phonegap-single-page-applications.md).
