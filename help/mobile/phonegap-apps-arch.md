...
title: 앱의 해부학
seo-title: 앱의 해부학
description: '이 페이지에서는 /libs/mobileapps/components/page/ng-page 구성 요소(로컬 서버의 CRXDE Lite)을 기반으로 하는 페이지 구성 요소에 대한 설명을 제공합니다. '
seo-description: '이 페이지에서는 /libs/mobileapps/components/page/ng-page 구성 요소(로컬 서버의 CRXDE Lite)을 기반으로 하는 페이지 구성 요소에 대한 설명을 제공합니다. '
...
앱의 해부학에 대해 학습하면 [단일 페이지 응용 프로그램](/help/mobile/phonegap-single-page-applications.md)을 참조하십시오.
