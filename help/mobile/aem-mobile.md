...
description: AEM 모바일 온디맨드 서비스 앱 관리를 시작하려면 이 페이지를 따르십시오. 온디맨드 서비스를 위한 AEM 관리자의 역할 및 책임을 대략적으로 설명합니다.
seo-description: AEM 모바일 온디맨드 서비스 앱 관리를 시작하려면 이 페이지를 따르십시오. 온디맨드 서비스를 위한 AEM 관리자의 역할 및 책임을 대략적으로 설명합니다.
...
>**전제 조건:**
>
>AEM Mobile On-demand Services에 대한 환경 설정을 시작하기 전에 [AEM Mobile 애플리케이션 대시보드 또는 제어 센터를 참조하십시오](/help/mobile/mobile-apps-ondemand-application-dashboard.md).
...
>[!NOTE]
>
>AEM 그룹 및 권한 설정에 대한 자세한 내용을 보려면 온라인 도움말에서 [사용자 역할 만들기 및 액세스 권한](https://helpx.adobe.com/digital-publishing-solution/help/account-admin-dps.html) 부여를 클릭합니다.
