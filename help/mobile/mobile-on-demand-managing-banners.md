...
### 배너 내의 메타데이터 보기 및 편집 {#viewing-and-editing-the-metadata-within-a-banner}

배너에는 제목, 설명, 이미지와 같은 많은 속성이 있습니다. 이 작업은 이러한 속성을 보고 수정하는 데 사용됩니다. 선택적으로, 이러한 변경 사항은 저장 시 Mobile On-Demand에 업로드할 수 있습니다.
...
이 작업은 Mobile On-Demand에서 선택한 배너를 삭제하고 선택적으로 로컬 AEM 인스턴스에서 삭제합니다.
