...
# Preflight를 사용하여 미리 보기 {#previewing-with-preflight}
...
>[!NOTE]
>
>AEM Preflight 앱은 콘텐츠 및 검색 페이지 미리 보기에 사용됩니다. Preflight 앱에 대한 자세한 내용을 살펴보려면 [여기를 클릭하십시오](https://helpx.adobe.com/digital-publishing-solution/help/preflight-app.html).
>
>AEM Preflight 앱은 [iTunes App Store](https://itunes.apple.com/us/app/adobe-experience-manager-mobile/id1042687518?mt=8), [Google Play Store](https://play.google.com/store/apps/details?id=com.adobe.dps.preflight&amp;hl=en)및 [Windows Store에서 다운로드할 수 있습니다](https://www.microsoft.com/en-us/store/p/adobe-experience-manager-mobile-preflight/9nblggh5wmxq).
