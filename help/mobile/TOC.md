...
+ Introduction to AEM Mobile {#introduction}
   ...
   + [AEM Mobile - GDPR 준비](aem-mobile-gdpr-compliance.md)
   + [모바일 앱 개발](develop-mobile-apps.md)
+ 온디맨드 서비스 앱 제작 {#authoring}
   ...
   + [애플리케이션 만들기 및 구성 작업](mobile-apps-ondemand-application-create-configure-action.md)
   + [아티클 관리](mobile-on-demand-managing-articles.md)
...
+ 온디맨드 서비스 앱 개발 {#developing}
   ...
   + [아티클 내보내기 구성 만들기](creating-article-export-configuration.md)
...
+ 온디맨드 서비스 앱 관리 {#administering}
   ...
   + [Preflight를 사용한 미리 보기](aem-mobile-manage-ondemand-services.md)
...
+ Adobe PhoneGap Enterprise 제작 {#author-phonegap}
   + [PhoneGap](phonegap.md)
   + [앱 메타데이터 편집](phonegap-editmetadata.md)
   + [앱 정의](phonegap-app-definitions.md)
   + [앱 콘텐츠 만들기 및 관리](phonegap-manage-app-content.md)
...
+ Adobe PhoneGap Enterprise 개발 {#developphonegap}
   ...
   + [AEM에서 모바일 애플리케이션 개발](developing-mobile-applications.md)
   + [Mobile with Content Sync](phonegap-contentsync.md)
   + [앱의 구조](phonegap-apps-arch.md)
   ...
   + [하이브리드 앱이 AEM Mobile용으로 준비되어 있습니까?](phonegap-adding-content-to-imported-app.md)
   ...
   + [Adobe Target Cloud 서비스 구성](aem-mobile-configuring-cloud-service.md)
   + [단일 페이지 애플리케이션](phonegap-single-page-applications.md)
   ...
   + [Adobe Mobile Analytics를 사용하여 앱 성능 추적](phonegap-intro-to-app-analytics.md)
+ Adobe PhoneGap Enterprise 관리 {#administering-phonegap}
   ...
   + [Adobe PhoneGap Build Cloud 서비스 구성](configure-phonegap-build-cloud.md)
   + [레퍼러 필터를 비워 둡니다.](setting-referrer-filter-empty.md)
   + [Adobe Mobile Services 클라우드 서비스 구성](configure-adobe-mobile-cloud-service.md)
