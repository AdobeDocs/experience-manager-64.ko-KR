...
description: 모바일 온디맨드 서비스 앱 제작 및 관리를 지원하도록 사용자 역할 및 사용자 및 그룹을 구성하는 방법을 이해하려면 이 페이지를 따르십시오.
seo-description: 모바일 온디맨드 서비스 앱 제작 및 관리를 지원하도록 사용자 역할 및 사용자 및 그룹을 구성하는 방법을 이해하려면 이 페이지를 따르십시오.
...
1. 앱 작성자 사용자 그룹을 만들었으므로 이제 [사용자 관리 콘솔을 통해 이 새 그룹에 개별 팀 구성원을 추가할 수 있습니다](http://localhost:4502/libs/granite/security/content/useradmin.md).

   ![chlimage_1-168](assets/chlimage_1-168.png)

1. AEM 컨텐츠 작성자 그룹에 추가할 수 있습니다.
...
app-admins 그룹의 구성원은 앱 작성자 **와 동일한 권한을 가진 애플리케이션 컨텐츠를 제작할 수 있으며** , 또한 다음 작업도 수행할 수 있습니다.
...
1. 콘텐트 내보내기 또는 업로드하려면
   ...
   * 내보내기 템플릿에 액세스하기 위해 /etc/contentsync에서 (읽기)
   * 읽기 시 경로 순회 경로 지정을 위한 /var의
   * (ContentSync 캐시된 내보내기 콘텐츠를 쓰기, 읽기 및 정리할 수 있는 /var/content/sync의 읽기, 쓰기, 수정, 삭제)
