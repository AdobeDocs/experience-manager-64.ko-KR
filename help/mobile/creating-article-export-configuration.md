...
사용 [ContentSync](/help/mobile/mobile-ondemand-contentsync.md) 컨텐츠를 함께 모으고 ***공유 리소스*** 패키지.

에 있는 ContentSync 구성 **&lt;dps-exporttemplate>/dps-article>** 장치에서 속성 정적 렌더링에 필요한 모든 콘텐츠 및 문서를 내보내도록 구성해야 합니다.
...
1. 이 경로로 이동합니다. [/etc/contentsync/templates/dps-we-unlimited-app/dps-article](http://localhost:4502/crx/de/index.jsp#/etc/contentsync/templates/dps-we-unlimited-app/dps-article)를 눌러 샘플 공유 리소스를 확인합니다.
