...
description: 앱 메타데이터는 애플리케이션을 공급업체 스토어에 릴리스하기 위해 필요한 세부 정보입니다. 앱 데이터 편집에 대해 알려면 이 페이지를 따르십시오.
...
다음 **앱 관리** 타일 및 &quot;앱 관리&quot; 페이지는 애플리케이션 메타데이터를 보고 편집하는 방법을 제공합니다. 앱 메타데이터는 애플리케이션을 공급업체 스토어에 릴리스하기 위해 필요한 세부 정보입니다. 여기에는 일반적인 메타데이터, iOS 메타데이터 및 스크린샷이 포함될 수 있습니다. 자세한 내용은 [앱 타일 관리](/help/mobile/phonegap-app-details-tile.md) 공통 및 iOS 메타데이터에 대한 자세한 내용을 참조하십시오.
...
1. &#39;..&#39;을 클릭하여 세부 정보를 보거나 편집하려면 오른쪽 아래 모서리에서 **앱 관리** 타일.
...
메타데이터 롤업에 앱 스크린샷을 포함할 수 있습니다. 일부 공급업체에서는 앱을 앱스토어에 제출할 때 정확한 스크린샷이 필요합니다. 이러한 이미지는 Assets에 이미 있어야 합니다. 자세한 내용은 [자산 선택기](/help/assets/asset-selector.md) 스크린샷을 업로드합니다.
...
1. 자산을 선택하고 을(를) 클릭합니다 **선택** 자산을 추가합니다.
