...
AEM Mobile에서는 앱에서 추적 데이터를 수집하고 보고하려면 Adobe Analytics 계정이 필요합니다. 구성의 일부로서 AEM *관리자*&#x200B;는 먼저 다음을 수행해야 합니다.
...
### Bloodhound {#testing-analytics-tracking-with-bloodhound} 를 사용하여 Analytics 추적 테스트
