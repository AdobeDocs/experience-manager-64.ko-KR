...
* **티저** 페이지는 해당 캠페인 페이지에 저장되며 특정 캠페인마다 사용 가능한 티저 단락의 정의를 포함합니다. 이러한 정의는 티저 단락을 표시할 때 사용되며 컨텐츠 변형, 변형을 선택하는 데 사용할 세그먼트 및 증폭 인수를 포함합니다.
...
페이지에 Teaser 단락을 추가할 때 **전략**&#x200B;을 정의해야 합니다.
