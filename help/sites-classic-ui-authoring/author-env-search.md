...
Apache Felix 웹 관리 콘솔(예: )을 사용하면 범위를 변경할 수 있습니다. `http://localhost:4502/system/console/configMgr`). 선택 `CQ WCM Find Replace Servlet (com.day.cq.wcm.core.impl.servlets.FindReplaceServlet)` 필요에 따라 범위를 구성합니다.
