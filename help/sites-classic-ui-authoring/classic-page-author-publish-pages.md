...
description: 작성 환경에서 컨텐츠를 작성 및 검토한 후에는 공개 웹 사이트에서 사용할 수 있도록 만들어야 합니다.
...
작성 환경에서 콘텐츠를 작성 및 검토한 후에는 공개 웹 사이트(게시 환경)에서 사용할 수 있도록 만들어야 합니다.
...
이 활성화/비활성화를 취소하려면 [워크플로우 콘솔](/help/sites-administering/workflows-administering.md#main-pars-title-3-yjqslz-refd) 을 눌러 해당 워크플로우를 종료합니다.
...
이 비활성화를 취소하려면, [워크플로우 콘솔](/help/sites-administering/workflows-administering.md#main-pars-title-3-yjqslz-refd) 을 눌러 해당 워크플로우를 종료합니다.
...
### 페이지 게시 상태 확인 - 클래식 UI {#determining-page-publication-status-classic-ui}
...
1. 를 엽니다. **도구** 콘솔에서 선택하여 콘솔 **시작** 페이지를 두 번 클릭한 다음 **복제** 콘솔을 열려면( `http://localhost:4502/etc/replication.html`).
