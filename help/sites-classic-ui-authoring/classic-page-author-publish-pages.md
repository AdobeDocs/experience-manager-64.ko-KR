...
1. **시작** 페이지에서 **도구** 콘솔을 선택하여 연 다음 **복제**&#x200B;를 두 번 클릭하여 콘솔을 엽니다( `http://localhost:4502/etc/replication.html`).
...
1. 수행할 작업을 선택합니다.
   ...
   1. *활성화될 페이지*&#x200B;를 확인하려면 **연습 실행**&#x200B;을 선택합니다.단순히 에뮬레이션이 실행되므로 페이지가 활성화되지 않습니다.
