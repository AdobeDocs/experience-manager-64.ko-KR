...
* **솔루션**:
   ...
   * 현재 세션에서 로그아웃한 다음 다시 로그인합니다. 사이드 킥이 기본 위치로 돌아갑니다.
...
* **원인**:
   ...
   * 기능 **찾기 및 바꾸기** 은 컨텐츠를 저장하는 방식과 검색 가능성 여부에 따라 다릅니다. 예를 들어, 블로그 텍스트는 `jcr:text` 검색할 수 있도록 구성되지 않은 속성입니다. 찾기 및 바꾸기 서블릿의 기본 범위에는 다음 속성이 포함됩니다.
...
* **솔루션**:
   ...
   * 이러한 정의는 다음 의 구성으로 변경할 수 있습니다 **일 CQ WCM 찾기 바꾸기 서블릿** 사용 **웹 콘솔**; 예를 들어
