...
[!UICONTROL Dynamic Media] 및 [!UICONTROL 인터랙티브 미디어] 는 [!UICONTROL Dynamic Media의 사이드] 킥에서 **[!UICONTROL 사용할 수 있습니다]**. 대화형 비디오, 대화형 이미지 또는 회전 메뉴 세트와 같은 대화형 자산에 **[!UICONTROL 대화형 미디어]** 구성 요소를 사용합니다. 기타 모든 다이내믹 미디어 구성 요소의 경우에는 **[!UICONTROL Dynamic Media]** 구성 요소를 사용하십시오.
