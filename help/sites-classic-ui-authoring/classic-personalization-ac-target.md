...
Adobe Campaign 뉴스레터를 타깃팅하려면 먼저 클래식 UI에만 사용할 수 있는 세그멘테이션을 설정해야 합니다. 그런 다음 Adobe Campaign에 대한 타깃팅된 경험을 만들 수 있습니다.
...
1. **페이지 만들기 **를 클릭하고 페이지 제목을 입력(예: We.Retail 브랜드)한 다음 **브랜드 **템플릿을 선택합니다.
...
터치 활성화 및 클래식 사용자 인터페이스 모두에서 타깃팅된 컨텐츠가 있는 뉴스레터를 만들 수 있습니다. 이 문서에서는 터치 지원 UI에 대한 절차에 대해 설명합니다.
