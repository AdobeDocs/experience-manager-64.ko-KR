---
title: 리치 텍스트 편집기
seo-title: 리치 텍스트 편집기
description: 리치 텍스트 편집기는 텍스트 컨텐츠를 AEM에 입력하는 기본 빌딩 블록입니다.
seo-description: 리치 텍스트 편집기는 텍스트 컨텐츠를 AEM에 입력하는 기본 빌딩 블록입니다.
...
>[!NOTE]
>
>**제목** 구성 요소는 줄바꿈 없는 짧은 텍스트를 포함하도록 디자인되었습니다. 즉석 편집 모드에서 제목을 편집할 때 줄바꿈을 삽입하면 제목 밑에 새 **텍스트** 구성 요소가 열립니다.
...
**잘라내기** 및 **복사**&#x200B;의 표준 기능을 사용할 수 있습니다. 형식이 서로 다른 경우를 처리하기 위해 몇 가지 방식의 **붙여넣기**&#x200B;가 제공됩니다.

* 잘라내기(**Ctrl-X**)
* 복사(**Ctrl-C**)
* 붙여넣기

   구성 요소의 기본 붙여넣기 메커니즘(**Ctrl-V**)으로서 최초 설치 시 &quot;Word에서 붙여넣기&quot;로 구성됩니다.
...
웹 사이트 내부 또는 외부 URL로 연결되는 링크를 생성하려면 필요한 텍스트를 강조 표시한 후 **하이퍼링크** 아이콘을 클릭합니다.

![](do-not-localize/chlimage_1-12.png)

대화 상자에서 타겟 URL 및 새 창에서 열지를 지정할 수 있습니다.
...
* 직접 URI 입력
* Sitemap을 사용하여 웹 사이트 내의 페이지 선택
* URI를 입력한 다음 타겟 앵커 추가(예: `www.TargetUri.org#AnchorName`
* 현재 페이지를 참조하는 경우 앵커만 입력(예: `#anchor`
* Content Finder에서 페이지를 검색하고 페이지 아이콘을 하이퍼링크 대화 상자로 드래그하기
...
>[!NOTE]
>
>**폭**, **높이** 및 특정 셀 속성은 다음 중 하나로 정의할 수 있습니다.
>
>* 픽셀
>* 백분율
