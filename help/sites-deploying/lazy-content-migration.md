...
이전 버전과의 호환성을 위해, AEM 6.3부터 시작하는 **컨텐츠** 및/등의 **구성 및 컨텐츠는** 업그레이드 시 즉시 제작되거나 변형되지 않습니다. 이러한 작업은 해당 구조에 대한 고객 애플리케이션의 종속성이 그대로 유지되도록 하기 위해 수행됩니다. AEM 6.4의 외부 컨텐츠가 다른 곳에서 호스팅되더라도 이러한 컨텐츠 구조와 관련된 기능은 여전히 동일합니다.
...
다음은 6.4에서 `CodeUpgradeTasks` 소개된 전체 목록입니다.
