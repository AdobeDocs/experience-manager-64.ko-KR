...
* 자산 오프로딩에 대한 일반적인 지침 및 우수 사례는 [일반 지침 및 자산 오프로딩 우수 사례를 참조하십시오](/help/assets/assets-offloading-best-practices.md#general-guidance-and-best-practices-for-asset-offloading).
* 오프로딩 에이전트의 자동 생성을 비활성화하는 방법에 대한 자세한 내용은 자동 에이전트 [관리 끄기를 참조하십시오](/help/assets/assets-offloading-best-practices.md#turning-off-automatic-agent-management).
