...
>
>이 작업은 http://localhost:4502/system/console/status-slingsettings으로 *이동하여* **&quot;실행 모드&quot;** 줄을 선택하면 수행할 수 있습니다.
...
1. 유지 관리 프로세스가 완료되고 인스턴스가 다시 시작된 후:
   ...
   * 대기 상태에서 데이터 저장소 가비지 컬렉션은 BlobGarbageCollection **MBean** -를 통해서만 사용할 수 `startBlobGC()`있습니다. RepositoryManagement **MBean** 은 대기 상태에서 사용할 수 없습니다.
   >[!NOTE]
   >
