...
>
>이 작업은 *http://localhost:4502/system/console/status-slingsettings*&#x200B;로 이동하여 **&quot;실행 모드&quot;** 행을 확인하여 수행할 수 있습니다.
...
1. JMX 콘솔로 이동하고 **org.apache.jackrabbit.oak를 사용하여 콜드 대기 인스턴스의 동기화 프로세스를 중지합니다.상태(&quot;대기&quot;)** 빈 이 방법에 대한 자세한 내용은 [모니터링](#monitoring)의 섹션을 참조하십시오.
1. 콜드 대기 인스턴스를 중지합니다.
...
1. 유지 관리 프로세스가 완료되고 인스턴스가 다시 시작된 후:
   ...
   * 대기 상태에서 데이터 저장소 가비지 컬렉션은 **BlobGarbageCollection** MBean - `startBlobGC()`을 통해서만 사용할 수 있습니다. 대기 상태에서 **RepositoryManagement** MBean을 사용할 수 없습니다.
