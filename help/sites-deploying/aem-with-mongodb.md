...
MongoDB Cloud Manager에 대한 자세한 내용은 MongoDB [설명서를](https://docs.mongodb.com/)참조하십시오.
...
Amazon Web Services를 사용하여 MongoDB를 설정하는 방법에 대한 설명서는 AWS에서 다음 [안내서인 MongoDB를 참조하십시오](https://docs.aws.amazon.com/quickstart/latest/mongodb/welcome.html).
