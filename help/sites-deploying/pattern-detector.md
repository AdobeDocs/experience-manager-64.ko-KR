...
1. AEM 웹 콘솔로 이동하여 다음 작업을 수행합니다.https://<i></i>serveraddress:serverport/system/console/configMgr
...
* **각 행에 개별 JSON 문서를 생성하는 사후 반응형 JSON 라인 인터페이스를**&#x200B;통해
