...
1. AEM 웹 콘솔로 이동: https://<i></i>serveraddress:serverport/system/console/configMgr
...
* **각 행에 개별 JSON 문서를 생성하는 인터랙티브한 JSON 라인 인터페이스를**&#x200B;통해
