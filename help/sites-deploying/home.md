---
title: AEM 6.4 배포 사용 안내서
seo-title: AEM 6.4 배포 사용 안내서
description: '이 안내서에서는 AEM 설치 및 배포와 같은 모든 AEM 배포 작업에 대해 설명합니다. '
seo-description: 'AEM 설치 및 배포와 같은 모든 AEM 배포 작업에 대해 다룹니다. '
...
이 안내서에서는 AEM 설치 및 배포와 같은 모든 AEM 배포 작업에 대해 설명합니다.
...
| [자산 사용 안내서](/help/assets/home.md) | 디지털 자산을 제작, 관리, 전달 및 최적화하는 방법을 살펴볼 수 있습니다. |
