...
[AEM Communities](/help/communities/overview.md)을 배포하려는 사이트의 경우, 게시 환경에서 커뮤니티 구성원이 게시한 UGC를 처리하기 위해 최적화된 배포](/help/communities/working-with-srp.md)를 선택하는 것이 좋습니다.[
