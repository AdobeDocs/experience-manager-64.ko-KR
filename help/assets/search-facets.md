...
1. 미리 보기를 닫으려면 미리 보기의 오른쪽 위 모서리에 있는 **[!UICONTROL 닫기]** ![닫기](assets/close.png)를 탭/클릭합니다.
...
기존 노드를 사용하려면 선택 대화 상자를 사용하여 노드를 지정합니다.
...
1. 지정한 모든 태그가 포함된 일치 항목을 검색하려면 **[!UICONTROL 모두 일치]**&#x200B;를 선택합니다.
...
| 설명 이름 | 설명 | 속성 |
|---|---|---|
| [!UICONTROL 전체 텍스트] | 전체 자산 노드에서 전체 텍스트 검색을 수행하는 검색 조건자입니다. jcr:contains 연산자와 매핑됩니다. 자산 노드의 특정 부분에서 전체 텍스트 검색을 수행하려면 상대 경로를 지정할 수 있습니다. | <ul><li>레이블</li><li>자리 표시자</li><li>속성 이름</li><li>설명</li></ul> |
| [!UICONTROL 경로 브라우저] | 사전 구성된 루트 경로에서 폴더 및 하위 폴더에서 에셋을 검색할 검색 설명 | <ul><li>자리 표시자</li><li>루트 경로</li><li>설명</li></ul> |
| [!UICONTROL 경로] | 결과를 위치에 필터링하는 데 사용합니다. 다른 경로를 옵션으로 지정할 수 있습니다. | <ul><li>레이블</li><li>경로</li><li>설명</li></ul> |
| [!UICONTROL 게시 상태] | 게시 상태를 기반으로 에셋을 검색하는 설명 검색 | <ul><li>레이블</li><li>속성 이름</li><li>설명</li></ul> |
| [!UICONTROL 상대적 날짜] | 작성 상대 날짜를 기준으로 에셋을 검색하는 조건자를 검색합니다. 예를 들어 2개월 전, 3주 전 등과 같은 옵션을 구성할 수 있습니다. | <ul><li>레이블</li><li>속성 이름</li><li>상대적 날짜</li></ul> |
...
| [!UICONTROL 날짜 범위] | 날짜 속성에 대해 지정된 범위 내에서 만들어진 에셋을 검색하는 조건자를 검색합니다. 검색 패널에서 날짜 선택기를 사용하여 시작 날짜와 종료 날짜를 지정할 수 있습니다. | <ul><li>레이블</li><li>자리 표시자</li><li>속성 이름</li><li>범위 텍스트(시작)</li><li>범위 텍스트(끝)</li><li>설명</li></ul> |
| [!UICONTROL 날짜] | 날짜 속성을 기반으로 한 에셋의 슬라이더 기반 검색을 위한 검색 조건자입니다. | <ul><li>레이블</li><li>속성 이름</li><li>설명</li></ul> |
| [!UICONTROL 파일 크기] | 검색 조건자를 사용하여 크기를 기준으로 자산을 검색합니다. 구성 가능한 노드에서 슬라이더 옵션을 선택하는 슬라이더 기반 조건자입니다. 기본 옵션은 CRX 저장소의 /libs/dam/options/predications/filesize에 정의됩니다. 파일 크기가 바이트 단위로 제공됩니다. | <ul><li>레이블</li><li>속성 이름</li><li>경로</li><li>설명</li></ul> |
| [!UICONTROL 마지막으로 수정된 자산] | 검색 조건자를 통해 최근에 수정된 에셋 검색 | <ul><li>속성 이름</li><li>속성 값</li><li>설명</li></ul> |
| [!UICONTROL 게시 상태] | 검색 조건자를 사용하여 게시 상태를 기반으로 자산을 검색합니다. | <ul><li>레이블</li><li>속성 이름</li><li>설명</li></ul> |
| [!UICONTROL 등급] | 검색 조건자를 사용하여 평균 등급을 기준으로 자산을 검색합니다. | <ul><li>레이블</li><li>속성 이름</li><li>옵션 경로</li><li>설명</li></ul> |
| [!UICONTROL 만료 상태] | 만료 상태를 기반으로 에셋을 검색할 조건자 검색 | <ul><li>레이블</li><li>속성 이름</li><li>설명</li></ul> |
...
기본적으로 잠금 아이콘은 **[!UICONTROL Forms 검색]** 페이지의 **[!UICONTROL 자산 관리자 검색 레일]** 앞에 표시됩니다. 양식에 검색 패싯을 추가하면 기본 양식이 수정되었음을 나타내는 잠금 아이콘이 사라집니다.
