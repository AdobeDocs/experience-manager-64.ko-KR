...
1. `https://[aem_server]:[port]/workflow`의 [!DNL Assets] 워크플로우 콘솔에 액세스합니다. [!UICONTROL DAM 자산 업데이트] 워크플로우를 엽니다.

1. 기본 방법을 사용하여 PDF 파일 및 AI 파일에 대한 축소판 및 웹 변환 생성을 방지하려면 다음 단계를 수행합니다.

   * **[!UICONTROL 축소판 프로세스]** 단계를 열고 필요한 경우 **[!UICONTROL 축소판]** 탭 아래의 **[!UICONTROL MIME 유형 건너뛰기]** 필드에서 `application/pdf` 또는 `application/postscript`을 추가합니다.

   ![skip_mime_types-2](assets/skip_mime_types-2.png)

   * **[!UICONTROL 웹 사용 이미지]** 탭에서 사용자의 요구 사항에 따라 **[!UICONTROL 건너뛰기 목록]**&#x200B;에 `application/pdf` 또는 `application/postscript`을 추가합니다.
...
1. 사이드 패널에서 **[!UICONTROL PDF 래스터라이저 처리기]** 단계를 **[!UICONTROL Process Thumbnails]** 단계 아래로 드래그합니다.
