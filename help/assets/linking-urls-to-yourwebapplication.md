...
seo-description: Dynamic Media에서 웹 애플리케이션에 URL을 연결하는 방법
...
1. 다음 방법 중 하나를 사용하여 게시된 정적 자산의 URL을 얻습니다.
   ...
   * **[!UICONTROL 자산 > 동적 표현물]**&#x200B;을 클릭한 다음, 정적 자산의 동적 표현물을 탭하고 URL을 복사합니다.
...
1. 페이지의 왼쪽 위 모서리 근처에 있는 **[!UICONTROL Cloud Service]s**&#x200B;를 탭한 다음 AEM 아이콘을 탭하고 **[!UICONTROL 일반 > CRXDE Lite]**&#x200B;로 이동합니다.
