...
통합하려면 [엔터프라이즈 Adobe Stock 플랜](https://stockenterprise.adobe.com/) 및 [!DNL Experience Manager] 6.4(서비스 팩 2 이상 배포)가 필요합니다. 6.4 서비스 팩 세부 정보는 이 [!DNL Experience Manager] 릴리스 정보를 참조하십시오 [](/help/release-notes/sp-release-notes.md).
