...
통합에는 서비스 팩 2가 적어도 배포된 [엔터프라이즈 Adobe Stock 플랜](https://stockenterprise.adobe.com/) 및 [!DNL Experience Manager] 6.4가 필요합니다. [!DNL Experience Manager] 6.4 서비스 팩 세부 정보는 [릴리스 노트](/help/release-notes/sp-release-notes.md)를 참조하십시오.
...
1. **[!UICONTROL 새 프로젝트 만들기]**&#x200B;를 클릭하고 **[!UICONTROL API 추가]**&#x200B;를 클릭합니다. ]에서 사용할 수 있는 [!UICONTROL API 목록에서 **[!UICONTROL Adobe Stock]**&#x200B;을 선택합니다. [!UICONTROL OAUTH 2.0 Web]을 선택합니다. 표시된 다양한 값을 구성하고 복사합니다.
...
1. [!DNL Experience Manager] 사용자 인터페이스에서 **[!UICONTROL 도구]** > **[!UICONTROL Cloud Services]** > **[!UICONTROL Adobe Stock]**&#x200B;으로 이동합니다.
...
>[!NOTE]
>
>[!DNL Adobe Stock] 구성이 여러 개 있는 경우 [사용자 환경 설정] 패널(**[!UICONTROL AEM]** > **[!UICONTROL 사용자 아이콘]** > **[!UICONTROL 사용자 환경 설정]** > **[!UICONTROL Stock 구성]**)에서 원하는 구성을 선택합니다.
