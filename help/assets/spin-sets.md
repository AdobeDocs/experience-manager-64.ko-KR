...
### 스핀 세트 이미지 슈팅 지침 {#guidelines-for-shooting-spin-set-images}
...
1. **[!UICONTROL 스핀 세트 편집기]** 페이지의 **[!UICONTROL 제목]** 필드에 스핀 세트의 이름을 입력합니다. 스핀 세트 위의 배너에 이름이 표시됩니다. 설명을 입력합니다(선택적).
