---
title: 자산 템플릿
description: AEM 자산의 자산 템플릿 및 자산 템플릿을 사용하여 마케팅 자료를 만드는 방법에 대해 알아봅니다.
...
고정 메시징 섹션에는 브랜드 로고 및 편집에 사용할 수 없는 저작권 정보와 같은 독점 컨텐츠가 포함될 수 있습니다. 편집 가능한 섹션에는 메시지를 사용자 정의하기 위해 편집할 수 있는 필드에 시각적 컨텐츠와 텍스트 컨텐츠가 포함될 수 있습니다.

제한된 편집을 수행하는 동시에 글로벌 사이니지를 안전하게 보호하는 자산 템플릿을 사용하면 컨텐츠 적응을 신속하게 수행하고 다양한 기능을 위해 컨텐츠 가공물로 배포할 수 있는 이상적인 구성 요소를 구축할 수 있습니다. 컨텐츠를 재활용하면 인쇄 및 디지털 채널을 관리하는 데 소요되는 비용을 절감하고 이러한 채널에서 일관되고 전체적인 경험을 제공할 수 있습니다.
...
에셋 템플릿은 대부분 InDesign 파일이지만 InDesign의 숙련도는 뛰어난 아티팩트를 제작하는 데 장애가 되지 않습니다. InDesign 템플릿의 필드를 제품 필드와 매핑할 필요는 없습니다. 웹 인터페이스에서 직접 WYSIWYG 모드에서 템플릿을 편집할 수 있습니다. 그러나 InDesign에서 편집 변경 사항을 처리하려면 먼저 AEM 자산을 InDesign 서버와 통합하도록 구성해야 합니다.

웹 인터페이스에서 InDesign 템플릿을 편집할 수 있으므로 크리에이티브 담당자와 마케팅 담당자 간의 공동 작업을 향상시킬 수 있을 뿐만 아니라 로컬 프로모션 이니셔티브의 출시 시간을 단축할 수 있습니다.
...
1. AEM 로고를 클릭하거나 탭한 다음 탐색 페이지에서 **[!UICONTROL 자산을]** 클릭/탭합니다.
...
1. (선택 사항) 태그 **[!UICONTROL 필드 옆에]** 있는 **[!UICONTROL 태그]** 아이콘을 클릭/탭하고브로셔에 대한 태그를 하나 이상 선택합니다. 확인을 클릭/탭하여 **** 선택을 확인합니다.
...
1. **[!UICONTROL 만들기]**&#x200B;를 클릭합니다. 새 브로셔가 만들어졌는지 확인하는 대화 상자가 표시됩니다. 열기를 클릭/탭하여 **[!UICONTROL 브로셔를]** 편집 모드로 엽니다.
   ...
   또는 대화 상자를 닫고 시작했던 템플릿 페이지의 폴더로 이동하여 만든 브로셔를 봅니다. 자료 유형이 카드 보기에서 축소판에 표시됩니다. 예를 들어 이 경우 축소판에 브로셔가 표시됩니다.
...
1. 편집할 자료를 열려면 다음 중 하나를 수행합니다.
   ...
   * 자료 자산 페이지의 도구 모음에서 편집 아이콘을 클릭/탭합니다.
   * 자료를 선택하고 도구 모음에서 편집 아이콘을 클릭/탭합니다.
   ...
   편집 가능 항목이 오른쪽에 표시됩니다. AEM Assets에서 필드를 편집하려면 템플릿의 해당 필드에 InDesign 태그가 지정되어 있어야 합니다. 즉, InDesign에서 편집 가능한 것으로 만들어야 합니다.

   ![chlimage_1-315](assets/chlimage_1-315.png)

   >[!NOTE]
   >
   >AEM 인스턴스가 InDesign 서버와 통합되어 AEM Assets가 InDesign 템플릿에서 데이터를 추출하고 이를 편집할 수 있도록 하려면 필요합니다. 자세한 내용은 AEM [자산과 InDesign Server 통합을 참조하십시오](indesign.md).
...
1. 미리 보기 **[!UICONTROL 아이콘을 클릭/탭하여]** 텍스트 변경 내용을 미리 볼 수 있습니다.
...
1. 편집 가능한 필드 목록에서 이미지 필드를 선택한 다음 자산 선택기에서 편집 가능한 필드로 원하는 이미지를 드래그합니다.
...
1. 미리 보기 **[!UICONTROL 아이콘을 클릭/탭하여]** 이미지를 미리 봅니다.

   ![chlimage_1-321](assets/chlimage_1-321.png)

1. 여러 페이지 자료의 특정 페이지를 편집하려면 하단에 있는 페이지 탐색기를 사용합니다.

   ![chlimage_1-322](assets/chlimage_1-322.png)

1. 도구 모음에서 미리 **[!UICONTROL 보기]** 아이콘을 클릭/탭하여 모든 변경 사항을 미리 볼 수 있습니다. 완료를 클릭/ **[!UICONTROL 탭하여]** 편집 변경 내용을 자료에 저장합니다.
...
1. 병합할 담보의 위치로 이동하고 병합할 담보의 축소판을 클릭/탭하여 선택합니다.
   ...
   다양한 필터를 적용하여 원하는 템플릿을 검색할 수 있습니다. 예를 들어 파일 유형이나 태그를 기반으로 템플릿을 검색할 수 있습니다.
...
1. 템플릿 구성 화면에서 담보의 이름을 지정합니다. 원하는 경우, 적절하다고 생각하는 태그를 지정합니다. PDF 형식으로 출력을 내보내려면 Acrobat **[!UICONTROL (.PDF)]** 옵션을 선택합니다. 기본적으로 자료는 JPG 및 InDesign 형식으로 내보내집니다. 여러 페이지 자료에 대한 표시 축소판을 변경하려면 축소판 변경을 클릭/ **[!UICONTROL 탭합니다]**.
