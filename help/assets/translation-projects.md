...
1. 자산에 대한 번역을 시작하려면 **[!UICONTROL 번역 작업]** 타일의 화살표를 클릭/탭하고 목록에서 **[!UICONTROL 시작을]** 선택합니다.
...
1. 번역 작업의 상태를 보려면 **[!UICONTROL 번역 작업]** 타일 맨 아래에 있는 줄임표를 클릭/탭합니다.
...
1. [ **[!UICONTROL 참조]** ] 창을 **[!UICONTROL 열고 [복사본] 아래에 있는]** 언어 **[!UICONTROL 사본]** 을 클릭/탭하여언어 사본목록을 표시합니다.
...
1. 참조 창 **[!UICONTROL 을]**&#x200B;열고 사본 **[!UICONTROL 에서 언어 사본]** 을 클릭/탭하여 **[!UICONTROL 언어 사본]** 목록을 표시합니다.
...
1. 언어 복사본을 이미 만든 언어 사본 **[!UICONTROL 에서]** 소스 루트 폴더를 클릭/탭한 다음 자산에 **[!UICONTROL 표시를 클릭/탭하여 AEM Assets에서]** 폴더를 엽니다.
