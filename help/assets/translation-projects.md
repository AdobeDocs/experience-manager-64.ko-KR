...
이 워크플로우에서 번역될 자산은 번역하려는 언어의 언어 루트로 복사됩니다. 또한 선택한 옵션에 따라 프로젝트 콘솔에서 자산에 대한 번역 프로젝트가 생성됩니다. 설정에 따라 번역 프로젝트를 수동으로 시작하거나 번역 프로젝트를 만드는 즉시 자동으로 실행할 수 있습니다.
...
작성 및 번역 워크플로우를 사용하여 처음으로 특정 언어에 대한 언어 사본을 생성할 수 있습니다. 워크플로우에서는 다음 옵션을 제공합니다.
...
대상 **언어 루트 내에 대상 폴더 계층 구조를 만들어 소스 언어 루트 내의 소스 폴더 계층 구조와 일치시키려면 구조만** 만들기 옵션을 사용합니다. 이 경우 소스 에셋이 대상 폴더에 복사됩니다. 그러나 번역 프로젝트는 생성되지 않습니다.
...
1. 만들기를 클릭/ **[!UICONTROL 탭합니다]**. 소스 폴더의 에셋이 4단계에서 선택한 로케일의 대상 폴더에 복사됩니다.
...
1. 언어 사본을 이미 만든 언어 복사본 아래의 **[!UICONTROL 소스]** 루트 폴더를 클릭/탭한 다음, 자산에 **[!UICONTROL 표시를 클릭/탭하여]** AEM 자산에서 폴더를 엽니다.
