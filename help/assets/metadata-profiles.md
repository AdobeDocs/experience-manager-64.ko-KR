---
title: 메타데이터 프로필을 사용하여 폴더의 모든 자산에 기본 메타데이터 적용
...
1. AEM 로고를 누르거나 클릭하고 **[!UICONTROL 도구 > 자산 > 메타데이터 프로필로 이동한]**&#x200B;다음 **[!UICONTROL 만들기를 누릅니다]**.
1. 메타데이터 프로필 제목(예: 샘플 메타데이터)을 입력하고 **[!UICONTROL 제출을 클릭합니다]**. 메타데이터 **[!UICONTROL 프로필에]** 대한 양식 편집이 표시됩니다.
...
1. 구성 요소를 클릭하고 설정 **[!UICONTROL 탭에서 해당 속성을]** 구성합니다. 예를 들어 설명 구성 **[!UICONTROL 요소를]** 클릭하고 해당 속성을 편집합니다.
   ...
   * **[!UICONTROL 기본값]**: 이 속성을 사용하여 메타데이터 구성 요소의 기본값을 추가합니다. 예를 들어 &quot;My description&quot;을 지정하면 이 값이 자산의 메타데이터 노드 `dc:desc` 에 있는 속성에 할당됩니다.
   ...
   >[!NOTE]
   >
   >새 메타데이터 속성에 기본값 추가(에 아직 존재하지 않음) `/jcr:content/metadata` node)는 기본적으로 자산의 속성 **[!UICONTROL 페이지에 속성 및 해당]** 값을 표시하지 않습니다. 자산의 [!UICONTROL 속성] 페이지에서 새 속성을 보려면 해당 스키마 양식을 수정합니다.

1. (선택 사항) **[!UICONTROL 양식]** **[!UICONTROL 작성]** 탭에서 양식 **[!UICONTROL 편집에 구성 요소를 더]** 추가하고설정탭에서 해당 속성을구성합니다. 양식 작성 탭에서 다음 속성을 **[!UICONTROL 사용할 수]** 있습니다.
...
1. 완료를 **[!UICONTROL 클릭합니다]**. 메타데이터 프로필이 **[!UICONTROL 메타데이터 프로필]** 페이지의 프로필 목록에 추가됩니다.
...
폴더에 프로필을 적용하는 것 외에도, 모든 폴더의 AEM 자산에 업로드된 콘텐트에 선택한 프로필이 적용되도록 전체적으로 적용할 수도 있습니다. 메타데이터 프로필을 전역적으로 적용하려면 다음 단계를 따르십시오.

1. 다음 중 하나를 수행하십시오.

   * 해당 프로파일로 `https://[aem_server]:[port]/mnt/overlay/dam/gui/content/assets/foldersharewizard.html/content/dam` 이동하여 적용하고 저장을 탭하거나 **[!UICONTROL 클릭합니다]**.

      ![chlimage_1-492](assets/chlimage_1-492.png)

   * 다음 노드로 CRXDE Lite으로 이동합니다. `/content/dam/jcr:content`. 속성을 추가하고 `metadataProfile:/etc/dam/metadata/dynamicmedia/<name_of_metadata_profile>` 모두 **[!UICONTROL 저장을 누릅니다]**.
...
1. 폴더에서 확인 표시를 눌러 선택한 다음 속성을 **[!UICONTROL 누릅니다]**.
1. 메타데이터 **[!UICONTROL 프로필]** 탭을 선택한 다음 드롭다운 **[!UICONTROL 메뉴에서]** 없음을 선택합니다. 저장을 **[!UICONTROL 누릅니다]**.
