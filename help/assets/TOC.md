...
+ 자산 관리 {#administer}
   ...
   + [자산을 효율적으로 번역하는 우수 사례](best-practices-for-translating-assets-efficiently.md)
   ...
   + [Assets Insights에 데모 패키지 사용](touch-ui-using-demo-package-for-asset-insights.md)
...
+ 자산 관리 {#managing}
   ...
   + [Assets에서 파일 체크인 및 체크아웃](check-out-and-submit-assets.md)
   + [스마트 컨텐츠 서비스를 사용하여 자산 태그 지정 구성](config-smart-tagging.md)
   + [중복 감지 활성화](duplicate-detection.md)
   + [AEM에서 자산 정렬이 개선되었습니다.](enhance-sort.md)
