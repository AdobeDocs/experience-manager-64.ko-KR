...
# AEM 6.4 자산 사용 안내서 {#assets}

+ [자산 사용 안내서](home.md)
+ [AEM 6.4 자산 릴리스 노트](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/assets.html)
+ [DAM 정보](assets.md)
+ [향상된 사용자 경험](ux-improvements.md)
...
+ 자산 관리 {#administer}
   ...
   + [메타데이터, 이미지 및 비디오 처리를 위한 프로필](processing-profiles.md)
   ...
   + [AEM Assets와 InDesign 서버 통합](indesign.md)
   ...
   + [컬렉션, 코드 조각 및 코드 조각 템플릿에 대한 다중 테넌트](multi-tenancy.md)
   + [원본에 쓰기](watermarking.md)
   + [일괄 메타데이터 가져오기 및 내보내기](metadata-import-export.md)
   + [자산 템플릿](asset-templates.md)
   + [AEM에서 Creative Cloud 폴더 공유 우수 사례](aem-cc-folder-sharing-best-practices.md)
...
+ Manage Assets {#managing}
   ...
   + [AEM에서 향상된 자산 정렬](enhance-sort.md)
   ...
   + [DTM을 통한 자산 통찰력 활성화](touch-ui-using-dtm-for-asset-insights.md)
