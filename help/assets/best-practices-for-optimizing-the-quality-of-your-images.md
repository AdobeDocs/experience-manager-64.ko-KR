...
description: 다이내믹 미디어의 이미지 품질 최적화를 위한 모범 사례 살펴보기
seo-description: 다이내믹 미디어의 이미지 품질 최적화를 위한 모범 사례 살펴보기
...
AEM에는 이미지를 조정 및 최적화하고 결과를 렌더링하기 위한 100개 이상의 다이내믹 미디어 이미지 제공 명령이 포함되어 있습니다. 다음 가이드라인은 몇 가지 필수 명령과 최상의 방법을 사용하여 프로세스를 간소화하고 좋은 결과를 신속하게 얻을 수 있도록 도와줍니다.
...
모범 사례 백서 [Adobe Scene7 Publishing System 및 이미지 서버에서](/help/assets/assets/s7_sharpening_images.pdf) 이미지를 선명하게 하는 기능은 AEM에도 적용됩니다.
...
* 언샵 마스킹( `&op_USM`) - 언샵 마스크는 업계 표준의 선명하게 하기 필터입니다. 가장 좋은 방법은 아래 지침에 따라 언샵 마스킹으로 이미지를 선명하게 하는 것입니다. 언샵 마스킹을 사용하면 다음 세 가지 매개 변수를 제어할 수 있습니다.
   ...
   * `&op_sharpen=`amount,radius,임계값
      ...
      * **[!UICONTROL 임계값]** (0-255, 효과의 민감도)
      ...
      모범 사례 백서 Adobe Scene7 [](/help/assets/assets/s7_sharpening_images.pdf)Publishing System 및 이미지 서버에서 이미지 선명하게 하기
