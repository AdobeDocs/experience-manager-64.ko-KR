...
![인터랙티브한 쇼퍼블 비디오에서 얻은 프레임](assets/chlimage_1-126.png) *인터랙티브한 쇼퍼블 비디오에서 촬영한 비디오 프레임.*
...
위의 접근 방식이 Example 웹 사이트에 적용되면 각각 **[!UICONTROL SEE MORE]** 버튼()이 있는 여러 제품 축소판이 있는 웹 페이지가 있습니다.
