...
Adobe Experience Manager Assets는 DAM 사용자가 크리에이티브 팀과 공동 작업을 할 수 있도록 Adobe Creative Cloud과 통합하여 콘텐츠 제작 프로세스의 공동 작업을 간소화할 수 있는 디지털 에셋 관리(DAM) 솔루션입니다.

Adobe Creative Cloud은 크리에이티브 팀에게 디지털 에셋을 만드는 데 도움이 되는 솔루션과 서비스 에코시스템을 제공합니다. 여기에는 데스크탑 및 모바일 애플리케이션, 데스크탑 동기화 또는 웹 경험이 포함된 스토리지와 같은 클라우드 서비스뿐만 아니라 Adobe Stock과 같은 마켓플레이스도 포함되어 있습니다.

사용 사례를 바탕으로 데스크탑과 엔터프라이즈급 DAM 간의 통합을 어떻게 선택하는지 그리고 원활한 워크플로우를 위해 어떤 모범 사례를 제공하는지 살펴보십시오.

>[!NOTE]
>
>AEM-Creative Cloud 폴더 공유는 더 이상 필요하지 않으며 더 이상 이 안내서에서 다루지 않습니다. Adobe은 크리에이티브 사용자가 AEM에서 관리되는 자산에 액세스할 수 있도록 하려면 [Adobe 자산 링크](https://helpx.adobe.com/kr/enterprise/using/adobe-asset-link.html) 또는 [AEM 데스크톱 앱](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/introduction.html)과 같은 최신 기능을 사용하는 것이 좋습니다.

## 크리에이티브 전문가, 마케터 및 DAM 사용자의 공동 작업 요구 사항 {#collaboration-needs-of-creatives-marketers-and-dam-users}

| 요구 사항 | 사용 사례 | 포함된 서피스 |
|---|---|---|
| 데스크탑에서 크리에이티브 작업을 위한 경험 간소화 | 크리에이티브 전문가를 위해 DAM(AEM Assets)을 통해 에셋에 대한 액세스를 간소화할 수 있고 기본 에셋 제작 애플리케이션에서 작업하는 데스크탑 사용자도 보다 폭넓게 이용할 수 있습니다. AEM에 대한 변경 사항을 검색, 사용(열기), 편집 및 저장하고 새로운 파일을 업로드하는 간편하고 간단한 방법이 필요합니다. | Win 또는 Mac 데스크탑;Creative Cloud 앱 |
| Adobe Stock에서 바로 사용할 수 있는 고품질의 에셋 제공 | 마케터는 자산 확보 및 검색을 지원하여 컨텐츠 제작 프로세스를 가속화할 수 있습니다. 크리에이티브 전문가는 크리에이티브 툴에서 바로 승인된 자산을 사용합니다. | AEM Assets;Adobe Stock marketplace;메타데이터 필드 |
...
|---|---|---|
| 크리에이티브 사용자는 Creative Cloud 앱을 종료하지 않고도 AEM에서 에셋을 검색하고, 열어 사용하고, AEM에 대한 변경 사항을 편집 및 업로드하고, 새로운 파일을 AEM에 업로드할 수 있습니다. | [Adobe Asset Link](https://helpx.adobe.com/enterprise/using/adobe-asset-link.html) | Photoshop, Illustrator 및 InDesign |
...
|---|---|---|---|
| 크리에이티브 사용자와 DAM 에셋 수(1) 감소 | ✔✔ | ✔ |  |
| 크리에이티브 사용자와 더 많은 DAM 에셋 공유(2) | ✔✔ | ✘ | [Brand Portal](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/home.html) <br> [자산 공유](assets-finder-editor.md) |
| DAM에 액세스할 수 있는 사용자와 DAM 에셋 공유 | ✔✔ | ✔ | [공유 링크](link-sharing.md) |
| DAM에 대한 액세스 권한이 없는 사용자와 DAM 에셋 공유 | ✘ | ✔✔ | [브랜드 포털](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/home.html) <br> [자산 공유](assets-finder-editor.md) |
| DAM에 더 적은 양의 에셋 저장 | ✔✔ | ✔ | [웹 UI 업로드](managing-assets-touch-ui.md) |
| DAM에 더 많은 자산 저장 (3) | ✔✔ | ✘ | [웹 UI ](managing-assets-touch-ui.md) <br> 업로드사용자 지정 스크립트/도구 |
| 대량의 에셋을 DAM으로 마이그레이션 | ✘ | ✘ | [마이그레이션 안내서](assets-migration-guide.md) |
| 신속하게 데스크탑에서 에셋 열기 | ✔✔ | ✘ |  |
| 신속하게 데스크탑에서 에셋 열기 및 변경 | ✔✔ | ✘ |  |
...
* [브랜드 ](https://helpx.adobe.com/experience-manager/brand-portal/user-guide.html) 포트폴리오를 참조하십시오.
* 사용자 지정 솔루션은 [자산 공유 공유물](https://adobe-marketing-cloud.github.io/asset-share-commons/) 코드 베이스를 기반으로 만들어집니다.
* AEM [링크 공유](/help/assets/link-sharing.md)를 클릭하여 링크를 사용하여 자산을 애드혹 공유할 수 있습니다.
* [AEM Assets 웹](/help/assets/managing-assets-touch-ui.md) 은 AEM 액세스 제어 설정에 의해 보안이 설정되고 필요한 IT/네트워크 구성 조정을 통해 외부 당사자를 위한 영역과 상호 작용하여 외부 사용자가 AEM에 액세스할 수 있도록 합니다.
...
* **크리에이티브한 에셋:** 마케팅 또는 LOB 팀과 공유할 수 있도록 크리에이티브 팀에서 선택/승인한 자산을 더 광범위한 팀과 공유할 준비가 완료되었거나, 선택할 수 있습니다.
...
* **DAM:** 디지털 에셋 관리. 이 문서에서는 특별히 별도로 언급되지 않는 한 AEM Experience Manager 자산과 비슷합니다.
...
* **크리에이티브 사용자를 위해 Photoshop, InDesign 또는 Illustrator:** Adobe Asset Link는 AEM에서 체크 아웃한 자산에 대한 진행 중인 작업을 깨끗한 처리 등 최고의 사용자 환경을 제공합니다
* **모든 일반 파일 포맷 또는 응용 프로그램에 대해 데스크탑에서 에셋에 대한 액세스를 간소화하기 위해 AEM 데스크탑 앱** 사용
...
[AEM 및 Adobe Stock ](/help/assets/aem-assets-adobe-stock.md) 통합을 통해 AEM 사용자는 Adobe Stock에서 AEM으로 에셋을 검색, 미리 보기, 라이선스 및 저장할 수 있습니다. 라이선스가 부여된 Adobe Stock 에셋과 저장된 에셋은 Stock 메타데이터를 선택했으며, 이 메타데이터를 추가 필터로 검색하는 데 사용할 수 있습니다.

이 통합에 대한 몇 가지 중요 사항:

* Adobe 스톡 에셋이 AEM에 저장되면 바이너리가 AEM 저장소에 저장된 일반 AEM Assets이 됩니다. Adobe Stock과 관련된 일부 메타데이터는 AEM의 자산에 대해 저장되며, 그렇지 않은 경우 통합 프로세스는 다른 파일과 동일하게 보입니다. 예를 들어 스마트 태그가 활성 상태인 경우 저장 시 태그가 이러한 자산에 추가됩니다.
* AEM에 저장된 에셋은 Adobe Stock에 다시 연결되는 링크가 아니라 복사본입니다.

**Creative Cloud에서 Adobe Stock에서 AEM으로 저장된 에셋을 사용하여 작업** 이 통합은 Adobe 에셋 링크와 독립적이지만 Adobe 에셋 링크는 이러한 방식으로 Stock에서 저장된 에셋을 인식하며 Photoshop, Illustrator 또는 InDesign의 Adobe 에셋 링크 확장 UI에 이러한 에셋에 추가 메타데이터와 Stock 아이콘을 표시합니다. 파일은 AEM에 저장할 때 일반 AEM 자산이므로 탐색, 열기 등에 사용할 수 있습니다.
Adobe Stock에서 이미 라이선스가 부여된 에셋을 AEM에 액세스할 수 있을 뿐만 아니라 Adobe 에셋 링크 확장 기능이 있는 Creative Cloud 앱에서 작업하는 크리에이티브 사용자는 Creative Cloud 라이브러리 패널을 사용하여 Adobe Stock 에셋을 검색하고 미리 보고 라이선스를 부여할 수 있습니다.
AEM Assets 라이선스를 구매하여 AEM에 저장된 Adobe Stock의 에셋은 배포에 액세스하는 광범위한 팀에서 사용할 수 있는 반면, Creative Cloud 라이브러리 패널을 통해 Adobe Stock의 크리에이티브 라이선스 에셋을 Creative Cloud 계정에서만 사용할 수 있습니다.
...
대부분의 조직은 다운스트림 마케팅/LOB 프로세스와 관련이 있는 자산만 저장하도록 선택합니다(AEM Sites 또는 Adobe Experience Cloud에서 제공하는 기타 채널을 통해 웹 채널과 같은 채널에 게시 - Marketing Cloud, Advertising Cloud, Analytics Cloud에서 측정, 사용자/파트너에게 제공 등). 또한 조직은 DAM에서 검토/승인 프로세스를 받을 수 있는 자산을 저장합니다. 이렇게 하면 DAM은 대부분 자산을 활용할 가능성이 높은 에셋을 저장하고 유휴 에셋을 저장하지 않습니다.
...
* 해당 자산에 비해 외부 팀에 자신의 작품을 선보일 더 많은 후보가 있다
...
일반적으로 자산 라이프사이클의 주요 마일스톤과 관련된 변경 사항입니다. 예를 들어 크리에이티브 팀이 제공한 요청/검토를 기반으로 한 초기 크리에이티브 에셋 또는 공식 업데이트를 DAM에 저장하고 버전을 지정해야 합니다.
...
* 크리에이티브 팀이 자산이 준비되었는지를 결정하기 전에 진행 중인 작업 중 단계의 에셋에 대한 크리에이티브한 변경을 자주 수행
...
이러한 경우 AEM 데스크탑 앱을 사용하면 최종/승인된 자산에 손쉽게 액세스할 수 있고 크리에이티브한 에셋을 DAM에 저장할 수 있습니다.
...
이러한 경우 AEM/Creative Cloud 통합을 활용하여 워크플로우를 향상시킬 수 있습니다. 이 사전 요구 사항은 크리에이티브 사용자가 Adobe ID을 소유하고 스토리지 서비스 Creative Cloud 계정을 갖는 것입니다.
...
다음 사용 사례에서는 DAM과 디자이너의 데스크탑 간 다양한 유형의 워크플로우에 대해 설명합니다.

#### DAM {#creating-new-designs-using-assets-from-dam}의 에셋을 사용하여 새 디자인 만들기

다음 다이어그램은 디지털 자산 라이프사이클을 보여줍니다. 크리에이티브 사용자와 DAM 사용자(마케터, LOB 사용자)가 기존 자산을 활용하여 더 많은 자산을 만들고 승인을 위해 보내는 방법을 설명합니다.

![chlimage_1-301](assets/chlimage_1-301.png)

자산 라이프사이클에는 다음 단계가 포함됩니다.

1. 승인된 자산을 크리에이티브 데스크탑에 공유:DAM의 최종 에셋은 크리에이티브 사용자가 사용할 수 있습니다(데스크탑).
1. 새 디자인 만들기(크리에이티브 디지털 에셋):새 파일은 WIP(Work-in-Progress) 영역에 저장됩니다.
1. 승인된 자산을 새 디자인에 사용(위치):크리에이티브 사용자는 Creative Cloud 앱에서 기존의 승인된 자산을 사용하여 새 자산을 만듭니다.
1. WIP 업데이트를 자주 저장:크리에이티브 사용자는 빠르게 반복하고 파일을 자주 저장합니다. 이 단계에서 크리에이티브 사용자는 다른 사용자와 공동 작업을 할 수 있지만 자주 저장되는 업데이트는 일반적으로 DAM 사용자에게 아무런 관심도 없습니다.
1. 자산이 크리에이티브 준비 상태에 도달하고 Creative Ready 폴더에 저장됩니다.
1. 자산 업데이트:DAM의 사용자가 에셋 업데이트 또는 새 파일을 사용할 수 있음
1. 자산이 프로덕션에 배치됨:조직에 따라 태그 지정, 승인 및 액세스 제어 변경을 구성하는 DAM 프로세스입니다. 이 단계에서 자산은 최종적인 것으로 간주되며 DAM을 활용하는 광범위한 팀에서 사용할 수 있습니다. 크리에이티브 사용자가 다른 에셋을 만드는 데 사용할 수도 있습니다.

다음은 이 프로세스를 통해 자산을 관리하는 방법에 대한 몇 가지 일반적인 권장 사항입니다.

* WIP 파일에 대해 Adobe Creative Cloud Assets 동기화된 폴더와 같은 전용 스토리지 영역/시스템을 사용합니다.DAM 사용자와 관련이 없는 잦은 업데이트는 AEM Assets이 아니라 전용 시스템에서 가장 잘 처리됩니다. WIP 자산은 Adobe Creative Cloud 데스크톱 응용 프로그램을 사용하여 로컬 디스크에 동기화하거나 로컬 저장소에 저장하는 등의 작업을 할 수 있습니다.
* DAM에 업로드된 최종 자산 및 자산에 대해 별도의 폴더/공유 사용:명확히 하자면 최종 자산은 자체 매핑된/공유 폴더(&quot;Final&quot; 예제)를 가지고 있어야 하며, DAM에 다시 업로드되는 에셋은 자체적으로 가져야 합니다(&quot;Creative Ready&quot;).

#### DAM {#changing-existing-assets-managed-in-dam}에서 관리되는 기존 자산 변경

경우에 따라 DAM의 자산을 변경해야 할 수 있습니다. 예:

* AEM Assets에서 수행한 검토 및 승인에서 자산 변경 요청
* 기존 최종 자산에 대한 주요 업데이트
* 기존 파일에 대한 빠른 편집(특히 마지막으로 승인되기 전에)

이러한 경우 AEM 데스크탑 앱이 이러한 작업을 수행하는 가장 쉬운 방법을 제공합니다.
...
* **1:** DAM에서 데스크탑으로 에셋을 공유하거나 원하는 애플리케이션(예: Adobe Photoshop 등)에서 데스크탑으로 직접 열 수 있습니다. 파일을 잠그려면 체크 아웃이 권장됩니다.
* **2:** 경미한 업데이트:파일을 편집하고 변경 내용을 저장합니다.
* 단계 2에 대한 대체 흐름
...
* **3:** 자산 업데이트가 DAM에 반영됩니다. 잠금을 해제하려면 자산을 확인합니다.
* **4:** 에셋이 프로덕션에 배치됩니다.

다음은 이 프로세스 전체에서 자산을 관리하는 방법에 대한 몇 가지 일반적인 권장 사항입니다.

* 파일을 변경한 내용이 적은 경우를 제외하고 AEM 데스크탑 앱으로 매핑된 네트워크 공유에서 연 파일을 직접 저장하지 마십시오.
* 추가 변경을 수행하거나, 간헐적으로 저장하거나, 크리에이티브 팀과 공동 작업하려면 파일을 별도의 WIP 폴더에 복사합니다.
...
이 설명은 데스크톱 사용자의 워크플로우에서 정상적인 부분으로 파일(예: 매주 또는 모든 사진 촬영 등)을 원활하게 업로드하는 것을 말합니다. 대규모 자산 마이그레이션은 여기에서 다루지 않습니다.

자산을 일괄 업로드하려면 다음 기능을 활용할 수 있습니다.

* 대용량/계층 폴더를 업로드하려면 [폴더 업로드](https://helpx.adobe.com/experience-manager/desktop-app/aem-desktop-app.html#bulkupload) 기능을 제공하는 AEM 데스크톱 앱을 사용합니다. 계층 폴더 구조를 업로드할 수도 있습니다. 에셋은 백그라운드에서 업로드되므로 웹 브라우저 세션과 연결되지 않습니다.
...
네트워크 파일 공유를 사용하여 디지털 자산을 관리하는 경우, AEM 데스크탑 앱이 매핑한 네트워크 공유를 사용하는 것만으로도 편리한 대체품으로 보일 수 있습니다. 네트워크 파일 공유에서 전환할 때 AEM 웹 UI는 네트워크 공유(검색, 컬렉션, 메타데이터, 공동 작업, 미리 보기 등)에서 가능한 것 이상으로 풍부한 디지털 자산 관리 기능을 제공하고 AEM 데스크탑 앱은 서버측 DAM 저장소를 데스크탑에서 작업과 연결하는 편리한 링크를 제공합니다.

AEM 데스크탑 앱을 사용하여 AEM Assets의 네트워크 공유에서 바로 에셋을 관리할 수 있습니다. 예를 들어 AEM 데스크탑 앱을 사용하여 여러 파일을 이동/복사하지 마십시오. 대신 AEM Assets 웹 UI를 사용하여 Finder/탐색기에서 네트워크 공유로 폴더를 드래그하거나 AEM Assets 폴더 업로드 기능을 사용합니다.

#### 자산 마이그레이션 {#asset-migration}

기존 시스템에서 새 시스템으로 에셋 마이그레이션을 계획 및 실행하거나 서버에 저장된 많은 양의 에셋을 마이그레이션하려면 [마이그레이션 안내서](/help/assets/assets-migration-guide.md)를 참조하십시오. AEM 데스크탑 앱과 AEM에서 Creative Cloud으로 통합해도 이러한 마이그레이션을 지원하지 않습니다. 인제스트할 에셋의 용량이 크고 메타데이터 매핑, 변형 및 인제스트에 대한 추가 요구 사항은 서로 다른 툴과 접근 방식을 사용하여 마이그레이션해야 합니다.
