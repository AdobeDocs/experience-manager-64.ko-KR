...
# 스마트 콘텐츠 서비스 {#configure-asset-tagging-using-the-smart-content-service}를 사용하여 자산 태그 지정 구성

[!DNL Adobe Developer Console]을(를) 사용하여 스마트 콘텐츠 서비스와 [!DNL Adobe Experience Manager]를 통합할 수 있습니다. 이 구성을 사용하여 [!DNL Experience Manager] 내에서 스마트 콘텐츠 서비스에 액세스합니다.

이 문서에서는 스마트 콘텐츠 서비스를 구성하는 데 필요한 다음 주요 작업에 대해 자세히 설명합니다. Smart Content Service에 요청을 전달하기 전에 백엔드에서 [!DNL Experience Manager] 서버가 [!DNL Adobe Developer Console] 게이트웨이로 서비스 자격 증명을 인증합니다.
...
1. [API ](#configure-smart-content-service) 키 및 다른 자격 증명을 사용하여 배포를 구성합니다 [!DNL Adobe Developer Console].
...
스마트 콘텐츠 서비스를 사용하기 전에 [!DNL Adobe Developer Console]에 통합을 만들려면 다음을 확인하십시오.
...
공용 인증서를 사용하면 [!DNL Adobe Developer Console]에서 프로필을 인증할 수 있습니다.
...
1. [!DNL Experience Manager]에서 **[!UICONTROL 도구 > Cloud Service > 이전 Cloud Services]**&#x200B;으로 이동하여 [!UICONTROL Cloud Services] 콘솔을 엽니다.
...
구성을 완료한 후 JMX MBean을 사용하여 구성을 확인합니다. 유효성을 확인하려면 다음 단계를 수행합니다.

1. `https://[aem_server]:[port]`에서 [!DNL Experience Manager] 서버에 액세스합니다.

1. **[!UICONTROL 도구 > 작업 > 웹 콘솔]**&#x200B;으로 이동하여 OSGi 콘솔을 엽니다. **[!UICONTROL 기본 > JMX]**&#x200B;을 클릭합니다.
