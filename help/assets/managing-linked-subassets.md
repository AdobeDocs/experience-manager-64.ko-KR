...
* **[!UICONTROL 데스크톱]** 작업을 참조하십시오. AEM 데스크탑 앱을 사용하는 경우 [데스크톱 작업을](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/using.html?lang=en#desktopactions-v2) 구성하는 방법을 참조하십시오.
