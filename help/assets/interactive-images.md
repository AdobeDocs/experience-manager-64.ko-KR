...
1. **(선택 사항) 핫스팟 변수 식별** - AEM Assets 및 Dynamic Media 독립 실행형을 사용하는 경우, 대화형 이미지를 만들 때 핫스팟 데이터를 입력할 수 있도록 기존 Quickview 구현에서 사용되는 동적 변수를 식별하여 시작하십시오. 자세한 내용은 [(선택 사항) 핫스팟 변수 식별](#optional-identifying-hotspot-variables).

   그러나 AEM Sites, AEM eCommerce 또는 두 가지 모두를 사용하는 경우 이 단계가 필요하지 않습니다.

   자세한 내용은 [AEM Assets의 eCommerce 개념](/help/sites-administering/concepts.md).
...
1. **(선택 사항) 대화형 이미지 뷰어 사전 설정 만들기** - 핫스팟을 표시하는 데 사용되는 그래픽 이미지를 사용자 정의합니다. 이름이 인 기본 대화형 이미지 뷰어 사전 설정을 사용하려는 경우에는 대화형 이미지 뷰어 사전 설정을 직접 만들 필요가 없습니다 `Shoppable_Banner` 을 가리키도록 업데이트하는 것이 좋습니다.
   ...
   자세한 내용은 [(선택 사항) 대화형 이미지 뷰어 사전 설정 만들기](managing-viewer-presets.md#creating-a-new-viewer-preset).

1. **이미지 배너 업로드** - 대화형 이미지를 만들 이미지 배너를 업로드합니다.

   자세한 내용은 [이미지 배너 업로드](#uploading-an-image-banner).

1. **이미지 배너에 핫스팟 추가** - 이미지 배너에 하나 이상의 핫스팟을 추가하고 각 핫스팟을 하이퍼링크, 빠른 보기 또는 경험 조각 등의 작업에 연결합니다. 핫스팟을 추가한 후에는 대화형 이미지를 게시하여 이 작업을 완료합니다.
   ...
   * 자세한 내용은 [자산 게시](publishing-dynamicmedia-assets.md) 대화형 이미지 자산을 게시하는 방법에 대한 자세한 내용.

1. **AEM에서 웹 사이트 또는 웹 사이트에 대화형 이미지 추가**

   * AEM Sites, AEM eCommerce 또는 둘 다 사용하는 경우 Interactive Media 구성 요소를 페이지로 드래그하여 AEM의 웹 페이지에 직접 대화형 이미지를 추가할 수 있습니다. 자세한 내용은 [페이지에 Dynamic Media 자산 추가](adding-dynamic-media-assets-to-pages.md).
   * AEM Assets 및 Dynamic Media 독립 실행형 을 사용하는 경우 웹 사이트에서 포함 코드를 복사한 다음 기존 Quickview와 통합해야 합니다. 자세한 내용은 [웹 사이트와 대화형 이미지 통합](#integrating-an-interactive-image-with-your-website).
   * 타사 WCM(Web Content Manager)을 사용하는 경우, 새 대화형 비디오를 웹 사이트에서 사용되는 기존 Quickview 구현과 통합해야 합니다. 자세한 내용은 [기존 Quickview와 대화형 이미지 통합](#integrating-an-interactive-image-with-an-existing-quickview).
...
>* AEM 구현은 다음을 수행합니다 *not* IBM Websphere Commerce, Elastic Path, hybris 또는 Intershop과 같은 모든 eCommerce 솔루션에서 제품 데이터를 AEM으로 가져오는 데 eCommerce 통합 프레임워크를 사용합니다. 자세한 내용은 [AEM Assets의 eCommerce 개념](/help/sites-administering/concepts.md).
>
...
* Google Chrome에서 나가는 모든 HTTP 요청을 보려면 F12 키를 눌러 **[!UICONTROL 개발자 도구]** 패널을 클릭한 다음 **[!UICONTROL 네트워크]** 탭.

   Mac에서 **[!UICONTROL Command+Option+I]** 열다 **[!UICONTROL 개발자 도구]** 패널을 클릭한 다음 네트워크 탭을 클릭합니다.

* Firefox에서는 F12를 눌러 Firebug 플러그인을 활성화하고 Net 탭을 사용하거나 기본 제공 파일을 사용할 수 있습니다 **[!UICONTROL 검사자]** 도구 및 해당 **[!UICONTROL 네트워크]** 탭.

   Mac에서 **[!UICONTROL Command+Option+I]** 열다 **[!UICONTROL 개발자 도구]** 패널을 클릭한 다음 **[!UICONTROL 검사자]** 탭.
...
데모 웹 페이지에는 여러 제품 축소판이 있으며, 각 페이지에는 빠른 보기 단추가 표시됩니다 **[!UICONTROL 자세히 보기]**. 웹 브라우저의 디버깅 도구가 계속 활성화되면 각 단추를 클릭하고 기록된 Quickview URL을 기록해 둡니다. 페이지에서 사용할 수 있는 4개의 제품 빠른 보기를 모두 활성화하면 백엔드에 대해 수행된 Quickview 요청 목록이 있습니다.
...
이라는 기본 기본 기본 대화형 이미지 뷰어 사전 설정을 사용하도록 선택할 수 있습니다. **[!UICONTROL Shopperable_Banner]** AEM Assets과 함께 제공됩니다. 또는 대화형 이미지에 사용할 사용자 지정 뷰어 사전 설정을 직접 만들 수도 있습니다.
...
뷰어 사전 설정을 저장하면 **[!UICONTROL 뷰어 사전 설정]** AEM Assets의 목록 페이지. 이 기능은 Interactive Media 구성 요소에 표시되고 자산을 볼 때마다 표시됩니다. 하지만, *게재* 이 뷰어 사전 설정이 있는 대화형 배너입니다. *게시* 뷰어 사전 설정도 마찬가지입니다(사용자 지정 또는 기본 제공 뷰어 사전 설정의 경우 true).

**대화형 이미지 뷰어 사전 설정을 만들려면**:

1. 왼쪽 레일에서 **[!UICONTROL 도구 > 자산 > 뷰어 사전 설정]**.
1. 페이지의 오른쪽 위 모서리 근처에 있는 탭하기 **[!UICONTROL 만들기]**.
1. 에서 **[!UICONTROL 새 뷰어 사전 설정]** 대화 상자에서 대화형 배너 뷰어 사전 설정을 설명하는 이름을 입력합니다.

   이 제목은 **[!UICONTROL 뷰어 사전 설정]** 저장한 후 페이지를 나열합니다.
1. 에서 **[!UICONTROL 리치 미디어 유형]** 풀다운 메뉴에서 **[!UICONTROL 대화형 이미지]**.
1. 탭 **만들기**.
1. 설정 **[!UICONTROL 뷰어 사전 설정 편집]** 페이지에서 **[!UICONTROL 모양]** 탭.
1. 다음 중 하나를 수행하십시오.

   * 이미지에 사용할 핫스팟이미지를 업로드하려면 **[!UICONTROL 자산 선택기]** 아이콘. 에서 **[!UICONTROL 컨텐츠 선택]** 페이지에서 사용할 핫스팟 이미지로 이동하여 선택한 다음 탭합니다 **[!UICONTROL 확인 표시]** 오른쪽 위 모서리에 있는 아이콘.
   * 사전 정의된 핫스팟 이미지를 선택하려면 **[!UICONTROL 핫스팟 갤러리]** 아이콘. 핫스팟 갤러리 팔레트에서 사용할 핫스팟 이미지를 탭합니다.

1. 페이지의 오른쪽 위 모서리 근처에 있는 탭하기 **[!UICONTROL 저장]**.

   새 뷰어 사전 설정을 게시해야 합니다.

   자세한 내용은 [추가한 뷰어 사전 설정 게시](managing-viewer-presets.md#publishing-viewer-presets).
...
의 편집기를 사용하여 이미지 배너에 핫스팟을 추가할 수 있습니다 **[!UICONTROL 핫스팟 관리]** 페이지.
...
대화형 이미지 만들기를 마치면 다음을 사용할 수 있습니다 **[!UICONTROL 미리 보기]** 대화형 이미지가 고객에게 표시되는 방식을 보여 줍니다.
...
1. 다음 중 하나를 수행하십시오.
   ...
   * 이미지를 탭하여 **[!UICONTROL 세부 사항 보기]** 페이지. 도구 모음에서 **[!UICONTROL 편집]**.

1. 페이지의 왼쪽 위 모서리 근처에 있는 탭하기 **[!UICONTROL 핫스팟 추가]** (손가락 탭 아이콘)을 클릭하여 열기 **[!UICONTROL 핫스팟 관리]** 페이지.
1. 페이지의 왼쪽 위 모서리 근처에 있는 탭하기 **[!UICONTROL 핫스팟]**.
1. a. 의 왼쪽 위 모서리 근처에 있습니다. **핫스팟 관리** 페이지, 탭 **[!UICONTROL 핫스팟]**.
나. 이미지에서 핫스팟을 표시할 위치를 누릅니다. If necessary, drag the hotspot to adjust its location.
c. a 및 b 단계를 반복하여 필요에 따라 핫스팟을 추가합니다. d. (선택 사항) 핫스팟을 삭제하려면 이미지에서 핫스팟을 선택한 다음 탭합니다 **[!UICONTROL 삭제]** (쓰레기통 아이콘) 아래의 **[!UICONTROL 핫스팟]** 제목.

1. 에서 **[!UICONTROL 이름]** 텍스트 필드에서 핫스팟의 이름을 입력합니다. 이 이름은 **[!UICONTROL 선택한 핫스팟]** 드롭다운 목록.
1. 다음 중 하나를 수행하십시오.

   * 탭 **[!UICONTROL Quickview]**.

      * AEM Sites 또는 eCommerce 고객인 경우 **[!UICONTROL 제품 선택기]** 아이콘(확대경)을 클릭하여 열기 **[!UICONTROL 제품 선택]** 페이지. 사용할 제품을 탭한 다음, **[!UICONTROL 선택]** 페이지의 오른쪽 위 모서리에서 로 돌아가십시오. **[!UICONTROL 핫스팟 관리]** 페이지.
      * 만약 *not* AEM Sites 또는 eCommerce 고객
   ...
   * 탭 **하이퍼링크**.
      ...
      * AEM Sites 고객인 경우 **[!UICONTROL 사이트 선택기]** 아이콘(폴더)을 클릭하여 URL로 이동합니다. 대화형 컨텐츠에 상대 URL이 있는 링크, 특히 AEM Sites 페이지에 대한 링크가 있는 경우 URL 기반 연결 방법이 지원되지 않습니다.
   ...
   * 탭 **경험 조각**.
      ...
      * AEM Sites 고객인 경우 **[!UICONTROL 검색]** 아이콘(확대경)을 클릭하여 열기 **[!UICONTROL 경험 조각]** 페이지. 사용할 경험 조각을 탭한 다음, **[!UICONTROL 선택]** 페이지의 오른쪽 위 모서리에서 핫스팟 관리 페이지로 돌아갑니다.
...
1. 탭 **[!UICONTROL 저장]** 작업을 저장하고 **[!UICONTROL 찾아보기]** 페이지.
1. 대화형 이미지를 게시합니다. 게시를 사용하면 배너를 클라우드를 통해 제공할 수 있고 타사 웹 사이트와 통합해야 하는 경우 포함 코드도 생성됩니다.

   자세한 내용은 [자산 게시](managing-assets-touch-ui.md#publishing-assets).
...
1. 미리 보기 페이지의 왼쪽 위 모서리 근처에 있는 **[!UICONTROL 컨텐츠]** 드롭다운 목록에서 **[!UICONTROL 뷰어]**.
1. 에서 **[!UICONTROL 뷰어]** 목록, 탭 **[!UICONTROL Shopperable_Banner]** 또는 만든 대화형 이미지 뷰어 사전 설정의 이름입니다.
...
AEM Sites 고객의 경우 대화형 미디어 구성 요소를 페이지로 드래그하여 대화형 이미지를 추가할 수 있습니다. 자세한 내용은 [페이지에 Dynamic Media 자산 추가](adding-dynamic-media-assets-to-pages.md)
...
세 남자의 사진은 정적인 것이다 `IMG` 태그:

```xml
<img class="img-responsive" width="100%" title="Hero Image 2" alt="Hero Image 2" src="images/shoppable-banner.jpg">
```

통합은 을 제거하는 것만큼 간단합니다 `IMG` 태깅하여 AEM Assets에서 복사한 포함 코드로 바꿉니다. 다음 URL에서 세 개의 원 핫스팟이 있는 페이지에서 쇼퍼블 인터랙티브 이미지를 보여 줍니다.
...
응답형 환경을 위한 쇼퍼블 대화형 이미지에 자르기를 적용하려면 대화형 이미지 구성 속성을 포함할 수 있습니다 `ZoomView.iscommand` 경로 - 여기서 `ZoomView` 는 및 를 호출할 구성 요소입니다 `iscommand` 은 적용하는 자르기 이미지 제공 명령입니다.
...
에서 이 URL을 재구성하려면 `quickViewActivate` 핸들러, `categoryId` 및 `SKU` 에서 사용할 수 있는 필드 `inData` 뷰어 코드에 의해 처리기에 전달되는 개체:
...
데모 웹 사이트에서 간단한 `loadQuickView()` 함수 호출. 이 함수는 Quickview 데이터 URL인 인수를 하나만 사용합니다. 이와 같이 쇼퍼블 대화형 이미지를 통합하는 데 필요한 마지막 단계는 다음 코드 행을 `quickViewActivate` 핸들러:
