...
[!DNL Experience Manager Assets] 구성 요소는 WCM edit clientlib의 확장을 사용합니다. clientlibs는 일반적으로 `init.jsp`.
...
일부 [!DNL Assets] 구성 요소는 [!DNL Experience Manager] 위젯 라이브러리. 콘텐츠 컨텍스트에서 제대로 렌더링하려면 추가 스타일 시트를 로드해야 합니다. 태그 작업 구성 요소에 하나 더 필요합니다.
