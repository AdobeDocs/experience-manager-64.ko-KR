...
seo-description: 변형을 사용하면 조각에 대한 컨텐츠를 작성한 다음 목적에 따라(필요한 경우) 해당 컨텐츠의 변형을 만들 수 있습니다.
...
[변형은](content-fragments.md#constituent-parts-of-a-content-fragment) 특정 채널 및/또는 시나리오에 사용할 마스터 컨텐츠의 복사본을 만들고 편집할 수 있으므로 컨텐츠 조각의 중요한 기능입니다.
...
여러 줄로 된 텍스트 필드를 편집할 때 전체 화면 편집기를 열 수 있습니다.
...
* 서식 [(](#formats) 서식[텍스트](#rich-text), [일반 텍스트](#plain-text), [마크다운)을](#markdown)선택합니다.
...
>[!NOTE]
>
>자세한 내용은 Marketing [설명서를](content-fragments-markdown.md) 참조하십시오.
...
>[!CAUTION]
>
>컨텐츠 조각에는 조상으로 유효한 언어 폴더가 있어야 합니다.사용할 언어 모델을 결정하는 데 사용됩니다.
>
...
1. 대상 단어 수를 지정하고 시작을 **[!UICONTROL 선택합니다]**.
1. 원래 텍스트는 제안된 요약과 함께 나란히 표시됩니다.
...
1. 요약을 **[!UICONTROL 선택하여]** 변경 내용을 확인합니다.
...
1. 마스터 **[!UICONTROL 또는]** 필요한 변형을 선택합니다.
1. 전체 화면 편집기를 엽니다.
1. 텍스트를 선택합니다. 주석 **[!UICONTROL 아이콘을]** 사용할 수 있게 됩니다.

   ![cfm-6420-24](assets/cfm-6420-24.png)

1. 대화 상자가 열립니다. 여기에 주석을 입력할 수 있습니다.

1. 전체 화면 편집기를 닫고 **[!UICONTROL 조각을]** 저장합니다.
...
* 선택한 조각에 대해 타임라인에서 [보고](https://helpx.adobe.com/experience-manager/6-3/assets/using/content-fragments-managing.html#timeline-for-content-fragments) 삭제할 수 있습니다.

### 조각에 자산 삽입 {#inserting-assets-into-your-fragment}

컨텐츠 조각을 작성하는 프로세스를 간소화하려면 자산( [이미지](managing-assets-touch-ui.md) )을 조각에 직접 추가할 수 있습니다.

서식과 함께 조각의 단락 시퀀스에 추가됩니다.페이지에서 [조각을](/help/sites-authoring/content-fragments.md)사용/참조할 때 서식을 지정할 수 있습니다.

>[!CAUTION]
>
>참조하는 페이지에서 이러한 자산을 이동하거나 삭제할 수 없으므로 조각 편집기에서 수행해야 합니다.
>
>그러나 자산(예: 크기)의 서식은 [페이지 편집기에서](/help/sites-authoring/content-fragments.md)수행해야 합니다. 조각 편집기의 자산 표시는 컨텐츠 플로우를 작성하기 위한 것입니다.
...
1. 선택을 **[!UICONTROL 사용하여]** 자산을 현재 위치에서 컨텐츠 조각의 단락 시스템에 추가합니다.
...
1. 사이드 **[!UICONTROL 패널의]** 아이콘 막대에서 변형을 선택합니다.
1. 변형 **[!UICONTROL 만들기를 선택합니다]**.
1. 대화 상자가 열리면 새 변형에 **[!UICONTROL 대한]** 제목 및 **[!UICONTROL 설명을]** 지정합니다.
1. 추가 **[!UICONTROL 선택]**;조각 **[!UICONTROL 마스터가]** 새 변형에 복사되며, 이 변형은 [편집을](#editing-a-variation)위해 열려 있습니다.
...
1. 필요한 변형을 선택합니다.
1. 작업 **[!UICONTROL 드롭다운에서]** 이름 **[!UICONTROL 변경을]** 선택합니다.

1. 결과 대화 상자에 **[!UICONTROL 새]** 제목 및/또는 **[!UICONTROL 설명을]** 입력합니다.
...
1. 조각을 열고 **[!UICONTROL 사이드]** 패널에서 변형을 선택합니다.
1. 필요한 변형을 선택합니다.
1. 작업 **[!UICONTROL 드롭다운에서]** 삭제를 **[!UICONTROL 선택합니다]** .

1. 대화 **[!UICONTROL 상자에서]** 삭제 작업을 확인합니다.
...
3. 마스터 및 변형은 나란히 표시됩니다.

   * 녹색은 컨텐츠가 추가되었음을 나타냅니다(변형에).
   * 빨간색은 제거된 컨텐츠(변형에서)를 나타냅니다.
   ![cfm-6420-27](assets/cfm-6420-27.png)

4. 동기화를 **[!UICONTROL 선택하면]**&#x200B;변형이 업데이트되고 표시됩니다.
