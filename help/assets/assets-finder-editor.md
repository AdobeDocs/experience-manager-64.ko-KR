...
자산 공유 페이지를 사용자 정의하려면 사이드 킥의 요소를 사용하고 쿼리 빌더 속성을 편집합니다. Geometrixx **[!UICONTROL Press Center]** 페이지는 다음 템플릿을 기반으로 한 페이지의 사용자 정의 버전입니다.

![screen_shot_2012-04-19at123048pm](assets/screen_shot_2012-04-19at123048pm.png)

디지털 자산 관리자를 통해 새 자산 공유 페이지를 만들려면:

1. 디지털 자산 관리자의 [새로 만들기] **[!UICONTROL 에서]**[새 **[!UICONTROL 자산 공유]를 선택합니다]**.
...
1. 자산 공유 페이지를 두 번 클릭하여 열고 페이지를 구성합니다.
   ...
   기본적으로 [새로 만들기]에서 [자산 공유] 페이지를 만들 **[!UICONTROL 때]**&#x200B;자동으로 [자산 뷰어] 및 [자산 편집기]가 만들어집니다.
...
1. 사용자 정의할 자산 공유 페이지에서 사이드킥에서 **[!UICONTROL 작업을]** 클릭합니다.
...
1. 사용자 정의할 자산 공유 페이지에서 검색을 **[!UICONTROL 클릭합니다]**.
...
1. 사용자 지정할 자산 공유 페이지에서 쿼리 **[!UICONTROL 빌더에서 편집을]** 클릭합니다. 기본적으로 일반 **[!UICONTROL 탭이]** 열립니다.
...
1. 쿼리 **[!UICONTROL 빌더 URL]** 필드에서 쿼리 빌더를 대체하거나 래핑하고 기존 쿼리 빌더 구성 요소로 새 서블릿 URL을 입력할 수 있습니다. 피드 **[!UICONTROL URL]** 필드에서 피드 URL을 무시할 수도 있습니다.

   ![screen_shot_2012-04-23at15313pm](assets/screen_shot_2012-04-23at15313pm.png)

1. 텍스트 **[!UICONTROL 필드에]** 결과 및 결과 페이지 번호에 표시할 텍스트를 입력합니다. 변경을 **[!UICONTROL 완료하면]** 확인을 클릭합니다.
...
자세한 내용은 [조건자 javadocs를 참조하십시오](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/search/eval/package-summary.html).
...
1. Geometrixx **[!UICONTROL 자산 편집기를]** 선택하고 만들기를 **[!UICONTROL 클릭합니다]**. 새 페이지가 만들어지고 페이지가 웹 사이트 **[!UICONTROL 탭에]** 나열됩니다.
...
자산 편집기 페이지를 사용자 정의하려면 사이드 킥의 요소를 사용합니다. Geometrixx Press Center에서 액세스하는 **[!UICONTROL 자산]** 편집기 페이지는 다음 템플릿을 기반으로 한 페이지의 사용자 정의 버전입니다.
...
1. 자산 **[!UICONTROL 편집기의 경로]** 필드에 자산 공유 페이지에서 자산을 열 자산 편집기의 경로를 입력하고 확인을 **[!UICONTROL 클릭합니다]**.
...
1. 사용자 정의할 자산 편집기 페이지의 사이드킥에서 자산 **[!UICONTROL 편집기를]** 선택합니다. 사용 가능한 모든 자산 편집기 구성 요소가 표시됩니다.
...
메타데이터 양식은 시작 및 종료 동작을 포함하는 양식입니다. 그 사이에 텍스트 **[!UICONTROL 필드를]** 입력합니다. 양식 [작업에](../sites-authoring/default-components.md) 대한 자세한 내용은 양식을 참조하십시오.

1. 양식의 시작 영역에서 **[!UICONTROL [편집]** ]을 클릭하여 시작 작업을 만듭니다. 원하는 경우 상자 제목을 입력할 수 있습니다. 기본적으로 상자 제목은 **[!UICONTROL 메타데이터입니다]**. 검증을 위해 java-script 클라이언트 코드를 생성하려면 클라이언트 유효성 검사 확인란을 선택합니다.

   ![screen_shot_2012-04-23at22911pm](assets/screen_shot_2012-04-23at22911pm.png)

1. 양식의 끝 영역에서 **[!UICONTROL [편집]** ]을 클릭하여 종료 작업을 만듭니다. 예를 들어 사용자가 메타데이터 변경 내용을 **[!UICONTROL 제출할]** 수 있도록 전송 단추를 만들 수 있습니다. 선택적으로 메타데이터를 원래 상태로 **[!UICONTROL 재설정하는]** 재설정 단추를 추가할 수 있습니다.

   ![screen_shot_2012-04-23at23138pm](assets/screen_shot_2012-04-23at23138pm.png)

1. 양식 시작과 **[!UICONTROL 양식 끝]** 사이에서 **메타데이터 텍스트 필드를**&#x200B;양식으로 드래그합니다. 사용자는 이러한 텍스트 필드에 메타데이터를 채우고 다른 작업을 제출하거나 완료할 수 있습니다.

1. 필드 이름(예: 제목) **을** 두 번 클릭하여 메타데이터 필드를 열고 변경합니다. [구성 요소 **[!UICONTROL 편집]** ] [!UICONTROL 창의 [일반] ] 탭에서 네임스페이스 및 필드 레이블뿐만 아니라 유형(예: `dc:title`)


   ![screen_shot_2012-04-23at23305pm](assets/screen_shot_2012-04-23at23305pm.png)

   메타데이터 [양식에서 사용 가능한](extending-assets.md) 네임스페이스를 수정하는 방법은 AEM 자산 사용자 지정 및 확장을 참조하십시오.

1. Click the **[!UICONTROL Constraints]** tab. 여기에서 필수 필드인지 여부를 선택하고 필요한 경우 제한 조건을 추가할 수 있습니다.
...
태그 구성 요소를 두 번 클릭하여 태그 대화 상자를 엽니다. 이 대화 상자에서 원할 경우 태그에서 제목을 변경할 수 있으며 할당된 네임스페이스를 선택할 수 있습니다. 이 필드를 편집 가능하도록 하려면 편집 **숨기기** 단추 확인란의 선택을 취소합니다. 기본적으로 태그는 편집 가능합니다.
...
축소판 구성 요소는 자산에서 선택한 축소판을 표시합니다(여러 형식의 경우 축소판이 자동으로 압축이 해제됨). 또한 구성 요소에는 파일 이름과 수정할 [수 있는](assets-finder-editor.md#adding-asset-editor-actions)작업이 표시됩니다.
...
1. 사용자 정의할 자산 편집기 페이지에서 사이드 킥에서 자산 **[!UICONTROL 편집기를]** 클릭합니다.<br>
...
## 자산 편집기 페이지를 사용하여 여러 자산 편집 {#multi-editing-assets-with-the-asset-editor-page}
...
1. 에서 Geometrixx Press **[!UICONTROL Center]** 페이지를 엽니다 `http://localhost:4502/content/geometrixx/en/company/press.html`.
1. 자산을 선택합니다.
...
1. Geometrixx Press **[!UICONTROL Center Asset Editor]** 페이지가 새 탭에 열립니다. 자산의 메타데이터는 다음과 같이 표시됩니다.

   * 일부 자산에만 적용되는 태그가 기울임꼴로 표시됩니다.
   * 모든 자산에 적용되는 태그는 일반 글꼴로 표시됩니다.
   * 태그 이외의 메타데이터:필드의 값은 선택한 모든 자산에 대해 동일한 경우에만 표시됩니다.

1. 다운로드를 **[!UICONTROL 클릭하여]** 자산 원본 표현물이 포함된 ZIP 파일을 다운로드합니다.
1. 태그 필드 옆에 있는 **[!UICONTROL 연필]** 아이콘을 클릭하여 태그를 편집합니다.
   ...
   * 태그를 `arrow` 클릭하고 태그를 선택하여 모든 자산에 새 태그를 추가합니다.
   확인을 **[!UICONTROL 클릭하여]** 양식의 변경 내용을 기록합니다. 태그 필드 옆의 **상자는** 자동으로 선택됩니다.

1. 설명 필드를 편집합니다. 예를 들어 다음과 같이 설정합니다. `This is a common description`Adobe 필드를 편집하면 양식이 제출되면 필드의 값이 선택한 자산의 기존 값을 덮어씁니다. 필드를 편집하면 필드 옆의 상자가 자동으로 선택됩니다.
