...
1. 필드 이름을 두 번 클릭합니다(예: **Title**). 메타데이터 필드를 열고 변경합니다. [!UICONTROL 구성 요소 편집] 창의 **[!UICONTROL 일반]** 탭에서 네임스페이스와 필드 레이블을 정의하고, 예를 들어 `dc:title` 유형을 정의합니다.
   ...
   메타데이터 양식에서 사용할 수 있는 네임스페이스 수정에 대한 내용은 [사용자 지정 및 확장 [!DNL Assets]](extending-assets.md)을 참조하십시오.
...
[!DNL Assets]을 사용하면 여러 자산을 한 번에 변경할 수 있습니다. 자산을 선택한 후 자산을 동시에 변경할 수 있습니다.
