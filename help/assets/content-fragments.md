...
AEM(Adobe Experience Manager) 컨텐츠 조각을 사용하면 디자인, 만들기, 조정 및 작업을 수행할 수 있습니다 [페이지에 영향을 받지 않는 컨텐츠 게시](/help/sites-authoring/content-fragments.md). 이를 통해 여러 위치/여러 채널에서 사용할 수 있는 컨텐츠를 준비할 수 있습니다.
...
* [관련 콘텐츠 사용](content-fragments-assoc-content.md) - 관련 콘텐츠 추가
...
AEM 컨텐츠 조각을 사용하여 구조화된 컨텐츠를 설명하고 관리할 수 있습니다. 구조화된 콘텐츠는 텍스트, 숫자 데이터, 부울, 날짜 및 시간 등을 포함하여 다양한 콘텐츠 유형을 포함할 수 있는 모델에서 정의됩니다.
...
* 구조화된 컨텐츠가 포함된 조각
   ...
   * 이는 [컨텐츠 조각 모델](content-fragments-models.md)- 결과 조각의 구조를 사전 정의합니다.
...
* [콘텐츠 조각 구성 요소(참조 구성 요소)를 통해 페이지 편집기](/help/sites-authoring/content-fragments.md)에서 사용됩니다.
   ...
   * **콘텐츠 조각** 구성 요소는 페이지 작성자가 사용할 수 있습니다. 따라서 페이지 작성자가 HTML 또는 JSON 형식으로 필요한 컨텐츠 조각을 참조하고 게재할 수 있습니다.
...
* 조각에 **에셋 삽입**(혼합 미디어 조각)
   ...
   * 에셋의 위치를 정의합니다.
   * 자세한 내용은 조각 편집기에서 [조각에 에셋 삽입](content-fragments-variations.md#inserting-assets-into-your-fragment)을 참조하십시오.
...
* **관련 콘텐츠**
   ...
   * 자세한 내용은 [관련 콘텐츠](content-fragments-assoc-content.md)를 참조하십시오.
...
* 페이지 편집기의 **에셋 브라우저**&#x200B;에서 사용할 수 있는 에셋
   ...
   * 자세한 내용은 [에셋 브라우저](/help/sites-authoring/author-environment-tools.md#assets-browser)를 참조하십시오.
...
* **조각 메타데이터**
   ...
   * [에셋 메타데이터 스키마](metadata.md)를 사용합니다.
...
* **변형**
   ...
   * 마스터 콘텐츠가 업데이트된 경우 변형을 마스터와 [동기화](content-fragments-variations.md#synchronizing-with-master)할 수 있습니다.
