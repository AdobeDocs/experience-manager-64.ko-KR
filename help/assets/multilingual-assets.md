...
Adobe Experience Manager(AEM) 자산을 사용하면 자산(이진, 메타데이터 및 태그 포함)의 번역 워크플로우를 자동화하여 다국어 프로젝트에서 사용할 수 있도록 다른 언어로 자산을 생성할 수 있습니다.
...
번역 서비스 공급자가 AEM과 통합할 커넥터를 제공하지 않는 경우 [대체 프로세스를 사용하십시오](/help/sites-administering/tc-manage.md#exporting-a-translation-job).
