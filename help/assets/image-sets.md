...
1. [여러 뷰에 대한 기본 이미지를 업로드합니다.](#uploading-assets-in-image-sets)
   ...
   AEM Assets는 많은 이미지 파일 포맷을 지원하지만 손실 없는 TIFF, PNG 및 EPS 이미지가 권장됩니다.
...
1. [이미지 세트 만들기를 참조하십시오.](#creating-image-sets)
   ...
   **중요** — 일괄 처리 세트는 자산 수집의 일부로 IPS(Image Production System)에 의해 생성되며 다이내믹 미디어 - Scene7 모드에서만 사용할 수 있습니다.
...
세트를 만드는 데 문제가 있는 경우, 다이내믹 미디어 문제 해결 - Scene7 [모드의 이미지 및 세트를 참조하십시오](troubleshoot-dms7.md#images-and-sets).
...
**중요:** 배치 세트는 IPS(Image Production System)에서 자산 수정의 일부로 생성되며 다이내믹 미디어 - Scene7 모드에서만 사용할 수 있습니다.
...
**중요** — 일괄 처리 세트는 자산 수집의 일부로 IPS [이미지 프로덕션 시스템에서] 생성되며 다이내믹 미디어 - Scene7 모드에서만 사용할 수 있습니다.)
