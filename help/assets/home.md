---
title: Assets 안내서
description: 이 안내서에서는 디지털 자산 만들기, 관리, 제공 및 최적화 방법과 같은 모든 [!DNL Experience Manager] 자산 작업을 다룹니다.
...
이 안내서에서는 디지털 자산 만들기, 관리, 제공 및 최적화 방법과 같은 모든 [!DNL Experience Manager] 자산 작업을 다룹니다.
...
| 사용 안내서 | 설명 |
|--- |---|
| [릴리스 정보](/help/release-notes/home.md) | 새로운 기능, 지원되는 플랫폼, 더 이상 사용되지 않거나 제거된 기능, 알려진 문제 등 [!DNL Experience Manager] 의 최신 릴리스에 대한 중요한 정보를 제공합니다. |
...
| [작성 안내서](/help/sites-authoring/home.md) | 이 안내서에서는 [!DNL Experience Manager] 의 작성 개념을 설명합니다. |
| [클래식 UI 작성 안내서](/help/sites-classic-ui-authoring/home.md) | 이 안내서에서는 클래식 사용자 인터페이스에서 [!DNL Experience Manager]의 작성 개념을 설명합니다. |
...
| [배포 사용 안내서](/help/sites-deploying/home.md) | 이 안내서에서는 [!DNL Experience Manager] 의 기본 사항을 보여줍니다. |
| [개발 사용 안내서](/help/sites-developing/home.md) | [!DNL Experience Manager] 인스턴스를 빌드하는 방법을 알아봅니다. |
| [관리 사용 안내서](/help/managing/home.md) | 이 안내서에서는 [!DNL Experience Manager] 프로젝트를 성공적으로 관리하는 방법을 설명합니다. |
