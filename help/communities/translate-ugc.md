...
* 프랑스의 한 회원이 여러 국가의 요리 웹사이트에서 프랑스어로 된 요리법을 커뮤니티 포럼에 게시했다
* 일본의 또 다른 멤버는 번역기능을 사용하여 프랑스어를 일본어로 번역하는 방법을 고안했다
* 일제의 요리법을 읽은 뒤, 일본의 한 회원이 일본어로 댓글을 올렸다
* 프랑스 출신 A씨는 번역을 통해 일본어 표현을 프랑스어로 번역한다
* 글로벌 커뮤니케이션!
...
* **[!UICONTROL 상위 구성]**(필수) 일반적으로 기본값으로 남습니다. 기본값은 
