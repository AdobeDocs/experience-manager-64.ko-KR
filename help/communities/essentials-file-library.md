...
# 파일 라이브러리 필수 사항 {#file-library-essentials}
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td>자세한 내용은 <a href="file-library.md">파일 라이브러리 기능</a></td> 
  </tr>
 </tbody>
</table>
...
다음을 포함하는 커뮤니티 사이트 구조 [파일 라이브러리 함수](functions.md#file-library-function), 구성된 포함 `file library` 구성 요소.
