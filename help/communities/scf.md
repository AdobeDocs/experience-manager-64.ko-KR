...
이 프레임워크는 풍부하고 대화형 구성 요소의 개발을 용이하게 하기 위한 모델 보기 JavaScript 프레임워크인 [Background.js](https://www.backbonejs.org/)의 확장을 포함합니다. 객체 지향 특성은 확장/재사용 가능한 프레임워크를 지원합니다. 클라이언트와 서버 간의 통신은 HTTP API를 통해 단순화됩니다.
