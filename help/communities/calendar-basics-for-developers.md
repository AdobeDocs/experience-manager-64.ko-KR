...
[달력 함수](functions.md#calendar-function)를 포함하는 커뮤니티 사이트 구조에는 구성된 c `alendar`구성 요소가 있습니다. 달력 함수는 [권한이 있는 구성원 사용자 그룹](users.md#privileged-members-group)을 식별하는 것을 지원합니다.
