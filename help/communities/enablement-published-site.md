...
두 학습자의 활동, 중재 콘솔에 액세스할 수 있는 `Riley Taylor` 링크 `Sidney Croft. By s`를 선택한 경우, 퀸은 `Administration`벌크 중재 콘솔을 사용하여 게시물을 중재할 [](moderation.md) 수 있습니다.
