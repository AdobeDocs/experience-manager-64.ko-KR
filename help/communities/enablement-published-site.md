...
즉, 두 학습자 `Riley Taylor` 및 `Sidney Croft. By s`이`Administration`링크를 선택하여 중재 콘솔에 액세스한 경우, Quinn은 [대량 조정 콘솔](moderation.md)을 사용하여 게시물을 중재할 수 있습니다.
...
**커뮤니티, [보고서 콘솔](reports.md)**&#x200B;로 이동하고 다음에 따라 보고서를 생성합니다
...
* 작성자 시
* 관리 권한으로 로그인
* 기본 메뉴에서 **[!UICONTROL 커뮤니티 > 리소스]**&#x200B;로 이동합니다.
...
* 작성자 시
* 관리 권한으로 로그인
* **[!UICONTROL 커뮤니티 > 보고서 > 지정 보고서]**&#x200B;로 이동합니다.
