...
즉, `Riley Taylor` 및 `Sidney Croft. By s`링크를 선택하여 중재 콘솔에 액세스한 두 명의 학습자가 작업을 수행하는 경우, 퀸은 [일괄 중재 콘솔](moderation.md)을 사용하여 게시물을 중재할 수 있습니다.`Administration`
...
* 작성자
* 관리자 권한으로 로그인
* 주 메뉴에서 **[!UICONTROL 커뮤니티 > 리소스]**&#x200B;로 이동합니다.
* `Enablement Tutorial` 사이트 선택
* 모든 리소스의 요약을 보려면 `Report`아이콘 선택
...
* 작성자
* 관리자 권한으로 로그인
* **[!UICONTROL 커뮤니티 > 보고서 > 할당 보고서]**&#x200B;로 이동합니다.
...
* 작성자
* 관리자 권한으로 로그인
* **[!UICONTROL 커뮤니티 > 보고서 > 보기 보고서]**&#x200B;로 이동합니다.
* 풀다운 메뉴에서 **[!UICONTROL 사이트]**&#x200B;를 선택합니다( `Enablement Tutorial` 선택).

* **[!UICONTROL 콘텐트 유형]** 선택(`all` 선택)

* **[!UICONTROL 날짜 범위]** 선택(`Last 7 days` 선택)
