...
* AEM 플랫폼용 내장 솔러는 MSRP에 사용되지 않습니다.
* AEM 플랫폼용 원격 솔루션을 사용하는 경우 MSRP와 공유할 수 있지만 다른 컬렉션을 사용해야 합니다
* 표준 검색 또는 MLS(다국어 검색)용으로 솔루션 구성 가능
...
사용자 지정 속성을 추가할 때 [UGC 검색 API로 만든 정렬 및 검색에 이러한 속성을 표시하려면 속성 이름에 접미사를 추가해야](#ugc-search-api)합니다. *가 필요합니다.
...
* [커뮤니티 콘텐츠 저장소](working-with-srp.md) - UGC 공용 저장소에 대해 사용 가능한 SRP 선택 사항에 대해 설명합니다.
