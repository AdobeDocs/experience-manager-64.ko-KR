...
>[!CAUTION]
>
>**scf-js-&amp;ast;** 접두사가 있는 모든 CSS 클래스 이름은 Javascript 코드에서 사용할 수 있습니다. 이러한 클래스는 구성 요소의 상태에 영향을 주며(예: 숨김에서 가시기로 전환) 무시하거나 제거할 수 없습니다.
>
>scf-js-&amp;ast;클래스는 스타일에 영향을 주지 않으며, 클래스 이름은 요소의 상태를 제어하므로 부작용이 있을 수 있는 경고가 있는 스타일시트에서 사용할 수 있습니다.
...
* /etc/clientlibs/social/hbs/&lt;구성 요소 이름>
...
* /libs/social/&lt;기능>/components/hbs/&lt;구성 요소 이름>/clientlibs
