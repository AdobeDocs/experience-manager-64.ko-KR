...
게시 인스턴스의 안내서를 사용하는 경우 구성 요소 및 기능을 사이트 방문자(로그인하지 않음)로서 그리고 로그인할 때 다양한 권한이 있는 구성원으로 체험할 수 있습니다.

>[!NOTE]
>
>SRP의 기본값이 [JSRP로](jsrp.md)남아 있는 경우 게시 인스턴스에 입력된 UGC는 게시에만 표시되며 작성자 인스턴스의 [중재](moderate-ugc.md) 콘솔에서는 표시되지 *않습니다.
