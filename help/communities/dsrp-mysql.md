...
[MySQL](https://dev.mysql.com/downloads/mysql/) 대상 OS에 대한 지침에 따라 다운로드하여 설치해야 합니다.
...
1. 대화 상자에서 `Setup New Connection`에 플랫폼에 적합한 값을 입력합니다
...
* 다음 값을 입력합니다.
   ...
   * **[!UICONTROL 데이터 소스 이름]**: 에 입력한 이름 [MySQL 연결](#new-connection-settings)예: &#39;communities&#39;
