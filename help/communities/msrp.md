...
동물원은 Ensemble의 경우 *host1:2181,host2:2181*&#x200B;과 같이 쉼표로 구분된 `HOST:PORT` 값을 입력합니다.
...
>[!NOTE]
>
>[노드 저장소 또는 데이터(이진)에 사용되는 데이터베이스 이름으로 기본적으로 이름 `communities`인 mongoDB 데이터베이스를 설정하지 않아야 합니다](../../help/sites-deploying/data-store-config.md). AEM 6](../../help/sites-deploying/storage-elements-in-aem-6.md)의 [스토리지 요소도 참조하십시오.
...
오류를 해결하려면 [표준 MLS 설치](solr.md#installing-standard-mls)에 대한 지침을 따르는 경우
...
1. [https://search.maven.org/#artifactdetails%7Corg.mongodb%7Cmongo-java-driver%7C2.13.2%7Cjar](https://search.maven.org/#artifactdetails%7Corg.mongodb%7Cmongo-java-driver%7C2.13.2%7Cjar)에서 드라이버를 다운로드합니다(버전 2.13.2 이상).
