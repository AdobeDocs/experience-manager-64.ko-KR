...
사이트 [템플릿 단계에서](sites-console.md#step2013asitetemplate)제목, 설명, URL의 이름을 입력하고 커뮤니티 사이트 템플릿을 선택합니다. 예:
...
* **[!UICONTROL 클라우드 구성]**: (클라우드 구성이 지정되지 않은 경우 비워 두십시오) 지정된 클라우드 구성의 경로를 제공하십시오.
...
* **[!UICONTROL 템플릿]**: 아래로 끌다 `Reference Site`
...
설정 단계에서 선택하기 전에 사용자 관리, 태깅, 중재, 그룹 관리, 분석, 번역 및 활성화와 관련된 구성에 대한 액세스를 제공하는 7개의 섹션이 있음을 알 수 있습니다. `Next`

[ [AEM Communities을 위한 시작하기] 자습서를](getting-started-enablement.md) 방문하여 활성화 기능을 사용한 작업을 경험하십시오.

#### USER MANAGEMENT {#user-management}

사용자 관리의 모든 [확인란 선택](sites-console.md#user-management)
...
>[!NOTE]
>
>제작 환경의 경우 사용자 지정 Facebook 및 Twitter 애플리케이션을 만들어야 합니다. Facebook 및 [Twitter로 소셜 로그인을 참조하십시오](social-login.md).

![createsitesettings](assets/createsitesettings.png)

#### TAGGING {#tagging}

커뮤니티 컨텐츠에 적용할 수 있는 태그는 이전에 [Tagging Console](../../help/sites-administering/tags.md#tagging-console) (예: [Tutorial 네임스페이스)을 통해 정의된 AEM 네임스페이스를 선택하여 제어합니다](setup.md#create-tutorial-tags).
...
>[!NOTE]
>
>[터널 서비스를](https://helpx.adobe.com/experience-manager/6-3/communities/using/deploy-communities.html#tunnel-service-on-author) 통해 게시 환경에만 존재하는 구성원 및 그룹을 선택할 수 있습니다.

![community_roles-1](assets/community_roles-1.png)

#### MODERATION {#moderation}

UGC(사용자 생성 콘텐츠)를 [중재하기](sites-console.md#moderation) 위한 기본 전역 설정을 적용합니다.
...
번역 [설정은](sites-console.md#translation) 사이트의 기본 언어 및 UGC를 번역할지 여부와 언어(있는 경우)를 지정합니다.
...
활성 커뮤니티를 빠르게 만들기 위한 유사한 자습서를 보려면 [AEM Communities](overview.md#enablement-community)지원 [시작하기를 참조하십시오](getting-started-enablement.md).
...
* **사이트 게시**&#x200B;커뮤니티 사이트를 게시하려면 월드 아이콘을 선택합니다(예: 로컬 컴퓨터에서 게시 서버가 실행 중인 경우 기본적으로 localhost:4503으로).
...
>1. 설정 **[!UICONTROL 옆에]** 있는 **[!UICONTROL 편집]**
...
>
>1. 확인 **[!UICONTROL 선택]**
>1. (선택 사항) 복제 큐 `Clear` 를 선택하거나 `Force Retry` 재설정합니다.
...
Aaron [](tutorials.md#demo-users) McDonald가
