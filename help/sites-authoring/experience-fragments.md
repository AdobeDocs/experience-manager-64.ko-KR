...
* Omnichannel Commerce를 사용하는 경우
   ...
   * 광범위한 소셜 미디어 채널에서 전자 상거래 관련 컨텐츠 공유
   * 터치포인트를 거래와 관련시키기
...
다음 예는 에 따라 구조화된 경험 조각을 보여줍니다 `Contributors`. 사용된 구조는 다중 사이트 관리(언어 사본 포함)와 같은 다른 기능을 사용할 수 있는 방법도 보여줍니다.

>[!CAUTION]
>
>다음 스크린샷은 Adobe Experience Manager를 클라우드 서비스로 사용하여 WKND 사이트에서 촬영되었습니다.

![경험 조각에 대한 폴더](assets/xf-folders.png)
...
>[!NOTE]
>
>업그레이드 시 값을 덮어쓰지 않으므로 허용된 **[!UICONTROL 템플릿을]**&#x200B;지정하는 데 권장되는 방법입니다.

1. 필수 **[!UICONTROL 경험 조각]** 폴더로 이동합니다.

1. 폴더를 선택한 다음 속성을 **[!UICONTROL 선택합니다]**.

1. 허용된 템플릿 필드에서 필요한 템플릿을 검색할 정규 **[!UICONTROL 표현식을 지정합니다]** .
...
1. 저장 **[!UICONTROL 및 닫기를 선택합니다]**.

### 인스턴스에 대해 허용되는 템플릿 구성 {#configure-allowed-templates-instance}

>[!CAUTION]
>
>지정된 템플릿은 업그레이드 시 **[!UICONTROL 덮어쓸 수 있으므로 이]** 방법으로 허용된 템플릿을 변경하지 않는 것이 좋습니다.
>
...
1. 필요한 폴더로 이동하고 만들기를 **[!UICONTROL 선택합니다]**.

1. 경험 **[!UICONTROL 조각을]** 선택하여 경험 조각 **[!UICONTROL 만들기 마법사를]** 엽니다.
...
1. 경험 조각에 대한 **[!UICONTROL 속성]**&#x200B;을 입력합니다.
...
1. 편집할 페이지를 엽니다.
   ...
   예: [http://localhost:4502/editor.html/content/we-retail/language-masters/kr/products/men.html](http://localhost:4502/editor.html/content/we-retail/language-masters/en/products/men.html)
...
이 기능은 브라우저에서 사용할 수 있지만, 주요 목적은 다른 애플리케이션(예: 타사 웹 앱, 사용자 정의 모바일 구현)이 URL만 사용하여 경험 조각의 컨텐츠에 직접 액세스할 수 있도록 하는 것입니다.
...
>[!NOTE]
>
>링크는 항상 게시 인스턴스를 참조합니다. 이러한 링크는 제3자가 소비하기 위한 것이므로 작성자가 아니라 항상 게시 인스턴스에서 호출됩니다.
