...
**편집**&#x200B;을 클릭하여 구성 요소를 구성합니다. 이 섹션에 설명된 설정을 구성할 수 있습니다. 이 Dynamic Media Classic(이전 Scene7) 이미지 템플릿은 다음과 같이 자세히 설명합니다. [Scene7 이미지 템플릿 구성 요소](/help/assets/scene7.md#image-template).
