...
활동 콘솔을 사용하면 마케팅을 만들고, 구성하고, 관리할 수 있습니다 [활동](/help/sites-authoring/personalization.md#activities) 브랜드:
...
활동 콘솔에서 활동은 브랜드별로 구성됩니다. 브랜드 및 폴더를 사용하여 활동 조직을 구성할 수 있습니다. 탭/클릭하여 활동 콘솔로 이동합니다 **개인화** 탭/클릭 **활동**.
...
1. 활동 콘솔에서 을(를) 클릭하거나 탭합니다 **만들기**&#x200B;그런 다음&#x200B;**브랜드 만들기**.
...
>
>하지만 콘솔에서 기존 Adobe Target 활동을 편집할 수 있습니다.
...
1. 다음 정보를 제공한 후 **다음**&#x200B;을 클릭하거나 탭합니다.
   ...
   * 활동의 이름입니다.
   * 사용할 타겟팅 엔진. ContextHub(AEM)이 기본적으로 선택되어 있습니다. Adobe Target을 사용해야 한다면 타겟팅된 콘텐츠 편집기에서 활동을 만드십시오.
   * 타겟팅 엔진으로 Adobe Target을 선택했다면 Adobe Target에 연결하는 데 사용할 클라우드 구성을 선택/편집하십시오. (클라우드 구성을 위해 만든 프레임워크를 선택하지 않도록 주의하십시오.)
...
1. Adobe Target을 타겟팅 엔진으로 사용하는 경우 이 활동에서 측정할 사항을 선택합니다. 사용 가능한 성공 지표에 대한 자세한 내용은 [활동 및 설정 목표 구성](/help/sites-authoring/content-targeting-touch.md)을 참조하십시오. 목표를 하나 이상 선택해야 합니다.
1. 클릭 또는 탭 **저장**.

   >[!NOTE]
   >
   >활동을 만든 후 사용할 수 있도록 게시해야 합니다.

## 활동 게시 및 게시 취소 {#publishing-and-unpublishing-activities}

활동을 게시하여 사용 가능하게 해야 합니다. 반대로 활동의 게시를 취소하여 활동을 사용할 수 없게 할 수 있습니다.
...
1. 브랜드를 클릭하거나 탭한 다음, 게시하거나 게시를 취소하려는 활동이 포함된 영역을 클릭합니다.
1. 게시 또는 게시 취소하려는 활동 또는 활동 옆에 있는 아이콘을 탭하거나 클릭합니다.

   ![screen_shot_2018-03-21at151925](assets/screen_shot_2018-03-21at151925.png)

1. 게시하려면 을(를) 탭하거나 클릭합니다 **게시**. 게시를 취소하려면 을(를) 탭하거나 클릭합니다 **게시 취소**. 활동이나 활동이 게시되거나 게시 취소되고 활동 콘솔에서 해당 상태가 변경됩니다(새로 고침이 필요할 수 있음).

## 작성 및 게시 인스턴스의 활동 {#activities-on-author-and-publish-instances}

Adobe Target 타겟팅 엔진을 사용하는 활동이 활성화되면 게시 인스턴스에서 두 번째 활동이 만들어집니다.

* 작성 인스턴스의 활동은 작성 인스턴스의 활동을 추적하며 방문자 경험을 시뮬레이션하는 데 유용합니다. 이 활동에 대해 기록된 분석은 작성 인스턴스에서 발생하는 사항만 반영합니다.
* 게시 인스턴스의 활동은 게시 서버의 활동을 반영하고 게시 서버의 활동에 응답합니다. 공개 웹 사이트에서 실행되는 활동입니다. 게시 활동만 실제 공개 사이트의 사용 추적 및 분석과 관련이 있습니다.

## 성능 보기 및 우승 경험 변환(A/B 테스트) {#viewing-performance-and-converting-winning-experiences-a-b-test}
...
1. ****&#x200B;우승자 푸시 링크를 클릭하거나 탭하여 해당 경험을 기본 경험으로 푸시합니다.
   ...
   * 모든 페이지가 수정되고 타겟팅된 콘텐츠가 우승 경험의 실제 콘텐츠로 교체됩니다. 우승 경험의 콘텐츠는 타겟팅되지 **않고** 일반 페이지의 일부가 됩니다.
   ...
   우승 경험은 보고서에서 더 많은 리프트를 생성하는 경험이며, 전환율을 기반으로 합니다.
...
Adobe Target 타겟팅 엔진을 사용하는 활동은 Adobe Target 캠페인과 동기화됩니다. 다음 조건이 충족되면 활동이 Adobe Target에 자동으로 동기화됩니다.
...
* 게시 인스턴스의 활동은 해당 Adobe Target 캠페인과 동일한 이름을 갖습니다.
* 작성 인스턴스의 활동은 `_author` 접미사를 사용하는 동일한 이름의 Target 캠페인에 해당합니다.

![chlimage_1-241](assets/chlimage_1-241.png)

활동이 수정되면 바로 _author 활동이 동기화됩니다. 즉각적인 동기화를 통해 Client Context 또는 ContextHub를 사용한 활동 시뮬레이션을 사용할 수 있습니다.
...
1. 다른 AEM 인스턴스에서는 동일한 브랜드 아래에 동일한 이름을 사용하여 활동이 만들어집니다. 이 활동의 동기화를 시도하면 실패합니다.

이러한 상황은 다음 경우에도 발생할 수 있습니다.

1. 활동이 생성되고 Adobe Target과 동기화됩니다. 그런 다음 활동이 AEM에서 삭제됩니다.
1. 활동은 동일한 브랜드 아래에 만들어지고 삭제된 활동과 동일한 이름을 사용하여 만들어집니다. 이 활동의 동기화를 시도하면 실패합니다.
