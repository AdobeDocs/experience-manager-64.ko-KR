...
>[!NOTE]
>
>이 섹션에서는 다양한 버전의 AEM에서 사용할 수 있고 표준 AEM 설치에서 기본적으로 사용할 수 있는 기초 구성 요소에 대해 설명합니다. 그러나 많은 기초 구성 요소가 AEM 6.4에서 더 이상 사용되지 않습니다.
>
...
기초 구성 요소를 사용할 수 있지만, 더 많은 확장성과 유연성을 제공하는 핵심 구성 요소로 대체되었습니다.
...
>[!CAUTION]
>이 기초 구성 요소는 더 이상 사용되지 않습니다. Adobe는 [코어 구성 요소](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=ko)를 대신 활용할 것을 권장합니다.
...
* **목록**
   ...
   * **목록 작성 방법**
      ...
      어떤 방법을 선택하든 목록에 포함된 각 페이지에는 이미지가 이미 연결되어 있어야 합니다. 회전판에 표시될 이 이미지입니다. 해당 페이지의 속성 아래에 지정된 페이지에 대한 이미지가 없는 경우 작업을 시작하기 전에 페이지에 이미지를 연결해야 합니다. 그러지 않으면 회전판에 비어 있거나 대부분이 비어 있는 페이지가 표시됩니다. 자세한 내용은 [페이지 속성 편집](/help/sites-authoring/editing-page-properties.md).
...
>[!NOTE]
>
>다음 **표** 구성 요소는 [리치 텍스트 편집기](/help/sites-authoring/rich-text-editor.md), 그대로 **[텍스트](#text)** 구성 요소.
>
...
>[!NOTE]
>
>다음 **텍스트** 구성 요소는 [리치 텍스트 편집기](/help/sites-authoring/rich-text-editor.md), 그대로 **[표](#table)** 구성 요소.
>
>을 사용하는 것이 좋습니다 **표** 구성 요소를 사용하여 구성할 수도 있지만 **텍스트** 구성 요소.
...
* 비디오
   ...
   * **크기**
      ...
      크기 옆의 상자에 비디오의 원래 크기(픽셀 단위 폭 x 높이)가 나타납니다(위 그림 참조). 비디오의 기본 차원을 재정의하려면 여기에 너비와 높이 차원을 수동으로 입력합니다. 클릭 **확인** 대화 상자를 닫습니다.
...
다음 예는 사용 중인 2열 구성 요소를 보여줍니다. 새 구성 요소에 대한 자리 표시자를 사용할 수 있습니다.
...
>[!NOTE]
>
>기초 구성 요소 양식 구성 요소는 다른 기초 구성 요소 양식 구성 요소(단추, 텍스트, 숨김 등)의 사용만 지원합니다. 기초 구성 요소 양식 없이 [코어 구성 요소](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=ko) 양식 구성 요소를 사용할 수 없으며, 반대의 경우도 마찬가지입니다.
