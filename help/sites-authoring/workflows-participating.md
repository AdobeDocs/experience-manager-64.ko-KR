...
워크플로는 일반적으로 페이지나 에셋에 대해 사람이 활동을 수행해야 하는 단계를 포함합니다. 워크플로는 활동을 수행할 사용자 또는 그룹을 선택하고 해당 개인 또는 그룹에 작업 항목을 지정합니다. 사용자는 알림을 받은 다음, 적절한 작업을 수행할 수 있습니다.
...
이 작업에서 다음을 표시할 수 있습니다.

* **다음 단계**: 다음 단계; 제공된 목록에서 선택할 수 있습니다
* **댓글**: 필요한 경우
...
* when [워크플로우 항목을 열어 세부 사항 보기](#opening-a-workflow-item-to-view-details-and-take-actions).

#### 참가자 단계 완료 - 받은 편지함 {#completing-a-participant-step-inbox}

다음 절차를 사용하여 작업 항목을 완료합니다.

1. **[AEM 받은 편지함](/help/sites-authoring/inbox.md)**&#x200B;을 엽니다.
1. 작업을 수행할 워크플로 항목을 선택합니다(썸네일 탭/클릭).
1. 도구 모음에서 **완료**&#x200B;를 선택합니다.
1. **작업 항목 완료** 대화 상자가 열립니다. 드롭다운 선택기에서 **다음 단계**&#x200B;를 선택한 다음 필요한 경우 **주석**&#x200B;을 추가합니다.
...
1. 를 엽니다. [편집할 페이지](/help/sites-authoring/managing-pages.md#opening-a-page-for-editing).
...
1. 경고 배너를 클릭/탭하여 사용 가능한 작업을 표시합니다. 선택 **고급**:
...
* **사용자**: 위임하려는 사용자; 제공된 목록에서 선택할 수 있습니다
* **댓글**: 필요한 경우
...
1. 대화 상자가 열립니다. 드롭다운 선택기에서 **사용자**(또는 그룹)를 지정한 다음 필요한 경우 **주석**&#x200B;을 추가합니다.
1. **확인**&#x200B;을 사용하여 단계를 완료합니다(또는 **취소**&#x200B;를 사용하여 작업 취소).
...
타임라인을 사용하여 단계를 위임 및/또는 할당할 수도 있습니다.

1. 필요한 페이지를 선택한 다음 **타임라인**&#x200B;을 엽니다(또는 **타임라인**&#x200B;을 연 다음 페이지 선택).
1. 경고 배너를 클릭/탭하여 사용 가능한 작업을 표시합니다. 선택 **할당자 변경**:
...
* **이전 단계**: 돌아올 단계; 제공된 목록에서 선택할 수 있습니다
* **댓글**: 필요한 경우

다음 중 하나에서 참가자 단계에서 뒤로 이동할 수 있습니다.
...
1. 필요한 페이지를 선택한 다음 **타임라인**&#x200B;을 엽니다(또는 **타임라인**&#x200B;을 연 다음 페이지 선택).
1. 경고 배너를 클릭/탭하여 사용 가능한 작업을 표시합니다. 선택 **롤백**:
...
* **워크플로우 정보**
   ...
   If [워크플로우 단계](/help/sites-developing/workflows.md#workflow-stages) 모델에 대해 구성되었으므로 다음 단계에 따라 진행 상황을 볼 수 있습니다.
...
1. 필요할 경우 적절한 작업을 선택하고 세부 정보를 제공한 후 **확인**&#x200B;을 클릭합니다(확인하지 않으려면 **취소** 클릭).
...
워크플로 인스턴스와 연결된 페이로드에 대한 세부 사항을 볼 수 있습니다. 처음에 패키지의 리소스가 표시된 다음 드릴다운하여 개별 페이지를 표시할 수 있습니다.
...
1. 도구 모음에서 **페이로드 보기**&#x200B;를 선택하여 대화 상자를 엽니다.
   ...
   워크플로 패키지는 단순히 저장소 내 경로에 대한 포인터 컬렉션이므로 여기에 항목을 추가/제거/수정하여 워크플로 패키지에서 참조되는 내용을 조정할 수 있습니다. 를 사용하십시오 **리소스 정의** 구성 요소를 사용하여 새 항목을 추가할 수 있습니다.
