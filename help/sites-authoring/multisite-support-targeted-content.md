...
마케터는 유럽 지역에 이러한 변경 사항을 롤아웃하려 할 것이고 **페이지 롤아웃**&#x200B;을 탭하거나 클릭하여 [Live Copy를 롤아웃](/help/sites-administering/msm-livecopy.md)합니다. 탭을 새로 고치면 유럽 영역이 마스터 영역에서 상속을 받으므로(롤아웃 후) 영국 사이트에 새 이미지가 사용됩니다.
