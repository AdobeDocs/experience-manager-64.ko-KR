...
두 환경은 상호 작용하여 컨텐츠를 방문자가 읽을 수 있도록 웹 사이트에서 사용할 수 있도록 만들어 줍니다.
...
작성 환경에서는 두 개의 UI를 통해 AEM 기능을 사용할 수 있도록 되어 있습니다. 게시 환경의 경우 사용자가 사용할 수 있도록 만들어진 인터페이스의 전체 모양 및 느낌을 디자인합니다.

## 작성 환경 {#author-environment}

작성자는 **[작성 환경](/help/sites-authoring/home.md)**&#x200B;에서 작업합니다. 이 환경은 콘텐츠 작성에 적합한 사용하기 쉬운 인터페이스(그래픽 사용자 인터페이스(GUI 또는 UI))를 제공합니다. 완전한 보호 기능을 제공하고 작성자가 적절한 액세스 권한이 지정된 계정을 사용하여 로그인해야 하는 회사 방화벽 뒤에 일반적으로 위치합니다.
...
* 변경 사항 관리 방식을 제어하는 워크플로우 예. 게시 전 검토 실행
* 개별 작업을 편성하는 프로젝트
...
일반적으로 게시 환경은 비무장 지대 안에 있습니다. 즉, 인터넷에 연결되지만 내부 네트워크의 보호 아래 사용되지 않습니다.
...
>[!NOTE]
>
>안타깝게도 사용된 용어에 겹치는 경우가 있습니다. 이 문제는 다음 경우에 발생할 수 있습니다.
>
>* **게시/게시 취소**
   >  이 용어는 콘텐츠를 게시 환경에서 공개적으로 사용할 수 있도록(또는 사용할 수 없도록) 하는 작업을 위한 기본 용어입니다.
>
>* **활성화/비활성화**
   >  게시/게시 취소와 동의어입니다. 클래식 UI에서 더 일반적입니다.
>
>* **복제**
