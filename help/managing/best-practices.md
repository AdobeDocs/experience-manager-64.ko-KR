...
* [checklist](/help/managing/best-practices-checklist.md)에 직접 기반을 두고 다음 내용을 자세히 설명하는 설명서입니다.
   ...
   * [프로젝트 ](#project-heartbeat-dashboard) 하트비트분석.
...
**역할별 상태** 워크시트는 **[Phase](#phases-and-milestones)** 및 **[Persona](#persona)**&#x200B;의 **[상태, 품질 및 완전성](#project-heartbeat-dashboard)**&#x200B;의 세부 분류를 보여줍니다.
