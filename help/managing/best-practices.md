...
* 문서(체크리스트 [에 따라](/help/managing/best-practices-checklist.md),
   ...
   * [프로젝트 하트비트](#project-heartbeat-dashboard) 분석.
...
* **위상 상태**
   ...
   * 프로젝트의 고급 상태 표시기 위험에 있는 영역을 강조 표시하는 데 유용합니다.
...
역할별 **상태** 워크시트는 **[위상](#project-heartbeat-dashboard)**및 페르소나를**[&#x200B;기준으로 상태, 품질 및 완전성](#phases-and-milestones)** 의 세부 **[분류를](#persona)**보여줍니다.
...
* **시스템 아키텍처**
   ...
   * 각 환경에 적합한 서버 기술 [요구 사항](/help/sites-deploying/technical-requirements.md) 및 [하드웨어 크기 조정 지침을 참조하십시오.](/help/managing/hardware-sizing-guidelines.md)
   * 각 환경에 대한 프로세스 예: 배포 및 유지 관리 요구 사항
...
* **시스템 통합**
   ...
   * 타사 시스템을 통합하는 방법 타사 시스템이 다운된 경우 오프라인/온라인, 클라이언트측/브라우저 측 또는 폴러버 처리와 같은 특별한 고려 사항과 함께
...
* **테스트 개념**
   ...
   * 이러한 테스트에 필요한 컨텐츠 준비
   * 사용할 테스트 도구 정보
   * 테스트에 참여할 사람의 높은 표시 특히 QA 팀 외부의 그룹
   * 테스트 자동화 세부 사항 예를 들어 Selenium 또는 AEM Developer 모드 사용
...
* **권한**
   ...
   * 게시 환경에 영향을 주는 권한 사용 정의 예를 들면 `replicate`
...
* **프로덕션 시스템**
   ...
   * 성능 테스트 요구 사항 품질 보증 [모범 사례 보기](/help/sites-deploying/configuring-performance.md#best-practices-for-quality-assurance)
...
* 하드웨어 기반 보안 개념에 대한 보안 개념, 보안 작업 및 권장 사항 제공 영역 및 방화벽 등
...
* AEM 설명서
   ...
   * AEM 개념:
      ...
      * [HTML 템플릿 언어(HTL)](https://helpx.adobe.com/experience-manager/htl/user-guide.html)
