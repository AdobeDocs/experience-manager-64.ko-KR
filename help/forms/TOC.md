...
+ 시작하기 {#getting-started}
   ...
   + 자습서:첫 번째 대화형 통신 만들기 {#create-first-interactive-communication}
      ...
      + [자습서:인터랙티브 커뮤니케이션 만들기](using/create-interactive-communication-tutorial.md)
...
+ AEM Forms {#install-aem-forms} 설치 및 구성
   ...
   + JEE에 AEM Forms 설치 {#jee-installation}
      ...
      + [AEM Forms 설치 준비(단일 서버)](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_64)
...
+ AEM Forms {#upgrade-aem-forms} 업그레이드
   ...
   + OSGi {#aem-forms-osgi-upgrade}에서 AEM Forms 업그레이드
      + [OSGi 기반의 AEM 6.4 양식으로 업그레이드](using/upgrade-forms-osgi.md)
   ...
   + JEE {#aem-forms-jee-upgrade}에서 AEM Forms 업그레이드
      ...
      + [Adobe Experience Manager Forms on JEE 업그레이드 확인 목록 및 계획](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      ...
      + [JBoss용 JEE 기반의 Adobe Experience Manager Forms으로 LiveCycle ES4 SP1에서 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-jboss-livecycle.pdf)
      + [JBoss 턴키용 JEE의 AEM Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      + [JBoss 턴키용 JEE의 LiveCycle ES4 SP1에서 Adobe Experience Manager Forms으로 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
      ...
      + [WebSphere용 JEE 기반의 Adobe Experience Manager Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [WebSphere용 JEE 기반의 Adobe Experience Manager Forms으로 LiveCycle ES4 SP1에서 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-websphere-livecycle.pdf)
...
+ 개발자 참조 {#developer-reference}
   ...
   + [적응형 Forms용 JavaScript 라이브러리 API 참조](https://helpx.adobe.com/experience-manager/6-4/forms/javascript-api/index.html)
