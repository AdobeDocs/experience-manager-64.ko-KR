...
+ 릴리스 노트 {#release-notes-new-features}
   ...
   + [더 이상 사용되지 않는 기능](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/deprecated-removed-features.html)
+ 시작하기 {#getting-started}
   ...
   + 자습서:간단한 적응형 양식 만들기 {#create-first-adaptive-form}
      ...
      + [자습서:광고 양식 스타일 지정](using/style-your-adaptive-form.md)
   + 자습서:간단한 인터랙티브한 커뮤니케이션 제작 {#create-first-interactive-communication}
...
+ AEM Forms 설치 및 구성 {#install-aem-forms}
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [JEE에 AEM Forms 설치 및 배포](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      + [JEE for WebLogic에 AEM Forms 설치 및 배포](http://www.adobe.com/go/learn_aemforms_installWebLogic_64)
      + [JEE for WebSphere에 AEM Forms 설치 및 배포](http://www.adobe.com/go/learn_aemforms_installWebSphere_64)
...
+ AEM Forms 업그레이드 {#upgrade-aem-forms}
   ...
   + JEE에서 AEM Forms 업그레이드 {#aem-forms-jee-upgrade}
      ...
      + [업그레이드 검사 목록 및 계획](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [JEE에서 AEM 6.4 양식으로 업그레이드](using/upgrade-forms-jee.md)
      + [JEE for JBoss의 AEM Forms 릴리스에서 AEM 6.4 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      + [LiveCycle ES4 SP1에서 JEE용 Adobe Experience Manager Forms로 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-jboss-livecycle.pdf)
      + [JEE에서 JBoss 턴키용 AEM Forms 릴리스에서 AEM 6.4 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      + [LiveCycle ES4 SP1에서 JEE의 AEM Forms for JBoss Turnkey로 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
      + [AEM Forms 릴리스에서 WebLogic용 JEE의 AEM 6.4 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      + [LiveCycle ES4 SP1에서 WebLogic용 JEE의 AEM Forms로 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-weblogic-livecycle.pdf)
      + [AEM Forms 릴리스에서 WebSphere용 JEE의 AEM 6.4 Forms로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [LiveCycle ES4 SP1에서 WebSphere용 JEE의 AEM Forms로 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
+ AEM Forms 관리 {#manage-administer-aem-forms}
   + [OSGi 그룹 및 권한에 대한 AEM Forms](using/forms-groups-privileges-tasks.md)
   + [새 폴더를 만들어 양식을 분류합니다.](using/creating-new-folders-categorize-forms.md)
...
+ 적응형 양식 - 기본 작성 {#adaptive-forms-basic-authoring}
   ...
   + [서명으로 양식에 전자 서명 적용](using/signing-forms-using-scribble.md)
   + [AEM Forms 키보드 단축키](using/keyboard-shortcuts.md)
   + [제출 검토자를 양식과 연결](using/adding-reviewers-form.md)
   + [양식 필드에 대한 컨텍스트 내 도움말 작성](using/authoring-in-field-help.md)
+ 적응형 양식 - 고급 저작 {#adaptive-forms-advanced-authoring}
   ...
   + [비동기 방식의 양식 제출](using/asynchronous-submissions-adaptive-forms.md)
   ...
   + [디자이너의 페이지 제로 컨텐츠 변경](using/changing-page-zero-content-designer.md)
...
+ 대화형 통신 {#interactive-communications}
   + [인터랙티브한 커뮤니케이션 제작 UI 소개](using/introduction-interactive-communication-authoring.md)
   + [인터랙티브한 커뮤니케이션 제작](using/create-interactive-communication.md)
   + [Interactive Communications에서 차트 사용](using/chart-component-interactive-communications.md)
...
+ 워크플로우 {#workflows}
   ...
   + [AEM 양식 중심의 워크플로우 단계에 대해 동적으로 사용자 또는 그룹 선택](using/dynamically-select-a-user-or-group-for-aem-workflow.md)
...
+ AEM Forms 작업 영역 {#use-aem-forms-workspace}
   ...
   + [추적 테이블 사용자 정의](using/sorting-tracking-tables-add-columns.md)
   ...
   + [작업 요약 창에서 정보 표시](using/displaying-information-task-summary-pane.md)
   ...
   + [Single Sign On 및 시간 초과 핸들러](using/single-sign-timeout-handlers.md)
...
+ HTML5 양식 {#html5-forms}
   ...
   + [HTML5 양식의 모범 사례](using/best-practices-for-html5-forms.md)
   ...
   + [HTML5 양식의 오른쪽에서 왼쪽으로 쓰는 언어](using/right-left-languages.md)
   + [Form Bridge와 HTML5 양식의 맞춤형 포털 통합](using/integrate-form-bridge-forms-portal.md)
   ...
   + [HTML5 양식에 액세스 가능한 복잡한 표 만들기](using/accessible-tables.md)
   ...
   + [HTML5 양식에 대한 로깅 사용](using/enable-logs.md)
...
+ 서신 및 통신사 {#letters-correspondences}
   ...
   + [서신 및 인터랙티브한 커뮤니케이션의 게시 처리](using/submit-letter-topostprocess.md)
   + [자산 목록 보기에 사용자 지정 작업 추가](using/add-custom-action-asset-listing-view.md)
   + [응답 UI 만들기에서 사용자 지정 작업/단추 추가](using/add-action-button-in-create-correspondence-ui.md)
   + [통신 관리 자산에 사용자 지정 속성 추가](using/add-custom-properties-cm-assets.md)
   ...
   + [사용자 정의 포털과 통신 UI 만들기 통합](using/integrating-create-correspondence-ui-with-your-portal.md)
...
+ AEM 양식 게시 및 처리 {#publish-process-aem-forms}
   ...
   + [AEM Forms 감시 폴더](using/watched-folder-in-aem-forms.md)
...
+ Forms 포털 {#use-forms-portal}
   ...
   + [양식 포털에서 제출된 양식을 사용하여 작업하는 API](using/report-submitted-data-forms.md)
...
+ Forms 디자이너 {#use-forms-designer}
   ...
   + [Designer FormCalc 참조](http://www.adobe.com/go/learn_aemforms_formCalc_64)
   + [HTML5 양식에서 자유롭게 서명 사용](using/scribble-signature.md)
+ AEM Forms 사용자 정의 {#customize-aem-forms}
   + [적응형 및 HTML5 양식을 위한 모양 프레임워크](using/introduction-widgets.md)
   + [사용자 정의 응용 양식 템플릿 만들기](using/custom-adaptive-forms-templates.md)
   ...
   + [적응형 양식의 오류 메시지 레이아웃 및 위치 지정](using/customize-layout-positioning-error-messages-adaptive-form.md)
...
+ JEE에서 AEM Forms에 대한 관리자 도움말 {#administrator-help}
   ...
   + 사용자 관리 구성 {#configure-user-management}
      ...
      + [AEM 양식에서 Single Sign-On 활성화](/help/forms/using/admin-help/enabling-single-sign-on-aem.md)
   ...
   + Acrobat Reader DC 확장 구성 {#configure-acrobat-reader-dc-extensions}
      + [Acrobat Reader DC 익스텐션에서 사용되는 인증서 유형](/help/forms/using/admin-help/certificate-types-used-acrobat-reader.md)
      ...
      + [Acrobat Reader DC 익스텐션에서 사용할 시간 초과 값 설정](/help/forms/using/admin-help/setting-timeout-values-acrobat-reader.md)
   ...
   + 양식 구성 {#configure-forms}
      + [양식 구성 기초](/help/forms/using/admin-help/overview-7.md)
   ...
   + 출력 구성 {#configure-output}
      ...
      + [출력을 위한 캐싱 구성](/help/forms/using/admin-help/configuring-caching-output.md)
   ...
   + AEM Forms 데이터베이스 유지 관리 {#maintain-aem-forms-database}
      ...
      + [IBM DB2 데이터베이스:정기적인 유지 관리를 위한 명령 실행](/help/forms/using/admin-help/ibm-db2-database-running-commands.md)
...
+ 프로세스 보고 {#process-reporting}
   ...
   + [프로세스 내 사용자 지정 보고서](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
...
+ 개발자 참조 {#developer-reference}
   ...
   + [어셈블러 서비스 및 DCX 참조](http://www.adobe.com/go/learn_aemforms_ddxRef_64)
   ...
   + JEE에서 AEM Forms를 사용한 프로그래밍 {#programming-aem-forms-jee}
      ...
      + API를 사용하여 서비스 작업 수행 {#performing-service-operations-using-apis}
         ...
         + [Bates 번호 매기기를 사용하여 문서 취합](developing/assembling-documents-using-bates-numbering.md)
         ...
         + [웹 서비스 API 파섹](developing/disassemble-pdf-document-using-web.md)
         + [문서 PDF/A 규격 확인](developing/determining-whether-documents-pdf-a.md)
         ...
         + [값별 양식 렌더링](developing/rendering-forms-value.md)
         ...
         + [CustomToolbars를 사용하여 HTML 양식 렌더링](developing/rendering-html-forms-custom-toolbars.md)
         + [인터랙티브한 PDF 양식 렌더링](developing/rendering-interactive-pdf-forms.md)
         + [렌더링 권한 사용 양식](developing/rendering-rights-enabled-forms.md)
         ...
         + [자격 증명 작업](developing/credentials.md)
         ...
         + [프로그래밍 방식으로 환경 설정 노드 관리](developing/programmatically-preferences-nodes.md)
         + [정책으로 문서 보호](developing/protecting-documents-policies.md)
         + [웹 서비스 API 파섹](developing/validate-ddx-document-using-web.md)