...
+ 시작하기 {#getting-started}
   ...
   + AEM Forms 참조 자료 {#aem-forms-reference-collaterals}
      ...
      + [We.Gov 참조 사이트 안내](using/gov-reference-site-walkthrough.md)
      ...
      + [We.Finance 자동 보험 갱신 참조 사이트](/help/forms/using/finance-auto-insurance-renewal-reference-site-walkthrough.md)
...
+ AEM Forms 설치 및 구성 {#install-aem-forms}
   ...
   + OSGi에 AEM Forms 설치 {#osgi-installation}
      + [OSGi에서 AEM 양식에 대해 지원되는 플랫폼](https://helpx.adobe.com/kr/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
   ...
   + JEE에 AEM Forms 설치 {#jee-installation}
      ...
      + [AEM Forms 설치 준비 중(단일 서버)](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_64)
      + [JBoss용 JEE에 Adobe Experience Manager Forms 설치 및 배포](http://www.adobe.com/go/learn_aemforms_installJBoss_64_kr)
      + [WebLogic용 JEE에 AEM Forms 설치 및 배포](http://www.adobe.com/go/learn_aemforms_installWebLogic_64_kr)
      + [WebSphere용 JEE에 Adobe Experience Manager Forms 설치 및 배포](http://www.adobe.com/go/learn_aemforms_installWebSphere_64_kr)
      ...
      + [JBoss 클러스터의 JEE에서 Adobe Experience Manager Forms 구성](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [WebLogic 클러스터의 JEE에서 Adobe Experience Manager Forms 구성](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [WebSphere 클러스터의 JEE에서 Adobe Experience Manager Forms 구성](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
...
+ AEM Forms 업그레이드 {#upgrade-aem-forms}
   ...
   + JEE에서 AEM Forms 업그레이드 {#aem-forms-jee-upgrade}
      ...
      + [JEE의 AEM 6.4 양식으로 업그레이드](using/upgrade-forms-jee.md)
      + [JBoss용 JEE의 Adobe Experience Manager Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      + [JBoss용 JEE의 Adobe Experience Manager Forms으로 LiveCycle ES4 SP1에서 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-jboss-livecycle.pdf)
      + [JBoss 턴키용 JEE의 AEM Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      + [JBoss 턴키용 JEE의 Adobe Experience Manager Forms으로 LiveCycle ES4 SP1에서 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
      + [WebLogic용 JEE의 Adobe Experience Manager Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      + [WebLogic용 JEE의 LiveCycle ES4 SP1에서 Adobe Experience Manager Forms으로 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-weblogic-livecycle.pdf)
      + [WebSphere용 JEE의 Adobe Experience Manager Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [WebSphere용 JEE의 LiveCycle ES4 SP1에서 Adobe Experience Manager Forms으로 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-websphere-livecycle.pdf)
+ AEM Forms 관리 {#manage-administer-aem-forms}
   ...
   + [XFA 또는 PDF 양식 템플릿을 다운로드합니다](using/download-xfa-or-pdf-form.md)
   ...
   + [적응형 양식 현지화를 위한 새 로케일 지원](using/supporting-new-language-localization.md)
   + 사용자 데이터 처리 {#handling-user-data}
      + [OSGi의 Forms 중심 워크플로우](using/forms-workflow-osgi-handling-user-data.md)
...
+ 적응형 Forms - 고급 작성 {#adaptive-forms-advanced-authoring}
   ...
   + [적응형 양식 비동기 제출](using/asynchronous-submissions-adaptive-forms.md)
...
+ 대화형 통신 {#interactive-communications}
   ...
   + [대화형 커뮤니케이션의 조건](using/conditions-interactive-communications.md)
...
+ AEM Forms 작업 공간 {#use-aem-forms-workspace}
   + [AEM Forms 작업 공간 소개](using/introduction-html-workspace.md)
   + [AEM Forms 작업 공간 작업](using/html-workspace-overview.md)
   + [AEM Forms 작업 공간 아키텍처](using/html-workspace-architecture.md)
   + [Flex 작업 영역에서 AEM Forms 작업 영역의 기능을 사용할 수 없습니다](using/features-html-workspace-available-flex.md)
   + [AEM Forms 작업 영역에서 Flex 작업 영역의 기능을 사용할 수 없습니다](using/features-flex-workspace-available-html.md)
   ...
   + [AEM 양식 작업 공간 사용자 지정 소개](using/introduction-customizing-html-workspace.md)
   + [AEM Forms 작업 공간 사용자 지정을 위한 일반 단계](using/generic-steps-html-workspace-customization.md)
   ...
   + [작업에 대한 탭 사용자 정의](using/customizing-tabs-task.md)
   + [작업 세부 사항 페이지 사용자 지정](using/customizing-task-details-page.md)
   ...
   + [경로 작업에 사용되는 이미지 사용자 지정](using/images-route-actions.md)
   ...
   + [AEM Forms 작업 영역에서 기존 프로세스 데이터를 사용하여 새 프로세스 시작](using/initiating-new-process-existing-process.md)
   ...
   + [브랜딩용 조직 로고 변경](using/changing-organization-logo-branding.md)
   + [작업 요약 창에 정보 표시](using/displaying-information-task-summary-pane.md)
   + [사용자 아바타 표시](using/displaying-user-avatar.md)
   + [AEM Forms 작업 공간 시작하기](using/getting-started-livecycle-html-workspace.md)
...
+ AEM Forms 앱 {#aem-forms-app}
   ...
   + [Android Studio 프로젝트를 설정하고 Android 앱을 빌드합니다.](using/setup-android-studio-project-build-installer.md)
   ...
   + [테마 사용자 지정](using/theme-customization.md)
...
+ 문자 및 서신 {#letters-correspondences}
   ...
   + [서신 UI에서 사용자 지정 작업/단추 추가](using/add-action-button-in-create-correspondence-ui.md)
...
+ AEM Forms 게시 및 처리 {#publish-process-aem-forms}
   ...
   + [초안 및 제출 스토리지 서비스 구성](using/configuring-draft-submission-storage.md)
   ...
   + [API를 사용하여 웹 페이지에서 양식 나열](using/listing-forms-webpage-using-apis.md)
   ...
   + [작업 할당 단계에서 사용자 지정 전자 메일 템플릿 사용](using/use-custom-email-template-assign-task-step.md)
   + [이메일 알림에 메타데이터 사용](using/use-metadata-in-email-notifications.md)
+ Forms 포털 {#use-forms-portal}
   + [Forms 포털 구성 요소에 대한 템플릿 사용자 지정](using/customizing-templates-forms-portal-components.md)
   + [Forms 포털 구성 요소 활성화](using/enabling-forms-portal-components.md)
   + [양식 포털 페이지 만들기](using/creating-form-portal-page.md)
   + [Forms 포털에서 제출된 양식을 사용하여 작업하는 API](using/report-submitted-data-forms.md)
...
+ 문서 서비스 {#use-document-services}
   ...
   + [Barcoded Forms 서비스](using/using-barcoded-forms-service.md)
...
+ Forms 디자이너 {#use-forms-designer}
   + [디자이너 사용](http://www.adobe.com/go/learn_aemforms_designer_64_kr)
   + [디자이너 빠른 시작 Tutorials](http://www.adobe.com/go/learn_aemforms_designer_quick_start_64)
   ...
   + [디자이너 양식 계산 참조](http://www.adobe.com/go/learn_aemforms_formCalc_64)
...
+ AEM Forms 사용자 지정 {#customize-aem-forms}
   ...
   + [적응형 양식을 위한 사용자 지정 레이아웃 구성 요소 만들기](using/custom-layout-components-forms.md)
   + [양식 라이브러리 항목에 사용자 지정 작업 추가](using/add-custom-action-form-lister.md)
   + [적응형 양식의 레이아웃 및 오류 메시지 위치 지정](using/customize-layout-positioning-error-messages-adaptive-form.md)
   + [사용자 지정 도구 모음 작업 만들기](using/creating-custom-toolbar-action.md)
   + [양식 이벤트 추적 사용자 지정](using/customizing-form-event-tracking.md)
   + [적응형 양식 필드에 대한 사용자 지정 모양 만들기](using/custom-appearance-widget-adaptive-form.md)
   ...
   + [적응형 양식에 대한 사용자 지정 제출 작업 쓰기](using/custom-submit-action-form.md)
...
+ 트랜잭션 보고서 {#transaction-reports}
   + [트랜잭션 보고서 개요](using/transaction-reports-overview.md)
...
+ JEE의 AEM Forms에 대한 관리자 도움말 {#administrator-help}
   ...
   + 사용자 관리 구성 {#configure-user-management}
      ...
      + [도메인 정보를 미리 가져오도록 AEM 양식 구성](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
   ...
   + 인증서 및 자격 증명 관리 {#manage-certificates-credentials}
      ...
      + [인증서 및 자격 증명 관리 기본 사항](/help/forms/using/admin-help/overview-2.md)
   ...
   + Acrobat Reader DC 확장 구성 {#configure-acrobat-reader-dc-extensions}
      ...
      + [Acrobat Reader DC 확장에서 사용할 자격 증명 구성](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md)
   ...
   + SSL 구성 {#configure-ssl}
      ...
      + [WebLogic Server에 대한 SSL 구성](/help/forms/using/admin-help/configuring-ssl-weblogic-server.md)
   ...
   + 문서 보안 작업 {#work-with-document-security}
      ...
      + [초대 및 로컬 사용자 계정 관리](/help/forms/using/admin-help/invited-local-user-accounts.md)
   ...
   + 출력 구성 {#configure-output}
      ...
      + [출력에 대한 파일 위치 지정](/help/forms/using/admin-help/specify-file-locations-output.md)
      + [사용 가능한 글꼴 만들기](/help/forms/using/admin-help/make-fonts-available.md)
   ...
   + 작업 공간 구성 {#configure-workspace}
      ...
      + [검색 템플릿 사용자 지정](/help/forms/using/admin-help/customizing-search-templates.md)
...
+ 프로세스 보고 {#process-reporting}
   ...
   + [프로세스 보고 시작하기](/help/forms/using/process-reporting/install-start-process-reporting.md)
   ...
   + [프로세스 보고의 사용자 지정 보고서](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
...
+ 개발자 참조 {#developer-reference}
   ...
   + [응용 Forms에 대한 JavaScript 라이브러리 API 참조](https://helpx.adobe.com/experience-manager/6-4/forms/javascript-api/index.html)
   + [어셈블러 서비스 및 DDX 참조](http://www.adobe.com/go/learn_aemforms_ddxRef_64)
   + [Workbench 도움말](http://www.adobe.com/go/learn_aemforms_workbench_64)
   + JEE에서 AEM Forms을 사용한 프로그래밍 {#programming-aem-forms-jee}
      ...
      + Java API 빠른 시작 - 코드 예 {#java-api-quick-start-code-examples}
         ...
         + [백업 및 복원 서비스 APIQ 빠른 시작](developing/backup-restore-service-api-quick.md)
         + [Barcoded Forms Service Java APIQ 빠른 시작(SOAP)](developing/barcoded-forms-service-java-api.md)
         + [구성 요소 및 서비스 Java APIQ 빠른 시작(SOAP)](developing/components-services-java-api-quick.md)
         ...
         + [문서 관리 서비스(사용 중지)Java API 빠른 시작(SOAP)](developing/document-management-service-deprecated-java.md)
         + [문서 보안 서비스 JavaAPI 빠른 시작(SOAP)](developing/document-security-service-java-api.md)
         ...
         + [LiveCycle Process Java API(SOAP)빠른 시작](developing/livecycleprocess-java-api-soap-quick.md)
         + [출력 서비스 Java API 빠른 시작(SOAP)](developing/output-service-java-api-quick.md)
         + [PDF 유틸리티 서비스 Java APIQ 빠른 시작(SOAP)](developing/pdf-utilities-service-java-api.md)
      ...
      + API를 사용하여 서비스 작업 수행 {#performing-service-operations-using-apis}
         ...
         + [암호화된 PDF 문서 정리](developing/assembling-encrypted-pdf-documents.md)
         ...
         + [AEM Forms for Backup 준비](developing/preparing-aem-forms-backup.md)
