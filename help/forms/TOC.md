...
+ AEM Forms {#install-aem-forms} 설치 및 구성
   ...
   + JEE에 AEM Forms 설치 {#jee-installation}
      ...
      + [문서 보안 서버만 설치 및 구성](using/installing-and-configuring-the-document-security-server.md)
...
+ AEM Forms {#upgrade-aem-forms} 업그레이드
   ...
   + JEE {#aem-forms-jee-upgrade}에서 AEM Forms 업그레이드
      ...
      + [JBoss용 JEE의 AEM 6.4 Forms으로 AEM Forms 릴리스에서 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      ...
      + [JBoss 턴키용 JEE의 AEM 6.4 Forms으로 AEM Forms 릴리스에서 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      ...
      + [AEM Forms 릴리스에서 WebLogic용 JEE의 AEM 6.4 Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      ...
      + [AEM Forms 릴리스에서 WebSphere용 JEE의 AEM 6.4 Forms으로 업그레이드](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [WebSphere용 JEE 기반의 AEM Forms으로 LiveCycle ES4 SP1에서 업그레이드](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-websphere-livecycle.pdf)
...
+ Forms 디자이너 {#use-forms-designer}
   ...
   + [디자이너의 빠른 시작 자습서](http://www.adobe.com/go/learn_aemforms_designer_quick_start_64)
   + [디자이너 샘플](http://www.adobe.com/go/learn_aemforms_designer_samples_64)
   + [디자이너 스크립트 기본 사항](http://www.adobe.com/go/learn_aemforms_scriptingBasics_64)
   + [디자이너 스크립팅 참조](http://www.adobe.com/go/learn_aemforms_scriptingReference_64)
   + [디자이너 FormCalc 참조](http://www.adobe.com/go/learn_aemforms_formCalc_64)
