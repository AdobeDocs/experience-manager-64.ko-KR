...
description: Java API 빠른 시작을 사용하여 응용 프로그램을 배포하고 제거하려면 Application Manager 서비스를 사용합니다.
seo-description: Java API 빠른 시작을 사용하여 응용 프로그램을 배포하고 제거하려면 Application Manager 서비스를 사용합니다.
