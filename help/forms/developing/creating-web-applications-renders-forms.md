...
![cw_cw_fragementformoternd](assets/cw_cw_fragementformfootercnd.png)
...
* 내보내기 경로에서 \Adobe\Adobe Experience Manager Forms\jboss\server\all\deploy으로 WAR 파일을 *[복사합니다]*.
