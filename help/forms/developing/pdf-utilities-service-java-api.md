...
다음 코드 예제에서는 문서가 PDF 문서인지 여부를 확인하고, 그렇다면 문서를 읽을 수 있는 가장 오래된 Acrobat 버전입니다. (PDF [문서 속성 검색을 참조하십시오](/help/forms/developing/pdf-utilities.md#retrieving-pdf-document-properties).)
