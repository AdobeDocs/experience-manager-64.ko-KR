...
다음 코드 예제에서는 *Loan.ps *라는 PostScript 파일을 *Loan.pdf라는 PDF 파일로 변환합니다*. (PostScript [를 PDF 문서로 변환을 참조하십시오](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents).)
