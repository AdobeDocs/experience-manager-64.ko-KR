...
Distiller® 서비스에서 Java API 빠른 시작(SOAP)을 사용할 수 있습니다.
...
다음 코드 예제에서는 *Loan.ps *라는 PostScript 파일을 Loan.pdf라는 PDF 파일로 *변환합니다*. (PostScript [를 PDF 문서로](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents)변환을 참조하십시오.)
