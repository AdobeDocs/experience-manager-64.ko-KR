...
description: 백업 및 복원 서비스 API를 사용하여 Java API 빠른 시작을 사용하여 백업 모드를 시작하고 종료할 수 있습니다.
seo-description: 백업 및 복원 서비스 API를 사용하여 Java API 빠른 시작을 사용하여 백업 모드를 시작하고 종료할 수 있습니다.
