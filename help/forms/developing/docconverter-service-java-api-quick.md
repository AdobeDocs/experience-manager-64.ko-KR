...
[빠른 시작(SOAP 모드):Java API를 사용한 PDF/A 호환성 확인](docconverter-service-java-api-quick.md#quick-start-soap-mode-determining-pdf-a-compliancy-using-the-java-api)
...
다음 Java 코드 예제에서는 Loan.pdf라는 *PDF 문서를* LoanArchive.pdf라는 PDF 파일로 저장된 PDF/ *A 문서로 변환합니다*. (문서를 [PDF/A 문서로 변환을 참조하십시오](/help/forms/developing/pdf-a-documents.md#converting-documents-to-pdf-a-documents).)
...
## 빠른 시작(SOAP 모드):Java API를 사용한 PDF/A 호환성 확인 {#quick-start-soap-mode-determining-pdf-a-compliancy-using-the-java-api}

다음 Java 코드 예제에서는 입력 PDF 문서가 PDF/A 규격인지 확인합니다. DocConverter 서비스로 전달되는 입력 PDF 문서의 이름은 LoanArchive.pdf *입니다*. 유효성 검사 결과는 ValidationResults.xml이라는 XML 파일에 *기록됩니다*. (프로그래밍 [방식으로 PDF/A 규정 준수 결정을 참조하십시오](/help/forms/developing/pdf-a-documents.md#programmatically-determining-pdf-a-compliancy).)
