...
다음 Java 코드 예제에서는 LoanSigned.pdf라는 PDF 파일을 기반으로 서명된 PDF 문서에 있는 디지털 서명을 확인합니다. 확인 시간은 현재 시간으로 설정되며 취소 확인 옵션은 최선의 노력으로 설정되어 있습니다. ([디지털 서명 확인](#unresolvedlink-lc-si)을 참조하십시오.)
...
다음 Java 코드 예제에서는 LoanAllSigs.pdf라는 PDF 파일을 기반으로 서명된 PDF 문서에 있는 여러 디지털 서명을 확인합니다. 확인 시간은 현재 시간으로 설정되며 취소 확인 옵션은 최선의 노력으로 설정되어 있습니다. ([여러 디지털 서명 확인](#unresolvedlink-lc-si)을 참조하십시오.)
