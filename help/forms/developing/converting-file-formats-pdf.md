...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>애플리케이션별 대화 상자 지침에 대한 무시 및 추가를 지정합니다. 이 섹션에는 이러한 정보의 예가 나와 있습니다. </p><p>이 정보가 들어 있는 파일이 적용됩니다.<i>[appname]</i>.add.<i>[locale]</i>.xml. 예: appmon.addition.en_US.xml</p></td> 
