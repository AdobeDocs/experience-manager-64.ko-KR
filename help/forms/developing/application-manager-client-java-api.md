...
description: Application Manager 클라이언트를 사용하여 애플리케이션 버전을 생성하고, 애플리케이션을 내보내고, 애플리케이션을 가져오고, AEM Forms 애플리케이션을 가져오고, 애플리케이션을 가져오고, 애플리케이션 상태를 확인하고, AEM Forms 및 이후 애플리케이션 아카이브를 미리 보고, AEM Forms 애플리케이션 아카이브를 삭제할 수 있습니다.
seo-description: Application Manager 클라이언트를 사용하여 애플리케이션 버전을 생성하고, 애플리케이션을 내보내고, 애플리케이션을 가져오고, AEM Forms 애플리케이션을 가져오고, 애플리케이션을 가져오고, 애플리케이션 상태를 확인하고, AEM Forms 및 이후 애플리케이션 아카이브를 미리 보고, AEM Forms 애플리케이션 아카이브를 삭제할 수 있습니다.
...
[빠른 시작(SOAP 모드):Java API를 사용하여 AEM Forms 및 이후 애플리케이션 아카이브 미리 보기](application-manager-client-java-api.md#quick-start-soap-mode-previewing-the-livecycle-es2-and-later-application-archive-using-the-java-api)
...
## 빠른 시작(SOAP 모드):Java API {#quick-start-soap-mode-creating-application-version-using-the-java-api}를 사용하여 애플리케이션 버전 만들기
...
## 빠른 시작(SOAP 모드):Java API {#quick-start-soap-mode-exporting-applications-using-the-java-api}를 사용하여 애플리케이션 내보내기
...
## 빠른 시작(SOAP 모드):Java API {#quick-start-soap-mode-importing-applications-using-the-java-api}를 사용하여 애플리케이션 가져오기
...
## 빠른 시작(SOAP 모드):Java API {#quick-start-soap-mode-getting-a-application-using-the-java-api}를 사용하여 애플리케이션 가져오기
...
## 빠른 시작(SOAP 모드):Java API {#quick-start-soap-mode-getting-the-applications-using-the-java-api}를 사용하여 애플리케이션 가져오기
...
## 빠른 시작(SOAP 모드):Java API {#quick-start-soap-mode-getting-status-of-applications-using-java-api}를 사용하여 응용 프로그램의 상태 가져오기
...
## 빠른 시작(SOAP 모드):Java API {#quick-start-soap-mode-previewing-the-livecycle-es2-and-later-application-archive-using-the-java-api}를 사용하여 LiveCycle ES2 이상 애플리케이션 아카이브 미리 보기
...
## 빠른 시작(SOAP 모드):Java API {#quick-start-soap-mode-deleting-the-application-archive-using-the-java-api}를 사용하여 애플리케이션 아카이브 삭제
