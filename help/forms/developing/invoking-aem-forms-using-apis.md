...
seo-description: Adobe Experience Manager Forms은 공유 인프라 내에서 작동하는 서비스로 구성된 J2EE 기반 엔터프라이즈 소프트웨어입니다. Java API, 웹 서비스, Remoting 및 REST API를 사용하여 클라이언트 애플리케이션을 사용하여 프로그래밍 방식으로 AEM Forms을 호출하는 방법을 알아봅니다.
