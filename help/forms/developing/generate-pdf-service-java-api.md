...
다음 코드 예제에서는 Word 파일 *Loan.doc* 를 *Loan.pdf라는 PDF 문서로*&#x200B;변환합니다. (Word [문서를 PDF 문서로 변환을 참조하십시오](/help/forms/developing/converting-file-formats-pdf.md#converting-word-documents-to-pdf-documents).)
...
## 빠른 시작(SOAP 모드): Java API를 사용하여 HTML 내용을 PDF 문서로 변환 {#quick-start-soap-mode-converting-html-content-to-a-pdf-document-using-the-java-api}

다음 Java 코드 예제는 https://www.adobe.com에 있는 HTML 내용을 *AdobeHTML.pdf라는 PDF 문서로 변환합니다*. (HTML [문서를 PDF 문서로 변환을 참조하십시오](/help/forms/developing/converting-file-formats-pdf.md#converting-html-documents-to-pdf-documents).)
...
## 빠른 시작(SOAP 모드): Java API(SOAP 모드)를 사용하여 PDF 문서를 RTF 파일로 변환 {#quick-start-soap-mode-converting-a-pdf-document-to-an-rtf-file-using-the-java-api-soap-mode}

다음 코드 예제에서는 Loan.pdf라는 PDF 문서 *를* Loan.rtf라는 RTF 문서로 *변환합니다*. (PDF [문서를 이미지가 아닌 포맷으로 변환을 참조하십시오](/help/forms/developing/converting-file-formats-pdf.md#converting-pdf-documents-to-non-image-formats).)
