...
[빠른 시작(SOAP 모드):Java API 파섹](generate-pdf-service-java-api.md#quick-start-soap-mode-converting-html-content-to-a-pdf-document-using-the-java-api)
...
## 빠른 시작(SOAP 모드):Java API 파섹 {#quick-start-soap-mode-converting-html-content-to-a-pdf-document-using-the-java-api}

다음 Java 코드 예는 https://www.adobe.com에 있는 HTML 컨텐츠를 AdobeHTML.pdf라는 PDF 문서로 *변환합니다*. (HTML [문서를 PDF 문서로 변환을 참조하십시오](/help/forms/developing/converting-file-formats-pdf.md#converting-html-documents-to-pdf-documents).)
...
다음 코드 예제에서는 Loan.pdf라는 PDF 문서를 *Loan* .rtf라는 RTF 문서로 *변환합니다*. (PDF [문서를 이미지가 아닌 포맷으로 변환을 참조하십시오](/help/forms/developing/converting-file-formats-pdf.md#converting-pdf-documents-to-non-image-formats).)
