...
HTML로 렌더링할 양식 디자인을 만들 때 javascript 언어로 된 스크립트의 경우 XFA 하위 집합으로 스크립팅을 제한해야 합니다.
