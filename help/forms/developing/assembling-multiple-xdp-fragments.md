...
[빠른 시작(SOAP 모드):Java API를 사용하여 여러 XDP 조각 조합](/help/forms/developing/assembler-service-java-api-quick.md#quick-start-soap-mode-assembling-multiple-xdp-fragments-using-the-java-api)
