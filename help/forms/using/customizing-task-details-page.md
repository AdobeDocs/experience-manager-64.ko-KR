...
>[!NOTE]
>
>AEM Forms 작업 공간의 **프로세스 시작 **탭에서 만든 작업을 사용하여 작업 세부 사항 페이지를 사용자 지정하려면 새 정보를 `/apps/ws/js/runtime/templates/startprocess.html`.
>
>세부 사항 페이지에 추가된 정보에 대한 새 스타일을 추가하려면 를 사용하여 CSS 파일을 수정합니다 *사용자 인터페이스 변경 사항* 섹션 [작업 공간 사용자 지정](/help/forms/using/changing-locale-user-interface.md).
