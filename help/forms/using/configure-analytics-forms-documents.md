...
적응형 양식, HTML5 양식 및 인터랙티브한 커뮤니케이션을 사용하는 동안 Adobe Analytics을 사용하여 사용자가 직면하는 인터랙션 패턴과 문제를 찾아낼 수 있습니다. 기본적으로 Adobe 분석은 다음 매개 변수에 대한 정보를 추적하고 저장합니다.
...
1. 작성자 인스턴스에서 AEM 웹 콘솔 구성 관리자를 https://&lt;*server*:&lt;*port*/system/console/configMgr에서 엽니다.
...
1. **Forms > Forms &amp; Documents**&#x200B;를 클릭하고 양식이나 문서를 선택한 다음 **Analytics 사용**&#x200B;을 클릭합니다. 분석이 활성화됩니다.
   ...
   **A.** 분석 활성화 단추  **B.** 선택한 양식
   ...
   양식 분석 보고서 보기에 대한 자세한 내용은 [AEM Forms 분석 보고서 보기 및 이해](/help/forms/using/view-understand-aem-forms-analytics-reports.md)를 참조하십시오.
