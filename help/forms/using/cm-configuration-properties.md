...
이러한 속성을 구성하려면 브라우저에서 다음 URL을 엽니다. `https://<server>:<port>/<contextPath>/system/console/configMgr` 통신 **관리 구성을 선택합니다**.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>최소 너비 수</td> 
   <td>로마자 숫자와 구분되는 목록을 사용할 때 글머리 기호/번호 필드에 적용할 최소 너비</td> 
   <td>8.0mm</td> 
   <td>모든 번호</td> 
  </tr> 
  <tr> 
   <td><p>최소 로마 숫자 너비</p> </td> 
  ...
  <tr> 
   <td>변환 유형</td> 
   <td>서신 작성 응용 프로그램에서 문자 미리 보기를 렌더링하는 데 사용하는 변환 유형입니다. </td> 
   <td>HTML 변환</td> 
   <td>HTML 변환/PDF 변환</td> 
  </tr> 
  <tr> 
   <td><p>CCR PDF 강조 표시 사용</p> </td> 
   <td><p>Create Correspondence 애플리케이션에서 PDF 강조 표시</p> </td> 
   <td><p>true</p> </td> 
   <td><p>true / false</p> </td> 
  </tr> 
  <tr> 
   <td><p>Target 강조 표시 유형</p> </td> 
   <td><p>통신 응용 프로그램의 Target 강조 표시 유형</p> </td> 
   <td><p>국경</p> </td> 
   <td><p>테두리/채우기/없음</p> </td> 
  </tr> 
  <tr> 
   <td><p>Target 밝은 영역 색상</p> </td> 
  ...
  <tr> 
   ...
   <td><p>통신 만들기 애플리케이션의 필드 강조 표시 유형</p> </td> 
   <td><p>채우기</p> </td> 
   <td><p>테두리/채우기/없음</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p>XDP 문서의 매개 변수 이름이 게시 프로세스로 전송되었습니다.</p> </td> 
   <td><p>inXDPDoc</p> </td> 
   <td><p>모든 문자열 변수 이름</p> </td> 
  </tr> 
  <tr> 
   <td><p>리디렉션 URL 매개 변수 이름</p> </td> 
   <td><p>게시물 프로세스에서 전송된 리디렉션 URL의 매개 변수 이름 이 값은 모든 문자열 변수 이름이 될 수 있습니다.</p> </td> 
   <td><p>redirectURL</p> </td> 
   <td><p>모든 문자열 변수 이름</p> </td> 
  </tr> 
  <tr> 
   <td><p>PDF 제출 유형</p> </td> 
   <td><p>PDF 전송 유형(편지 작성 애플리케이션에서 제출할 때 생성된 PDF 유형)</p> </td> 
   <td><p>nonInteractive</p> </td> 
   <td><p>대화형/비대화형</p> </td> 
  </tr> 
  <tr> 
   <td><p>데이터 사전 인스턴스 최적화</p> </td> 
   <td><p>데이터 사전 인스턴스 b/w 서버 및 클라이언트의 최적화된 전송 가능</p> </td> 
   <td><p>true</p> </td> 
   <td><p>true / false</p> </td> 
  </tr> 
  <tr> 
   <td><p>불일치를 자동으로 수정 </p> </td> 
   <td><p>활성화되면 편지 할당에서 가능한 불일치를 자동으로 처리합니다</p> </td> 
   <td><p>true</p> </td> 
   <td><p>true / false</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p>문자 관리 기능 활성화/비활성화(게시 서버에만 적용)</p> </td> 
   <td><p>false</p> </td> 
   <td><p>true / false</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p>사용자 정의 문자 전달에 대한 감사 기능 활성화/비활성화</p> </td> 
   <td><p>false</p> </td> 
   <td><p>true / false</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p>Letter의 시퀀스에 따라 통신 인터페이스를 만들 때 데이터 요소 순서를 유지합니다.</p> </td> 
   <td><p>true</p> </td> 
   <td><p>true / false</p> </td> 
  </tr> 
  <tr> 
   <td><p>지원 다시 로드</p> </td> 
   <td><p>서버 측에서 렌더링된 문자로 다시 로드 지원을 활성화/비활성화합니다.</p> <p>이를 비활성화하면 문자 렌더링 성능이 향상됩니다.</p> </td> 
   <td><p>false</p> </td> 
  ...
  <tr> 
   <td>호환성 옵션</td> 
   <td>configname:configvalue 포맷의 호환성 옵션을 쉼표로 구분하여 지정합니다.</td> 
   <td>acm.compatibilityOptions</td> 
   <td> </td> 
  </tr> 
  <tr> 
   <td><p>디버그 디렉토리 </p> <p> </p> </td> 
   <td>디버깅을 위한 파일 시스템 폴더 위치입니다. 디렉토리가 없는 경우 디버그 덤프 <code>exists</code>가 생성되지 않습니다.</td> 
