...
![사용자 정의 레이아웃 도구 모음의 데스크탑 보기](assets/toolbar_1.png)**그림:** *사용자 정의 레이아웃 도구 모음의 데스크탑 보기*
