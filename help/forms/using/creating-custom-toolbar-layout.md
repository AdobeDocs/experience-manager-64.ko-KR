...
![](assets/default_toolbar_layout.png) 도구 모음의 샘플 레이아웃&#x200B;****&#x200B;그림:도구 *모음의 샘플 레이아웃*

적응형 양식은 즉시 사용 가능한 레이아웃 세트를 제공합니다.

![](assets/toolbar1.png) 즉시 사용 가능한 툴바 레이아웃그림 ****:즉시 *사용 가능한 툴바 레이아웃*
...
![](assets/toolbar_1.png) 사용자 정의 레이아웃 도구 모음의 데스크탑 보기그림&#x200B;****:사용자 *정의 레이아웃 도구 모음의 데스크탑 보기*
