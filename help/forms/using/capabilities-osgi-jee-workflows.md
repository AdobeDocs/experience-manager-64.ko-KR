...
<table> 
 <tbody>
  <tr>
   <td>기능</td> 
   <td>OSGi에서 양식 중심의 AEM 워크플로우<br /> </td> 
...
1. OSGi에서 양식 중심의 AEM 워크플로우를 사용하여 이미 채워진 적응형 양식에 서명할 수 있습니다. OSGi의 양식 중심의 AEM 워크플로우는 양식 서명을 지원합니다. 양식 [서명](/help/forms/using/working-with-adobe-sign.md#create-in-form-signing-experience) 환경은 지원되지 않습니다.
...
1. AEM 양식 JEE 워크플로우에는 Adobe Sign에 대한 별도의 단계가 없습니다. AEM 양식 JEE 워크플로우에 대해 Adobe Sign이 활성화된 적응형 양식이 필요합니다. 자세한 내용은 Adobe Sign [설명서를](/help/forms/using/working-with-adobe-sign.md#add-and-configure-the-signature-step-component)참조하십시오.
...
1. 이메일 보내기 [단계를 사용하여](/help/forms/using/aem-forms-workflow-step-reference.md#send-email-step) 이메일을 보낼 수 있습니다.

## AEM 받은 편지함과 AEM Forms 앱 기능 간의 차이점 {#differences-between-aem-inbox-and-aem-forms-app-features}

양식 중심의 워크플로우를 실행하는 중요한 두 가지 방법 중 하나는 AEM Inbox 및 [AEM Forms](/help/forms/using/manage-applications-inbox.md) 앱을 사용하는 것입니다. 그러나 AEM 받은 편지함 및 AEM Forms 앱의 기능은 다릅니다. AEM Inbox는 양식 [중심의 워크플로우에서만](/help/forms/using/aem-forms-workflow.md) 작동하지만 AEM Forms 앱은 양식 중심의 워크플로우와 프로세스 관리에서 모두 작동합니다.
