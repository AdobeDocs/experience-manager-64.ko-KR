...
**모바일 레이아웃** 모바일 장치에서 양식의 탐색을 제어합니다. 장치 너비가 768픽셀 이상이면 레이아웃은 모바일 레이아웃으로 간주되어 모바일 장치에 최적화됩니다.

**도구 모음 레이아웃** 양식의 도구 모음이나 패널 도구 모음에 있는 작업 단추 배치를 제어합니다.
...
패널 레이아웃은 `/libs/fd/af/layouts/panel` 위치에 있습니다.

![적응형 양식의 루트 패널에 대한 패널 레이아웃](assets/layouts.png)**목록:** *적응형 양식의 패널 레이아웃 목록*

### Responsive - everything on one page without navigation {#responsive-everything-on-one-page-without-navigation-br}

이 패널 레이아웃을 사용하면 특수 탐색을 하지 않고도 장치의 화면 크기에 맞게 조정되는 반응형 레이아웃을 만들 수 있습니다.

이 레이아웃을 사용하면 여러 **[!UICONTROL 패널 응용 양식]** 구성 요소를 패널 안에 하나씩 배치할 수 있습니다.

![작은 화면에 표시되는 응답형 레이아웃을 사용하는 양식](assets/responsive_layout_seen_on_small_screen.png)

**그림:** *작은 화면에 표시되는 응답형 레이아웃을 사용하는 양식*

![큰 화면에서 보이는 응답형 레이아웃을 사용하는 양식](assets/responsive_layout_seen_on_large_screen.png)

**그림:** *큰 화면에서 보이는 응답형 레이아웃을 사용하는 양식*

### 마법사 - 한 번에 한 단계씩 표시하는 다단계 양식 {#wizard-a-multi-step-form-showing-one-step-at-a-time}

이 패널 레이아웃을 사용하여 양식 내에서 안내 탐색을 제공할 수 있습니다. 예를 들어, 사용자를 단계별로 안내하면서 양식에 필수 정보를 캡처하려면 이 레이아웃을 사용합니다.

구성 요소 `Panel adaptive form` 를 사용하여 패널 내에서 단계별 탐색을 제공할 수 있습니다. 이 레이아웃을 사용하면 사용자가 현재 단계가 완료된 후에만 다음 단계로 이동합니다
...
**그림:** *다중 단계 양식의 마법사 레이아웃의 단계 완료 표현식*
...
이 레이아웃을 사용하면 아코디언 스타일 탐색이 있는 패널에 구성 `Panel adaptive form` 요소를 배치할 수 있습니다. 이 레이아웃을 사용하여 반복 가능한 패널을 만들 수도 있습니다. 반복 가능한 패널을 사용하면 필요에 따라 패널을 동적으로 추가하거나 제거할 수 있습니다. 패널이 반복되는 최소 및 최대 횟수를 정의할 수 있습니다. 또한 패널 항목에 제공된 정보에 따라 패널 제목을 동적으로 결정할 수 있습니다.
...
**그림:** *아코디언 레이아웃을 사용하여 만든 반복 가능한 패널*

### 탭 레이아웃 - 탭이 왼쪽에 나타납니다. {#tabbed-layout-tabs-appear-on-the-left}

이 레이아웃을 사용하면 탭 탐색 기능이 있는 패널에 구성 `Panel adaptive form` 요소를 배치할 수 있습니다. 패널 내용의 왼쪽에 탭이 표시됩니다.

![탭 레이아웃에서 탭이 왼쪽에 나타납니다](assets/tabbed_layout_left.png)

**그림:** *패널 왼쪽에 나타나는 탭*

### 탭 방식의 레이아웃 - 탭이 맨 위에 표시됩니다. {#tabbed-layout-tabs-appear-on-the-top}
...
이 레이아웃은 내비게이션 막대와 탐색 메뉴를 사용하여 탐색을 제어합니다. 탐색 막대는 양식에 **다음** 및 **이전** 의 탐색 단계를 나타내는 **아이콘** 및 **** 을 표시합니다.
...
**그림:** *적응형 양식의 모바일 레이아웃 목록*

모바일 레이아웃을 사용하는 경우, 양식 메뉴에서 ![aem6forms_form_menu](assets/aem6forms_form_menu.png) 아이콘을 눌러 다양한 양식 패널에 액세스할 수 있습니다.
...
### 양식 헤더에서 패널 제목이 없는 레이아웃 {#layout-without-panel-titles-in-the-form-header}
...
도구 모음 레이아웃은 `/libs/fd/af/layouts/toolbar` 위치에 있습니다. 적응형 양식은 기본적으로 다음과 같은 도구 모음 레이아웃을 제공합니다.
