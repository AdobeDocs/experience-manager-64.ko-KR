...
![적응형 양식의 루트 패널에 대한 ](assets/layouts.png)
**패널 레이아웃 목록그림:적응형 양식의** *패널 레이아웃 목록*
...
**그림:** *다단계 양식의 마법사 레이아웃의 단계 완료 표현식*
