...
규칙 편집기에서 사용할 수 있는 규칙 유형에 대한 자세한 내용은 규칙 편집기](/help/forms/using/rule-editor.md#p-available-rule-types-in-rule-editor-p)에서 사용 가능한 규칙 유형을 참조하십시오.[

### 규칙 구문 선택에 대한 지침 {#guidelines-for-choosing-a-rule-construct}

규칙 구절을 사용하여 대부분의 사용 사례를 얻을 수 있지만, 다음은 하나의 구문을 다른 구문보다 선택하는 몇 가지 지침입니다. 규칙 편집기에서 사용 가능한 규칙에 대한 자세한 내용은 규칙 편집기](/help/forms/using/rule-editor.md#p-available-rule-types-in-rule-editor-p)에서 사용 가능한 규칙 유형을 참조하십시오.[
