...
이제 적응형 양식 또는 대화형 커뮤니케이션에서 웹 서비스에서 사용할 수 있는 글꼴을 사용할 수 있습니다. Adobe의 웹 글꼴 서비스인 [Typekit](https://typekit.com/) 을 구성으로 사용할 수 있습니다. Typekit을 사용하려면 키트 및 글꼴을 만들고 [Typekit 웹 사이트](https://typekit.com/)에서 키트 ID를 얻습니다.
