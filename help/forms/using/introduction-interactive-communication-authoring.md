...
seo-title: 대화형 커뮤니케이션을 작성하는 데 사용할 수 있는 다양한 사용자 인터페이스 요소를 소개합니다
description: 대화형 커뮤니케이션을 작성하는 데 사용할 수 있는 다양한 사용자 인터페이스 요소를 소개합니다
seo-description: 대화형 커뮤니케이션을 작성하는 데 사용할 수 있는 다양한 사용자 인터페이스 요소를 소개합니다
...
[대화형 통신](/help/forms/using/interactive-communications-overview.md)을 작성하는 사용자 인터페이스는 직관적이며, 대화형 커뮤니케이션의 인쇄 및 웹 채널을 작성하는 데 다음과 같은 기능을 제공합니다.

* WYSIWYG 드래그 앤 드롭 문서 편집기
* 자산에 대한 통합 저장소 - 서버에 업로드되고 서버에서 만든 자산은 Interactive Communication 작성 인터페이스의 자산 브라우저에서 사용할 수 있습니다

[새 대화형 커뮤니케이션을 만들거나 기존 대화형 커뮤니케이션을 편집하는 경우, 다음 사용자 인터페이스 요소를 사용합니다.](/help/forms/using/create-interactive-communication.md)
...
**A.** 채널 브라우저  **B.** 컨텐츠 브라우저  **C.** 속성 브라우저  **D.** 자산 브라우저  **E.** 구성 요소 브라우저 **F.** 데이터 소스 브라우저 - 데이터 모델  **G.** 데이터 소스 브라우저 - 기본 컨텐츠
...
| 표 | amp;ast; | ✓ | 행 및 열에 데이터를 구성할 수 있는 표를 추가합니다. |
...
amp;ast;인쇄 채널에서 레이아웃 조각을 사용하여 표를 추가합니다.
...
### 구성 요소 {#key-points-for-working-with-components} 작업에 대한 주요 사항
...
* 구성 요소가 해당 요소 이름으로 식별됩니다. ![cmppr](assets/cmppr.png)을 탭할 때 속성 브라우저에서 요소 이름 필드 값을 변경하여 구성 요소의 이름을 변경할 수 있습니다. 요소 이름 필드는 문자, 숫자, 하이픈(-) 및 밑줄(_)만 사용할 수 있습니다. 다른 특수 문자는 사용할 수 없으며 요소 이름은 문자로 시작해야 합니다.
...
구성 요소를 선택하면 해당 구성 요소로 작업할 수 있는 도구 모음이 표시됩니다. 구성 요소의 잘라내기, 붙여넣기, 이동 및 속성 지정 옵션이 제공됩니다. 옵션은 다음과 같습니다.
...
맨 위에 있는 페이지 도구 모음에서는 대화형 커뮤니케이션을 미리 보고 해당 속성을 변경할 수 있는 옵션을 제공합니다. 작성 시 대화형 커뮤니케이션을 미리 보고 그에 따라 변경할 수 있습니다. 페이지 도구 모음에서 다음 내용이 표시됩니다.

* 사이드 패널 ![사이드 패널 전환](assets/toggle-side-panel.png):사이드바를 표시하거나 숨길 수 있습니다.
...
* 편집:다음과 같은 다른 모드를 선택할 수 있습니다.편집, 스타일, 개발자 및 디자인.
   ...
   * 스타일:대화형 커뮤니케이션의 구성 요소 모양을 스타일을 지정할 수 있습니다. 예를 들어 스타일 모드에서 패널을 선택하고 배경색을 지정할 수 있습니다.
