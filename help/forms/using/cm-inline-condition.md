...
인라인 조건을 사용하고 인터랙티브한 커뮤니케이션 및 문자에서 반복하면 문맥에 맞게 잘 구성된 커뮤니케이션을 만들 수 있습니다.
...
자세한 내용은 Interactive Communications에서 텍스트로 규칙 [만들기를 참조하십시오](/help/forms/using/texts-interactive-communications.md).
...
1. 선택한/조건부 텍스트가 편지에 표시되는지 여부를 평가하는 조건을 구성한 다음 확인 표시를 눌러 표현식을 저장합니다.
   ...
   표현식 만들기에 대한 자세한 내용은 표현식 **빌더에서 표현식 및 원격 함수** 만들기를 [참조하십시오](/help/forms/using/expression-builder.md). 식에 지정된 값은 데이터 사전의 요소에 대해 지원되어야 합니다. 자세한 내용은 데이터 [사전을 참조하십시오](/help/forms/using/data-dictionary.md).
