...
title: 양식 작업
seo-title: 양식 작업
description: AEM Forms 앱의 작업 또는 시작점과 연결된 양식 보기 및 업데이트
seo-description: AEM Forms 앱의 작업 또는 시작점과 연결된 양식 보기 및 업데이트
...
1. 고급 아래에서 옵션을 활성화합니다. **AEM Forms 앱과**&#x200B;동기화하고 저장을 **누릅니다**.
