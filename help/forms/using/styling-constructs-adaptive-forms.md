...
description: LESS 프레임워크를 사용하여 적응형 양식의 모양을 사용자 정의할 수 있습니다.
seo-description: LESS 프레임워크를 사용하여 적응형 양식의 모양을 사용자 정의할 수 있습니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>유용한 정보를 제공하는 버튼을 위한 글꼴 색상</p> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>홀수 본문 행의 배경색입니다. The default value is <code>rgb(255, 255, 255)</code>.</p> </td> 
  </tr> 
  <tr> 
   <td><p><code>table-even-row-bg-color</code></p> </td> 
   <td><p>짝수 본문 행의 배경색입니다. The default value is <code>#eee</code>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>위젯의 미리 보기 아이콘(Bootstrap 아이콘)용 색상</p> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>중첩된/자식/하위 탐색기가 있는 탭 내비게이터(왼쪽 및 위쪽)</p> </td> 
  </tr> 
  <tr> 
   <td><p><code>nested_false</code></p> </td> 
   <td><p>중첩된/자식/하위 탐색기가 없는 탭 내비게이터(왼쪽 및 위쪽)</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>패널의 완성 표현식이 true를 반환하는 경우 글꼴 색상</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p>패널에 한 번 초점이 맞춰졌다가 완성 표현식이 false를 반환하는 경우 글꼴 색상</p> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>도구 모음, 모바일 장치, 왼쪽에서 고정 위치</p> </td> 
  </tr> 
  <tr> 
