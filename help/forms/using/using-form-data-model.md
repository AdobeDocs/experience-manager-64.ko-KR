...
다음을 만들 수 있습니다 [적응형 양식](/help/forms/using/creating-adaptive-form.md) 및 [적응형 양식 조각](/help/forms/using/adaptive-form-fragments.md) 양식 데이터 모델 기반. 적응형 양식 또는 적응형 양식 조각을 만들 때 양식 데이터 모델을 사용하려면 다음을 수행하십시오.
...
양식 데이터 모델을 기반으로 하는 적응형 양식 또는 적응형 양식 조각을 만들면 양식 데이터 모델 개체가 **[!UICONTROL 데이터 모델 개체]** 적응형 양식 편집기의 컨텐츠 브라우저에 있는 탭.
...
양식 데이터 모델 편집기를 사용하면 양식 데이터 모델에서 데이터 모델 개체에 대한 샘플 데이터를 생성하고 편집할 수 있습니다. 이 데이터를 사용하여 대화형 통신 및 적응형 양식을 미리 보고 테스트할 수 있습니다. 에 설명된 대로 미리 보기 전에 샘플 데이터를 생성해야 합니다 [양식 데이터 모델 작업](/help/forms/using/work-with-form-data-model.md#sample).

샘플 양식 데이터 모델 데이터를 사용하여 대화형 커뮤니케이션을 미리 보려면 다음을 수행하십시오.

1. AEM 작성자 인스턴스에서 **[!UICONTROL Forms > Forms 및 문서]**.
1. 대화형 커뮤니케이션을 선택하고 탭하기 **[!UICONTROL 미리 보기]** 도구 모음에서 를 선택하여 **[!UICONTROL 웹 채널]**, **[!UICONTROL 인쇄 채널]**, 또는 **[!UICONTROL 두 채널 모두]** 대화형 커뮤니케이션을 미리 보려면
1. 미리 보기에서 [*channel*] 대화 상자 **[!UICONTROL 양식 데이터 모델의 테스트 데이터]** 선택한 후 탭합니다. **[!UICONTROL 미리 보기]**.

대화형 커뮤니케이션은 미리 채워진 샘플 데이터를 사용하여 열립니다.

![web-preview](assets/web-preview.png)

마찬가지로 샘플 데이터를 사용하여 적응형 양식을 미리 보려면 작성자 모드에서 적응형 양식을 열고 탭합니다 **[!UICONTROL 미리 보기]**.
...
사용자가 양식 데이터 모델을 기반으로 양식을 제출할 때 데이터 모델 개체에 대해 제출된 데이터를 해당 데이터 소스에 기록하도록 양식을 구성할 수 있습니다. 이 사용 사례를 달성하기 위해 AEM Forms에서는 [양식 데이터 모델 제출 작업](/help/forms/using/configuring-submit-actions.md)양식 데이터 모델을 기반으로 하는 적응형 양식에 대해서만 기본적으로 사용할 수 있습니다. 데이터 소스에 데이터 모델 개체에 대해 제출된 데이터를 기록합니다.
...
1. 추가된 구성 요소를 탭하고 탭합니다 ![settings_icon](assets/settings_icon.png) 구성 요소에 대한 속성 브라우저를 열려면 다음을 수행하십시오.
1. Bind Reference 필드에서 ![foldersearch_18](assets/foldersearch_18.png) 양식 데이터 모델에서 추가한 이진 속성을 선택합니다. 필요에 따라 다른 속성을 구성합니다.

   탭 ![확인 단추](assets/check-button.png) 속성을 저장합니다. 이제 첨부 파일 필드가 양식 데이터 모델의 이진 속성에 바인딩됩니다.
...
양식 데이터 모델을 기반으로 하는 적응형 양식에서는 다음을 수행할 수 있습니다 [규칙 만들기](/help/forms/using/rule-editor.md) 양식 데이터 모델에 구성된 서비스를 호출하는 중입니다. 다음 **[!UICONTROL 서비스 호출]** 규칙의 작업은 양식 데이터 모델에서 사용 가능한 모든 서비스를 나열하며 서비스에 대한 입력 및 출력 필드를 선택할 수 있도록 해줍니다. 를 사용할 수도 있습니다 **값 설정** 규칙 유형을 사용하여 양식 데이터 모델 서비스를 호출하고 필드의 값을 서비스가 반환한 출력으로 설정합니다.

예를 들어, 다음 규칙은 사원 ID를 입력으로 사용하는 get 서비스를 호출하고 반환된 값은 해당 종속 ID, 성, 이름 및 성별 필드에 형식으로 채워집니다.

![invoke-service](assets/invoke-service.png)

또한 `guidelib.dataIntegrationUtils.executeOperation` 규칙 편집기의 코드 편집기에서 JavaScript를 작성할 API입니다. API 세부 사항은 [양식 데이터 모델 서비스를 호출하는 API](/help/forms/using/invoke-form-data-model-services.md).
