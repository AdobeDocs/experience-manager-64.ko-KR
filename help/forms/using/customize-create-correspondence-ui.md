...
# 통신 UI {#customize-create-correspondence-ui} 만들기 사용자 정의
...
![Create Correspondence UIFigure:Create Correspondence UI](assets/0_1_introscreenshot.png)
**** *의 사용자 지정 아이콘*
...
![사용자 정의 로고를 사용하여 통신 사용자 인터페이스 ](assets/0_1_introscreenshot-1.png)
**만들기 그림:** *편지 쓰기 UI 만들기의 사용자 정의 아이콘*
