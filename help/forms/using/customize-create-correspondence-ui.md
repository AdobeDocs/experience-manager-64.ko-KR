...
![](assets/0_1_introscreenshot.png) 통신 UI 만들기의 사용자 정의 아이콘&#x200B;****:통신 *UI 만들기의 사용자 정의 아이콘*
...
![](assets/0_1_introscreenshot-1.png) 사용자 정의 로고를&#x200B;**사용하여 통신 사용자 인터페이스**&#x200B;만들기 그림:통신 *UI 만들기의 사용자 정의 아이콘*
