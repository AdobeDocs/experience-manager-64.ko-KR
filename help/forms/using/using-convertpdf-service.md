...
PDF 변환 서비스는 PDF 문서를 PostScript 또는 이미지 파일(JPEG, JPEG 2000, PNG 및 TIFF)로 변환합니다. PDF 문서를 PostScript로 변환하는 것은 모든 PostScript 프린터에서 서버 기반 무인 인쇄에 유용합니다. PDF 문서를 지원하지 않는 컨텐츠 관리 시스템에서 문서를 보관하는 경우 PDF 문서를 여러 페이지로 된 TIFF 파일로 변환하는 것이 실용적입니다.
...
* PDF 문서를 JPEG, JPEG 2000, PNG 및 TIFF 이미지 포맷으로 변환할 수 있습니다. 이러한 이미지 형식으로 변환할 때 변환 작업을 사용하여 소스 문서와 이미지 옵션 사양을 지정할 수 있습니다. 사양에는 이미지 변환 포맷, 이미지 해상도, 색상 변환 등 다양한 기본 설정이 포함되어 있습니다.
...
* **[toImage](https://helpx.adobe.com/experience-manager/6-4/forms/javadocs/com/adobe/fd/cpdf/api/ConvertPdfService.html#toImage)**: PDF 문서를 이미지 파일로 변환합니다. 지원되는 이미지 포맷은 JPEG, JPEG2000, PNG 및 TIFF입니다.
