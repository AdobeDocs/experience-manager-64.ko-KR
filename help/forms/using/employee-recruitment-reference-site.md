...
John Doe는 그의 받은 편지함에서 인터뷰를 예약하는 임무를 받습니다. John Doe는 작업을 선택 및 열고 인터뷰 날짜와 시간, 위치, 그리고 인터뷰를 담당하는 HR 담당자를 존 제이콥으로 수정합니다. John Doe가 초대 이메일 전송을 클릭합니다. 사라에게 이메일이 보내지고, 사라를 인터뷰하기 위해 고용 매니저 글로리아에게 업무가 할당되었다.
