...
1. 다음으로 이동 `/libs/fd/af/runtime/clientlibs/guideRuntime`그리고 `fp.validation` 값 **포함** 속성을 사용합니다.

1. /libs/fd/af/runtime/clientlibs/guideRuntimeWithXFA로 이동하여 를 추가합니다. `fp.validation` 값 **포함** 속성을 사용합니다.
