...
1. 1단계에서 만든 노드에 두 폴더 `less` 와 `css`파일 `css.txt` 을 추가합니다.
   ...
   * `/apps/clientlibs/fd/af/guidetheme/common/less/layoutvariables.less`
   ...
   적응형 양식에서 제공되는 더 적은 수의 변수를 사용하거나, 이러한 변수를 재정의하거나, 더 적은 변수를 새로 만들 수 있습니다.
   ...
   * `layouts.less`
   ...
   >
   >그러나 css.txt 파일에서 style.less 파일을 만들지 않으면 다음 줄의 주석을 해제해야 합니다.
   >
   >**`#base=less`**
   >
   >그리고 다음 줄에 주석을 답니다.
...
1. 적응형 양식 테마 [섹션을 만들기](/help/forms/using/creating-custom-adaptive-form-themes.md#p-to-create-an-adaptive-form-theme-p) 위해 만든 테마를 포함하려면 사용자 정의 유형 페이지를 만듭니다 `cq:Component`.
   ...
   1. 페이지에서 테마를 사용하려면 overriding file library.jsp를 노드에 추가해야 합니다.

      그런 다음 이 아티클의 적응형 양식 테마 섹션을 만들려면
