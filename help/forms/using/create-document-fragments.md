...
# 자습서:문서 조각 {#tutorial-create-document-fragments} 만들기
...
[양식 데이터 모델 만들기](create-form-data-model-tutorial.md) 섹션에 설명된 대로 **FDM_Create_First_IC**&#x200B;을 이 자습서에서 문서 조각을 만드는 양식 데이터 모델로 사용합니다.
