...
<table> 
 <tbody>
  ...
  <tr>
   <td><p>초기화 </p> </td> 
   <td><p>이 스크립트는 런타임에 실행되며 응용 형식으로 재정의할 수 없습니다.</p> </td> 
  </tr>
  <tr>
   <td><p>계산</p> </td> 
   <td><p>적응형 양식의 계산 식에 매핑됩니다.</p> </td> 
  </tr>
  <tr>
   <td><p>유효성 검사 </p> </td> 
  ...
  <tr>
   ...
   <td><p>이 스크립트는 런타임에 실행되며 응용 형식으로 재정의할 수 없습니다.<br /> </p> </td> 
  </tr>
  <tr>
   <td><p>종료 </p> </td> 
   <td><p>이 스크립트는 런타임에 실행되며 응용 형식으로 재정의할 수 없습니다.</p> </td> 
