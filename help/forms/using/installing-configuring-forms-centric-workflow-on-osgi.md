...
OSGi [에서 양식 중심의 워크플로우를](/help/forms/using/aem-forms-workflow.md) 사용하여 적응형 양식 기반 워크플로우를 신속하게 구축할 수 있습니다. 이러한 워크플로우를 통해 검토 및 승인 워크플로우, 비즈니스 프로세스 워크플로우 및 기타 반복적인 작업을 자동화할 수 있습니다. 또한 이러한 워크플로우를 통해 문서 처리(PDF 문서 작성, 조합, 배포 및 보관, 디지털 서명 추가, 문서 액세스 제한, 바코드 양식 디코딩 등)와 양식 및 문서에서 Adobe Sign 서명 워크플로우를 사용할 수 있습니다.
...
AEM Forms는 강력한 엔터프라이즈급 플랫폼입니다. OSGi의 양식 중심 워크플로우는 AEM Forms 기능 중 하나에 불과합니다. 전체 기능 목록은 AEM Forms [소개를 참조하십시오](/help/forms/using/introduction-aem-forms.md).

>[!NOTE]
>
>OSGi의 양식 중심 워크플로우를 사용하면 JEE 스택에 완벽한 프로세스 관리 기능을 설치하지 않고도 OSGi 스택에서 다양한 작업을 위한 워크플로우를 신속하게 구축 및 배포할 수 있습니다. OSGi 및 JEE의 프로세스 관리에 대한 양식 중심의 AEM 워크플로우를 [비교한](/help/forms/using/capabilities-osgi-jee-workflows.md) 내용을 통해 기능의 차이점과 유사점을 살펴볼 수 있습니다.
>
...
>[!NOTE]
>
>OSGi에 이미 AEM [Forms를 설치한 경우](#next-steps) 설치 및 구성 데이터 캡처 기능 [문서에 설명된 대로 문서의 다음 단계](/help/forms/using/installing-configuring-aem-forms-osgi.md) 섹션으로 건너뜁니다.
...
OSGi 시나리오의 일반적인 Adobe Sign 및 양식 중심 워크플로우에서는 사용자가 적응형 양식을 작성하여 서비스에 적용합니다. 예를 들어 신용 카드 신청서와 시민 혜택 양식이 있습니다. 사용자가 애플리케이션 양식을 채우고 제출 및 서명하면 승인/거부 워크플로우가 시작됩니다. 서비스 공급업체는 AEM 받은 편지함에서 애플리케이션을 검토하고 Adobe Sign을 사용하여 응용 프로그램에 전자 서명합니다. 유사한 전자 서명 워크플로우를 사용하려면 AEM Forms와 Adobe Sign을 통합할 수 있습니다.
...
* [서신 및 인터랙티브한 커뮤니케이션의 게시 처리](/help/forms/using/submit-letter-topostprocess.md)
