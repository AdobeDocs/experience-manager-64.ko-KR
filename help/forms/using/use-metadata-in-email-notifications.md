...
메타데이터를 사용하여 양식 워크플로우 이메일 알림의 정보를 채울 수 있습니다.

작업 할당 단계를 사용하여 작업을 만들고 사용자 또는 그룹에 지정할 수 있습니다. 작업이 사용자 또는 그룹에 할당되면 정의된 사용자 또는 정의된 그룹의 각 구성원에게 이메일 알림이 전송됩니다. 일반적인 [이메일 알림](/help/forms/using/use-custom-email-template-assign-task-step.md)에는 할당된 작업의 링크와 작업과 관련된 정보가 포함되어 있습니다.
