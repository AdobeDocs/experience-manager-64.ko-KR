...
가장 일반적으로 적용 가능한 단계는 AEM Forms 작업 영역 사용자 [지정을](/help/forms/using/generic-steps-html-workspace-customization.md)위한 일반 단계에서 다룹니다. 세부 단계를 비롯하여 이러한 사용자 지정의 구체적인 예는 이 문서의 후반부에 있는 관련 문서를 참조하십시오.
...
이러한 사용자 지정을 수행하는 정확한 단계는 AEM Forms 작업 [영역 사용자 지정을](/help/forms/using/generic-steps-html-workspace-customization.md)위한 일반 단계를 참조하십시오. AEM Forms 작업 영역과 함께 제공되는 CSS 파일은 /libs/ws/css/에 있습니다. CSS 관련 사용자 지정의 경우 배송 패키지를 [사용하십시오](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p). CSS 관련 사용자 지정에 대한 구체적인 예는 이 문서의 후반부에 있는 관련 도움말 항목을 참조하십시오.

#### 이미지 {#image}

AEM Forms 작업 영역을 사용자 지정하여 사용자 아바타를 추가하거나 조직의 로고를 추가할 수 있습니다. 이러한 사용자 지정의 경우 배송 [패키지를 사용하십시오](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p).
...
AEM Forms 작업 영역에서 이미지 사용자 지정을 시작하려면 AEM Forms 작업 [영역 사용자 지정을](/help/forms/using/generic-steps-html-workspace-customization.md)위한 일반 단계를 따르십시오. 이미지 관련 사용자 지정 예제에 대한 자세한 내용은 이 문서의 후반부에 있는 관련 도움말 항목을 참조하십시오.
...
이러한 사용자 지정 예제에 대한 자세한 내용은 이 문서의 후반부에 있는 도움말 항목을 참조하십시오. 사용자 지정할 [템플릿에 따라](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p) 배송 패키지 [또는](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p)개발 패키지 중에서 선택합니다.
...
* 배송, 디버그 및 개발 프로필용 CRX 패키지(CRX 패키지에 [](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p)아래 참조).
