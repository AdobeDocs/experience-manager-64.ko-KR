...
AEM 양식 작업 영역에서는 인터페이스의 프레젠테이션 의미론과 기능을 수정하는 기능을 제공합니다. 스타일, 레이아웃, 서식, 브랜딩 및 핵심 기능을 변경하기 위한 사용자 정의 유형은 아래에 설명되어 있습니다.
...
가장 일반적으로 적용할 수 있는 단계는 AEM Forms 작업 영역 사용자 지정을 위한 [일반 단계입니다](/help/forms/using/generic-steps-html-workspace-customization.md). 세부 단계를 비롯한 이러한 사용자 지정 예제에 대한 자세한 내용은 이 문서의 후반부에 있는 관련 문서를 참조하십시오.

#### 스타일 시트 이해 {#understanding-the-style-sheet}

작업 영역을 사용자 정의하기 전에 /libs/ws/css/style.css에서 AEM Forms과 함께 제공되는 기본 스타일 시트를 잘 알고 있습니다.
...
이러한 사용자 지정을 수행하는 정확한 단계는 AEM Forms 작업 공간 사용자 [지정에 대한 일반 단계를 참조하십시오](/help/forms/using/generic-steps-html-workspace-customization.md). AEM Forms 작업 영역과 함께 제공되는 CSS 파일은 /libs/ws/css/입니다. CSS 관련 사용자 지정의 경우 [배송 패키지를 사용하십시오](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p). CSS 관련 사용자 정의에 대한 특정 예제는 이 문서의 끝 부분에 있는 관련 도움말 항목을 참조하십시오.

#### 이미지 {#image}

AEM Forms 작업 영역을 사용자 지정하여 사용자 아바타를 추가하거나 조직의 로고를 추가할 수 있습니다. 이러한 사용자 설정의 경우 [배송 패키지를 사용하십시오](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p).
...
AEM Forms 작업 영역에서 이미지를 사용자 정의하려면 AEM Forms 작업 공간 사용자 지정에 대한 [일반 단계를 따르십시오](/help/forms/using/generic-steps-html-workspace-customization.md). 이미지 관련 사용자 지정 예제에 대한 자세한 내용은 이 문서의 후반부에 있는 관련 도움말 항목을 참조하십시오.
...
이러한 사용자 지정 예제에 대한 자세한 내용은 이 문서의 마지막에 제공되는 도움말 항목을 참조하십시오. 사용자 정의할 템플릿에 따라 [배송 패키지](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p) 또는 [개발 패키지](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p)중에서 선택합니다.

### 의미 변경 {#semantic-changes}

AEM Forms 작업 영역 기능을 수정하려면 JavaScript 소스 코드를 변경합니다. 핵심 기능의 수정 사항은 의미 체계 변경 사항으로 레이블이 지정됩니다. AEM Forms 작업 공간의 소스 코드의 일부로 제공되는 모델, 뷰 및 템플릿을 수정할 수 있습니다.
...
AEM Forms 작업 영역은 구성 요소 기반 소프트웨어이므로 손쉽게 사용자 정의 및 재사용할 수 있습니다. 작업 영역 구성 요소를 웹 애플리케이션과 손쉽게 통합할 수 있습니다.
...
이 패키지에는 AEM Forms 작업 영역의 소스 코드가 들어 있습니다. 소포는 에서 사용할 수 있습니다 `[*LC root*]\sdk\html-workspace\adobe-lc-workspace-src.zip`.

기본적으로 다음을 생성하는 기능을 제공하므로 사용자 지정을 위한 것입니다.

* 배송, 디버그 및 개발 프로파일에 대한 CRX 패키지( [CRX 패키지에](/help/forms/using/introduction-customizing-html-workspace.md#p-crx-package-p)아래 참조).
...
* client-html:
   ...
   * src/main/webapp -
      ...
      * js:
         ...
         * minifier - 사용자 정의된 javascript 코드의 조합, 축소 및 통합에 사용됩니다.
         ...
         * 런타임:
            ...
            * 서비스 - AEM Forms 작업 공간에 사용된 service.js를 포함합니다. 모든 서버 호출은 service.js를 통해 수행됩니다.
         ...
         * main.js
         * router.js
      * libs/ws: pdf.html 및 pluginPing.pdf는 AEM Forms 작업 영역에서 PDF forms을 로드하는 데 사용되고 WSNextAdapter.swf는 AEM Forms 작업 영역에서 SWF 양식 및 안내선을 로드하는 데 사용됩니다.
      * locales:
...
* js:
   ...
   * 런타임:
      ...
      * 경로 - AEM Forms 작업 영역의 시작 프로세스, 수행할 작업, 추적 및 환경 설정을 로드하는 javascript 파일과 HTML 파일을 포함합니다.
      * 서비스 - AEM Forms 작업 공간에 사용된 service.js를 포함합니다.
      * 템플릿 - AEM Forms 작업 공간에 있는 모든 구성 요소의 HTML 파일 등 모든 템플릿을 포함합니다.
      * util - AEM Forms 작업 영역에서 사용되는 모든 유틸리티 파일(JavaScript)을 포함합니다.
