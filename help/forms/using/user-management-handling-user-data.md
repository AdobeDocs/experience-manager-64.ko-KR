...
사용자 관리는 사용자 데이터를 My Sql, Oracle, MS SQL Server 및 IBM DB2와 같은 데이터베이스에 저장합니다. 또한 AEM 작성자의 Forms 응용 프로그램(`https://[*server*]:[*host*]/lc`)에 최소 한 번 로그인한 사용자는 AEM 저장소에 생성됩니다. 따라서 사용자 관리는 다음 데이터 저장소에 저장됩니다.
...
`https://[*server*]:[*host*]/lc` 아래의 Forms 응용 프로그램에 적어도 한 번 액세스한 사용자의 사용자 관리 데이터도 AEM 저장소에 저장됩니다.
