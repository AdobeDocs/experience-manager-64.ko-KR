...
를 사용할 수 있습니다 `getDocumentUsageRights`정책으로 보호된 PDF 문서에 적용된 Reader 확장 사용 권한을 검색하는 Java API입니다. 사용 권한에 대한 정보를 검색하면 정책으로 보호된 PDF 문서에 대해 기능 판독기 확장 기능을 사용하도록 설정할 수 있습니다.
