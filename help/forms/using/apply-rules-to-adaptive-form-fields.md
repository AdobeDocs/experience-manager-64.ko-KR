...
이 자습서는 첫 번째 적응형 양식 [만들기 시리즈의 한 단계입니다](/help/forms/using/create-your-first-adaptive-form.md) . Adobe은 전체 자습서 사용 사례를 이해하고, 실행하고, 시연하기 위해 연재 순서에서 시리즈 다음에 나오는 것이 좋습니다.
...
적응형 Forms 규칙 편집기에서 규칙 [편집기에 대해 자세히 알아볼 수 있습니다](/help/forms/using/rule-editor.md).
