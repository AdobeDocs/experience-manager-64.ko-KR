...
1. 앱 폴더에서 다음 단계를 사용하여 선택 폴더에 있는 항목 폴더와 유사한 경로/구조가 있는 항목이라는 폴더를 만듭니다.
   ...
   1. [오버레이 노드] 대화 상자에 다음 값이 있는지 확인합니다.
      ...
      **[!UICONTROL 경로:]** /libs/fd/cm/ma/gui/content/csmsets/jcr:content/body/content/header/items/selection/items
...
1. 새로 만든 항목 폴더 아래에서 특정 자산의 사용자 지정 단추/작업에 대한 노드를 추가합니다(예:downloadFlatPDF)에서 다음 단계를 수행합니다.
   ...
   1. 노드 만들기 대화 상자에 다음 값이 있는지 확인하고 **[!UICONTROL 확인]**&#x200B;을 클릭합니다.
      ...
      **[!UICONTROL 문자:]** nt:unstructured

   1. 새로 만든 노드를 클릭합니다(여기에서 downloadFlatPDF). CRX에 노드의 속성이 표시됩니다.
   1. 노드에 다음 속성을 추가하고(여기에서 downloadFlatPDF) **[!UICONTROL 모두 저장]**&#x200B;을 클릭합니다.
...
1. 앱 폴더에서 다음 단계를 사용하여 관리자 폴더에 있는 항목 폴더와 유사한 경로/구조가 있는 js라는 폴더를 만듭니다.
   ...
   1. **[!UICONTROL 확인]**&#x200B;을 클릭합니다. 폴더 구조는 앱 폴더에 생성됩니다. **[!UICONTROL 모두 저장]**&#x200B;을 클릭합니다.
...
1. apps 폴더에서 다음 단계를 사용하여 actionhandler 폴더에 있는 항목 폴더와 유사한 경로/구조가 있는 항목이라는 폴더를 만듭니다.
   ...
   1. [오버레이 노드] 대화 상자에 다음 값이 있는지 확인합니다.
      ...
      **[!UICONTROL 경로:]** /libs/fd/cm/ma/gui/content/commons/actionhandler/items/
...
1. 새로 만든 항목 노드 아래에서 특정 자산의 사용자 지정 단추/작업에 대한 노드를 추가합니다(예:letterpdfdownloader)를 사용합니다.
   ...
   1. 노드 만들기 대화 상자에 다음 값이 있는지 확인하고 **[!UICONTROL 확인]**&#x200B;을 클릭합니다.
      ...
      **[!UICONTROL 이름:]** letterpdfdownloader(또는 이 속성에 지정할 이름 - 고유해야 합니다. 여기에서 다른 이름을 사용하는 경우 formaction.js 파일의 ACTION_URL 변수에서 동일한 이름을 지정하십시오.)

      **[!UICONTROL 문자:]** nt:unstructured

   1. 새로 만든 노드를 클릭합니다(여기에서 downloadFlatPDF). CRX에 노드의 속성이 표시됩니다.

   1. 노드에 다음 속성을 추가하고(여기에서 letterpdfdownloader) **[!UICONTROL 모두 저장]**&#x200B;을 클릭합니다.
...
1. 다음 위치에서 명령의 작업 처리를 위한 코드와 함께 POST.jsp라는 파일을 만듭니다.
   ...
   1. 다음 코드를 POST.jsp 파일에 추가하고 **[!UICONTROL 모두 저장]**&#x200B;을 클릭합니다.
...
1. **[!UICONTROL Forms > 문자]**&#x200B;를 선택합니다. 통신 관리에는 시스템에서 사용 가능한 문자가 나열됩니다.
1. **[!UICONTROL 선택]**&#x200B;을 클릭한 다음 문자를 클릭하여 선택합니다.
1. **[!UICONTROL 자세히]** > &lt;플랫 PDF 다운로드>를 선택합니다(이 문서의 지침에 따라 생성된 사용자 정의 기능). [문자를 PDF로 다운로드] 대화 상자가 나타납니다.
...
1. [PDF로 편지 다운로드] 대화 상자에서 PDF의 데이터를 채울 관련 XML을 선택합니다.
   ...
   >[!NOTE]
   >
   >편지지 PDF로 다운로드하기 전에 **[!UICONTROL 보고서 만들기]** 옵션을 사용하여 편지의 데이터로 XML 파일을 만들 수 있습니다.
