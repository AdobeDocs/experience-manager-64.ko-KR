...
# JEE의 AEM Forms에 대한 일반적인 보안 고려 사항 {#general-security-considerations-for-aem-forms-on-jee}

JEE 환경에서 AEM Forms의 강화를 준비하는 방법을 알아봅니다.
...
운영 체제의 보안을 유지하는 경우 운영 체제 공급업체에서 설명하는 다음 사항을 포함하여 해당 조치를 신중하게 구현하십시오.
...
<table> 
 ...
 <tbody>
  ...
  <tr> 
   ...
   <td><p>Oracle <a href="https://docs.oracle.com/database/121/TDPSG/GUID-6E2F4E53-5D87-4FCD-9C9C-6792217D7014.htm#TDPSG94426" target="_blank">12g 설명서의 보안 장 참조</a></p> </td> 
  </tr> 
 </tbody> 
</table>

이 표에서는 JEE 구성 프로세스 중 AEM Forms에서 열어야 하는 기본 포트를 설명합니다. https를 통해 연결하는 경우 포트 정보와 IP 주소를 적절하게 조정합니다. 포트 구성에 대한 자세한 내용은 응용 프로그램 서버용 JEE *에 AEM Forms* 설치 및 배포 문서를 참조하십시오.
...
## AEM Forms의 JEE 보안 고려 사항 {#aem-forms-on-jee-security-considerations}
...
lc_[database].xml 파일은 명확한 텍스트 형식의 암호를 포함할 수 없습니다. 응용 프로그램 서버의 이러한 암호를 암호화하는 방법에 대해서는 응용 프로그램 서버 공급업체에 문의하십시오.
