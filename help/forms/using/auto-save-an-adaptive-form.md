...
1. (선택 사항) 익명 사용자를 위해 콘텐츠를 자동으로 저장하려면 **익명 사용자에 대해 자동 저장 활성화** 옵션을 선택하고 **[!UICONTROL 확인]**&#x200B;을 클릭합니다.
   ...
   >
   >서비스를 구성하려면 `https://[server]:[host]/system/console/configMgr`의 AEM Web Console 구성으로 이동한 후 **[!UICONTROL Forms Common Configuration Service]** 를 편집하여 **[!UICONTROL Allow]** 필드에서 **[!UICONTROL 모든 사용자]** 옵션을 선택하고 구성을 저장합니다.
