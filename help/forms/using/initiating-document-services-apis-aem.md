...
### DCX 작업 과정 호출 {#invoke-ddx-workflow}

**DCX 호출** 작업 과정에서는 `Invoke` Assembler 서비스 API를 호출하여 문서를 조합하거나 분해하고 PDF에 워터마크를 추가하는 등의 작업을 수행할 수 있습니다.

1. 사이드킥의 Forms Workflow 탭 아래에 있는 **[!UICONTROL DCX 호출]** 워크플로우 단계를 드래그합니다.
...
### 비대화형 PDF 출력 작업 과정 생성   {#generate-non-interactive-pdf-output-workflow-nbsp}
