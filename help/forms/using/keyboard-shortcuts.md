...
description: 이 문서에서는 Windows 및 Macintosh 운영 체제용 적응형 양식 편집기, 테마 편집기, 컨텐츠 브라우저 및 통신 관리와 함께 사용할 수 있는 키보드 단축키를 나열합니다.
...
이 문서에서는 Windows 및 Macintosh 운영 체제용 적응형 양식 편집기, 테마 편집기, 컨텐츠 브라우저 및 통신 관리와 함께 사용할 수 있는 키보드 단축키를 나열합니다.

## 응용 양식 편집기 {#adaptiveformeditor}

| **작업** | **Windows의 단축키** | **Mac OS의 단축키** |
|---|---|---|
| 선택한 적응형 양식 구성 요소의 속성 브라우저 열기 | Alt+Enter | Alt+Return |
...
| 선택한 구성 요소 복사 | Ctrl+C | Ctrl-C&amp;Amp;ast; |
| 선택한 구성 요소를 잘라냅니다. 잘라내기 구성 요소는 새 위치에 붙여넣을 때까지 사라지지 않습니다. | Ctrl+X | Ctrl-X&amp;Amp;ast; |
...
>[!NOTE]
>
>Mac OS의 경우 Ctrl 및 Command 키를 모두 사용하여 &#39;&amp;ast;&#39;로 표시된 단축키가 작동합니다.
...
| **작업** | **Windows의 단축키** | **Mac OS의 단축키** |
|---|---|---|
| 포커스가 있을 때 컨텐츠 브라우저의 양식 객체 트리에서 모든 아코디언을 확장합니다. | 모든 아코디언을 선택하려면 Ctrl+A, 확장하려면 오른쪽 화살표 | Command+A를 눌러 모든 아코디언을 선택하고 오른쪽 화살표를 클릭하여 확장합니다. |
| 포커스가 있는 경우 컨텐츠 브라우저의 양식 객체 트리의 모든 아코디언 축소 | 축소하려면 Ctrl+A를 누른 상태에서 모든 아코디언 선택 후 왼쪽 화살표 선택 | Command+A를 눌러 모든 아코디언을 선택하고 왼쪽 화살표를 클릭하여 축소합니다. |
...
[1] 는 Windows의 경우 Ctrl + 오른쪽 화살표, Mac OS의 경우 Command + 오른쪽 화살표 교체.\
[2] 는 Windows의 경우 Ctrl + 왼쪽 화살표, Mac OS의 경우 Command + 왼쪽 화살표를 바꿉니다.

## 서신 관리 {#correspondence-management}

이 섹션에서는 통신 관리 텍스트 편집기에서 사용할 수 있는 다양한 키보드 및 액세서빌러티 단축키를 나열합니다. 다음과 같은 시기에 바로 가기를 사용할 수 있습니다.

* [Text](document-fragments.md) 자산 만들기 또는 편집
...
### 텍스트 선택 및 {#text-selection-and-moving-the-cursor-around} 주위의 커서 이동

<table> 
 <tbody>
  <tr>
   <th><strong>작업</strong></th> 
   <th><strong>Windows의 단축키</strong></th> 
   <th><strong>Mac OS의 단축키</strong><br /> </th> 
  </tr>
  <tr>
   <td><p>현재 단어 선택</p> </td> 
  ...
  <tr>
   <td><p>선택 영역을 단락의 끝으로 확장합니다.</p> </td> 
  ...
  <tr>
   <td><p>텍스트를 한 문자씩 앞으로 선택</p> </td> 
   <td><p>Shift+오른쪽 화살표</p> </td> 
   <td>Shift+오른쪽 화살표</td> 
  </tr>
  <tr>
   <td><p>뒤쪽으로 한 단락을 하나씩 텍스트 선택</p> </td> 
   <td><p>Shift+위쪽 키</p> </td> 
   <td>Shift+위쪽 키</td> 
  </tr>
  <tr>
   <td><p>앞으로 단락을 하나씩 선택한 텍스트</p> </td> 
  ...
  <tr>
   <td><p>현재 위치에서 모듈 끝까지 텍스트 선택</p> </td> 
...
<table> 
 <tbody>
  <tr>
   ...
   <th><p><strong>Windows의 단축키<br /> </strong></p> </th> 
   <th><strong>Mac OS의 단축키</strong></th> 
  </tr>
  <tr>
   <td><p>단락 가운데 정렬</p> </td> 
   <td><p>Ctrl+E</p> </td> 
...
<table> 
 <tbody>
  <tr>
   <th><p><strong>작업</strong></p> </th> 
   <th><p><strong>Windows의 단축키</strong></p> </th> 
   <th><strong>Mac OS의 단축키</strong></th> 
  </tr>
  <tr>
...
<table> 
 <tbody>
  <tr>
   <th><strong>작업</strong></th> 
   <th><strong>Windows의 단축키<br /> </strong></th> 
   <th><strong>Mac OS의 단축키</strong></th> 
  </tr>
  <tr>
   <td><p>텍스트 붙여넣기 </p> </td> 
