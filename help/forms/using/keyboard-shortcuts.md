...
| 선택한 적응형 양식 구성 요소에 대한 속성 브라우저 닫기 | Ctrl+Alt+W | Command+Alt+W |
...
| 양식 개체 트리에서 다음 항목을 선택합니다. | 아래쪽 화살표 | 아래쪽 화살표 |
| 양식 개체 트리에서 이전 항목 선택 | 위쪽 화살표 | 위쪽 화살표 |

[1] Windows의 경우 Ctrl + 오른쪽 화살표, Mac OS의 경우 Command + 오른쪽 화살표 대체\
[2] Windows의 경우 Ctrl + 왼쪽 화살표, Mac OS의 경우 Command + 왼쪽 화살표 대체
...
<table> 
 <tbody>
  ...
  <tr>
   <td><p>텍스트를 한 단락씩 뒤로 선택</p> </td> 
   <td><p>Shift+위쪽 키</p> </td> 
   <td>Shift+위쪽 키</td> 
  </tr>
  <tr>
   <td><p>앞으로 단락을 하나씩 선택</p> </td> 
