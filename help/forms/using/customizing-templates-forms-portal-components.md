...
* **htmlStyle**  및  **pdfStyle**:렌더링에 각각 사용되는 HTML 및 PDF 아이콘의 스타일을 표시합니다. 유효한 값은 &quot;**__FP_display_none**&quot; 또는 **blank**&#x200B;입니다
...
1. **지역화 지원**:정적 텍스트를 현지화하려면  **${localize-***YOUR_TEXT***}**  속성을 사용하고 현지화된 값이 없는 경우 사용할 수 있도록 하십시오.
...
1. **구성 속성 사용**:Search &amp; Lister 구성 요소에는 사용자 인터페이스에서 사용할 수 있는 몇 가지 구성이 있습니다. 예를 들어, 편집 대화 상자를 통해 저장된 HTML ToolTip 텍스트를 표시하려면 **${config-htmlLinkText} 속성을 사용합니다.**&#x200B;마찬가지로 PDF 도구 설명 텍스트의 경우 **${config-pdfLinkText}**  특성을 사용합니다.
...
1. 초안 및 제출 문서를 여는 링크를 만드는 동안 **$path.html** 을 앵커 태그에 대한 **href** 속성 값으로 지정할 수 있습니다.
