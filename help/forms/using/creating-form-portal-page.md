...
양식 포털 구성 요소는 웹 개발자에게 AEM(Adobe Experience Manager)을 사용하여 제작한 웹 사이트에서 양식 포털을 만들고 사용자 정의하는 구성 요소를 제공합니다. 양식 포털에 대한 간단한 개요를 보려면 [포털에서](/help/forms/using/introduction-publishing-forms.md)양식 게시 소개를 참조하십시오.
...
![](assets/component-categories.png) 구성 요소 브라우저의 AEM Forms 포털 구성 요소&#x200B;****&#x200B;그림:양식 *포털 구성 요소 카테고리*
...
![](assets/fp-grid-viw.png) 페이지의 검색 및 라이브러리 구성 요소&#x200B;****&#x200B;그림:격자 *레이아웃이 있는 페이지에서 구성 요소 검색 및 목록 만들기*

### 목록 창 {#list-pane}

목록 창은 양식이 나열되는 영역입니다. 검색 및 라이브러리 구성 요소는 목록 창에서 양식의 표시를 제어하는 데 사용할 수 있는 다양한 구성 옵션을 제공합니다.

목록 창을 구성하려면 검색 및 라이브러리 구성 요소를 누른 다음 ![settings_icon](assets/settings_icon.png)을 누릅니다. 구성 **[!UICONTROL 요소 편집]** 대화 상자가 열립니다.

![](assets/edit-list.png) 편집 모드의 목록 창&#x200B;****&#x200B;그림:편집 *모드의 목록 창*

편집 **[!UICONTROL 대화]** 상자에는 아래 표에 설명된 구성 옵션을 제공하는 여러 탭이 포함되어 있습니다. 완료되면 **[!UICONTROL 확인을]** 눌러 구성을 저장합니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>항목 추가</td> 
   <td>AEM Forms UI를 사용하여 자산이 업로드되는 폴더를 구성합니다. 기본적으로 업로드된 모든 자산이 나열됩니다. AEM Forms UI에 대한 자세한 내용은 <a href="/help/forms/using/introduction-managing-forms.md" target="_blank">양식</a>관리 소개를 참조하십시오.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> </td> 
   <td>결과 텍스트</td> 
   <td><p>결과 텍스트를 구성합니다(예: 601 결과 중 1-12 <strong>개</strong>). The default value is <strong>Results</strong>.</p> <p>예를 들어, 이 <strong>필드에 </strong>Forms를 지정하고 총 601 <strong>개의 양식이 있는 경우 결과 텍스트는 601 Forms 중 1-12로변경됩니다.</strong></p> </td> 
  </tr> 
  <tr> 
   <td> </td> 
   <td>페이지 텍스트</td> 
   <td><p>페이지 텍스트를 구성합니다(예: 페이지 <strong>1/ </strong>51). The default value is <strong>Page</strong>.</p> <p>예를 들어, 이 <strong>필드에 </strong>애플리케이션 양식을 지정하고 51페이지가 있는 경우 페이지 텍스트는 애플리케이션 양식 <strong></strong>1/51로 변경됩니다.</p> </td> 
  </tr> 
  <tr> 
   <td> </td> 
   <td>/ 텍스트</td> 
   <td><p>의 단어를 <strong>지정된 텍스트(51</strong> 페이지의 1 <strong>페이지)로 </strong>바꿉니다. The default value is <strong>of</strong>.</p> <p>예를 들어 이 <strong>필드에서 </strong>out of <strong>in을 지정하면 텍스트가 51 </strong>페이지 중 1페이지로변경됩니다.</p> </td> 
  </tr> 
  <tr> 
...
![](assets/search-with-predicates.png) 날짜, 전체 텍스트, 속성 및 태그 조건자가 있는 검색&#x200B;**패널**&#x200B;그림:날짜, *전체 텍스트, 속성 및 태그 조건자가 있는 검색 패널*
...
1. 다음을 지정합니다.
   ...
   * **** 유형:사용 가능한 유일한 옵션은 마지막 **[!UICONTROL 수정 날짜입니다]**.
   * **** 텍스트:날짜 설명 구성 요소에 대한 레이블 또는 캡션입니다. 기본값은 **[!UICONTROL 마지막 수정 날짜입니다]**.
   * **** 시작 날짜 레이블:시작 날짜 필드의 레이블 또는 캡션.
   * **** 종료 날짜 레이블:종료 날짜 필드에 대한 레이블 또는 캡션.
   * **** 숨기기:기본 날짜 필터를 적용하여 양식을 나열합니다.
...
1. 구성 요소를 누른 다음 ![settings_icon](assets/settings_icon.png)을 누릅니다. 편집 대화 상자가 열립니다.
1. 기본 제목 필드에 제목을 **[!UICONTROL 지정합니다]** .
1. 확인을 **[!UICONTROL 누릅니다]**.
...
1. 구성 요소를 누른 다음 ![settings_icon](assets/settings_icon.png)을 누릅니다. 편집 **[!UICONTROL 대화 상자가]** 열립니다.
...
페이지의 아무 곳에서나 양식을 연결하려면 링크 구성 요소를 사용합니다. 링크 구성 요소에 대한 자세한 내용은 페이지에 [링크 구성 요소 포함을](/help/forms/using/embedding-link-component-page.md)참조하십시오.

초안 상태의 양식과 이미 제출된 양식을 나열하려면 초안 및 제출 **[!UICONTROL 구성 요소를]** 사용합니다. 자세한 내용은 초안 및 제출 [구성 요소](/help/forms/using/draft-submission-component.md)맞춤화를 참조하십시오.
...
![](assets/search_lister.png) 검색 및 라이브러리 구성 요소의 스크린샷&#x200B;****&#x200B;그림:검색 *및 라이브러리 구성 요소*

## 양식 포털 페이지 사용자 정의 {#customizing-a-forms-portal-page-br}

양식 포털 페이지를 사용자 지정하여 페이지에 고유한 모양을 제공할 수 있습니다. 또한 메타데이터를 추가하여 검색 경험을 향상시키고 페이지 레이아웃을 변경하고 사용자 정의 CSS 스타일을 추가할 수 있습니다. 자세한 내용은 Forms 포털 구성 [요소에 대한 템플릿 맞춤화를 참조하십시오](/help/forms/using/customizing-templates-forms-portal-components.md).

AEM Forms UI를 사용하여 양식에 사용자 지정 메타데이터를 추가할 수 있습니다. 사용자 지정 메타데이터는 최종 사용자에게 양식 목록 및 검색 환경을 제공할 때 유용합니다. 사용자 지정 메타데이터에 대한 자세한 내용은 Forms 포털 [구성 요소에 대한 템플릿 맞춤화를 참조하십시오](/help/forms/using/customizing-templates-forms-portal-components.md).

즉시 사용 가능한 양식 포털은 렌더링 작업을 제공합니다. 양식 포털을 사용자 지정하여 추가 작업을 추가할 수 있습니다. 자세한 내용은 양식 라이브러리 [항목에 사용자 정의 작업 추가를 참조하십시오.](/help/forms/using/add-custom-action-form-lister.md)
