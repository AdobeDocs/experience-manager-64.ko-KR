...
1. JEE 웹 컨텐츠 디렉토리 항목에 대한 AEM Forms의 읽기 및 실행, 목록 폴더 내용 및 읽기 권한을 새 사용자 계정에 부여합니다.
1. 응용 프로그램 서버를 시작합니다.
...
1. JEE 웹 컨텐츠 디렉토리에 대해 AEM Forms에 대한 읽기 및 실행, 목록 폴더 내용 및 읽기 권한을 새 사용자 계정에 지정합니다.
