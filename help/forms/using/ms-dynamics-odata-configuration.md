...
* [AEM 6.4 Forms 추가 기능 패키지를 설치함](https://helpx.adobe.com//experience-manager/6-4/forms/using/installing-configuring-aem-forms-osgi.html)
...
1. Microsoft Azure Active Directory 계정으로 이동하여 등록된 응용 프로그램의 **[!UICONTROL 회신 URL]** 설정에 다음 클라우드 서비스 구성 URL을 추가하십시오.
...
1. **[!UICONTROL MS Dynamics OData Cloud Service(OData 서비스)]** 구성을 선택하고 **[!UICONTROL 속성]**&#x200B;을 탭합니다. 클라우드 서비스 구성 속성 대화 상자가 열립니다.
   ...
   **[!UICONTROL 인증 설정]** 탭에서 다음을 수행합니다.
   ...
   1. **[!UICONTROL 서비스 루트]** 필드의 값을 입력합니다. Dynamics 인스턴스로 이동하고 **[!UICONTROL 개발자 리소스]**&#x200B;로 이동하여 서비스 루트 필드에 대한 값을 확인합니다. 예: https://&lt;tenant-name>/api/data/v9.1/
   1. **[!UICONTROL 클라이언트 Id]**(**[!UICONTROL 응용 프로그램 ID]**)와 **[!UICONTROL 클라이언트 암호]**, **[!UICONTROL OAuth URL]**, **[!UICONTROL 새로 고침 토큰 URL]**, **[!UICONTROL 액세스 토큰 URL]** 및 **[!UICONTROL 리소스]**&#x200B;의 기본값을 사용자의 Dynamics 구성/Microsoft Dynamics 구성 값으로 바꿉니다. 양식 데이터 모델로 Microsoft Dynamics를 구성하려면 **[!UICONTROL 리소스]** 필드에 Dynamics 인스턴스 URL을 지정해야 합니다. 서비스 루트 URL을 사용하여 Dynamics 인스턴스 URL을 파생하십시오. 예: [https://org.crm.dynamics.com](https://org.crm.dynamics.com/)
   1. Microsoft Dynamics에서 인증 프로세스를 위해 **[!UICONTROL 인증 범위]** 필드에 **[!UICONTROL openid]**&#x200B;을 지정하십시오.
...
양식 데이터 모델을 검토하려면 **[!UICONTROL Forms > 데이터 통합]**&#x200B;으로 이동합니다. **[!UICONTROL Microsoft Dynamics FDM]**&#x200B;을 선택하고 **[!UICONTROL 편집]**&#x200B;을 클릭하여 편집 모드에서 양식 데이터 모델을 엽니다. 또는 다음 URL에서 직접 양식 데이터 모델을 열 수 있습니다.
