...
런타임 시 행을 추가하거나 삭제할 **`+`** 버튼과 *`-`* 버튼이 표시됩니다.
...
![](assets/desktopview.png) desktopview ****&#x200B;그림:왼쪽 *레이아웃에 머리글이 있는 표의 데스크탑 보기*

![](assets/headersontheleft.png) headersontheleft ****&#x200B;그림:왼쪽 *레이아웃에 머리글이 있는 표의 모바일 보기*
...
![](assets/collapsed-column.png) collapsed-column ****&#x200B;그림:모바일 *장치에 표시되는 열이 두 개뿐인 표의 축소된 열*

![](assets/collapsible_column.png) collapsible_column ****&#x200B;그림:모바일 *장치에서 표의 확장된 열*
...
런타임 시 이 데이터를 테이블과 병합하려면 테이블이 포함된 적응형 양식을 wcmmode가 비활성화된 절대 XML 위치로 지정해야 합니다. 예를 들어 적응형 양식이 http://localhost:4502/myForms/bankTransaction.html에 *있고* 데이터 XML 파일이 C:/myTransactions/bankSummary.xml에 저장된 *경우*&#x200B;다음 URL에서 데이터가 있는 테이블을 볼 수 있습니다.
