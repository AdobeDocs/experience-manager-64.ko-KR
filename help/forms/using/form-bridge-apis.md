...
description: 외부 응용 프로그램은 FormBridge API를 사용하여 XFA 모바일 양식에 연결합니다. API는 부모 창에서 FormBridgeInitialized 이벤트를 전달합니다.
seo-description: 외부 응용 프로그램은 FormBridge API를 사용하여 XFA 모바일 양식에 연결합니다. API는 부모 창에서 FormBridgeInitialized 이벤트를 전달합니다.
...
### getFieldValue() API {#example-of-nbsp-getfieldvalue-api} 예
