...
**트러스트 관리자:** 관리 콘솔의 Trust Store Management 페이지에서 관리되는 PKI 신뢰 설정 및 PKI 자격 증명을 관리할 수 있습니다.
...
**AEM forms Content Space 관리자:** 관리 콘솔의 콘텐츠 서비스(더 이상 사용되지 않음) 페이지에서 설정을 보고 수정할 수 있습니다.

**AEM forms Contentspace 사용자:** 컨텐트 공간(더 이상 사용되지 않음) 웹 페이지에 로그인할 수 있음
...
**AEM forms IBM CM Connector 관리자:** 관리 콘솔의 IBM Content Manager용 커넥터 페이지에서 설정을 보고 수정할 수 있습니다.
...
**Rights Management 초대된 사용자 및 로컬 사용자 관리:** 관련 Rights Management 페이지에서 초대된 모든 사용자와 로컬 사용자를 관리하는 데 필요한 작업을 수행할 수 있습니다.

**Rights Management 정책 집합 관리자:** 관련 Rights Management 페이지의 모든 정책 세트에 필요한 모든 작업을 수행합니다.
...
**작업 공간 사용자:** Workspace 최종 사용자 응용 프로그램에 로그인할 수 있음

**출력 관리자:** 관리 콘솔의 출력 페이지에서 설정을 보고 수정할 수 있습니다.

**PDFG 관리자:** 관리 콘솔의 PDF Generator 페이지에서 설정을 보고 수정할 수 있습니다.

**PDFG 사용자:** PDF Generator의 모든 비관리 기능 이용

**Acrobat Reader DC 익스텐션 웹 애플리케이션:** Acrobat Reader DC 익스텐션 웹 애플리케이션 사용 가능
...
## 역할에 할당되는 사용자 결정 {#determine-who-is-assigned-to-a-role}
...
**구성 요소 삭제:** 시스템의 구성 요소 삭제

**구성 요소 읽기:** 시스템의 구성 요소 읽기

**컨텐트 공간 관리자:** 컨텐트 공간(더 이상 사용되지 않음) 관리자에 대한 권한

**컨텐트 공간 콘솔 로그인:** 컨텐트 공간(더 이상 사용되지 않음) 콘솔 로그인 권한
...
**도메인 컨트롤:** 인증 및 디렉토리 공급자를 비롯한 모든 사용자 관리 도메인에 대한 설정 만들기, 삭제 또는 수정
...
**리포지토리 위임:** 리소스에 대한 ACL 설정

**저장소 읽기:** 리소스 내용 보기

**저장소 트래버스:** 리소스 목록 요청에 리소스 포함 또는 리소스 메타데이터 읽기
...
**Rights Management 정책 세트 관리:** 모든 정책 집합 내에서 모든 정책 및 문서 관리

**Rights Management 정책 집합 추가 코디네이터:** 정책 집합 코디네이터 권한 추가, 제거 및 변경
...
**Rights Management 정책 집합 문서 게시자 관리:** 정책 세트를 만들 때 사용자에게 문서 게시자의 역할을 할당합니다. 문서 게시자는 정책으로 문서를 보호하는 사용자입니다.

**Rights Management 정책 집합 제거 코디네이터:** 정책 세트에서 정책 집합 코디네이터 제거

**Rights Management 정책 집합 폐지 문서:** 정책 세트의 문서에 대한 액세스 취소

**Rights Management 정책 집합 전환 정책:** 문서의 정책 전환

**Rights Management 정책 집합 취소 문서:** 문서 취소
...
**서비스 수정:** 시스템에서 서비스의 구성 속성을 수정합니다. IDE에서 서비스 잠금 및 잠금 해제, 서비스에서 끝점 추가 또는 제거 등이 포함됩니다

**서비스 보기:** 시스템의 모든 서비스 보기 여기에는 모든 프로세스 및 프로세스 변형이 포함됩니다.

**SERVICE_AGENT_PERM:** 프로세스를 통해 생성된 서비스에 대한 데이터 보기 및 프로세스 인스턴스 사용
...
**트래버스:** 리소스 목록 요청에 리소스 포함 또는 리소스 메타데이터 읽기
