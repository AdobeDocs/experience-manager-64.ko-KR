---
title: 오늘의 메시지 설정
seo-title: 오늘의 메시지 설정
description: 하루 중 메시지를 사용하면 Workspace 사용자 인터페이스의 시작 페이지에 표시할 메시지를 설정할 수 있습니다.
seo-description: 하루 중 메시지를 사용하면 Workspace 사용자 인터페이스의 시작 페이지에 표시할 메시지를 설정할 수 있습니다.
...
지원되는 태그에 대한 자세한 내용은 [Flex 언어 참조](https://www.adobe.com/support/documentation/en/flex/)에서 TextField 클래스에 대한 `htmlText` 속성의 정의를 참조하십시오.

## {#set-the-message-of-the-day} 일 메시지 설정
