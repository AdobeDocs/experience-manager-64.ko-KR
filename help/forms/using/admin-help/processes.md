...
title: 프로세스 관리
seo-title: 프로세스 관리
description: 프로세스 목록 페이지에는 사용자가 시작하거나 자동으로 시작된 프로세스가 표시됩니다. 프로세스 관리에 대해 자세히 알아보십시오.
seo-description: 프로세스 목록 페이지에는 사용자가 시작하거나 자동으로 시작된 프로세스가 표시됩니다. 프로세스 관리에 대해 자세히 알아보십시오.
...
## 프로세스 인스턴스 {#working-with-process-instances} 작업
...
### 프로세스 인스턴스 {#terminate-a-process-instances} 종료
...
## 작업 {#working-with-operations} 작업

작업 세부 정보 페이지에는 프로세스 중 하나의 작업 및 현재 사용자 지정에 대한 요약이 표시됩니다.

1. 관리 콘솔에서 서비스 > Forms 워크플로우 > Forms 워크플로우를 클릭합니다.
1. 프로세스 이름을 클릭하여 프로세스 인스턴스를 표시합니다. 프로세스 인스턴스를 눌러 프로세스 인스턴스 세부 사항 페이지를 표시한 다음 작업 세부 사항 페이지를 표시할 작업을 선택합니다.
