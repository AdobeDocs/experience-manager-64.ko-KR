...
컨텐츠 저장소 루트 디렉토리의 기본 위치는 *[GDS 루트]*/lccs_data이고, 여기서 *[GDS 루트]*&#x200B;는 [GDS 위치](files-back-recover.md#gds-location)에 설명된 위치입니다. 컨텐츠 저장소 루트 디렉토리에 있는 다음 디렉토리를 백업합니다.
...
인덱스 루트 디렉토리의 기본 위치는 각 노드의 *[aem-forms root]*/lucene-indexes입니다.
