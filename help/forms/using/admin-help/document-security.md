...
정책을 사용하여 문서를 보호할 수 있습니다. *정책*&#x200B;은 기밀 설정과 권한이 있는 사용자 목록이 포함된 정보 모음입니다. 정책에서 지정하는 기밀 설정에 따라 정책을 적용하는 문서를 받는 사람이 사용할 수 있는 방법이 결정됩니다. 예를 들어 받는 사람이 텍스트를 인쇄 또는 복사하거나 텍스트를 편집하거나 서명 및 주석을 보호된 문서에 추가할 수 있는지 여부를 지정할 수 있습니다.
