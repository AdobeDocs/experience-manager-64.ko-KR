...
컴퓨터 이름을 사용하여 서버에 액세스하는 경우(예: Internet Explorer에는 https://lcserver:8080*,*설정 없음). 점이 없는 URL(&quot;.&quot;)을 입력하면 Internet Explorer는 사이트를 로컬 인트라넷 사이트로 처리합니다. 사이트에 정규화된 이름을 사용하는 경우 사이트를 신뢰할 수 있는 사이트로 추가해야 합니다.
