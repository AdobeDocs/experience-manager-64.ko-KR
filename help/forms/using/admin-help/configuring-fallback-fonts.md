...
1. aem-forms root *[/configurationManager/export]*&#x200B;디렉토리에서 adobe-livecycle-appserver *[]*.ear 파일로 이동하여 백업 복사본을 만들고 원본 파일의 압축을 해제합니다.
...
1. 필요에 따라 일반 및 폴백 글꼴 위치와 이름을 수정하고 파일을 저장합니다.
   ...
   FontManagerResources.properties 파일의 글꼴 항목은 *[aem-forms 루트]*/글꼴 디렉토리에 상대적입니다. 기본 AEM 양식 글꼴이 아닌 글꼴을 지정하는 경우 이 디렉토리 구조 내에 해당 글꼴을 설치해야 합니다(기존 디렉토리 내 또는 새로 만든 글꼴).
