...
1. 다음 섹션에서 필요한 정보를 완료합니다.
   ...
   [HTML에서 PDF로 설정](/help/forms/using/admin-help/configuring-file-type-settings1.md#main-pars-heading-3)
   ...
   [Microsoft Visio 설정(Windows 전용)](/help/forms/using/admin-help/configuring-file-type-settings1.md#main-pars-header-1354428557)
