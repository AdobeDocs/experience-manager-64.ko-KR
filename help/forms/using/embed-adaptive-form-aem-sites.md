...
seo-title: AEM Sites 페이지에 적응형 양식 또는 대화형 커뮤니케이션 포함
description: AEM Sites 페이지에 적응형 양식을 포함할 수 있습니다. 사용자는 사이트 페이지를 종료하지 않고 양식을 작성하고 제출할 수 있습니다.
seo-description: AEM Sites 페이지에 적응형 양식을 포함할 수 있습니다. 사용자는 사이트 페이지를 종료하지 않고 양식을 작성하고 제출할 수 있습니다.
...
외부 웹 페이지에 적응형 양식을 포함하는 방법에 대한 내용은 [외부 웹 페이지에 적응형 양식 포함](/help/forms/using/embed-adaptive-form-external-web-page.md)을 참조하십시오.

AEM Sites 페이지에서 다음을 사용하여 적응형 양식 또는 대화형 커뮤니케이션을 추가할 수 있습니다.

* **[AEM Forms 컨테이너](/help/forms/using/embed-adaptive-form-aem-sites.md#af-component)**
구성 요소AEM Forms은 사이트 페이지에 추가할 수 있는 구성 요소를 제공합니다. AEM Forms 컨테이너 구성 요소를 사용하여 적응형 양식 및 대화형 커뮤니케이션을 포함할 수 있습니다.

* **[자산](/help/forms/using/embed-adaptive-form-aem-sites.md#asset-browser)**
브라우저 만드는 모든 양식 및 대화형 커뮤니케이션은 자산 아래에서 사용할 수 있습니다. 양식을 페이지에서 자산으로 드래그하여 놓을 수 있습니다.

## 전제 조건 {#prerequisites}

편집 가능한 템플릿을 사용하는 AEM Sites 페이지에 적응형 양식 또는 대화형 커뮤니케이션을 포함하려면 AEM Form 구성 요소가 관련 템플릿에서 허용된 구성 요소로 구성되어 있는지 확인하십시오. 자세한 내용은 [페이지 템플릿 만들기](/help/sites-authoring/templates.md)에서 **정책 및 속성(레이아웃 컨테이너)** 섹션을 참조하십시오.
...
1. AEM Forms 컨테이너 편집 대화 상자에서 다음을 지정합니다.
   ...
   * (적응형 양식만 해당) **게시물 제출**:양식 제출 시 트리거할 작업을 선택합니다. 감사 메시지를 표시하거나 감사 인사 페이지를 표시하도록 선택할 수 있습니다.
      ...
      * **제출 시 페이지 새로 고침**:포함된 적응형 양식이 포함된 페이지를 새로 고쳐 감사 인사 페이지를 표시할 수 있도록 합니다. 감사 인사 페이지는 페이지를 새로 고치지 않고 AEM Forms 컨테이너의 적응형 양식을 대체합니다. 이 옵션은 감사 인사 페이지를 표시하도록 선택하는 경우에만 사용할 수 있습니다.
...
* 편집 모드에서 사이트 페이지 내에서 적응형 양식 또는 대화형 커뮤니케이션을 탭한 다음, 새 창에서 **[!UICONTROL 편집]**&#x200B;을 누릅니다. 원본 양식은 수정할 수 있는 편집 모드로 열립니다.
