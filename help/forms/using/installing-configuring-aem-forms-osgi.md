...
적응형 양식, PDF 양식 및 HTML5 양식 설치 및 구성 적응형 양식용 Adobe Analytics와 Adobe Target을 구성하여 양식 사용을 분석하고 프로파일을 기반으로 사용자를 타깃팅합니다.
...
AEM Forms의 데이터 캡처 기능 설치 및 구성을 시작하기 전에 다음을 확인하십시오.
...
1. Deserialization 방화벽 **[!UICONTROL 구성을 검색하고 엽니다]**.
1. sun.util.calendar **[!UICONTROL 패키지를]** 화이트리스트 **** 필드에 추가합니다. **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
...
1. 레퍼러 필터 서비스를 구성합니다.
   ...
   Apache Felix 구성 관리자에 관리자로 로그인합니다. 구성 관리자의 기본 URL은 `https://[server]:[port_number]/system/console/configMgr`입니다. [ **[!UICONTROL 구성]** ] 메뉴에서 [Apache Sling Referrer **[!UICONTROL 필터] 옵션을]** 선택합니다. 호스트 허용 필드에 디스패처의 호스트 이름을 입력하여 레퍼러로 허용하고 저장을 **[!UICONTROL 클릭합니다]**. 항목의 형식은 `https://[server]:[port]`입니다.
...
1. 적응형 **[!UICONTROL 양식 및 대화형 통신 웹 채널 구성을]** 클릭하여 구성 값을 편집합니다. 구성 값 편집 대화 상자에서 적응형 양식 수 필드에 AEM Forms 서버의 인스턴스가 캐싱할 수 있는 최대 양식 또는 문서 **[!UICONTROL 수를 지정합니다]** . 기본값은 100입니다. **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
