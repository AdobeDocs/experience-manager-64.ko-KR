...
1. 자산을 선택하고 이전에 게시된 버전 **[!UICONTROL 으로 되돌리기를 탭하면]** ![reverttoreviouslapublishedversion이](assets/reverttopreviouslypublishedversion.png)표시됩니다.
...
1. 자산을 선택하고 **[!UICONTROL 삭제를]** ![누릅니다](assets/delete.png).
