...
1. 채널 **마법사** :
   ...
   1. 인쇄 템플릿으로 **create_first_ic_print_template** 을 지정하고 선택을 **누릅니다**. [ **웹 채널에기본으로 인쇄 사용] 확인란을 선택하지** 마십시오.
...
1. 왼쪽 창에서 **Data Sources** 탭을 선택하고 **호출** 데이터 모델 개체를 항목별 호출 **대상 영역에 드래그하여** 놓습니다. 호출 **데이터 모델 개체의 모든** 속성은 오른쪽 창의 항목별 호출 **대상 영역에 테이블 열로** 표시됩니다.
...
1. 다음 단계에 따라 대화형 통신에 하이퍼링크 텍스트에 스타일을 지정하여 단추로 표시합니다.
   ...
   1. Dimension 및 위치 **에 대한** 여백 **필드** 에서 **편집****아이콘을 누르고 RightMarginV50px 및을 동시에** ****&#x200B;설정합니다. 위쪽, 아래쪽 및 왼쪽 필드는 공백으로 설정됩니다.
...
1. 4단계에서 **** 웹 채널에기본으로 인쇄 사용 확인란을 선택하면 컨텐츠 및 바인딩이 인쇄 채널에서 웹 채널에 대해 자동으로 생성됩니다.
