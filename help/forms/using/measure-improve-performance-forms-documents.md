...
적응형 양식에 대한 A/B 테스트를 만들고 실행하려면 [AEM Forms](/help/forms/using/ab-testing-adaptive-forms.md#p-set-up-and-integrate-target-in-aem-forms-p)에서 Target 설정 및 통합에 설명된 대로 AEM Forms에서 Target을 구성하십시오.
...
양식 분석 보고서에 대한 자세한 내용은 [AEM Forms 분석 보고서 보기 및 이해](/help/forms/using/view-understand-aem-forms-analytics-reports.md)를 참조하십시오.
...
적응형 양식에 대한 A/B 테스트를 만드는 방법에 대한 자세한 내용은 적응형 양식](/help/forms/using/ab-testing-adaptive-forms.md)의 [A/B 테스트를 참조하십시오.
