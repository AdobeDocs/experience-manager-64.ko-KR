...
XFA를 참조하는 응용 양식에는 XFA에서 사용할 수 있는 필드와 함께 필드가 바인딩되어 있습니다. 양식 템플릿을 업데이트할 때 관련 응용 양식이 XFA와 동기화하려고 시도합니다. 자세한 내용은 관련 XFA와 [적응형 양식 동기화를 참조하십시오](/help/forms/using/synchronizing-adaptive-forms-xfa.md).
