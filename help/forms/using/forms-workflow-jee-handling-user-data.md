...
description: AEM Forms JEE 워크플로우는 비즈니스 프로세스를 디자인, 만들기 및 관리하는 도구를 제공합니다. 사용자 데이터 액세스 및 삭제, 워크플로우 개시자나 참여자가 알려진 경우 프로세스 인스턴스 ID 식별, 사용자 데이터가 기본 변수에 저장되어 있을 때 프로세스 인스턴스 ID 식별, 프로세스 인스턴스 ID를 기반으로 워크플로우 인스턴스에서 사용자 데이터 제거 및 고아 작업 작업에 대해 자세히 알아봅니다.
seo-description: AEM Forms JEE 워크플로우는 비즈니스 프로세스를 디자인, 만들기 및 관리하는 도구를 제공합니다. 사용자 데이터 액세스 및 삭제, 워크플로우 개시자나 참여자가 알려진 경우 프로세스 인스턴스 ID 식별, 사용자 데이터가 기본 변수에 저장되어 있을 때 프로세스 인스턴스 ID 식별, 프로세스 인스턴스 ID를 기반으로 워크플로우 인스턴스에서 사용자 데이터 제거 및 고아 작업 작업에 대해 자세히 알아봅니다.
...
AEM Forms JEE 워크플로우 프로세스 만들기에 대한 자세한 내용은 [Workbench 도움말](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/WorkbenchHelp.pdf)을 참조하십시오.
