...
1. 활성 시작 날짜 및 활성 날짜 **필드에서 날짜** 선택부터 **활성** 사이의날짜를 지정할 수 있습니다.

   *** 활성 시작** 및 **활성** 날짜 및 시간을 선택하는 경우, 자산은 각각 해당 시작 날짜/시간과 종료 날짜/시간 사이에서만 표시되고 루프됩니다.
...
1. 구성 요소 활성화(Component Activation) **대화 상자에서 활성** 및 **활성 **에서 **까지 날짜 및 시간을** 선택합니다. 예약 선택이 완료되면 확인 표시 아이콘을 클릭합니다.
