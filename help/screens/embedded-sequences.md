...
다음 구성 요소를 시퀀스 채널에 추가하는 선택 사항이 있습니다.
...
>[!NOTE]
>
>스크린 프로젝트에서 다른 구성 요소를 사용하는 방법에 대해 알려면 [채널에 구성 요소 추가](/help/screens/adding-components-to-a-channel.md)를 참조하십시오.
...
>
>*채널 경로*&#x200B;에 대해 자세히 알려면 스크린 작성에서 [채널 지정](/help/screens/channel-assignment.md)을 참조하십시오.
...
>
>*채널 역할*&#x200B;에 대해 자세히 알려면 스크린 작성에서 [채널 지정](/help/screens/channel-assignment.md)을 참조하십시오.
